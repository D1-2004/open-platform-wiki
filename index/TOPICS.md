...
- 导航栏定制：现行 [setNavigationBar](../docs/01-应用开发/03-Ogu5SlPY4t-客户端JSAPI/0045-jsapi-set-navigation-bar.md)；归档参考[导航栏透明（H5）](../docs/01-应用开发/03-Ogu5SlPY4t-客户端JSAPI/0864-the-microapplication-navigation-bar-is-transparent.md)、[左侧导航按钮文字](../docs/01-应用开发/03-Ogu5SlPY4t-客户端JSAPI/0786-set-left-navigation-button-text.md)；查任意 JSAPI 名用 `dkdoc jsapi <名>`（如 setOptionMenu 快照未收录——下否定结论前先查表再声明"快照未见"）
