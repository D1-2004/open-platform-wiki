...
group: "专属版客户端插件"
tab: "插件开发"
breadcrumb: "开发指南 > 开发 HarmonyOS 插件"
doc_id: "blFrFnwVwg"
updated_at: "2026-05-22 18:44:03"
---

> Source: https://open.dingtalk.com/document/development/create-plug-in-project
> Path: 专属版客户端插件 / 插件开发 / 开发指南 > 开发 HarmonyOS 插件
> Updated: 2026-05-22 18:44:03
...
3. 使用命令行创建第一个插件工程
   ...
   （2）在根目录中，使用命令行`hvigorw createDingtalkBundle -p bundleId=XXXX`，创建插件模块。如下图示例。
   ...
   > **[!NOTE]**
   >
   > 1. 假如需要修改BundleID，请同时修改工程中“dingtalk-bundle.json5”和“Bundle.ets”两个文件中的值。
   > 2. 命令创建的子工程名称默认格式：bundle\_{BundleID}。
   > 3. **请不要开启字节码方式编译，字节码方式编译存在较多问题，不建议使用。**
...
2. 参照文档[新建页面和路由](0018-new-page-and-route.md)编写设置页面。示例如下：
   ...
   ```
3. 使用设置项扩展点[设置项扩展点（HarmonyOS）](0024-set-item-extension-point-harmonyos.md),参照指导文档添加代码。示例如下：
