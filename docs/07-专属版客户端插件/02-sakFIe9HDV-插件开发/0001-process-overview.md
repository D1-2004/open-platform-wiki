...
group: "专属版客户端插件"
tab: "插件开发"
breadcrumb: "开发指南 > 开发 Android 插件"
doc_id: "L59bQVLpsB"
updated_at: "2026-05-22 18:13:22"
---

> Source: https://open.dingtalk.com/document/development/process-overview
> Path: 专属版客户端插件 / 插件开发 / 开发指南 > 开发 Android 插件
> Updated: 2026-05-22 18:13:22
...
2. 安装 Dingtalk DevKit 工具：
   ...
   - Mac系统：
     ...
     2. 单击设置图标，并单击 **Install plugin from Disk** ，选择已经下载好的 Dingtalk DevKit.zip 文件，安装并重启 IDE。
        ...
        ![](https://alidocs.oss-accelerate.aliyuncs.com/res/NybEnBQEjLLPlP13/img/576203a7-0777-4428-a617-2dea20348810.png#7949)
...
> **[!NOTE]**
>
> 建议同时阅读[配置插件依赖项](0006-client-specific-configuration-plugin-dependencies.md)章节，了解钉钉的插件构建产物配置说明。
...
3. **调试环境运行Crash，类找不到问题**

   NoClassDefFoundError 问题，通常是由于deb包信息缺失引起，请参考文档[常见的编译错误](0041-development-building-faq.md#f9502a802etoo)解决。
4. **调试环境已经验证通过了，集成包会遇到编译失败或者功能异常**
