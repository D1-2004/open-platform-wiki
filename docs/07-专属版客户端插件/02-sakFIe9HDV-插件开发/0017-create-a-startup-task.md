...
group: "专属版客户端插件"
tab: "插件开发"
breadcrumb: "开发参考 > HarmonyOS 插件 > 创建启动任务"
doc_id: "XKB0qNqrEl"
updated_at: "2025-10-15 17:02:13"
---

> Source: https://open.dingtalk.com/document/development/create-a-startup-task
> Path: 专属版客户端插件 / 插件开发 / 开发参考 > HarmonyOS 插件 > 创建启动任务
> Updated: 2025-10-15 17:02:13
...
> **[!NOTE]**
>
> 1. 启动任务会阻塞进入首页，因此**请务必在成功或失败后均调用 callback**，避免出现启动卡死现象。
> 2. 启动任务可能发生在账号未登录时（进入登录页面前触发调用），请做好登录态的逻辑处理。
