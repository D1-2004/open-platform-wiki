...
group: "专属版客户端插件"
tab: "插件开发"
breadcrumb: "开发参考 > 使用扩展点 > 截录屏控制扩展点 > 截录屏控制扩展点（HarmonyOS）"
doc_id: "fJ3yTbRZzY"
updated_at: "2025-10-15 17:02:24"
---

> Source: https://open.dingtalk.com/document/development/screen-extension-harmonyos
> Path: 专属版客户端插件 / 插件开发 / 开发参考 > 使用扩展点 > 截录屏控制扩展点 > 截录屏控制扩展点（HarmonyOS）
> Updated: 2025-10-15 17:02:24
...
| notifyDataChange() | 通知业务策略有变更，刷新 UIAbility 配置  **注意：请避免在 invokeSync(api='getAbilityPrivacyLevel') 中调用 notifyDataChange，否则会出现死循环。** |
| getData() | 无效接口 |
| invoke() | 无效接口 |
