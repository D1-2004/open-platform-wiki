...
group: "专属版客户端插件"
tab: "插件开发"
breadcrumb: "开发参考 > 使用扩展点 > Web容器生命周期扩展 > Web容器生命周期扩展（HarmonyOS）"
doc_id: "ofh2aRydMo"
updated_at: "2025-10-15 17:02:25"
---

> Source: https://open.dingtalk.com/document/development/web-extensions-harmonyos
> Path: 专属版客户端插件 / 插件开发 / 开发参考 > 使用扩展点 > Web容器生命周期扩展 > Web容器生命周期扩展（HarmonyOS）
> Updated: 2025-10-15 17:02:25
