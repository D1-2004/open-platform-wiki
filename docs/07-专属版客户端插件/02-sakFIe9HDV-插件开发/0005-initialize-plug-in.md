...
group: "专属版客户端插件"
tab: "插件开发"
breadcrumb: "开发参考 > Android 插件 > 初始化插件（MainBundle）"
doc_id: "dIEoNIxWyi"
updated_at: "2025-10-15 17:01:57"
---

> Source: https://open.dingtalk.com/document/development/initialize-plug-in
> Path: 专属版客户端插件 / 插件开发 / 开发参考 > Android 插件 > 初始化插件（MainBundle）
> Updated: 2025-10-15 17:01:57
