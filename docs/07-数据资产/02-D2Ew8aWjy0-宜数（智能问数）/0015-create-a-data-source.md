...
1. 单击“数据工厂”菜单，选择“数据源管理”，单击“新建数据源”按钮进入选择数据库类型界面。
   ...
   ![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1870954371/p890620.png)

2. 根据自有数据库的类型，选择数据库，单击“下一步”，进行数据源信息录入界面。

   ![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1870954371/p890621.png)
...
3. 填写数据库的连接信息，包括，名称，描述，连接地址，用户和密码，点击“测试连通性”进行连通性测试，连通性测试成功后，点击“确定”按钮进行保存数据源完成数据源的创建。
   ...
   ![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/5145754371/p889002.png)
