...
3. 配置数据集信息：
   ...
   ![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/6287946871/p772539.png)
4. 设置数据集字段：
   ...
   1. 选择单张表选择目标数据表，拖拽至指示板中。
      ...
      ![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/6287946871/p772543.png)
   2. 拖拽后，单击数据表名，进入选择字段页面。

      > 勾选你需要的字段，勾选需要字段后，✓ 状态发生变化，字段别名变为可编辑状态。

      ![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/6287946871/p772551.png)

      选择完成后，单击确认。既可以自动预览字段内容。

      ![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/6287946871/p772567.png)
   3. 设置完成后，单击**保存数据集**。
...
3. 配置数据集的信息：
   ...
   ![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/6287946871/p772584.png)配置完成后，保存数据集。
...
4. 跳转到连接平台，配置连接流：
   ...
   2. 配置触发事件，用户可自定义触发事件，以实际业务为准。配置请参考[配置触发事件](../../02-连接平台/02-XdgyZifJkr-我的连接/0002-configure-trigger-events-1.md)。
   3. 配置执行动作：
...
数据集创建完成后，你就可以进行使用了，详情参考[使用数据集](0010-dataopen-using-data-sets.md)。
...
- 数据表是否支持 JOIN，如何实现？
  ...
  3. 设置连接关系。
     ...
     ![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/6287946871/p772581.png)
