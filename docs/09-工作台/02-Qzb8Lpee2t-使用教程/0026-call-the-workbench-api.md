...
- [获取工作台插件检验的规则信息](../../01-应用开发/02-4a8AMF6u2A-服务端API/0991-you-can-call-this-operation-to-obtain-the-information-about.md)
- [获取工作台插件权限点](../../01-应用开发/02-4a8AMF6u2A-服务端API/0990-obtain-the-permissions-of-the-workbench-plug-in.md)
