---
title: "步骤二：创建组件"
source_url: "https://open.dingtalk.com/document/dingstart/step-2-create-components"
namespace: "dingstart"
slug: "step-2-create-components"
group: "工作台"
tab: "使用教程"
breadcrumb: "组件教程 > 全码组件 > 基础教程 > 步骤二：创建组件"
doc_id: "kmtTBJaumw"
updated_at: "2025-09-03 15:57:03"
---

> Source: https://open.dingtalk.com/document/dingstart/step-2-create-components
> Path: 工作台 / 使用教程 / 组件教程 > 全码组件 > 基础教程 > 步骤二：创建组件
> Updated: 2025-09-03 15:57:03
...
2. 打开[插件管理](https://open-dev.dingtalk.com/v1/fe/old#/bench-plugin)页面。
3. 单击**创建全码组件。**
