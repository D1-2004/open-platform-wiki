...
group: "连接平台"
tab: "连接器中心"
breadcrumb: "官方连接器 > 使用教程 > 工作通知 > 发送工作通知文本消息"
doc_id: "bwEalLyeAl"
updated_at: "2026-07-30 09:19:04"
---

> Source: https://open.dingtalk.com/document/connection/send-notification-message
> Path: 连接平台 / 连接器中心 / 官方连接器 > 使用教程 > 工作通知 > 发送工作通知文本消息
> Updated: 2026-07-30 09:19:04
...
3. 配置执行动作：
   ...
   3. 配置参数：
      ...
      2. 出入参配置：
         ...
         - [微应用id](../02-XdgyZifJkr-我的连接/0015-official-connector-generic-field-acquisition-1.md#7c21daa0ffp70)：选择输入值。
