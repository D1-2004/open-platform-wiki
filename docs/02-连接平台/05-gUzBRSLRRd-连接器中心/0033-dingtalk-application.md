---
title: "采购申请钉钉 OA 申请审批通过后同步到金蝶云星空"
source_url: "https://open.dingtalk.com/document/connection/dingtalk-application"
namespace: "connection"
slug: "dingtalk-application"
group: "连接平台"
tab: "连接器中心"
breadcrumb: "三方连接器 > 使用教程 > 金蝶云星空 > 采购申请钉钉 OA 申请审批通过后同步到金蝶云星空"
doc_id: "GUlkGnUsz2"
updated_at: "2026-05-19 19:46:22"
---

> Source: https://open.dingtalk.com/document/connection/dingtalk-application
> Path: 连接平台 / 连接器中心 / 三方连接器 > 使用教程 > 金蝶云星空 > 采购申请钉钉 OA 申请审批通过后同步到金蝶云星空
> Updated: 2026-05-19 19:46:22

# 采购申请钉钉 OA 申请审批通过后同步到金蝶云星空
...
2. 单击管理后台。进入后台管理页面。
   ...
   ![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/0452622071/p745443.png)
3. 创建表单，配置表单内容。

   ![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/0452622071/p745445.png)
4. 配置完成后，发布表单**。**

## 恭喜，你已完成全部配置！

1. 你可以根据上述创建的OA审批表单，发起审批实例。
2. 查看连接流的执行情况以及金蝶系统的数据同步情况。

   ![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/9153786071/p746818.png)
