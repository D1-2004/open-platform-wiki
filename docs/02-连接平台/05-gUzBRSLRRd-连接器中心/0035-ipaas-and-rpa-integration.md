...
工作通知接口需要应用的[agentId](../02-XdgyZifJkr-我的连接/0015-official-connector-generic-field-acquisition-1.md#7c21daa0ffp70)，目前可通过用户登录开发者后台，然后搜索应用，进入应用后复制对应的agentId。
...
4. 配置参数：
   ...
   - **微应用的id**：应用agentId，获取详情参见[应用Id](../02-XdgyZifJkr-我的连接/0015-official-connector-generic-field-acquisition-1.md#7c21daa0ffp70)。
...
2. 使用postman构建请求。
   ...
   - **请求地址：**上述步骤二、三中连接器中**发送给工作通知第一阶段RPA任务触发**的[Webhook](../02-XdgyZifJkr-我的连接/0013-using-connectors-1.md#636e0c4a67u8r)地址
