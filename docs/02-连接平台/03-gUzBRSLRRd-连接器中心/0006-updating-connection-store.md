...
group: "连接平台"
tab: "连接器中心"
breadcrumb: "内置工具 > 数据存储 > 使用数据存储更新连接项目数据"
doc_id: "7vrQrYNnAE"
updated_at: "2026-05-19 16:01:38"
---

> Source: https://open.dingtalk.com/document/connection/updating-connection-store
> Path: 连接平台 / 连接器中心 / 内置工具 > 数据存储 > 使用数据存储更新连接项目数据
> Updated: 2026-05-19 16:01:38
...
4. 配置执行动作（节点2），选择**内置工具 > 数据存储 > 新增或更新键值对**，并配置参数：
   ...
   ![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/3024864071/p754443.png)
5. 配置执行动作（节点3），选择**内置工具 > 数据存储 > 查询键值对**，并配置参数：
   ...
   ![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/3024864071/p754444.png)
6. 单击**保存草稿** > **调试**，查看调试效果。

   1. 保存并调试：

      ![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/3024864071/p754449.png)
   2. 查看调试效果：

      - 新增货更新键值对：

        ![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/3024864071/p754450.png)
      - 查询键值对：

        ![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/3024864071/p754452.png)
