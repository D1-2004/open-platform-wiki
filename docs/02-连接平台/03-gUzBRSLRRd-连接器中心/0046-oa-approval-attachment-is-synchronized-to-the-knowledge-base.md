...
group: "连接平台"
tab: "连接器中心"
breadcrumb: "官方连接器 > OA审批 > 使用教程 > OA审批附件同步到知识库"
doc_id: "883mSIfSHk"
updated_at: "2026-05-19 16:02:08"
---

> Source: https://open.dingtalk.com/document/connection/oa-approval-attachment-is-synchronized-to-the-knowledge-base
> Path: 连接平台 / 连接器中心 / 官方连接器 > OA审批 > 使用教程 > OA审批附件同步到知识库
> Updated: 2026-05-19 16:02:08
...
2. 拥有OA审批的管理员权限。
3. 拥有一个所在钉钉组织的[知识库](../../01-应用开发/02-4a8AMF6u2A-服务端API/0550-knowledge-base-overview.md)。
...
![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/4924134371/p887620.png)
...
3. 添加临时变量节点。
   ...
   1. **选择连接器-流程变量：**
      ...
      ![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/4924134371/p887614.png)
   2. **选择执行动作-**创建基本类型变量**：**

      ![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/4924134371/p887623.png)
   3. 设置入参：
...
4. 添加权限。
   ...
   ![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/4924134371/p887611.png)
5. 获取文件上传信息。
   ...
   ![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/4924134371/p887626.png)
6. 获取文件下载信息。
   ...
   ![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/4924134371/p887625.png)
7. 上传文件。
   ...
   ![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/4924134371/p887613.png)
8. 提交文件。
   ...
   ![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/4924134371/p887618.png)
9. 发布连接流。
...
2. 流程设计
   ...
   1. 设置审批人，本示例使用**自动通过**：
      ...
      ![image.gif](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/4924134371/p887612.gif)
   2. 添加连接器：

      ![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/4924134371/p887609.png)
   3. 选择连接器。

      ![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/4924134371/p887615.png)

      ![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/4924134371/p887624.png)

## **恭喜，你已完成全部配置！**

你已完成本教程的全部内容，可以开始测试。

1. 需提前创建[知识库和知识库目录](../../01-应用开发/02-4a8AMF6u2A-服务端API/0550-knowledge-base-overview.md)。
2. 附件大小建议在3MB以内。

   ![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/4924134371/p887603.png)

   ![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/4924134371/p887608.png)
