...
2. 配置执行动作：
   ...
   3. 配置参数：
      ...
      - **markdown格式正文**：选择**输入值**，本示例填写如下：
        ...
        > *提醒来自温柔、可爱、贴心的钉三多～*
        ```
      - **accessToken**：选择**输入值**，本示例填写：[机器人Webhook的access\_token值](../../01-应用开发/02-4a8AMF6u2A-服务端API/0789-faq-robot.md#cf081fe0c4jc1)。
      - **标题**：选择**输入值**，本示例填写：日报。
