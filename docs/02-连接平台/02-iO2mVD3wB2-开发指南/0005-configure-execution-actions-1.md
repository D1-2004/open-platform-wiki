...
> Path: 连接平台 / 开发指南 / 开发连接流 > 编排连接流程 > 配置执行动作
...
1. 单击**执行动作**节点，在连接流配置界面右侧弹出执行动作配置页。![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/5643786071/p760004.png)
2. 在连接器选择页面，浏览并找到你需要的连接器，并单击选中它。选定连接器后，系统会在“执行动作”页面，自动显示该连接器提供的所有可用执行动作。

   ![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/5643786071/p760008.png)
3. 选择需要的执行动作，进入配置参数页面。![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/5643786071/p760011.png)
...
> 如果你需要添加执行逻辑，请参考：[配置分支](0006-configuration-branch-1.md)/[配置子流程](0007-configure-sub-processes-1.md)。
...
![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/5643786071/p759997.png)
