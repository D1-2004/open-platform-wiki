...
doc_id: "T4til4gdSc"
updated_at: "2025-09-23 19:20:20"
---

> Source: https://open.dingtalk.com/document/connection/basic-auth-authentication-1
> Path: 连接平台 / 开发指南 / 开发参考 > 鉴权设置 > Basic Auth鉴权
> Updated: 2025-09-23 19:20:20
...
**设置鉴权字段**，固定使用username和password，无需设置，直接单击**下一步**。
...
3. **进行鉴权验证**
   ...
   ​填写账号名称和密码，单击**鉴权验证**，查看返回结果是否符合预期，最后单击**完成**。
