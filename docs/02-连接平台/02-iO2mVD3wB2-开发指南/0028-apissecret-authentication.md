...
doc_id: "MDJeI4fnWL"
updated_at: "2025-09-23 19:20:19"
---

> Source: https://open.dingtalk.com/document/connection/apissecret-authentication
> Path: 连接平台 / 开发指南 / 开发参考 > 鉴权设置 > API Secret鉴权
> Updated: 2025-09-23 19:20:19
...
**设置APISecret字段**，固定使用Api的私钥（apiSecret），填写APISecret值。
