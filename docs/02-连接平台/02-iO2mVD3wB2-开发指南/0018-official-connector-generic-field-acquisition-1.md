...
group: "连接平台"
tab: "开发指南"
breadcrumb: "开发连接器 > 开发参考 > 官方连接器通用字段获取"
doc_id: "uteDyhCiGo"
updated_at: "2025-10-21 14:06:58"
---

> Source: https://open.dingtalk.com/document/connection/official-connector-generic-field-acquisition-1
> Path: 连接平台 / 开发指南 / 开发连接器 > 开发参考 > 官方连接器通用字段获取
> Updated: 2025-10-21 14:06:58
...
![获取用户userId信息..png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/0140955861/p677250.png)

## **组织Id（corpId）**

企业的corpId，可在[开发者后台](https://open-dev.dingtalk.com/)右上角获取。

![corpId获取..png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/0140955861/p677251.png)

## **应用Id（agentId）**

应用在企业的AgentId可以在[开发中后台](https://open-dev.dingtalk.com/fe/app#/corp/app)中选择任意企业内部开发的钉钉应用，查看应用信息获取。

![应用agentId..png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/0140955861/p677252.png)
...
1. 单击编辑部门信息。
   ...
   ![查看部门id1..png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/0140955861/p677253.png)
2. 查看部门Id。

   ![查看部门id2..png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/0140955861/p677254.png)

## **文件Id（mediaId）**

获取方式参见[上传媒体文件](../../01-应用开发/02-4a8AMF6u2A-服务端API/0644-upload-media-files.md)。
...
2. 在Pre-request Script中填写获取钉钉access\_token：
   ...
   > **[!NOTE]**
   >
   > appKey和AppSecret，可通过[Client ID/Client Secret](https://open.dingtalk.com/document/development/development-basic-concepts#section-pje-9wf-l7c)获取。
...
![媒体文件postman请求..png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/2318976861/p683407.png)

3. 配置Body参数：

   需要选择form-data类型，并且media参数需要设置为File类型，然后上传本地文件后发送请求获取media\_id。

   ![配置媒体文件postman请求..png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/2318976861/p683408.png)
4. 选择文件并发起调用。

   ![获取mediaId 的postman..png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/2318976861/p683409.png)

## **机器人编码（robotCode）**

在[开发者后台](https://open-dev.dingtalk.com/fe/app#/corp/app)中选择任意企业内部开发的钉钉应用，点击左侧【消息推送】，即可找到RobotCode。

> **[!NOTE]**
>
> 查看RobotCode，需该机器人发布完成后，才可查看。

![复制robotCode..png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/0140955861/p677255.png)
...
![image..png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/0140955861/p677256.png)

## **用户UnionId（unionId）强烈不建议使用**
...
![群模板ID..png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/0140955861/p677257.png)
...
1. 依次填写参数，**发起调用**并使用钉钉客户端**扫码**连接控制台：
   ...
   - **filterNotOwnerGroup**：false。
     ...
     ![获取群id..png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/0140955861/p677258.png)
2. 连接控制台后，再次发起调用，即可选取群会话，获取群会话Id。

   ![获取会话Id..png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/0140955861/p677259.png)
...
![processCode..png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/0140955861/p677260.png)

## **审批钉盘空间ID（spaceId）**

获取方式参见[获取审批钉盘空间信息](../../01-应用开发/02-4a8AMF6u2A-服务端API/0498-obtains-the-information-about-approval-nail-disk.md)接口。
...
1. 单击宜搭应用。
   ...
   ![单击附件应用..png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/9062823861/p667629.png)
2. 单击**应用设置** > **部署运维。**

   ![应用参数宜搭..png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/9062823861/p667694.png)

## **互动卡片Id（cardTemplateId）**

可在[开发者后台](https://open-dev.dingtalk.com/)中选择卡片内容，选择对应卡片的id。

![卡片模板ID..png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/0140955861/p677261.png)
