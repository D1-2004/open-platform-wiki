...
group: "连接平台"
tab: "开发指南"
breadcrumb: "开发参考 > 鉴权设置 > 阿里云OSS签名鉴权"
doc_id: "RilYFQ2e7Y"
updated_at: "2025-09-23 19:20:24"
---

> Source: https://open.dingtalk.com/document/connection/alibaba-cloud-oss-signature-authentication-1
> Path: 连接平台 / 开发指南 / 开发参考 > 鉴权设置 > 阿里云OSS签名鉴权
> Updated: 2025-09-23 19:20:24
...
2. **设置鉴权字段，**并单击**下一步**：
   ...
   ![设置鉴权字段..png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/9751065861/p677182.png)
3. **设置鉴权请求参数，**并单击**保存配置并调试**。
   ...
   **HTTP请求头：**
   ...
   - **Date：表达式 >** `FORMATDATE(NOW(),'E, dd MMM yyyy HH:mm:ss z','GMT')`。
     ...
     ![表达式设置-oss..png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/9751065861/p677217.png)
   - **Authorization：Python。**

     ![python-oss..png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/9751065861/p677218.png)
...
4. 鉴权调试：
   ...
   1. 设置鉴权调试接口：
      ...
      ![设置入参-调试-oss..png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/9751065861/p677219.png)
   2. 单击**添加账户。**

      ![添加账户-oss..png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/9751065861/p677221.png)
   3. **完成账户添加。**

      ![完成账户添加..png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/8751065861/p677220.png)
   4. 单击**鉴权调试**，查看调试结果。

      ![调试结果-oss..png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/9751065861/p677222.png)
   5. 单击**完成调试**，实现保存。
      ...
      ![完成调试并保存-oss..png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/9751065861/p677223.png)
