...
group: "连接平台"
tab: "我的连接"
breadcrumb: "开发参考 > 鉴权设置 > 官方模板鉴权 > 阿里云API网关摘要签名鉴权"
doc_id: "eO9dNUw7i8"
updated_at: "2026-07-27 17:25:56"
---

> Source: https://open.dingtalk.com/document/connection/alibaba-cloud-api-gateway-digest-signature-authentication-1
> Path: 连接平台 / 我的连接 / 开发参考 > 鉴权设置 > 官方模板鉴权 > 阿里云API网关摘要签名鉴权
> Updated: 2026-07-27 17:25:56
...
- 拥有一个[阿里云API网关应用](https://apigateway.console.aliyun.com/?spm=5176.8465980.top-nav.22.432e1450nEHDnz&accounttraceid=59d7a2cdbc244dce96d55203fa295c49mgvw#/cn-hangzhou/apps/list?AppName=)并查询应用AppKey和AppSecret。
  ...
  ![应用Appkey..png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/6534415871/p677224.png)
...
2. **设置鉴权字段，**并单击**下一步**：
   ...
   ![设置鉴权字段-摘要签名..png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/6534415871/p677225.png)
3. **设置鉴权请求参数，**并单击**保存配置并调试**。
   ...
   **HTTP请求头：**
   ...
   - **x-ca-key：**阿里云API网关鉴权的AppKey，会作为鉴权字段传入，因此这里类型选择“鉴权字段”并选中“阿里云API网关的appKey”。
     ...
     ![key..png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/6534415871/p677230.png)
   - **x-ca-timestamp：**时间戳，这里类型选择“表达式”，进行获取当前时间戳的表达式配置。

     ![时间戳设置..png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/6534415871/p677227.png)
   - **x-ca-nonce**：主要用于防止重放攻击，这里类型选择“表达式”，进行UUID的表达式配置。

     ![uuid..png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/6534415871/p677228.png)
   - **x-ca-signature-method**：鉴权使用的加密算法，因为我们使用HmacSHA256的加密算法，所以这里类型选择“固定值”，值写入：`HmacSHA256`。

     ![menthod..png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/6534415871/p677229.png)
   - **x-ca-signature**：由于签名需要对包括运行时的入参进行排序等操作后再进行加密计算，因此这里使用Python脚本去实现。类型选择“Python脚本”。

     ![Python-参数鉴权..png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/6534415871/p677231.png)
...
4. 鉴权调试：
   ...
   1. 设置鉴权调试接口：
      ...
      ![设置调试接口..png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/4534415871/p677132.png)
   2. 设置鉴权调试参数：

      ![设置调试参数..png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/4534415871/p677135.png)
   3. 添加账户：

      ![添加账户..png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/4534415871/p677137.png)
   4. 单击**鉴权调试，**查看调试结果：

      ![单击调试..png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/6534415871/p677233.png)
   5. 单击**完成调试**，实现保存。

      ![完成调试并保存-1..png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/6534415871/p677234.png)
