...
doc_id: "HqyODTtiSw"
updated_at: "2026-07-24 09:20:46"
---

> Source: https://open.dingtalk.com/document/connection/connector-shelf-specification-1
> Path: 连接平台 / 我的连接 / 开发连接器 > 上架连接器
> Updated: 2026-07-24 09:20:46
...
- 完成[使用连接器](0013-using-connectors-1.md)的流程。
...
1. 检查基本信息填写：
   ...
   ![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/6406584871/p766350.png)
2. 检查出入参配置：
...
1. 登录[开发者后台](https://open-dev.dingtalk.com)，单击**开放能力** > **连接平台** > **服务商** > **上架连接器**。
   ...
   ![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/6406584871/p1090299.png)
...
3. 单击上架，按照提示完成连接器上架操作。
   ...
   ![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/6406584871/p766359.png)
