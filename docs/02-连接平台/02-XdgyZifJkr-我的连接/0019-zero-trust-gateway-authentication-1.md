...
doc_id: "l1nASqmdxN"
updated_at: "2026-07-27 17:25:43"
---

> Source: https://open.dingtalk.com/document/connection/zero-trust-gateway-authentication-1
> Path: 连接平台 / 我的连接 / 开发参考 > 鉴权设置 > 零信任网关鉴权
> Updated: 2026-07-27 17:25:43
...
2. **设置鉴权字段**，固定使用accessKeyId和accessKeySecret，无需设置，直接单击**下一步**。
...
6. **进行鉴权验证，**填写accessKeyId和accessKeySecret，单击**鉴权验证**，查看返回结果是否符合预期，最后单击**完成**。
   ...
   - 返回结果，如果鉴权失败，需要查看以下请求入参信息是否设置正确：
     ...
     - 请求方式**method**是否设置正确。
     - 请求头**headers**中**x-ztna-accessKeyId**是否设置正确，以及自动生成的**x-ztna-signature**是否加密正确。
