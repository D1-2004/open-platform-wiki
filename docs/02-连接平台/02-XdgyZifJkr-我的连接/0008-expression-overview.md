...
group: "连接平台"
tab: "我的连接"
breadcrumb: "开发连接流 > 参考 > 表达式"
doc_id: "XO4W01t05k"
updated_at: "2026-07-24 09:20:37"
---

> Source: https://open.dingtalk.com/document/connection/expression-overview
> Path: 连接平台 / 我的连接 / 开发连接流 > 参考 > 表达式
> Updated: 2026-07-24 09:20:37
...
**我的连接 >我的连接流**，并进入连接流编辑页面，在参数编辑界面选择表达式。

> **[!NOTE]**
>
> 表达式使用教程，可参考[审批表单数据同步至宜搭](../05-gUzBRSLRRd-连接器中心/0010-approval-form-appropriate.md)。

![iShot2022-03-23 16](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/7306584871/p421969.png)

![iShot2022-03-23 16](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/7306584871/p421972.png)
...
SORTED\_JSONSTRING(object | string), 可将JSON对象或JSON字符串转换为字段有序的字符串

用法：SORTED\_JSONSTRING({'b':1,'a':2})

示例：SORTED\_JSONSTRING({'b':1,'a':2}),结果为'{'a':2,'b':1}'
