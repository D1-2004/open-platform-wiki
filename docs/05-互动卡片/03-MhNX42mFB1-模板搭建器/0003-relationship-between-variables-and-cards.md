...
在[数据源面板](0002-outline-tree-panel.md#aa650d08c1k6k)中，我们可以查看当前卡片中所配置的变量信息。

![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/4122985871/p532265.png)

> **[!NOTE]**
>
> 关于变量的创建、编辑等操作请参考[数据源面板](0002-outline-tree-panel.md#aa650d08c1k6k)。

## **变量的作用**

通过[绑定变量](0004-binding-variables.md)，我们能做到：

- **展示变量内容**：绑定变量后，卡片就能使用变量的值来进行展示
- [条件渲染](0006-conditional-rendering-card.md)：结合变量的值来控制组件的显示与隐藏
- [循环渲染](0007-loop-rendering.md)：结合数组变量和「循环渲染容器」组件来循环渲染数组项
...
![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/4122985871/p526806.png)
