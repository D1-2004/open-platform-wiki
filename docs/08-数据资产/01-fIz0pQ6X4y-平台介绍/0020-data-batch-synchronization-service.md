...
1. 选择**首页**，并单击**去同步**。
   ...
   ![去同步..png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/3790482961/p677851.png)
2. 根据业务分析需要，选择相应的业务场景下的数据资产。本示例选用**用户考勤明细。**
   ...
   ![用户考勤明细](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/8013171861/p632432.png)

## **步骤二：分组发布数据接口**

不同维度的数据字段不能打包在同一个API中，所以需要分组发布接口。

![选中并发布](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/9013171861/p632436.png)
...
![审核中](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/9013171861/p632450.png)

## 步骤五：审核完成，数据同步至钉钉表格

数据同步申请审核完成后，在数据服务管理中，找到该服务，并点击右侧**同步**按钮，即可完成数据同步。

![同步](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/9013171861/p632457.png)
