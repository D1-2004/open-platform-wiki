...
1. 选择**创建数据服务**，单击**去生成**。
   ...
   ![去生成](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1803171861/p632607.png)
2. 查看数据资产目录。

   ![查看数据资产目录](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/5703171861/p632571.png)
...
1. 选择不同维度数据。
   ...
   - 组织维度：
     ...
     ![组织维度](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/5703171861/p632578.png)
   - 员工维度：

     ![员工维度](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/5703171861/p632579.png)
2. 单击**下一步。**

   ![下一步](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/5703171861/p632580.png)
3. 进行分组发布。

![分组发布](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/5703171861/p632582.png)

## **步骤三：数据图表配置**

进行数据图表配置并确认发布。

![图表配置](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1803171861/p632612.png)

图表发布形式有两种选项：

- **动态卡片：**可发送到指定人或群。

![动态卡片](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1803171861/p632618.png)
...
![创建并投放](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1803171861/p632636.png)
...
![上架](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/5703171861/p632600.png)
