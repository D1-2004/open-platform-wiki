...
- **调用Android应用授权登录接入流程报错'Caused by: android.content.pm.PackageManager$NameNotFoundException: com.alibaba.android.rimet'**
  ...
  答：调用[Android应用授权登录接入流程](../01-XOnnmGCTbn-开发指南/0106-mini-app-procedures-for-authorized-logon-to-ios-applications.md)出现上述错误时，需要在AndroidManifest.xml该文件内添加要查询的APP包名。
