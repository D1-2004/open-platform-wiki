---
title: "Range"
source_url: "https://open.dingtalk.com/document/development/range"
namespace: "development"
slug: "range"
group: "应用开发"
tab: "客户端JSAPI"
breadcrumb: "酷应用 > 文档酷应用 > API参考文档 > Range"
doc_id: "lBAv4EYJSG"
updated_at: "2025-08-27 18:09:30"
---

> Source: https://open.dingtalk.com/document/development/range
> Path: 应用开发 / 客户端JSAPI / 酷应用 > 文档酷应用 > API参考文档 > Range
> Updated: 2025-08-27 18:09:30
...
| 参数 | 类型 | 是否必传 | 说明 |
| --- | --- | --- | --- |
| numberFormat | string | 是 | 数字格式，详情参考[数字格式](https://open.dingtalk.com/document/orgapp-client/number-format#topic-2193105)。 |
