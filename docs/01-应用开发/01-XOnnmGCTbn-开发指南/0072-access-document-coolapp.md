...
1. 选择**扩展到文档。**。
2. 完善文档酷应用基本信息。
3. 上传文档酷应用Manifest文件，Manifest文件定义了文档酷应用的基础行为，详情参见[配置文档酷应用Manifest](0073-configure-document-coolapp-manifest.md)，示例如下：
...
文档酷应用完成发布后，需要完成[发布应用](0017-publish-dingtalk-application.md)，以便企业成员正式使用。建议发布前进行沙箱环境测试，确保功能稳定性和安全性。
