---
title: "获取多个表单实例ID"
source_url: "https://open.dingtalk.com/document/development/obtain-the-ids-of-multiple-form-instances"
namespace: "development"
slug: "obtain-the-ids-of-multiple-form-instances"
group: "应用开发"
tab: "服务端API"
breadcrumb: "历史文档（不推荐） > 宜搭 > 表单 > 获取多个表单实例ID"
doc_id: "5ycpaVDdtN"
updated_at: "2025-09-08 19:03:41"
---

> Source: https://open.dingtalk.com/document/development/obtain-the-ids-of-multiple-form-instances
> Path: 应用开发 / 服务端API / 历史文档（不推荐） > 宜搭 > 表单 > 获取多个表单实例ID
> Updated: 2025-09-08 19:03:41
...
>
> - 如果未使用本接口，推荐使用[获取多个表单实例ID](https://open.dingtalk.com/document/orgapp/api-searchformdataidlist-v2)接口。
...
```
POST /v1.0/yida/forms/instances/ids/{appType}/{formUuid}?pageNumber=Integer&pageSize=Integer HTTP/1.1
...
```
POST /v1.0/yida/forms/instances/ids/APP_PBKTxxx/FORM-EF6Y4Gxxx?pageNumber=1&pageSize=100 HTTP/1.1
Host:api.dingtalk.com
...
public class Sample {
    ...
    public static void main(String[] args_) throws Exception {
        ...
        searchFormDataIdListHeaders.xAcsDingtalkAccessToken = "<your access token>";
        SearchFormDataIdListRequest searchFormDataIdListRequest = new SearchFormDataIdListRequest()
                ...
                .setLanguage("zh_CN")
                .setSearchFieldJson("123")
                .setUserId("manager123")
                .setOriginatorId("manager123")
                .setCreateToTimeGMT("2021-05-01")
                .setCreateFromTimeGMT("2021-05-01");
        try {
            client.searchFormDataIdListWithOptions("APP_PBKTxxx", "FORM-EF6Y4Gxxx", searchFormDataIdListRequest, searchFormDataIdListHeaders, new RuntimeOptions());
...
class Sample:
    ...
    def main(
        ...
        search_form_data_id_list_headers = dingtalkyida__1__0_models.SearchFormDataIdListHeaders()
        search_form_data_id_list_headers.x_acs_dingtalk_access_token = '<your access token>'
        search_form_data_id_list_request = dingtalkyida__1__0_models.SearchFormDataIdListRequest(
...
class Sample {
    ...
    public static function main($args){
        ...
        $searchFormDataIdListHeaders = new SearchFormDataIdListHeaders([]);
        $searchFormDataIdListHeaders->xAcsDingtalkAccessToken = "<your access token>";
        $searchFormDataIdListRequest = new SearchFormDataIdListRequest([
            "modifiedToTimeGMT" => "2021-09-10",
            "systemToken" => "hexxxx",
            "modifiedFromTimeGMT" => "2021-05-01",
            "language" => "zh_CN",
...
func _main (args []*string) (_err error) {
  ...
  searchFormDataIdListHeaders := &dingtalkyida_1_0.SearchFormDataIdListHeaders{}
  searchFormDataIdListHeaders.XAcsDingtalkAccessToken = tea.String("<your access token>")
  searchFormDataIdListRequest := &dingtalkyida_1_0.SearchFormDataIdListRequest{
    ...
    SearchFieldJson: tea.String("123"),
  ...
  tryErr := func()(_e error) {
    ...
    _, _err = client.SearchFormDataIdListWithOptions(tea.String("APP_PBKTxxx"), tea.String("FORM-EF6Y4Gxxx"), searchFormDataIdListRequest, searchFormDataIdListHeaders, &util.RuntimeOptions{})
    if _err != nil {
      return _err
    }
...
export default class Client {
  ...
  static async main(args: string[]): Promise<void> {
    ...
    let searchFormDataIdListHeaders = new $dingtalkyida_1_0.SearchFormDataIdListHeaders({ });
    searchFormDataIdListHeaders.xAcsDingtalkAccessToken = "<your access token>";
    let searchFormDataIdListRequest = new $dingtalkyida_1_0.SearchFormDataIdListRequest({
      modifiedToTimeGMT: "2021-09-10",
      systemToken: "hexxxx",
      modifiedFromTimeGMT: "2021-05-01",
      language: "zh_CN",
    ...
    try {
      await client.searchFormDataIdListWithOptions("APP_PBKTxxx", "FORM-EF6Y4Gxxx", searchFormDataIdListRequest, searchFormDataIdListHeaders, new $Util.RuntimeOptions({ }));
    } catch (err) {
...
namespace AlibabaCloud.SDK.Sample
{
    public class Sample 
    {
        ...
        public static void Main(string[] args)
        {
            ...
            AlibabaCloud.SDK.Dingtalkyida_1_0.Models.SearchFormDataIdListHeaders searchFormDataIdListHeaders = new AlibabaCloud.SDK.Dingtalkyida_1_0.Models.SearchFormDataIdListHeaders();
            searchFormDataIdListHeaders.XAcsDingtalkAccessToken = "<your access token>";
            AlibabaCloud.SDK.Dingtalkyida_1_0.Models.SearchFormDataIdListRequest searchFormDataIdListRequest = new AlibabaCloud.SDK.Dingtalkyida_1_0.Models.SearchFormDataIdListRequest
            {
                ModifiedToTimeGMT = "2021-09-10",
                SystemToken = "hexxxx",
                ModifiedFromTimeGMT = "2021-05-01",
            ...
            try
            {
                client.SearchFormDataIdListWithOptions("APP_PBKTxxx", "FORM-EF6Y4Gxxx", searchFormDataIdListRequest, searchFormDataIdListHeaders, new AlibabaCloud.TeaUtil.Models.RuntimeOptions());
            }
            catch (TeaException err)
            {
...
int main(int argc, char *args[]) {
  ...
  shared_ptr<Alibabacloud_Dingtalkyida_1_0::SearchFormDataIdListHeaders> searchFormDataIdListHeaders = make_shared<Alibabacloud_Dingtalkyida_1_0::SearchFormDataIdListHeaders>();
  searchFormDataIdListHeaders->xAcsDingtalkAccessToken = make_shared<string>("<your access token>");
  shared_ptr<Alibabacloud_Dingtalkyida_1_0::SearchFormDataIdListRequest> searchFormDataIdListRequest = make_shared<Alibabacloud_Dingtalkyida_1_0::SearchFormDataIdListRequest>(map<string, boost::any>({
    ...
    {"searchFieldJson", boost::any(string("123"))},
  ...
  try {
    client->searchFormDataIdListWithOptions(make_shared<string>("APP_PBKTxxx"), make_shared<string>("FORM-EF6Y4Gxxx"), searchFormDataIdListRequest, searchFormDataIdListHeaders, make_shared<Darabonba_Util::RuntimeOptions>(Darabonba_Util::RuntimeOptions()));
  }
