...
> **[!IMPORTANT]**
>
> 当前接口已完成升级迭代且不再支持新应用申请，存量应用调用不受影响，建议未接入的开发者使用[批量设置企业群管理员](0740-batch-setup-group-administrator.md)接口，已接入的开发者结合实际尽快完成迁移。
...
| 名称 | 类型 | 是否必填 | 示例值 | 描述 |
| --- | --- | --- | --- | --- |
| chatid | String | 是 | chat14432xxxx | 群会话ID，可通过[创建群](1458-session-management-creates-groups.md)接口获取chatid参数值。 |
