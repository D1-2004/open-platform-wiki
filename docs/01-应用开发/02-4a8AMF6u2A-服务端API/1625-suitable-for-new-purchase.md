---
title: "新购宜搭产品"
source_url: "https://open.dingtalk.com/document/development/suitable-for-new-purchase"
namespace: "development"
slug: "suitable-for-new-purchase"
group: "应用开发"
tab: "服务端API"
breadcrumb: "历史文档（不推荐） > 宜搭 > 应用 > 新购宜搭产品"
doc_id: "xV9PHjYnOr"
updated_at: "2025-09-08 19:03:50"
---

> Source: https://open.dingtalk.com/document/development/suitable-for-new-purchase
> Path: 应用开发 / 服务端API / 历史文档（不推荐） > 宜搭 > 应用 > 新购宜搭产品
> Updated: 2025-09-08 19:03:50
...
```
POST /v1.0/yida/apps/freshOrders HTTP/1.1
...
public class Sample {
    ...
    public static void main(String[] args_) throws Exception {
        ...
        BuyFreshOrderHeaders buyFreshOrderHeaders = new BuyFreshOrderHeaders();
        buyFreshOrderHeaders.xAcsDingtalkAccessToken = "<your access token>";
        BuyFreshOrderRequest buyFreshOrderRequest = new BuyFreshOrderRequest()
                .setProduceCode("yun-1234")
                .setInstanceId("12")
                .setInstanceName("A发起的实例")
                .setAccessKey("hexaaaa")
                .setCallerUnionId("44234122")
                .setChargeType("subscribe")
                .setEndTimeGMT(1234567891234L)
                .setBeginTimeGMT(1234567891234L)
                .setAccountNumber("123")
                .setCommerceType("subscribe")
                .setCommodityType("standard");
        try {
            client.buyFreshOrderWithOptions(buyFreshOrderRequest, buyFreshOrderHeaders, new RuntimeOptions());
...
class Sample:
    ...
    def main(
        ...
        buy_fresh_order_headers = dingtalkyida__1__0_models.BuyFreshOrderHeaders()
        buy_fresh_order_headers.x_acs_dingtalk_access_token = '<your access token>'
        buy_fresh_order_request = dingtalkyida__1__0_models.BuyFreshOrderRequest(
        ...
        try:
            client.buy_fresh_order_with_options(buy_fresh_order_request, buy_fresh_order_headers, util_models.RuntimeOptions())
    ...
    async def main_async(
        ...
        try:
            await client.buy_fresh_order_with_options_async(buy_fresh_order_request, buy_fresh_order_headers, util_models.RuntimeOptions())
        except Exception as err:
            if not UtilClient.empty(err.code) and not UtilClient.empty(err.message):
                # err 中含有 code 和 message 属性，可帮助开发定位问题
                pass
...
class Sample {
    ...
    public static function main($args){
        ...
        $buyFreshOrderHeaders = new BuyFreshOrderHeaders([]);
        $buyFreshOrderHeaders->xAcsDingtalkAccessToken = "<your access token>";
        $buyFreshOrderRequest = new BuyFreshOrderRequest([
            "produceCode" => "yun-1234",
            "instanceId" => "12",
            "instanceName" => "A发起的实例",
            "accessKey" => "hexaaaa",
...
func _main (args []*string) (_err error) {
  ...
  buyFreshOrderHeaders := &dingtalkyida_1_0.BuyFreshOrderHeaders{}
  buyFreshOrderHeaders.XAcsDingtalkAccessToken = tea.String("<your access token>")
  buyFreshOrderRequest := &dingtalkyida_1_0.BuyFreshOrderRequest{
    ...
    ChargeType: tea.String("subscribe"),
    ...
    CommodityType: tea.String("standard"),
  }
  tryErr := func()(_e error) {
    ...
    _, _err = client.BuyFreshOrderWithOptions(buyFreshOrderRequest, buyFreshOrderHeaders, &util.RuntimeOptions{})
    if _err != nil {
      return _err
    }
...
export default class Client {
  ...
  static async main(args: string[]): Promise<void> {
    ...
    let buyFreshOrderHeaders = new $dingtalkyida_1_0.BuyFreshOrderHeaders({ });
    buyFreshOrderHeaders.xAcsDingtalkAccessToken = "<your access token>";
    let buyFreshOrderRequest = new $dingtalkyida_1_0.BuyFreshOrderRequest({
      produceCode: "yun-1234",
      instanceId: "12",
      instanceName: "A发起的实例",
      accessKey: "hexaaaa",
    ...
    try {
      await client.buyFreshOrderWithOptions(buyFreshOrderRequest, buyFreshOrderHeaders, new $Util.RuntimeOptions({ }));
    } catch (err) {
...
namespace AlibabaCloud.SDK.Sample
{
    public class Sample 
    {
        ...
        public static void Main(string[] args)
        {
            ...
            AlibabaCloud.SDK.Dingtalkyida_1_0.Models.BuyFreshOrderHeaders buyFreshOrderHeaders = new AlibabaCloud.SDK.Dingtalkyida_1_0.Models.BuyFreshOrderHeaders();
            buyFreshOrderHeaders.XAcsDingtalkAccessToken = "<your access token>";
            AlibabaCloud.SDK.Dingtalkyida_1_0.Models.BuyFreshOrderRequest buyFreshOrderRequest = new AlibabaCloud.SDK.Dingtalkyida_1_0.Models.BuyFreshOrderRequest
            {
                ProduceCode = "yun-1234",
                InstanceId = "12",
                InstanceName = "A发起的实例",
            ...
            try
            {
                client.BuyFreshOrderWithOptions(buyFreshOrderRequest, buyFreshOrderHeaders, new AlibabaCloud.TeaUtil.Models.RuntimeOptions());
            }
            catch (TeaException err)
            {
...
int main(int argc, char *args[]) {
  ...
  shared_ptr<Alibabacloud_Dingtalkyida_1_0::BuyFreshOrderHeaders> buyFreshOrderHeaders = make_shared<Alibabacloud_Dingtalkyida_1_0::BuyFreshOrderHeaders>();
  buyFreshOrderHeaders->xAcsDingtalkAccessToken = make_shared<string>("<your access token>");
  shared_ptr<Alibabacloud_Dingtalkyida_1_0::BuyFreshOrderRequest> buyFreshOrderRequest = make_shared<Alibabacloud_Dingtalkyida_1_0::BuyFreshOrderRequest>(map<string, boost::any>({
    ...
    {"chargeType", boost::any(string("subscribe"))},
    ...
    {"commodityType", boost::any(string("standard"))}
  }));
  try {
    client->buyFreshOrderWithOptions(buyFreshOrderRequest, buyFreshOrderHeaders, make_shared<Darabonba_Util::RuntimeOptions>(Darabonba_Util::RuntimeOptions()));
  }
