...
slug: "obtains-the-completed-approval-tasks-in-an-organization"
group: "应用开发"
tab: "服务端API"
breadcrumb: "宜搭 > 任务 > 获取组织内已完成的审批任务"
doc_id: "jQxfB5syz4"
updated_at: "2025-10-09 18:05:49"
---

> Source: https://open.dingtalk.com/document/development/obtains-the-completed-approval-tasks-in-an-organization
> Path: 应用开发 / 服务端API / 宜搭 > 任务 > 获取组织内已完成的审批任务
> Updated: 2025-10-09 18:05:49
...
| 字段 | 值 |
| --- | --- |
| HTTP URL | https://api.dingtalk.com/v1.0/yida/tasks/completedTasks/{corpId}/{userId} |
| HTTP Method | GET |
| 支持的应用类型 | appType-企业内部应用　appType-第三方企业应用 |
| 权限要求 | permission-Yida.Task.Read-宜搭任务读权限 |
...
public class Sample {
    ...
    public static void main(String[] args_) throws Exception {
        ...
        GetCorpAccomplishmentTasksHeaders getCorpAccomplishmentTasksHeaders = new GetCorpAccomplishmentTasksHeaders();
        getCorpAccomplishmentTasksHeaders.xAcsDingtalkAccessToken = "<your access token>";
        GetCorpAccomplishmentTasksRequest getCorpAccomplishmentTasksRequest = new GetCorpAccomplishmentTasksRequest()
                .setPageSize(10)
                .setLanguage("zh_CN")
                .setPageNumber(1)
                .setKeyword("{}")
                ...
                .setToken("adfasdadfasfda112adfaf");
        try {
            client.getCorpAccomplishmentTasksWithOptions("ding123", "manager123", getCorpAccomplishmentTasksRequest, getCorpAccomplishmentTasksHeaders, new RuntimeOptions());
...
class Sample:
    ...
    def main(
        ...
        get_corp_accomplishment_tasks_headers = dingtalkyida__1__0_models.GetCorpAccomplishmentTasksHeaders()
        get_corp_accomplishment_tasks_headers.x_acs_dingtalk_access_token = '<your access token>'
        get_corp_accomplishment_tasks_request = dingtalkyida__1__0_models.GetCorpAccomplishmentTasksRequest(
            page_size=10,
            language='zh_CN',
            page_number=1,
            keyword='{}',
            ...
            token='adfasdadfasfda112adfaf'
        )
        try:
            client.get_corp_accomplishment_tasks_with_options('ding123', 'manager123', get_corp_accomplishment_tasks_request, get_corp_accomplishment_tasks_headers, util_models.RuntimeOptions())
    ...
    async def main_async(
        ...
        try:
            await client.get_corp_accomplishment_tasks_with_options_async('ding123', 'manager123', get_corp_accomplishment_tasks_request, get_corp_accomplishment_tasks_headers, util_models.RuntimeOptions())
        except Exception as err:
            if not UtilClient.empty(err.code) and not UtilClient.empty(err.message):
                # err 中含有 code 和 message 属性，可帮助开发定位问题
                pass
...
class Sample {
    ...
    public static function main($args){
        ...
        $getCorpAccomplishmentTasksHeaders = new GetCorpAccomplishmentTasksHeaders([]);
        $getCorpAccomplishmentTasksHeaders->xAcsDingtalkAccessToken = "<your access token>";
        $getCorpAccomplishmentTasksRequest = new GetCorpAccomplishmentTasksRequest([
            "pageSize" => 10,
            "language" => "zh_CN",
            "pageNumber" => 1,
            "keyword" => "{}",
...
func _main (args []*string) (_err error) {
  ...
  getCorpAccomplishmentTasksHeaders := &dingtalkyida_1_0.GetCorpAccomplishmentTasksHeaders{}
  getCorpAccomplishmentTasksHeaders.XAcsDingtalkAccessToken = tea.String("<your access token>")
  getCorpAccomplishmentTasksRequest := &dingtalkyida_1_0.GetCorpAccomplishmentTasksRequest{
    ...
    Token: tea.String("adfasdadfasfda112adfaf"),
  }
  tryErr := func()(_e error) {
    ...
    _, _err = client.GetCorpAccomplishmentTasksWithOptions(tea.String("ding123"), tea.String("manager123"), getCorpAccomplishmentTasksRequest, getCorpAccomplishmentTasksHeaders, &util.RuntimeOptions{})
    if _err != nil {
      return _err
    }
...
export default class Client {
  ...
  static async main(args: string[]): Promise<void> {
    ...
    let getCorpAccomplishmentTasksHeaders = new $dingtalkyida_1_0.GetCorpAccomplishmentTasksHeaders({ });
    getCorpAccomplishmentTasksHeaders.xAcsDingtalkAccessToken = "<your access token>";
    let getCorpAccomplishmentTasksRequest = new $dingtalkyida_1_0.GetCorpAccomplishmentTasksRequest({
      pageSize: 10,
      language: "zh_CN",
      pageNumber: 1,
      keyword: "{}",
    ...
    try {
      await client.getCorpAccomplishmentTasksWithOptions("ding123", "manager123", getCorpAccomplishmentTasksRequest, getCorpAccomplishmentTasksHeaders, new $Util.RuntimeOptions({ }));
    } catch (err) {
...
namespace AlibabaCloud.SDK.Sample
{
    public class Sample 
    {
        ...
        public static void Main(string[] args)
        {
            ...
            AlibabaCloud.SDK.Dingtalkyida_1_0.Models.GetCorpAccomplishmentTasksHeaders getCorpAccomplishmentTasksHeaders = new AlibabaCloud.SDK.Dingtalkyida_1_0.Models.GetCorpAccomplishmentTasksHeaders();
            getCorpAccomplishmentTasksHeaders.XAcsDingtalkAccessToken = "<your access token>";
            AlibabaCloud.SDK.Dingtalkyida_1_0.Models.GetCorpAccomplishmentTasksRequest getCorpAccomplishmentTasksRequest = new AlibabaCloud.SDK.Dingtalkyida_1_0.Models.GetCorpAccomplishmentTasksRequest
            {
                PageSize = 10,
                Language = "zh_CN",
                PageNumber = 1,
            ...
            try
            {
                client.GetCorpAccomplishmentTasksWithOptions("ding123", "manager123", getCorpAccomplishmentTasksRequest, getCorpAccomplishmentTasksHeaders, new AlibabaCloud.TeaUtil.Models.RuntimeOptions());
            }
            catch (TeaException err)
            {
...
int main(int argc, char *args[]) {
  ...
  shared_ptr<Alibabacloud_Dingtalkyida_1_0::GetCorpAccomplishmentTasksHeaders> getCorpAccomplishmentTasksHeaders = make_shared<Alibabacloud_Dingtalkyida_1_0::GetCorpAccomplishmentTasksHeaders>();
  getCorpAccomplishmentTasksHeaders->xAcsDingtalkAccessToken = make_shared<string>("<your access token>");
  shared_ptr<Alibabacloud_Dingtalkyida_1_0::GetCorpAccomplishmentTasksRequest> getCorpAccomplishmentTasksRequest = make_shared<Alibabacloud_Dingtalkyida_1_0::GetCorpAccomplishmentTasksRequest>(map<string, boost::any>({
    ...
    {"token", boost::any(string("adfasdadfasfda112adfaf"))}
  }));
  try {
    client->getCorpAccomplishmentTasksWithOptions(make_shared<string>("ding123"), make_shared<string>("manager123"), getCorpAccomplishmentTasksRequest, getCorpAccomplishmentTasksHeaders, make_shared<Darabonba_Util::RuntimeOptions>(Darabonba_Util::RuntimeOptions()));
  }
...
| data | Array | 已完成的审批任务列表。 |
| originatorNickName | String | 发起人昵称。 |
| processInstanceId | String | 流程实例ID。 |
| originatorName | String | 发起人姓名。 |
| finishTimeGMT | String | 结束时间。 |
| activeTimeGMT | String | 激活时间。 |
| actualActionerId | String | 实际执行人ID。 |
| originatorEmail | String | 发起人邮箱。 |
| title | String | 标题 |
| outResultName | String | 结果名称。 |
| outResult | String | 审批结果，取值：   - agree：同意 - disagree：拒绝 |
| originatorPhoto | String | 发起人照片。 |
| taskType | String | 任务类型。 |
| originatorNickNameInEnglish | String | 发起人英文昵称。 |
| createTimeGMT | String | 创建时间。 |
| titleInEnglish | String | 标题英文。 |
| appType | String | 应用ID。 |
| originatorNameInEnglish | String | 发起人英文名。 |
| originatorId | String | 根据流程发起人工号查询。 |
| taskId | String | 任务ID。 |
| status | String | 状态。 |
...

{
  ...
  "data" : [ {
    ...
    "titleInEnglish" : "title A",
    "appType" : "APP_PBKTxxx",
    "originatorNameInEnglish" : "XiaoHong LI",
