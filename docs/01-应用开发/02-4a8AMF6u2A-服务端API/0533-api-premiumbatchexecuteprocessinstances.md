...
doc_id: "F9q1n3Pi47"
updated_at: "2025-09-11 21:04:34"
---

> Source: https://open.dingtalk.com/document/development/api-premiumbatchexecuteprocessinstances
> Path: 应用开发 / 服务端API / OA 审批 > 高级版专享接口 > 官方 OA 审批 > 审批任务 > 批量同意或拒绝审批任务
> Updated: 2025-09-11 21:04:34
...
| taskId | Long | 是 | 任务ID，可调用[获取单个审批实例详情](0494-obtains-the-details-of-a-single-approval-instance-pop.md)接口获取`taskId`参数值。 |
...
| actionerUserId | String | 是 | 实际执行人用户ID，可通过调用[获取单个审批实例详情](0494-obtains-the-details-of-a-single-approval-instance-pop.md)接口获取。 |
