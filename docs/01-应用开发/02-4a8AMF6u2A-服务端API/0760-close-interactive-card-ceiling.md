...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| outTrackId | String | 是 | 卡片的外部ID，最大长度64，与[创建卡片](0778-interface-for-creating-a-card-instance.md)/[创建并投放卡片](0781-create-and-deliver-cards.md)中的 outTrackId 保持一致。也可在对应模板的**卡片实例管理**中获取：  image |
