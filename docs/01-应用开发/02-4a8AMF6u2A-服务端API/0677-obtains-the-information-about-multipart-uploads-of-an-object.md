...
步骤一：调用[初始化文件分片上传](0676-initialize-a-multipart-upload-object.md)接口，获取上传标识uploadKey。
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| uploadKey | String | 是 | 上传唯一标识，调用[初始化文件分片上传](0676-initialize-a-multipart-upload-object.md)接口，获取上传标识uploadKey。 |
