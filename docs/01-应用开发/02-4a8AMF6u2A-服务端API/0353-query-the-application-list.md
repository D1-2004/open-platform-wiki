...
slug: "query-the-application-list"
group: "应用开发"
tab: "服务端API"
breadcrumb: "宜搭 > 应用 > 查询宜搭应用列表"
doc_id: "R9TaAl73Nc"
updated_at: "2025-10-09 18:05:57"
---

> Source: https://open.dingtalk.com/document/development/query-the-application-list
> Path: 应用开发 / 服务端API / 宜搭 > 应用 > 查询宜搭应用列表
> Updated: 2025-10-09 18:05:57
...
| 字段 | 值 |
| --- | --- |
| HTTP URL | https://api.dingtalk.com/v1.0/yida/organizations/applications |
| HTTP Method | GET |
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| appFilter | String | 否 | 应用过滤条件。   - 不传该参数：获取发布到了宜搭应用中心的宜搭应用。 - createdByMe：获取当前操作人创建的宜搭应用。 - managedByMe：获取当前操作人管理的宜搭应用。 |
| pageNumber | Integer | 否 | 页码数，从1开始。 |
| corpId | String | 是 | 钉钉企业的corpId值。 |
| pageSize | Integer | 否 | 每页最大条目数，最大值100。 |
| appNameSearchKeyword | String | 否 | 根据应用名称检索时的关键词。 |
| userId | String | 是 | 操作人userId。 |
| token | String | 是 | 根据corpId、userId和CorpToken使用md5加密计算生成的字符串。      该参数需线下提供，请通过[宜搭技术支持](dingtalk://dingtalkclient/action/sendmsg?dingtalk_id=somjffs)咨询。 |
...
```
GET /v1.0/yida/organizations/applications?appFilter=createdByMe&pageNumber=1&corpId=dingxxxx&pageSize=100&appNameSearchKeyword=小明的测试应用&userId=user001&token=B0xxx HTTP/1.1
...
public class Sample {
    ...
    public static void main(String[] args_) throws Exception {
        ...
        ListApplicationHeaders listApplicationHeaders = new ListApplicationHeaders();
        listApplicationHeaders.xAcsDingtalkAccessToken = "<your access token>";
        ListApplicationRequest listApplicationRequest = new ListApplicationRequest()
                .setAppFilter("createdByMe")
                .setPageNumber(1)
                .setCorpId("dingxxxx")
                .setPageSize(100)
                .setAppNameSearchKeyword("小明的测试应用")
                .setUserId("user001")
                .setToken("B0xxx");
        try {
            client.listApplicationWithOptions(listApplicationRequest, listApplicationHeaders, new RuntimeOptions());
...
class Sample:
    ...
    def main(
        ...
        list_application_headers = dingtalkyida__1__0_models.ListApplicationHeaders()
        list_application_headers.x_acs_dingtalk_access_token = '<your access token>'
        list_application_request = dingtalkyida__1__0_models.ListApplicationRequest(
            app_filter='createdByMe',
            page_number=1,
            corp_id='dingxxxx',
            page_size=100,
            app_name_search_keyword='小明的测试应用',
            user_id='user001',
            token='B0xxx'
        )
        try:
            client.list_application_with_options(list_application_request, list_application_headers, util_models.RuntimeOptions())
    ...
    async def main_async(
        ...
        try:
            await client.list_application_with_options_async(list_application_request, list_application_headers, util_models.RuntimeOptions())
        except Exception as err:
            if not UtilClient.empty(err.code) and not UtilClient.empty(err.message):
                # err 中含有 code 和 message 属性，可帮助开发定位问题
                pass
...
class Sample {
    ...
    public static function main($args){
        ...
        $listApplicationHeaders = new ListApplicationHeaders([]);
        $listApplicationHeaders->xAcsDingtalkAccessToken = "<your access token>";
        $listApplicationRequest = new ListApplicationRequest([
            "appFilter" => "createdByMe",
            "pageNumber" => 1,
            "corpId" => "dingxxxx",
            "pageSize" => 100,
            "appNameSearchKeyword" => "小明的测试应用",
            "userId" => "user001",
            "token" => "B0xxx"
        ]);
        try {
...
func _main (args []*string) (_err error) {
  ...
  listApplicationHeaders := &dingtalkyida_1_0.ListApplicationHeaders{}
  listApplicationHeaders.XAcsDingtalkAccessToken = tea.String("<your access token>")
  listApplicationRequest := &dingtalkyida_1_0.ListApplicationRequest{
    AppFilter: tea.String("createdByMe"),
    PageNumber: tea.Int32(1),
    CorpId: tea.String("dingxxxx"),
    PageSize: tea.Int32(100),
    AppNameSearchKeyword: tea.String("小明的测试应用"),
    UserId: tea.String("user001"),
    Token: tea.String("B0xxx"),
  }
  tryErr := func()(_e error) {
    ...
    _, _err = client.ListApplicationWithOptions(listApplicationRequest, listApplicationHeaders, &util.RuntimeOptions{})
    if _err != nil {
      return _err
    }
...
export default class Client {
  ...
  static async main(args: string[]): Promise<void> {
    ...
    let listApplicationHeaders = new $dingtalkyida_1_0.ListApplicationHeaders({ });
    listApplicationHeaders.xAcsDingtalkAccessToken = "<your access token>";
    let listApplicationRequest = new $dingtalkyida_1_0.ListApplicationRequest({
      appFilter: "createdByMe",
      pageNumber: 1,
      corpId: "dingxxxx",
      pageSize: 100,
    ...
    try {
      await client.listApplicationWithOptions(listApplicationRequest, listApplicationHeaders, new $Util.RuntimeOptions({ }));
    } catch (err) {
...
namespace AlibabaCloud.SDK.Sample
{
    public class Sample 
    {
        ...
        public static void Main(string[] args)
        {
            ...
            AlibabaCloud.SDK.Dingtalkyida_1_0.Models.ListApplicationHeaders listApplicationHeaders = new AlibabaCloud.SDK.Dingtalkyida_1_0.Models.ListApplicationHeaders();
            listApplicationHeaders.XAcsDingtalkAccessToken = "<your access token>";
            AlibabaCloud.SDK.Dingtalkyida_1_0.Models.ListApplicationRequest listApplicationRequest = new AlibabaCloud.SDK.Dingtalkyida_1_0.Models.ListApplicationRequest
            {
                AppFilter = "createdByMe",
                PageNumber = 1,
                CorpId = "dingxxxx",
            ...
            try
            {
                client.ListApplicationWithOptions(listApplicationRequest, listApplicationHeaders, new AlibabaCloud.TeaUtil.Models.RuntimeOptions());
            }
            catch (TeaException err)
            {
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| pageNumber | Long | 当前页的页码。 |
| totalCount | Long | 总数量。 |
| data | Array | 返回的信息列表。 |
| creatorUserId | String | 创建者的userId。 |
| corpId | String | 钉钉组织corpId。 |
| icon | String | 宜搭图标地址。 |
| description | String | 描述信息。 |
| applicationStatus | String | 应用状态。   - ONLINE：上线 - OFFLINE：下线 |
| appConfig | String | 宜搭应用配置。 |
| inexistence | String | 是否被删除了。   - y：删除了 - n：未被删除。 |
| subCorpId | String | 子组织的钉钉CorpId |
| appType | String | 宜搭应用编码。 |
| name | String | 宜搭应用的名称。 |
| systemToken | String | 应用密钥。      仅宜搭专属版。 |
| releaseToDingStatus | String | 钉钉工作台发布状态 |
...

{
  ...
  "data" : [ {
    ...
    "corpId" : "ding5xxx",
    "icon" : "appdiqiu%%#0089FF",
    "description" : "小明创建的宜搭应用",
    "applicationStatus" : "ONLINE",
    "appConfig" : "{\"ODIN_TOPIC_ID\":\"256\",\"APPPROVIDER\":\"vigo\",\"NEEDAYALYSIS\":\"n\",\"NAVTYPE\":\"top_side\",\"SHOWICON\":\"n\",\"REPORT_SUPPORT_META_3\":\"y\",\"ALLOW_EXTERNAL_ADDRESS_BOOK\":\"y\",\"REPORTVERSION\":\"V5\",\"FORM_SCHEMA_VERSION\":\"V5\",\"EXCEL_SOURCE\":\"LOCAL\",\"DEVICETYPE\":\"web,mobile\",\"ENABLE_CSRF_SWITCH\":\"y\",\"NEW_ALLOW_EXTERNAL_ADDRESS_BOOK\":\"y\",\"COLOUR\":\"blue\",\"DINGTALK_CID\":\"LOCAL\",\"APPMODE\":\"normal\",\"NAVLAYOUT\":\"auto\",\"SHOWNAV\":\"y\",\"SHOWCRUMB\":\"y\",\"SUPPORT_META_3\":\"y\",\"SUPPORT_META_2\":\"y\",\"SYSTEMLINK\":\"https://www.aliwork.com/APP_LDYQVBGT167NAON5KB1X/workbench\",\"DATA_QUERY_VERSION\":\"V1\",\"DB_SOURCE_TYPE\":\"TDDL_MYSQL\",\"ISTODINGAPPCENTER\":\"n\",\"REVERSION\":\"5.9.16\",\"EDS_DB_INDEX\":\"24\",\"NAVIGATION\":\"TODO,DONE,SUBMIT\",\"APPTYPE\":\"single\"}",
    "inexistence" : "y",
    "subCorpId" : "ding8eaxxx",
    "appType" : "APP_XCxxx",
    "name" : "测试应用",
    "systemToken" : "04D66S91QV*******",
    "releaseToDingStatus" : "离线:offline,在线：online"
  } ]
}
```
