...
slug: "delete-enterprise-employee-attribute-field-visibility-settings"
group: "应用开发"
tab: "服务端API"
breadcrumb: "通讯录管理 > 用户管理 > 删除用户属性可见性设置"
doc_id: "aVeU6xGcMh"
...
> Path: 应用开发 / 服务端API / 通讯录管理 > 用户管理 > 删除用户属性可见性设置
...
企业调用[设置用户属性可见性](https://open.dingtalk.com/document/app/add-or-update-the-hidden-settings-of-the-employee-property)接口后，可调用本接口删除企业员工属性字段的隐藏设置信息。
...
| 字段 | 值 |
| --- | --- |
| HTTP URL | https://api.dingtalk.com/v1.0/contact/staffAttributes/visibilitySettings/{settingId} |
| HTTP Method | DELETE |
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| settingId | Long | 是 | 设置的ID，可通过[设置用户属性可见性](0074-add-or-update-the-hidden-settings-of-the-employee-property.md)接口获取id参数值。 |
