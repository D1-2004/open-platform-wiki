...
| dentryId | String | 是 | 需要被复制的文件或文件夹Id，可调用[获取文件或文件夹列表](0664-get-a-list-of-files-or-folders.md)或[根据dentryUuid获取spaceId和dentryId](0671-api-getdentryidbyuuid.md)接口获取id参数值。 |
...
| targetFolderId | String | 是 | 需要存放的位置父目录Id，可调用[获取文件或文件夹列表](0664-get-a-list-of-files-or-folders.md)接口获取id参数值。 |
