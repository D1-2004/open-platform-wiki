...
| updateFormDataJson | String | 是 | 用于更新表单实例的数据，格式参考[创建或更新表单数据格式说明](0367-instructions-for-creating-or-updating-form-data-format.md)。 |
...
| formInstanceIdList | Array of String | 是 | 表单实例Id，调用[获取实例ID列表](0310-api-getinstanceidlist-v2.md)接口或者[获取多个表单实例ID](0324-api-searchformdataidlist-v2.md)接口获取。 |
