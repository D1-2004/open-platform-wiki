...
| 字段 | 值 |
| --- | --- |
| HTTP URL | https://api.dingtalk.com/v1.0/yida/processes/designStructures |
| HTTP Method | GET |
...
| userId | String | 是 | 钉钉userId。 |
| appType | String | 是 | 应用编码。 |
| processId | Long | 否 | 流程id。 |
...
```
GET /v1.0/yida/processes/designStructures?systemToken=hexxx&userId=02465454670427591261&appType=APP_PBKT0MFBEBTDO8T7SLVP&processId=36679675117&processCode=TPROC--6LA66Z610ADN8KFCFWEBDDZ4HORT20MSODCZL0 HTTP/1.1
...
public class Sample {
    ...
    public static void main(String[] args_) throws Exception {
        ...
        com.aliyun.dingtalkyida_1_0.models.GetProcessDesignByCodeHeaders getProcessDesignByCodeHeaders = new com.aliyun.dingtalkyida_1_0.models.GetProcessDesignByCodeHeaders();
        getProcessDesignByCodeHeaders.xAcsDingtalkAccessToken = "<your access token>";
        com.aliyun.dingtalkyida_1_0.models.GetProcessDesignByCodeRequest getProcessDesignByCodeRequest = new com.aliyun.dingtalkyida_1_0.models.GetProcessDesignByCodeRequest()
                .setSystemToken("hexxx")
                .setUserId("02465454670427591261")
                .setAppType("APP_PBKT0MFBEBTDO8T7SLVP")
                .setProcessId(36679675117L)
                .setProcessCode("TPROC--6LA66Z610ADN8KFCFWEBDDZ4HORT20MSODCZL0");
        try {
            client.getProcessDesignByCodeWithOptions(getProcessDesignByCodeRequest, getProcessDesignByCodeHeaders, new com.aliyun.teautil.models.RuntimeOptions());
...
class Sample:
    ...
    def main(
        ...
        get_process_design_by_code_headers = dingtalkyida__1__0_models.GetProcessDesignByCodeHeaders()
        get_process_design_by_code_headers.x_acs_dingtalk_access_token = '<your access token>'
        get_process_design_by_code_request = dingtalkyida__1__0_models.GetProcessDesignByCodeRequest(
            system_token='hexxx',
            user_id='02465454670427591261',
            app_type='APP_PBKT0MFBEBTDO8T7SLVP',
            process_id=36679675117,
            process_code='TPROC--6LA66Z610ADN8KFCFWEBDDZ4HORT20MSODCZL0'
        )
        try:
            client.get_process_design_by_code_with_options(get_process_design_by_code_request, get_process_design_by_code_headers, util_models.RuntimeOptions())
    ...
    async def main_async(
        ...
        try:
            await client.get_process_design_by_code_with_options_async(get_process_design_by_code_request, get_process_design_by_code_headers, util_models.RuntimeOptions())
        except Exception as err:
            if not UtilClient.empty(err.code) and not UtilClient.empty(err.message):
                # err 中含有 code 和 message 属性，可帮助开发定位问题
                pass
...
class Sample {
    ...
    public static function main($args){
        ...
        $getProcessDesignByCodeHeaders = new GetProcessDesignByCodeHeaders([]);
        $getProcessDesignByCodeHeaders->xAcsDingtalkAccessToken = "<your access token>";
        $getProcessDesignByCodeRequest = new GetProcessDesignByCodeRequest([
            "systemToken" => "hexxx",
            "userId" => "02465454670427591261",
            "appType" => "APP_PBKT0MFBEBTDO8T7SLVP",
            "processId" => 36679675117,
            "processCode" => "TPROC--6LA66Z610ADN8KFCFWEBDDZ4HORT20MSODCZL0"
        ]);
        try {
            $client->getProcessDesignByCodeWithOptions($getProcessDesignByCodeRequest, $getProcessDesignByCodeHeaders, new RuntimeOptions([]));
        }
        catch (Exception $err) {
...
func _main (args []*string) (_err error) {
  ...
  getProcessDesignByCodeHeaders := &dingtalkyida_1_0.GetProcessDesignByCodeHeaders{}
  getProcessDesignByCodeHeaders.XAcsDingtalkAccessToken = tea.String("<your access token>")
  getProcessDesignByCodeRequest := &dingtalkyida_1_0.GetProcessDesignByCodeRequest{
    SystemToken: tea.String("hexxx"),
    UserId: tea.String("02465454670427591261"),
    AppType: tea.String("APP_PBKT0MFBEBTDO8T7SLVP"),
    ProcessId: tea.Int64(36679675117),
    ProcessCode: tea.String("TPROC--6LA66Z610ADN8KFCFWEBDDZ4HORT20MSODCZL0"),
  }
  tryErr := func()(_e error) {
    ...
    _, _err = client.GetProcessDesignByCodeWithOptions(getProcessDesignByCodeRequest, getProcessDesignByCodeHeaders, &util.RuntimeOptions{})
    if _err != nil {
      return _err
    }
...
class Client {
  ...
  static async main(args) {
    ...
    let getProcessDesignByCodeHeaders = new dingtalkyida_1_0.GetProcessDesignByCodeHeaders({ });
    getProcessDesignByCodeHeaders.xAcsDingtalkAccessToken = '<your access token>';
    let getProcessDesignByCodeRequest = new dingtalkyida_1_0.GetProcessDesignByCodeRequest({
      systemToken: 'hexxx',
      userId: '02465454670427591261',
      appType: 'APP_PBKT0MFBEBTDO8T7SLVP',
      processId: 36679675117,
    ...
    try {
      await client.getProcessDesignByCodeWithOptions(getProcessDesignByCodeRequest, getProcessDesignByCodeHeaders, new Util.RuntimeOptions({ }));
    } catch (err) {
...
namespace AlibabaCloud.SDK.Sample
{
    public class Sample 
    {
        ...
        public static void Main(string[] args)
        {
            ...
            AlibabaCloud.SDK.Dingtalkyida_1_0.Models.GetProcessDesignByCodeHeaders getProcessDesignByCodeHeaders = new AlibabaCloud.SDK.Dingtalkyida_1_0.Models.GetProcessDesignByCodeHeaders();
            getProcessDesignByCodeHeaders.XAcsDingtalkAccessToken = "<your access token>";
            AlibabaCloud.SDK.Dingtalkyida_1_0.Models.GetProcessDesignByCodeRequest getProcessDesignByCodeRequest = new AlibabaCloud.SDK.Dingtalkyida_1_0.Models.GetProcessDesignByCodeRequest
            {
                SystemToken = "hexxx",
                UserId = "02465454670427591261",
                AppType = "APP_PBKT0MFBEBTDO8T7SLVP",
            ...
            try
            {
                client.GetProcessDesignByCodeWithOptions(getProcessDesignByCodeRequest, getProcessDesignByCodeHeaders, new AlibabaCloud.TeaUtil.Models.RuntimeOptions());
            }
            catch (TeaException err)
            {
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| formulaRules | Array | 节点提交规则配置。 |
| nodeType | String | 节点类型。 |
| ruleType | String | 规则类型。 |
| triggerMode | String | 触发模式。 |
| block | String | 是否block。 |
| message | String | 内容。 |
| activityId | Array of String | 节点。 |
| activityAction | Array of String | 行为节点。 |
| rule | Object | 规则公示。 |
| content | String | 内容。 |
| displayRule | String | 展示值。 |
| source | String | 编码值。 |
| name | Object | 名称。 |
| zh\_CN | String | 中文名称。 |
| en\_US | String | 英文名称。 |
| nodes | Array | 流程节点。 |
| nextId | Array of String | 后续节点。 |
| childNodes | Array of Object | 子节点。 |
| name | Object | 名称。 |
| en\_US | String | 中文名称。 |
| zh\_CN | String | 英文名称。 |
...
| nodeId | String | 节点id。 |
| props | Map | 详细配置。 |
| approvalSummary | Array | 审批摘要配置。 |
| title | Object | 描述。 |
| zh\_CN | String | 中文标题。 |
| en\_US | String | 英文标题。 |
| type | String | 国际化标识。 |
| flowConfig | Object | 流程字段权限配置。 |
| sid\_instDetail | Array | 流程字段权限配置详细。 |
| fieldId | String | 字段id。 |
| fieldBehavior | String | 控制行为。 |
| props | Object | 基础配置。 |
| processMobileDetailUrl | String | 移动端url。 |
| bindingForm | String | 表单id。 |
| processInitUrl | String | 流程初始化url。 |
| noRecordRecall | Boolean | 无痕回收。 |
| allowCollaboration | Boolean | 允许协作。 |
| allowTemporaryStorage | Boolean | 允许暂存。 |
| processCode | String | 流程id。 |
| stopAssociationRulesIfFailed | Boolean | 关联规则失败时是否停止。 |
| allowWithdraw | Boolean | 允许撤回。 |
| processDetailUrl | String | 流程详细url。 |
...

{
  ...
  "props" : {
    "processMobileDetailUrl" : "https://example.com",
    "bindingForm" : "FORM-xxx",
    "processInitUrl" : "https://example.com",
    "noRecordRecall" : true,
    "allowCollaboration" : false,
    "allowTemporaryStorage" : false,
    "processCode" : "TPROC--BDC66HB1FIPNPCMNE5VV787RY4D5327NBKTZL0",
    "stopAssociationRulesIfFailed" : false,
    "allowWithdraw" : true,
    "processDetailUrl" : "https://example.com"
  }
}
```
