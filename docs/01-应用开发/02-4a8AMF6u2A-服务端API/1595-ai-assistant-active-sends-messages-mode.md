...
> Path: 应用开发 / 服务端API / 历史文档（不推荐） > 智能交互 > AI助理发消息（主动发送模式）
...
| content | String | 否 | 消息体内容，与消息体类型对应，必须是 **JSON** 格式。详见[普通卡片（Schema模式）](1596-message-content-filling-guidance.md#d1806d6452z8o)。 |
