...
slug: "disassociate-an-organization"
group: "应用开发"
tab: "服务端API"
breadcrumb: "通讯录管理 > 上下级组织（原关联组织） > 解除关联组织"
doc_id: "OG0PwSO3b7"
updated_at: "2026-06-08 09:30:55"
---

> Source: https://open.dingtalk.com/document/development/disassociate-an-organization
> Path: 应用开发 / 服务端API / 通讯录管理 > 上下级组织（原关联组织） > 解除关联组织
> Updated: 2026-06-08 09:30:55
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| attachDeptId | Long | 是 | 伙伴组织在上下游组织内的部门ID，上下游组织通过[获取部门列表](0082-user-management-acquires-the-list-departments.md)接口获取dept\_id参数值。 |
