...
doc_id: "EvaV9iJgJ0"
updated_at: "2025-09-12 17:18:58"
---

> Source: https://open.dingtalk.com/document/development/api-empstartdismission
> Path: 应用开发 / 服务端API / 智能人事 > 员工管理 > 员工加入待离职
> Updated: 2025-09-12 17:18:58
...
| terminationReasonVoluntary | Array of String | 否 | 主动离职原因id，可调用[获取企业已有的所有离职原因](0945-api-getalldismissionreasons.md)接口获取。 |
| terminationReasonPassive | Array of String | 否 | 被动离职原因id，可调用[获取企业已有的所有离职原因](0945-api-getalldismissionreasons.md)接口获取。 |
| remark | String | 否 | 备注。 |
