...
| 字段名 | 类型 | 必填 | 含义 |
| --- | --- | --- | --- |
| sticker | string(enum Emoji) | 否 | 表情编码，详见 [表情（Emoji）枚举值](0576-enumeration-values-of-emojis.md)。 |
...
| 字段名 | 类型 | 必填 | 含义 |
| --- | --- | --- | --- |
| code | string(enum Emoji) | 是 | 表情编码，详见[表情（Emoji）枚举值](0576-enumeration-values-of-emojis.md)。 |
