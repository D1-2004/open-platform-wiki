...
slug: "api-getformdatabyid-v2"
group: "应用开发"
tab: "服务端API"
breadcrumb: "宜搭 > 表单 > 查询表单数据"
doc_id: "nmoz6mUK1C"
updated_at: "2026-06-15 10:44:08"
---

> Source: https://open.dingtalk.com/document/development/api-getformdatabyid-v2
> Path: 应用开发 / 服务端API / 宜搭 > 表单 > 查询表单数据
> Updated: 2026-06-15 10:44:08

# 查询表单数据

调用本接口，通过表单实例ID查询表单数据。

## 请求

| **基本信息** | |
| --- | --- |
| HTTP URL | https://api.dingtalk.com/v2.0/yida/forms/instances/{id} |
| HTTP Method | GET |
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| id | String | 否 | 表单实例ID，通过[获取多个表单实例ID](0324-api-searchformdataidlist-v2.md)接口获取。 |
...
| useAlias | Boolean | 否 | 是否使用组件别名，开启之后返回值formData中组件id将以别名形式返回 |
...
```
GET /v2.0/yida/forms/instances/FORM_INST_12345?appType=APP_PBKT0MFBEBTDO8T7SLVP&systemToken=hexxxx&userId=user123&language=zh_CN&useAlias=true&formUuid=FORM-AA28579F69644FC19A47FE267457E664ZVR1 HTTP/1.1
...
public class Sample {
    ...
    public static void main(String[] args_) throws Exception {
        ...
        com.aliyun.dingtalkyida_2_0.models.GetFormDataByIDRequest getFormDataByIDRequest = new com.aliyun.dingtalkyida_2_0.models.GetFormDataByIDRequest()
                ...
                .setLanguage("zh_CN")
                .setUseAlias(true)
                .setFormUuid("FORM-AA28579F69644FC19A47FE267457E664ZVR1");
        try {
            client.getFormDataByIDWithOptions("FORM_INST_12345", getFormDataByIDRequest, getFormDataByIDHeaders, new com.aliyun.teautil.models.RuntimeOptions());
...
class Sample {
    ...
    public static function main($args){
        ...
        $getFormDataByIDRequest = new GetFormDataByIDRequest([
            ...
            "language" => "zh_CN",
            "useAlias" => true,
            "formUuid" => "FORM-AA28579F69644FC19A47FE267457E664ZVR1"
        ]);
        try {
...
class Client {
  ...
  static async main(args) {
    ...
    let getFormDataByIDHeaders = new dingtalkyida_2_0.GetFormDataByIDHeaders({ });
    getFormDataByIDHeaders.xAcsDingtalkAccessToken = '<your access token>';
    let getFormDataByIDRequest = new dingtalkyida_2_0.GetFormDataByIDRequest({
      appType: 'APP_PBKT0MFBEBTDO8T7SLVP',
      systemToken: 'hexxxx',
      userId: 'user123',
      language: 'zh_CN',
...
namespace AlibabaCloud.SDK.Sample
{
    public class Sample 
    {
        ...
        public static void Main(string[] args)
        {
            ...
            AlibabaCloud.SDK.Dingtalkyida_2_0.Models.GetFormDataByIDHeaders getFormDataByIDHeaders = new AlibabaCloud.SDK.Dingtalkyida_2_0.Models.GetFormDataByIDHeaders();
            getFormDataByIDHeaders.XAcsDingtalkAccessToken = "<your access token>";
            AlibabaCloud.SDK.Dingtalkyida_2_0.Models.GetFormDataByIDRequest getFormDataByIDRequest = new AlibabaCloud.SDK.Dingtalkyida_2_0.Models.GetFormDataByIDRequest
            {
                AppType = "APP_PBKT0MFBEBTDO8T7SLVP",
                SystemToken = "hexxxx",
                UserId = "user123",
