...
doc_id: "LkxUirZKhM"
updated_at: "2025-09-08 19:06:53"
---

> Source: https://open.dingtalk.com/document/development/obtain-a-permission-list
> Path: 应用开发 / 服务端API / 历史文档（不推荐） > 文档/文件 > 钉盘 > 权限管理 > 获取权限列表
> Updated: 2025-09-08 19:06:53
...
>
> - 如果未使用本接口，推荐使用存储产品[获取权限列表](https://open.dingtalk.com/document/orgapp/obtain-a-permission-list-storage)接口。
> - 如果已使用本接口，建议您根据自身实际情况切换至推荐接口。

调用本接口，实现获取用户对钉盘空间和文件的权限列表，以获取用户对钉盘文件的权限列表为例，具体示例如下图所示。

![](https://img.alicdn.com/imgextra/i2/O1CN015zvfSG1kMRx8C9nvr_!!6000000004669-2-tps-645-647.png)
