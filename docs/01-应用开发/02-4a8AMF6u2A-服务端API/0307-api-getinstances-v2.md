...
slug: "api-getinstances-v2"
group: "应用开发"
tab: "服务端API"
breadcrumb: "宜搭 > 流程 > 获取流程实例"
doc_id: "ZbDnTIgGk1"
updated_at: "2026-06-15 10:44:11"
---

> Source: https://open.dingtalk.com/document/development/api-getinstances-v2
> Path: 应用开发 / 服务端API / 宜搭 > 流程 > 获取流程实例
> Updated: 2026-06-15 10:44:11

# 获取流程实例

调用本接口，获取宜搭的流程实例信息，包括实例Id、创建时间、发起人等信息。

## **请求**

| **基本信息** | |
| --- | --- |
| HTTP URL | https://api.dingtalk.com/v2.0/yida/processes/instances |
| HTTP Method | POST |
...
| taskId | String | 否 | 任务ID，可通过[获取实例ID列表](0310-api-getinstanceidlist-v2.md)接口获取。 |
...
| useAlias | Boolean | 否 | 是否使用组件别名；开启之后，入参searchFieldJson、orderConfigJson中组件id支持以别名形式传入，同时返回值data中组件id将以别名形式返回 |
...
```
POST /v2.0/yida/processes/instances?pageNumber=1&pageSize=100 HTTP/1.1
...

{
  ...
  "orderConfigJson" : "{'gmt_create':'+','textField_1234':'+'}",
  "useAlias" : false
}
```
...
public class Sample {
    ...
    public static void main(String[] args_) throws Exception {
        ...
        com.aliyun.dingtalkyida_2_0.models.GetInstancesHeaders getInstancesHeaders = new com.aliyun.dingtalkyida_2_0.models.GetInstancesHeaders();
        getInstancesHeaders.xAcsDingtalkAccessToken = "<your access token>";
        com.aliyun.dingtalkyida_2_0.models.GetInstancesRequest getInstancesRequest = new com.aliyun.dingtalkyida_2_0.models.GetInstancesRequest()
                .setPageNumber(1)
                .setPageSize(100)
                ...
                .setOrderConfigJson("{'gmt_create':'+','textField_1234':'+'}")
                .setUseAlias(false);
        try {
            client.getInstancesWithOptions(getInstancesRequest, getInstancesHeaders, new com.aliyun.teautil.models.RuntimeOptions());
...
class Sample:
    ...
    def main(
        ...
        get_instances_headers = dingtalkyida__2__0_models.GetInstancesHeaders()
        get_instances_headers.x_acs_dingtalk_access_token = '<your access token>'
        get_instances_request = dingtalkyida__2__0_models.GetInstancesRequest(
            page_number=1,
            page_size=100,
            ...
            order_config_json="{'gmt_create':'+','textField_1234':'+'}",
            use_alias=False
        )
        try:
...
func _main (args []*string) (_err error) {
  ...
  getInstancesHeaders := &dingtalkyida_2_0.GetInstancesHeaders{}
  getInstancesHeaders.XAcsDingtalkAccessToken = tea.String("<your access token>")
  getInstancesRequest := &dingtalkyida_2_0.GetInstancesRequest{
    ...
    OrderConfigJson: tea.String("{'gmt_create':'+','textField_1234':'+'}"),
...
class Client {
  ...
  static async main(args) {
    ...
    let getInstancesHeaders = new dingtalkyida_2_0.GetInstancesHeaders({ });
    getInstancesHeaders.xAcsDingtalkAccessToken = '<your access token>';
    let getInstancesRequest = new dingtalkyida_2_0.GetInstancesRequest({
      pageNumber: 1,
      pageSize: 100,
      appType: 'APP_PBKT0xxx',
      systemToken: 'hexxxx',
...
namespace AlibabaCloud.SDK.Sample
{
    public class Sample 
    {
        ...
        public static void Main(string[] args)
        {
            ...
            AlibabaCloud.SDK.Dingtalkyida_2_0.Models.GetInstancesHeaders getInstancesHeaders = new AlibabaCloud.SDK.Dingtalkyida_2_0.Models.GetInstancesHeaders();
            getInstancesHeaders.XAcsDingtalkAccessToken = "<your access token>";
            AlibabaCloud.SDK.Dingtalkyida_2_0.Models.GetInstancesRequest getInstancesRequest = new AlibabaCloud.SDK.Dingtalkyida_2_0.Models.GetInstancesRequest
            {
                PageNumber = 1,
                PageSize = 100,
                AppType = "APP_PBKT0xxx",
