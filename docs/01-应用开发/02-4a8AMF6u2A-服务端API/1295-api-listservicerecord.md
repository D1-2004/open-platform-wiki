...
| teamCode | String | 否 | 团队编码，可通过[分页查询客户列表](1291-api-listcustomer.md)接口获取。 |
| customerId | String | 否 | 服务客户的客户ID，可通过[分页查询客户列表](1291-api-listcustomer.md)接口获取。 |
