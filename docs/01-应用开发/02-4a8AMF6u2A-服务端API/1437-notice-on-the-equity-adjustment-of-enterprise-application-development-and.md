...
source_url: "https://open.dingtalk.com/document/development/notice-on-the-equity-adjustment-of-enterprise-application-development-and"
namespace: "development"
slug: "notice-on-the-equity-adjustment-of-enterprise-application-development-and"
group: "应用开发"
tab: "服务端API"
breadcrumb: "平台公告与计费 > 平台公告 > 关于企业应用开发和自动化在钉钉PaaS 底座中的权益调整的通告"
doc_id: "m7O55WLJB9"
updated_at: "2026-01-22 20:38:23"
---
...
> Path: 应用开发 / 服务端API / 平台公告与计费 > 平台公告 > 关于企业应用开发和自动化在钉钉PaaS 底座中的权益调整的通告
> Updated: 2026-01-22 20:38:23
...
| **OpenAPI名称** | **OpenAPI详情** |
| --- | --- |
| [添加待入职员工](0945-add-employees-to-be-hired-supports-system-and-custom-fields.md) | 在企业自有通讯录系统内，添加待入职员工时，调用本接口在钉钉智能人事应用内同步添加待入职员工 |
| [配置考勤排班附加信息](0211-synchronization-scheduling-information.md) | 企业考勤排班信息较多，手动配置排班的打卡位置、打卡WiFi信息比较繁琐，可调用本接口，更新排班的附加信息 |
| [查询指定用户的封账规则](0242-encapsulate-account-sealing-and-unsealing-rules.md) | 开启封账后，封账范围内的考勤结果将封存不允许修改。包含以下操作：请假，外出，出差，加班，补卡申请；员工排班，修改考勤结果等，调用本接口根据企业员工userId列表，获取员工的封账规则信息 |
| [发送DING消息](0712-robot-sends-nail-message.md) | 企业在紧急场景下，可调用本接口给指定员工发起应用内DING消息、短信DING消息和电话DING消息提醒 |
| [撤回已经发送的DING消息](0713-robot-withdraws-pin-message.md) | 已发送的DING消息，支持调用本接口进行撤回 |
| [上传打卡记录](0197-upload-punch-records.md) | 企业使用三方打卡设备或门禁系统刷卡，调用本接口，可将三方打卡或刷卡记录上传到钉钉考勤，作为员工的考勤打卡信息 |
