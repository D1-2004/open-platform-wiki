...
> Path: 应用开发 / 服务端API / 历史文档（不推荐） > OA审批 > 查询待办列表
...
>
> - 如果未使用本接口，推荐使用新版规范[查询通过流程中心集成的OA审批任务](https://open.dingtalk.com/document/orgapp/query-oa-approval-tasks-integrated-through-process-center)接口。
