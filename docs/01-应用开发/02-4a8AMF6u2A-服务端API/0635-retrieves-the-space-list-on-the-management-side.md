...
调用本接口，根据spaceId获取指定空间的信息，包括空间名称、空间属性、空间大小等。
...
| 字段 | 值 |
| --- | --- |
| HTTP URL | https://api.dingtalk.com/v1.0/drive/managements/spaces/query |
| HTTP Method | POST |
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| spaceIds | Array of String | 是 | 空间ID列表，最多允许传入30个，可调用[获取空间列表](0634-queries-a-space-list.md)接口获取。 |
