...
slug: "delete-multiple-form-instances"
group: "应用开发"
tab: "服务端API"
breadcrumb: "宜搭 > 表单 > 批量删除表单实例"
doc_id: "zh6AXUkx5v"
updated_at: "2026-04-24 14:14:30"
---

> Source: https://open.dingtalk.com/document/development/delete-multiple-form-instances
> Path: 应用开发 / 服务端API / 宜搭 > 表单 > 批量删除表单实例
> Updated: 2026-04-24 14:14:30

# 批量删除表单实例

调用本接口，批量删除表单实例数据，从表单实例列表中移除。
...
| 字段 | 值 |
| --- | --- |
| HTTP URL | https://api.dingtalk.com/v1.0/yida/forms/instances/batchRemove |
| HTTP Method | POST |
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| formUuid | String | 是 | 页面编码，获取方式如下所示： |
...
| formInstanceIdList | Array of String | 是 | 宜搭表单实例Id，调用[获取实例ID列表](0310-api-getinstanceidlist-v2.md)接口或者[获取多个表单实例ID](0324-api-searchformdataidlist-v2.md)接口获取。 |
| userId | String | 是 | 用户的userId，可通过[获取部门用户userid列表](0065-query-the-list-of-department-userids.md)接口获取。 |
| executeExpression | Boolean | 否 | 是否需要触发表单绑定的校验规则、关联业务规则和第三方服务回调。   - **true**：需要。 - **false**：不需要     该参数值传false可以降低API的耗时以及获得更大的单次删除数据量上限。 |
...
```
POST /v1.0/yida/forms/instances/batchRemove HTTP/1.1
...
public class Sample {
    ...
    public static void main(String[] args_) throws Exception {
        ...
        batchRemovalByFormInstanceIdListHeaders.xAcsDingtalkAccessToken = "<your access token>";
...
class Sample {
    ...
    public static function main($args){
        ...
        $batchRemovalByFormInstanceIdListHeaders = new BatchRemovalByFormInstanceIdListHeaders([]);
        $batchRemovalByFormInstanceIdListHeaders->xAcsDingtalkAccessToken = "<your access token>";
        $batchRemovalByFormInstanceIdListRequest = new BatchRemovalByFormInstanceIdListRequest([
            "formUuid" => "FORM-GX866MC1NC1VOFF6WVQW33FD16E23L3CPMKVKA",
            "appType" => "APP_XCE0EVXS6DYG3YDYC5RD",
            "asynchronousExecution" => true,
            "systemToken" => "09866181UTZVVD4R3DC955FNKIM52HVPU5WWK7",
...
export default class Client {
  ...
  static async main(args: string[]): Promise<void> {
    ...
    batchRemovalByFormInstanceIdListHeaders.xAcsDingtalkAccessToken = "<your access token>";
    let batchRemovalByFormInstanceIdListRequest = new $dingtalkyida_1_0.BatchRemovalByFormInstanceIdListRequest({
      formUuid: "FORM-GX866MC1NC1VOFF6WVQW33FD16E23L3CPMKVKA",
      appType: "APP_XCE0EVXS6DYG3YDYC5RD",
      asynchronousExecution: true,
      systemToken: "09866181UTZVVD4R3DC955FNKIM52HVPU5WWK7",
    ...
    try {
      await client.batchRemovalByFormInstanceIdListWithOptions(batchRemovalByFormInstanceIdListRequest, batchRemovalByFormInstanceIdListHeaders, new $Util.RuntimeOptions({ }));
    } catch (err) {
...
namespace AlibabaCloud.SDK.Sample
{
    public class Sample 
    {
        ...
        public static void Main(string[] args)
        {
            ...
            AlibabaCloud.SDK.Dingtalkyida_1_0.Models.BatchRemovalByFormInstanceIdListHeaders batchRemovalByFormInstanceIdListHeaders = new AlibabaCloud.SDK.Dingtalkyida_1_0.Models.BatchRemovalByFormInstanceIdListHeaders();
            batchRemovalByFormInstanceIdListHeaders.XAcsDingtalkAccessToken = "<your access token>";
            AlibabaCloud.SDK.Dingtalkyida_1_0.Models.BatchRemovalByFormInstanceIdListRequest batchRemovalByFormInstanceIdListRequest = new AlibabaCloud.SDK.Dingtalkyida_1_0.Models.BatchRemovalByFormInstanceIdListRequest
            {
                FormUuid = "FORM-GX866MC1NC1VOFF6WVQW33FD16E23L3CPMKVKA",
                AppType = "APP_XCE0EVXS6DYG3YDYC5RD",
                AsynchronousExecution = true,
            ...
            try
            {
                client.BatchRemovalByFormInstanceIdListWithOptions(batchRemovalByFormInstanceIdListRequest, batchRemovalByFormInstanceIdListHeaders, new AlibabaCloud.TeaUtil.Models.RuntimeOptions());
            }
            catch (TeaException err)
            {
