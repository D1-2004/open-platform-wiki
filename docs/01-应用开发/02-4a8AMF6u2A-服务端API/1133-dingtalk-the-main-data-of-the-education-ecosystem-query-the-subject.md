...
> Path: 应用开发 / 服务端API / 行业与生态 > 行业开放 > 新教育 > 通用基础 > 获取学科元数据列表
...
| parent\_id | Number | 否 | 11 | 父ID，调用[获取部门列表](1155-obtains-the-department-node-list.md)接口获取dept\_type为period时的dept\_id参数值。 |
