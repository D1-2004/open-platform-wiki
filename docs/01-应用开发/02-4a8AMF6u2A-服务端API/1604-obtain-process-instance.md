---
title: "获取流程实例"
source_url: "https://open.dingtalk.com/document/development/obtain-process-instance"
namespace: "development"
slug: "obtain-process-instance"
group: "应用开发"
tab: "服务端API"
breadcrumb: "历史文档（不推荐） > 宜搭 > 流程 > 获取流程实例"
doc_id: "oBxG2uoVy1"
updated_at: "2025-09-08 19:03:33"
---

> Source: https://open.dingtalk.com/document/development/obtain-process-instance
> Path: 应用开发 / 服务端API / 历史文档（不推荐） > 宜搭 > 流程 > 获取流程实例
> Updated: 2025-09-08 19:03:33
...
>
> - 如果未使用本接口，推荐使用[获取流程实例](https://open.dingtalk.com/document/orgapp/api-getinstances-v2)接口。
> - 如果已使用本接口，建议您根据自身实际情况评估是否切换至推荐接口。

例如，企业宜搭应用内的流程列表如下截图，调用本接口获取流程实例的详情信息。
![](https://img.alicdn.com/imgextra/i3/O1CN01nH6sKI1KANVwd40t6_!!6000000001123-2-tps-950-466.png)
...
```
POST /v1.0/yida/processes/instances?pageNumber=Integer&pageSize=Integer HTTP/1.1
...
| searchFieldJson | String | 否 | 查询过滤条件，支持2种模式的过滤规则。模式1：根据组件值模糊匹配，示例：{"textField\_jcr0069m":"danhang","selectField\_jcr0069q":"K"} 模式2: 采用数据管理的查询过滤条件，匹配功能更强大，示例：[{"key":"currentNodeName","value":"步凡","type":"TEXT","operator":"like","componentName":"TextField”}]，详情参考 [条件搜索传参格式说明](https://www.yuque.com/yida/support/agb8im#2036e57b1c463d3e0226a067ee923eef_h3_32)。 |
| originatorId | String | 否 | 根据流程发起人工号查询。 |
| createFromTimeGMT | String | 否 | 创建时间起始值。 |
| createToTimeGMT | String | 否 | 创建时间终止值。 |
| modifiedFromTimeGMT | String | 否 | 修改时间起始值。 |
| modifiedToTimeGMT | String | 否 | 修改时间终止值。 |
| taskId | String | 否 | 任务ID。 |
| instanceStatus | String | 否 | 实例状态。 |
| approvedResult | String | 否 | 流程审批结果。 |
| orderConfigJson | String | 否 | 排序规则，参数值参考[宜搭使用手册](https://www.yuque.com/yida/support/agb8im#CQro8)。 |
...
| actionExecutor | Array | 多个执行人。 |
| name | Object | 名称。 |
| nameInEnglish | String | 英文名称。 |
| type | String | 类型。 |
| nameInChinese | String | 中文名称。 |
| deptName | String | 部门名称。 |
| userId | String | 用户的userid。 |
| email | String | 邮箱。 |
| approvedResult | String | 流程审批结果。 |
| formUuid | String | 表单ID。 |
| data | Map | 数据。 |
| processCode | String | 流程编码。 |
| modifiedTimeGMT | String | 修改时间。 |
| originator | Object | 发起人。 |
| name | Object | 名称。 |
| nameInEnglish | String | 英文名称。 |
| type | String | 类型。 |
| nameInChinese | String | 中文名称。 |
...
```
POST /v1.0/yida/processes/instances?pageNumber=1&pageSize=100 HTTP/1.1
Host:api.dingtalk.com
...

{
  ...
  "language" : "zh_CN",
  "formUuid" : "FORM-xxx",
  "searchFieldJson" : "F6Y4G8Wxxx",
  "originatorId" : "user23123",
...
public class Sample {
    ...
    public static void main(String[] args_) throws Exception {
        ...
        getInstancesHeaders.xAcsDingtalkAccessToken = "<your access token>";
        GetInstancesRequest getInstancesRequest = new GetInstancesRequest()
                ...
                .setSearchFieldJson("F6Y4G8Wxxx")
                .setOriginatorId("user23123")
        ...
        try {
            client.getInstancesWithOptions(getInstancesRequest, getInstancesHeaders, new RuntimeOptions());
...
class Sample:
    ...
    def main(
        ...
        get_instances_headers = dingtalkyida__1__0_models.GetInstancesHeaders()
        get_instances_headers.x_acs_dingtalk_access_token = '<your access token>'
        get_instances_request = dingtalkyida__1__0_models.GetInstancesRequest(
            app_type='APP_PBKT0xxx',
            system_token='hexxxx',
            user_id='manager123',
            language='zh_CN',
            form_uuid='FORM-xxx',
            search_field_json='F6Y4G8Wxxx',
            originator_id='user23123',
        ...
        try:
            client.get_instances_with_options(get_instances_request, get_instances_headers, util_models.RuntimeOptions())
    ...
    async def main_async(
        ...
        try:
            await client.get_instances_with_options_async(get_instances_request, get_instances_headers, util_models.RuntimeOptions())
        except Exception as err:
            if not UtilClient.empty(err.code) and not UtilClient.empty(err.message):
                # err 中含有 code 和 message 属性，可帮助开发定位问题
                pass
...
class Sample {
    ...
    public static function main($args){
        ...
        $getInstancesHeaders = new GetInstancesHeaders([]);
        $getInstancesHeaders->xAcsDingtalkAccessToken = "<your access token>";
        $getInstancesRequest = new GetInstancesRequest([
            "appType" => "APP_PBKT0xxx",
            "systemToken" => "hexxxx",
            "userId" => "manager123",
            "language" => "zh_CN",
...
func _main (args []*string) (_err error) {
  ...
  getInstancesHeaders := &dingtalkyida_1_0.GetInstancesHeaders{}
  getInstancesHeaders.XAcsDingtalkAccessToken = tea.String("<your access token>")
  getInstancesRequest := &dingtalkyida_1_0.GetInstancesRequest{
    ...
    SearchFieldJson: tea.String("F6Y4G8Wxxx"),
    OriginatorId: tea.String("user23123"),
  ...
  tryErr := func()(_e error) {
    ...
    _, _err = client.GetInstancesWithOptions(getInstancesRequest, getInstancesHeaders, &util.RuntimeOptions{})
    if _err != nil {
      return _err
    }
...
export default class Client {
  ...
  static async main(args: string[]): Promise<void> {
    ...
    let getInstancesHeaders = new $dingtalkyida_1_0.GetInstancesHeaders({ });
    getInstancesHeaders.xAcsDingtalkAccessToken = "<your access token>";
    let getInstancesRequest = new $dingtalkyida_1_0.GetInstancesRequest({
      appType: "APP_PBKT0xxx",
      systemToken: "hexxxx",
      userId: "manager123",
      language: "zh_CN",
    ...
    try {
      await client.getInstancesWithOptions(getInstancesRequest, getInstancesHeaders, new $Util.RuntimeOptions({ }));
    } catch (err) {
...
namespace AlibabaCloud.SDK.Sample
{
    public class Sample 
    {
        ...
        public static void Main(string[] args)
        {
            ...
            AlibabaCloud.SDK.Dingtalkyida_1_0.Models.GetInstancesHeaders getInstancesHeaders = new AlibabaCloud.SDK.Dingtalkyida_1_0.Models.GetInstancesHeaders();
            getInstancesHeaders.XAcsDingtalkAccessToken = "<your access token>";
            AlibabaCloud.SDK.Dingtalkyida_1_0.Models.GetInstancesRequest getInstancesRequest = new AlibabaCloud.SDK.Dingtalkyida_1_0.Models.GetInstancesRequest
            {
                AppType = "APP_PBKT0xxx",
                SystemToken = "hexxxx",
                UserId = "manager123",
            ...
            try
            {
                client.GetInstancesWithOptions(getInstancesRequest, getInstancesHeaders, new AlibabaCloud.TeaUtil.Models.RuntimeOptions());
            }
            catch (TeaException err)
            {
...
int main(int argc, char *args[]) {
  ...
  shared_ptr<Alibabacloud_Dingtalkyida_1_0::GetInstancesHeaders> getInstancesHeaders = make_shared<Alibabacloud_Dingtalkyida_1_0::GetInstancesHeaders>();
  getInstancesHeaders->xAcsDingtalkAccessToken = make_shared<string>("<your access token>");
  shared_ptr<Alibabacloud_Dingtalkyida_1_0::GetInstancesRequest> getInstancesRequest = make_shared<Alibabacloud_Dingtalkyida_1_0::GetInstancesRequest>(map<string, boost::any>({
    ...
    {"formUuid", boost::any(string("FORM-xxx"))},
    {"searchFieldJson", boost::any(string("F6Y4G8Wxxx"))},
    {"originatorId", boost::any(string("user23123"))},
    {"createFromTimeGMT", boost::any(string("2021-05-01"))},
    {"createToTimeGMT", boost::any(string("2021-05-01"))},
    {"modifiedFromTimeGMT", boost::any(string("2021-05-01"))},
    {"modifiedToTimeGMT", boost::any(string("2021-09-10"))},
    {"taskId", boost::any(string("task-123"))},
    {"instanceStatus", boost::any(string("RUNNING"))},
    {"approvedResult", boost::any(string("agree"))}
  }));
  try {
    client->getInstancesWithOptions(getInstancesRequest, getInstancesHeaders, make_shared<Darabonba_Util::RuntimeOptions>(Darabonba_Util::RuntimeOptions()));
  }
