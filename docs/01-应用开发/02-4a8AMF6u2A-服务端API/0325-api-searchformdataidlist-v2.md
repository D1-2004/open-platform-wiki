...
slug: "api-searchformdataidlist-v2"
group: "应用开发"
tab: "服务端API"
breadcrumb: "宜搭 > 表单 > 获取多个表单实例ID"
doc_id: "qyEM3DeaRk"
updated_at: "2026-06-15 10:44:14"
---

> Source: https://open.dingtalk.com/document/development/api-searchformdataidlist-v2
> Path: 应用开发 / 服务端API / 宜搭 > 表单 > 获取多个表单实例ID
> Updated: 2026-06-15 10:44:14
...
| **基本信息** | |
| --- | --- |
| HTTP URL | https://api.dingtalk.com/v2.0/yida/forms/instances/ids/{appType}/{formUuid} |
| HTTP Method | POST |
...
```
POST /v2.0/yida/forms/instances/ids/APP_PBKTxxx/FORM-EF6Y4Gxxx?pageNumber=1&pageSize=100 HTTP/1.1
...
public class Sample {
    ...
    public static void main(String[] args_) throws Exception {
        ...
        com.aliyun.dingtalkyida_2_0.models.SearchFormDataIdListHeaders searchFormDataIdListHeaders = new com.aliyun.dingtalkyida_2_0.models.SearchFormDataIdListHeaders();
        searchFormDataIdListHeaders.xAcsDingtalkAccessToken = "<your access token>";
        com.aliyun.dingtalkyida_2_0.models.SearchFormDataIdListRequest searchFormDataIdListRequest = new com.aliyun.dingtalkyida_2_0.models.SearchFormDataIdListRequest()
                .setPageNumber(1)
                .setPageSize(100)
                ...
                .setUseAlias(false);
        try {
            client.searchFormDataIdListWithOptions("APP_PBKTxxx", "FORM-EF6Y4Gxxx", searchFormDataIdListRequest, searchFormDataIdListHeaders, new com.aliyun.teautil.models.RuntimeOptions());
...
func _main (args []*string) (_err error) {
  ...
  searchFormDataIdListHeaders := &dingtalkyida_2_0.SearchFormDataIdListHeaders{}
  searchFormDataIdListHeaders.XAcsDingtalkAccessToken = tea.String("<your access token>")
  searchFormDataIdListRequest := &dingtalkyida_2_0.SearchFormDataIdListRequest{
...
class Client {
  ...
  static async main(args) {
    ...
    let searchFormDataIdListHeaders = new dingtalkyida_2_0.SearchFormDataIdListHeaders({ });
    searchFormDataIdListHeaders.xAcsDingtalkAccessToken = '<your access token>';
    let searchFormDataIdListRequest = new dingtalkyida_2_0.SearchFormDataIdListRequest({
      pageNumber: 1,
      pageSize: 100,
      modifiedToTimeGMT: '2021-09-10',
      systemToken: 'hexxxx',
...
namespace AlibabaCloud.SDK.Sample
{
    public class Sample 
    {
        ...
        public static void Main(string[] args)
        {
            ...
            AlibabaCloud.SDK.Dingtalkyida_2_0.Models.SearchFormDataIdListHeaders searchFormDataIdListHeaders = new AlibabaCloud.SDK.Dingtalkyida_2_0.Models.SearchFormDataIdListHeaders();
            searchFormDataIdListHeaders.XAcsDingtalkAccessToken = "<your access token>";
            AlibabaCloud.SDK.Dingtalkyida_2_0.Models.SearchFormDataIdListRequest searchFormDataIdListRequest = new AlibabaCloud.SDK.Dingtalkyida_2_0.Models.SearchFormDataIdListRequest
            {
                PageNumber = 1,
                PageSize = 100,
                ModifiedToTimeGMT = "2021-09-10",
