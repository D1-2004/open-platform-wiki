...
slug: "obtains-the-information-about-multipart-uploads-of-an-object"
group: "应用开发"
tab: "服务端API"
...
步骤一：调用[初始化文件分片上传](0674-initialize-a-multipart-upload-object.md)接口，获取上传标识uploadKey。
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| uploadKey | String | 是 | 上传唯一标识，调用[初始化文件分片上传](0674-initialize-a-multipart-upload-object.md)接口，获取上传标识uploadKey。 |
