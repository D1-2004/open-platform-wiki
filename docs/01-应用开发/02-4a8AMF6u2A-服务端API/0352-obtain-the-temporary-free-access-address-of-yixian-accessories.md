...
slug: "obtain-the-temporary-free-access-address-of-yixian-accessories"
group: "应用开发"
tab: "服务端API"
breadcrumb: "宜搭 > 附件 > 获取宜搭附件临时免登地址"
doc_id: "TmkVPbKktY"
updated_at: "2026-04-29 13:24:41"
---

> Source: https://open.dingtalk.com/document/development/obtain-the-temporary-free-access-address-of-yixian-accessories
> Path: 应用开发 / 服务端API / 宜搭 > 附件 > 获取宜搭附件临时免登地址
> Updated: 2026-04-29 13:24:41
...
| 字段 | 值 |
| --- | --- |
| HTTP URL | https://api.dingtalk.com/v1.0/yida/apps/temporaryUrls/{appType} |
| HTTP Method | GET |
| 支持的应用类型 | appType-企业内部应用　appType-第三方企业应用 |
| 权限要求 | permission-Yida.Attachment.Read-宜搭附件读权限 |
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| appType | String | 是 | 应用编码，可在宜搭的应用设置中获取，如下图所示：  image |

### 查询参数

| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| systemToken | String | 是 | 应用密钥，可在宜搭的应用设置中获取，如下图所示：  image |
| userId | String | 是 | 用户的userid，可调用[获取部门用户userid列表](0065-query-the-list-of-department-userids.md)接口获取。 |
| language | String | 否 | 语言，取值：   - **zh\_CN**：中文（默认值） - **en\_US**：英文 |
| fileUrl | String | 是 | 宜搭附件地址。 |
| timeout | Long | 否 | 临时地址失效时间，单位毫秒。  例如：60000表示有效期一分钟。   - 最大值: 86400000 , 即24小时。 - 不填则默认60000，即1分钟 - 填0或者负数无效。 |
...
```
GET /v1.0/yida/apps/temporaryUrls/APP_PBKT0xxx?systemToken=hexxxx&userId=manager123&language=zh_CN&fileUrl=https://www.aliwork.com/fileHandle?appType=APP_VN7I6xxx&fileName=fileName.xlsx&instId=&type=download&timeout=60000 HTTP/1.1
...
public class Sample {
    ...
    public static void main(String[] args_) throws Exception {
        ...
        getOpenUrlHeaders.xAcsDingtalkAccessToken = "<your access token>";
        GetOpenUrlRequest getOpenUrlRequest = new GetOpenUrlRequest()
                .setSystemToken("hexxxx")
                .setUserId("manager123")
                .setLanguage("zh_CN")
                .setFileUrl("https://www.aliwork.com/fileHandle?appType=APP_VN7I6xxx&fileName=fileName.xlsx&instId=&type=download")
                .setTimeout(60000L);
        try {
            client.getOpenUrlWithOptions("APP_PBKT0xxx", getOpenUrlRequest, getOpenUrlHeaders, new RuntimeOptions());
...
class Sample:
    ...
    def main(
        ...
        get_open_url_headers = dingtalkyida__1__0_models.GetOpenUrlHeaders()
        get_open_url_headers.x_acs_dingtalk_access_token = '<your access token>'
        get_open_url_request = dingtalkyida__1__0_models.GetOpenUrlRequest(
            system_token='hexxxx',
            user_id='manager123',
            language='zh_CN',
            file_url='https://www.aliwork.com/fileHandle?appType=APP_VN7I6xxx&fileName=fileName.xlsx&instId=&type=download',
            timeout=60000
        )
        try:
            client.get_open_url_with_options('APP_PBKT0xxx', get_open_url_request, get_open_url_headers, util_models.RuntimeOptions())
    ...
    async def main_async(
        ...
        try:
            await client.get_open_url_with_options_async('APP_PBKT0xxx', get_open_url_request, get_open_url_headers, util_models.RuntimeOptions())
        except Exception as err:
            if not UtilClient.empty(err.code) and not UtilClient.empty(err.message):
                # err 中含有 code 和 message 属性，可帮助开发定位问题
                pass
...
class Sample {
    ...
    public static function main($args){
        ...
        $getOpenUrlRequest = new GetOpenUrlRequest([
            ...
            "userId" => "manager123",
            "language" => "zh_CN",
            "fileUrl" => "https://www.aliwork.com/fileHandle?appType=APP_VN7I6xxx&fileName=fileName.xlsx&instId=&type=download",
            "timeout" => 60000
        ]);
        try {
            $client->getOpenUrlWithOptions("APP_PBKT0xxx", $getOpenUrlRequest, $getOpenUrlHeaders, new RuntimeOptions([]));
...
func _main (args []*string) (_err error) {
  ...
  getOpenUrlHeaders := &dingtalkyida_1_0.GetOpenUrlHeaders{}
  getOpenUrlHeaders.XAcsDingtalkAccessToken = tea.String("<your access token>")
  getOpenUrlRequest := &dingtalkyida_1_0.GetOpenUrlRequest{
    SystemToken: tea.String("hexxxx"),
    UserId: tea.String("manager123"),
    Language: tea.String("zh_CN"),
    FileUrl: tea.String("https://www.aliwork.com/fileHandle?appType=APP_VN7I6xxx&fileName=fileName.xlsx&instId=&type=download"),
    Timeout: tea.Int64(60000),
  }
  tryErr := func()(_e error) {
    ...
    _, _err = client.GetOpenUrlWithOptions(tea.String("APP_PBKT0xxx"), getOpenUrlRequest, getOpenUrlHeaders, &util.RuntimeOptions{})
    if _err != nil {
      return _err
    }
...
namespace AlibabaCloud.SDK.Sample
{
    public class Sample 
    {
        ...
        public static void Main(string[] args)
        {
            ...
            try
            {
                client.GetOpenUrlWithOptions("APP_PBKT0xxx", getOpenUrlRequest, getOpenUrlHeaders, new AlibabaCloud.TeaUtil.Models.RuntimeOptions());
            }
            catch (TeaException err)
            {
...
int main(int argc, char *args[]) {
  ...
  shared_ptr<Alibabacloud_Dingtalkyida_1_0::GetOpenUrlHeaders> getOpenUrlHeaders = make_shared<Alibabacloud_Dingtalkyida_1_0::GetOpenUrlHeaders>();
  getOpenUrlHeaders->xAcsDingtalkAccessToken = make_shared<string>("<your access token>");
  shared_ptr<Alibabacloud_Dingtalkyida_1_0::GetOpenUrlRequest> getOpenUrlRequest = make_shared<Alibabacloud_Dingtalkyida_1_0::GetOpenUrlRequest>(map<string, boost::any>({
    {"systemToken", boost::any(string("hexxxx"))},
    {"userId", boost::any(string("manager123"))},
    {"language", boost::any(string("zh_CN"))},
    {"fileUrl", boost::any(string("https://www.aliwork.com/fileHandle?appType=APP_VN7I6xxx&fileName=fileName.xlsx&instId=&type=download"))},
    {"timeout", boost::any(60000)}
  }));
  try {
    client->getOpenUrlWithOptions(make_shared<string>("APP_PBKT0xxx"), getOpenUrlRequest, getOpenUrlHeaders, make_shared<Darabonba_Util::RuntimeOptions>(Darabonba_Util::RuntimeOptions()));
  }
