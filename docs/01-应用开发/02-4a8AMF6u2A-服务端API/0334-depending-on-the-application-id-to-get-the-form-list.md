...
slug: "depending-on-the-application-id-to-get-the-form-list"
group: "应用开发"
tab: "服务端API"
breadcrumb: "宜搭 > 表单 > 获取指定应用下的表单列表"
doc_id: "ihqAxlJl7o"
updated_at: "2026-04-24 14:14:26"
---

> Source: https://open.dingtalk.com/document/development/depending-on-the-application-id-to-get-the-form-list
> Path: 应用开发 / 服务端API / 宜搭 > 表单 > 获取指定应用下的表单列表
> Updated: 2026-04-24 14:14:26
...
| formTypes | String | 否 | 表单类型。   - **receipt**：普通单据表单 - **process**：流程表单      - 不传时两种表单均返回。 - 如需查询多种类型，可用英文逗号分隔。 |
| pageSize | Integer | 否 | 每页条目数，默认值100，最大值100。 |
| pageNumber | Integer | 否 | 页码，不传默认为1。 |
| userId | String | 是 | 操作人userId，可通过[获取部门用户userid列表](0065-query-the-list-of-department-userids.md)接口获取。 |
