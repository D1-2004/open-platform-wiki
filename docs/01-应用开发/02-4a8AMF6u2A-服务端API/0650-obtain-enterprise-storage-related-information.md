...
slug: "obtain-enterprise-storage-related-information"
group: "应用开发"
tab: "服务端API"
breadcrumb: "文档/文件 > 存储管理 > 企业管理 > 获取企业信息"
doc_id: "0cJeXcVvvc"
...
> Path: 应用开发 / 服务端API / 文档/文件 > 存储管理 > 企业管理 > 获取企业信息
...
| 字段 | 值 |
| --- | --- |
| HTTP URL | https://api.dingtalk.com/v1.0/storage/orgs/{corpId} |
| HTTP Method | GET |
