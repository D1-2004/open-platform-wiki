...
| queryDsl | String | 否 | 查询DSL语法，参考[客户群查询DSL语法说明](1370-dsl-syntax-description.md)。 |
...
| openGroupSetId | String | 客户群所在的群组openGroupSetId。   - 如果是客户群组裂变出的客户群，会返回该字段。 - 如果是调用[创建客户群](1355-create-a-customer-group.md)接口创建的客户群，不返回该字段。 |
