...
group: "应用开发"
tab: "服务端API"
breadcrumb: "宜搭 > 任务 > 提交评论"
doc_id: "8JSaFLpXZj"
updated_at: "2026-05-15 08:57:13"
---

> Source: https://open.dingtalk.com/document/development/submit-comment
> Path: 应用开发 / 服务端API / 宜搭 > 任务 > 提交评论
> Updated: 2026-05-15 08:57:13
...
| 字段 | 值 |
| --- | --- |
| HTTP URL | https://api.dingtalk.com/v1.0/yida/forms/remarks |
| HTTP Method | POST |
| 支持的应用类型 | appType-企业内部应用　appType-第三方企业应用 |
| 权限要求 | permission-Yida.Comment.Write-宜搭评论写权限 |
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| appType | String | 是 | 应用编码，获取方式如下： |
| systemToken | String | 是 | 应用密钥，获取方式如下： |
| replyId | Long | 否 | 对评论进行回复。 |
| language | String | 否 | 语言，取值：   - **zh\_CN**：中文（默认值） - **en\_US**：英文 |
| formInstanceId | String | 是 | 实例ID。 |
| userId | String | 是 | 评论人的的useid。 |
| atUserId | String | 否 | 被@的用户userid，将评论内容通过钉钉发给指定用户。 |
| content | String | 是 | 评论内容。 |
| formUuid | String | 否 | 表单UUID，使用组件别名时必填。 |
| env | String | 否 | 环境标：   - **vpc**（默认）：国内 - **sgp\_vpc**：海外 |
...
```
POST /v1.0/yida/forms/remarks HTTP/1.1
...
public class Sample {
    ...
    public static void main(String[] args_) throws Exception {
        ...
        com.aliyun.dingtalkyida_1_0.models.SaveFormRemarkHeaders saveFormRemarkHeaders = new com.aliyun.dingtalkyida_1_0.models.SaveFormRemarkHeaders();
        saveFormRemarkHeaders.xAcsDingtalkAccessToken = "<your access token>";
        com.aliyun.dingtalkyida_1_0.models.SaveFormRemarkRequest saveFormRemarkRequest = new com.aliyun.dingtalkyida_1_0.models.SaveFormRemarkRequest()
                .setAppType("APP_PBKT0xxx")
                .setSystemToken("hexxxx")
                .setReplyId(12L)
                .setLanguage("zh_CN")
                .setFormInstanceId("33f6d221-17xxx")
                .setUserId("user123")
                .setAtUserId("atuser123")
                .setContent("同意审批");
        try {
            client.saveFormRemarkWithOptions(saveFormRemarkRequest, saveFormRemarkHeaders, new com.aliyun.teautil.models.RuntimeOptions());
...
class Sample:
    ...
    def main(
        ...
        save_form_remark_headers = dingtalkyida__1__0_models.SaveFormRemarkHeaders()
        save_form_remark_headers.x_acs_dingtalk_access_token = '<your access token>'
        save_form_remark_request = dingtalkyida__1__0_models.SaveFormRemarkRequest(
            app_type='APP_PBKT0xxx',
            system_token='hexxxx',
            reply_id=12,
            language='zh_CN',
            form_instance_id='33f6d221-17xxx',
            user_id='user123',
            at_user_id='atuser123',
            content='同意审批'
        )
        try:
            client.save_form_remark_with_options(save_form_remark_request, save_form_remark_headers, util_models.RuntimeOptions())
    ...
    async def main_async(
        ...
        try:
            await client.save_form_remark_with_options_async(save_form_remark_request, save_form_remark_headers, util_models.RuntimeOptions())
        except Exception as err:
            if not UtilClient.empty(err.code) and not UtilClient.empty(err.message):
                # err 中含有 code 和 message 属性，可帮助开发定位问题
                pass
...
class Sample {
    ...
    public static function main($args){
        ...
        $saveFormRemarkHeaders = new SaveFormRemarkHeaders([]);
        $saveFormRemarkHeaders->xAcsDingtalkAccessToken = "<your access token>";
        $saveFormRemarkRequest = new SaveFormRemarkRequest([
            "appType" => "APP_PBKT0xxx",
            "systemToken" => "hexxxx",
            "replyId" => 12,
            "language" => "zh_CN",
        ...
        try {
            $client->saveFormRemarkWithOptions($saveFormRemarkRequest, $saveFormRemarkHeaders, new RuntimeOptions([]));
        }
        catch (Exception $err) {
...
func _main (args []*string) (_err error) {
  ...
  saveFormRemarkHeaders := &dingtalkyida_1_0.SaveFormRemarkHeaders{}
  saveFormRemarkHeaders.XAcsDingtalkAccessToken = tea.String("<your access token>")
  saveFormRemarkRequest := &dingtalkyida_1_0.SaveFormRemarkRequest{
    AppType: tea.String("APP_PBKT0xxx"),
    SystemToken: tea.String("hexxxx"),
    ReplyId: tea.Int64(12),
    Language: tea.String("zh_CN"),
    FormInstanceId: tea.String("33f6d221-17xxx"),
    UserId: tea.String("user123"),
    AtUserId: tea.String("atuser123"),
    Content: tea.String("同意审批"),
  }
  tryErr := func()(_e error) {
    ...
    _, _err = client.SaveFormRemarkWithOptions(saveFormRemarkRequest, saveFormRemarkHeaders, &util.RuntimeOptions{})
    if _err != nil {
      return _err
    }
...
class Client {
  ...
  static async main(args) {
    ...
    let saveFormRemarkHeaders = new dingtalkyida_1_0.SaveFormRemarkHeaders({ });
    saveFormRemarkHeaders.xAcsDingtalkAccessToken = '<your access token>';
    let saveFormRemarkRequest = new dingtalkyida_1_0.SaveFormRemarkRequest({
      appType: 'APP_PBKT0xxx',
      systemToken: 'hexxxx',
      replyId: 12,
      language: 'zh_CN',
    ...
    try {
      await client.saveFormRemarkWithOptions(saveFormRemarkRequest, saveFormRemarkHeaders, new Util.RuntimeOptions({ }));
    } catch (err) {
...
namespace AlibabaCloud.SDK.Sample
{
    public class Sample 
    {
        ...
        public static void Main(string[] args)
        {
            ...
            AlibabaCloud.SDK.Dingtalkyida_1_0.Models.SaveFormRemarkHeaders saveFormRemarkHeaders = new AlibabaCloud.SDK.Dingtalkyida_1_0.Models.SaveFormRemarkHeaders();
            saveFormRemarkHeaders.XAcsDingtalkAccessToken = "<your access token>";
            AlibabaCloud.SDK.Dingtalkyida_1_0.Models.SaveFormRemarkRequest saveFormRemarkRequest = new AlibabaCloud.SDK.Dingtalkyida_1_0.Models.SaveFormRemarkRequest
            {
                AppType = "APP_PBKT0xxx",
                SystemToken = "hexxxx",
                ReplyId = 12,
            ...
            try
            {
                client.SaveFormRemarkWithOptions(saveFormRemarkRequest, saveFormRemarkHeaders, new AlibabaCloud.TeaUtil.Models.RuntimeOptions());
            }
            catch (TeaException err)
            {
