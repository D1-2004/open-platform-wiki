...
> - 如果未使用本接口，推荐使用以下存储接口：
>
>   - 添加文件，推荐使用存储产品[获取文件上传信息](https://open.dingtalk.com/document/orgapp/obtain-storage-upload-information)和[提交文件](https://open.dingtalk.com/document/orgapp/submit-documents)接口。
>   - 添加文件夹，推荐使用存储产品[添加文件夹](https://open.dingtalk.com/document/orgapp/add-folder)接口。
...
| mediaId | String | 否 | 对应OSS Object Key。   - 企业内部应用，调用[获取文件上传信息](hhttps://open.dingtalk.com/document/orgapp/obtain-upload-information)接口获取。 - 第三方企业应用，调用[获取文件上传信息](https://open.dingtalk.com/document/isvapp/obtain-upload-information)接口获取。   **[!NOTE]**  - 当**fileType**值为**file**文件时，此参数必填。 - 当**fileType**值为**folder**文件夹时，此参数可不填。 |
