...
> **[!IMPORTANT]**
>
> 为提升接口使用体验，本文档于 2025 年 04 月 28 日迁移至历史文档（不推荐）目录，不再支持新应用接入，已接入的应用不受影响。如果未使用本接口，请使用[发送DING消息](0710-robot-sends-nail-message.md)接口。
