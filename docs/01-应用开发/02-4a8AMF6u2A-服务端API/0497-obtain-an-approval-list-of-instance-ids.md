...
doc_id: "EzsYM7fkLL"
updated_at: "2026-04-24 14:10:44"
---
...
2. 调用[获取单个审批实例详情](0494-obtains-the-details-of-a-single-approval-instance-pop.md)接口，获取审批实例详情信息。
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| processCode | String | 是 | 审批流的唯一码。   - 调用[创建或更新审批表单模板](0487-create-an-approval-form-template.md)接口获取`processCode`参数值。 - 通过[名词解释-processCode](0469-workflow-overview.md)获取。 |
