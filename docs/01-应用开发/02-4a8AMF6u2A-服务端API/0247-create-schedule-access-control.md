...
| userId | String | 是 | 用户ID。当**scopeType**取值为**user**时，传入用户的**unionId**。  **[!NOTE]**  单人最多添加500个共享人 。 |
