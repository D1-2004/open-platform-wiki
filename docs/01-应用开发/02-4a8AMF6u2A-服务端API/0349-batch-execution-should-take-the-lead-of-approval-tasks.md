...
slug: "batch-execution-should-take-the-lead-of-approval-tasks"
group: "应用开发"
tab: "服务端API"
breadcrumb: "宜搭 > 任务 > 批量执行宜搭审批任务"
doc_id: "WPDQntD2PZ"
updated_at: "2025-10-09 18:05:54"
---

> Source: https://open.dingtalk.com/document/development/batch-execution-should-take-the-lead-of-approval-tasks
> Path: 应用开发 / 服务端API / 宜搭 > 任务 > 批量执行宜搭审批任务
> Updated: 2025-10-09 18:05:54

# 批量执行宜搭审批任务

调用本接口批量执行宜搭表单实例的审批任务。

## 接口调用说明

- 批量审批操作目前支持的审批动作仅包含：同意、拒绝。
- 调用本接口之前，请先前往流程设计器中，确保指定的审批节点已经开启了批量审批的功能。 ![](https://img.alicdn.com/imgextra/i3/O1CN019lRzwl1bM9BIdJ5Fb_!!6000000003450-2-tps-2418-1072.png)
...
| 字段 | 值 |
| --- | --- |
| HTTP URL | https://api.dingtalk.com/v1.0/yida/tasks/batches/execute |
| HTTP Method | POST |
| 支持的应用类型 | appType-企业内部应用　appType-第三方企业应用 |
| 权限要求 | permission-Yida.Task.Write-宜搭任务写权限 |
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| outResult | String | 是 | 审批动作，目前支持的审批动作如下：   - agree: 同意。 - disagree: 拒绝。 |
| appType | String | 是 | 宜搭应用编码。      该参数从宜搭应用中获取。 |
| systemToken | String | 是 | 宜搭应用密钥。      该参数从宜搭应用中获取。 |
| remark | String | 否 | 审批意见。 |
| userId | String | 是 | 操作人userId。 |
| taskInformationList | String | 是 | 批量执行的审批任务列表，数组对象格式，每个元素值包含taskId和formInstId两个子属性。       - taskId，表示待执行的审批任务Id，调用[查询流程运行任务（VPC）](0345-query-process-running-tasks-vpc.md)接口获取。 - formInstId，表示当前taskId所属的宜搭表单实例Id，调用[获取实例ID列表](0311-api-getinstanceidlist-v2.md)接口或者[获取多个表单实例ID](0325-api-searchformdataidlist-v2.md)接口获取。   该参数示例值如下：   ``` "[{\"taskId\":\"2291xxx\",\"formInstId\":\"d84a79xxx\"}, {\"taskId\":\"2291xxx\",\"formInstId\":\"f8035e2axxx\"}]" ``` |
...
```
POST /v1.0/yida/tasks/batches/execute HTTP/1.1
Host:api.dingtalk.com
x-acs-dingtalk-access-token:d0928cb68b8635039678c876525fbd83
Content-Type:application/json

{
  "outResult" : "agree",
  "appType" : "APP_XCxxxx",
  "systemToken" : "0986xxxxx",
  "remark" : "OK",
  "userId" : "manager1234",
  "taskInformationList" : "[{\"taskId\":\"2295962401\",\"formInstId\":\"e38e8755-d914-4212-9977-70fb7adf4c29\"},{\"taskId\":\"2295939663\",\"formInstId\":\"e104945b-3a9e-410e-9c4a-0e4ec708905b\"}]"
}
```
...
public class Sample {
    ...
    public static void main(String[] args_) throws Exception {
        ...
        ExecuteBatchTaskHeaders executeBatchTaskHeaders = new ExecuteBatchTaskHeaders();
        executeBatchTaskHeaders.xAcsDingtalkAccessToken = "<your access token>";
        ExecuteBatchTaskRequest executeBatchTaskRequest = new ExecuteBatchTaskRequest()
                .setOutResult("agree")
                .setAppType("APP_XCxxxx")
                .setSystemToken("0986xxxxx")
                .setRemark("OK")
                .setUserId("manager1234")
                .setTaskInformationList("[{\"taskId\":\"2295962401\",\"formInstId\":\"e38e8755-d914-4212-9977-70fb7adf4c29\"},{\"taskId\":\"2295939663\",\"formInstId\":\"e104945b-3a9e-410e-9c4a-0e4ec708905b\"}]");
        try {
            client.executeBatchTaskWithOptions(executeBatchTaskRequest, executeBatchTaskHeaders, new RuntimeOptions());
...
class Sample:
    ...
    def main(
        ...
        execute_batch_task_headers = dingtalkyida__1__0_models.ExecuteBatchTaskHeaders()
        execute_batch_task_headers.x_acs_dingtalk_access_token = '<your access token>'
        execute_batch_task_request = dingtalkyida__1__0_models.ExecuteBatchTaskRequest(
            out_result='agree',
            app_type='APP_XCxxxx',
            system_token='0986xxxxx',
            remark='OK',
            user_id='manager1234',
            task_information_list='[{"taskId":"2295962401","formInstId":"e38e8755-d914-4212-9977-70fb7adf4c29"},{"taskId":"2295939663","formInstId":"e104945b-3a9e-410e-9c4a-0e4ec708905b"}]'
        )
        try:
            client.execute_batch_task_with_options(execute_batch_task_request, execute_batch_task_headers, util_models.RuntimeOptions())
    ...
    async def main_async(
        ...
        try:
            await client.execute_batch_task_with_options_async(execute_batch_task_request, execute_batch_task_headers, util_models.RuntimeOptions())
        except Exception as err:
            if not UtilClient.empty(err.code) and not UtilClient.empty(err.message):
                # err 中含有 code 和 message 属性，可帮助开发定位问题
                pass
...
class Sample {
    ...
    public static function main($args){
        ...
        $executeBatchTaskHeaders = new ExecuteBatchTaskHeaders([]);
        $executeBatchTaskHeaders->xAcsDingtalkAccessToken = "<your access token>";
        $executeBatchTaskRequest = new ExecuteBatchTaskRequest([
            "outResult" => "agree",
            "appType" => "APP_XCxxxx",
            "systemToken" => "0986xxxxx",
            "remark" => "OK",
...
func _main (args []*string) (_err error) {
  ...
  executeBatchTaskHeaders := &dingtalkyida_1_0.ExecuteBatchTaskHeaders{}
  executeBatchTaskHeaders.XAcsDingtalkAccessToken = tea.String("<your access token>")
  executeBatchTaskRequest := &dingtalkyida_1_0.ExecuteBatchTaskRequest{
    OutResult: tea.String("agree"),
    AppType: tea.String("APP_XCxxxx"),
    SystemToken: tea.String("0986xxxxx"),
    Remark: tea.String("OK"),
    UserId: tea.String("manager1234"),
    TaskInformationList: tea.String("[{\"taskId\":\"2295962401\",\"formInstId\":\"e38e8755-d914-4212-9977-70fb7adf4c29\"},{\"taskId\":\"2295939663\",\"formInstId\":\"e104945b-3a9e-410e-9c4a-0e4ec708905b\"}]"),
  }
  tryErr := func()(_e error) {
    ...
    _, _err = client.ExecuteBatchTaskWithOptions(executeBatchTaskRequest, executeBatchTaskHeaders, &util.RuntimeOptions{})
    if _err != nil {
      return _err
    }
...
export default class Client {
  ...
  static async main(args: string[]): Promise<void> {
    ...
    let executeBatchTaskHeaders = new $dingtalkyida_1_0.ExecuteBatchTaskHeaders({ });
    executeBatchTaskHeaders.xAcsDingtalkAccessToken = "<your access token>";
    let executeBatchTaskRequest = new $dingtalkyida_1_0.ExecuteBatchTaskRequest({
      outResult: "agree",
      appType: "APP_XCxxxx",
      systemToken: "0986xxxxx",
      remark: "OK",
    ...
    try {
      await client.executeBatchTaskWithOptions(executeBatchTaskRequest, executeBatchTaskHeaders, new $Util.RuntimeOptions({ }));
    } catch (err) {
...
namespace AlibabaCloud.SDK.Sample
{
    public class Sample 
    {
        ...
        public static void Main(string[] args)
        {
            ...
            AlibabaCloud.SDK.Dingtalkyida_1_0.Models.ExecuteBatchTaskHeaders executeBatchTaskHeaders = new AlibabaCloud.SDK.Dingtalkyida_1_0.Models.ExecuteBatchTaskHeaders();
            executeBatchTaskHeaders.XAcsDingtalkAccessToken = "<your access token>";
            AlibabaCloud.SDK.Dingtalkyida_1_0.Models.ExecuteBatchTaskRequest executeBatchTaskRequest = new AlibabaCloud.SDK.Dingtalkyida_1_0.Models.ExecuteBatchTaskRequest
            {
                OutResult = "agree",
                AppType = "APP_XCxxxx",
                SystemToken = "0986xxxxx",
            ...
            try
            {
                client.ExecuteBatchTaskWithOptions(executeBatchTaskRequest, executeBatchTaskHeaders, new AlibabaCloud.TeaUtil.Models.RuntimeOptions());
            }
            catch (TeaException err)
            {
...
int main(int argc, char *args[]) {
  ...
  shared_ptr<Alibabacloud_Dingtalkyida_1_0::ExecuteBatchTaskHeaders> executeBatchTaskHeaders = make_shared<Alibabacloud_Dingtalkyida_1_0::ExecuteBatchTaskHeaders>();
  executeBatchTaskHeaders->xAcsDingtalkAccessToken = make_shared<string>("<your access token>");
  shared_ptr<Alibabacloud_Dingtalkyida_1_0::ExecuteBatchTaskRequest> executeBatchTaskRequest = make_shared<Alibabacloud_Dingtalkyida_1_0::ExecuteBatchTaskRequest>(map<string, boost::any>({
    {"outResult", boost::any(string("agree"))},
    {"appType", boost::any(string("APP_XCxxxx"))},
    {"systemToken", boost::any(string("0986xxxxx"))},
    {"remark", boost::any(string("OK"))},
    {"userId", boost::any(string("manager1234"))},
    {"taskInformationList", boost::any(string("[{"taskId":"2295962401","formInstId":"e38e8755-d914-4212-9977-70fb7adf4c29"},{"taskId":"2295939663","formInstId":"e104945b-3a9e-410e-9c4a-0e4ec708905b"}]"))}
  }));
  try {
    client->executeBatchTaskWithOptions(executeBatchTaskRequest, executeBatchTaskHeaders, make_shared<Darabonba_Util::RuntimeOptions>(Darabonba_Util::RuntimeOptions()));
  }
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| failNumber | Integer | 审批失败的任务数量。 |
| successNumber | Integer | 审批成功的任务数量。 |
| total | Integer | 总任务数。 |
