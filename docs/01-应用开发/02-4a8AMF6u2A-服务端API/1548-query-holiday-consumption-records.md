...
doc_id: "SNDjjcI05n"
updated_at: "2025-09-08 19:03:23"
---
...
> Updated: 2025-09-08 19:03:23

# 批量查询员工假期余额变更记录

调用本接口，根据员工分页获取假期余额记录信息。

> **[!IMPORTANT]**
>
> 为提升接口使用体验，针对批量查询员工假期余额变更记录接口规范进行升级。本文旧版规范接口文档已于2023年03月13日迁移至历史文档（不推荐）目录，且本接口仅保持现有功能，不再新增支持其他能力。
>
> - 如果未使用本接口，推荐使用新版规范[批量查询员工假期余额变更记录](https://open.dingtalk.com/document/orgapp/batch-query-employee-leave-balance-change-record)接口。
...
> **[!NOTE]**
>
> 通过[钉钉管理后台](https://oa.dingtalk.com/#/welcome) **> 考勤统计 > 假期管理 > 员工假期余额**，只显示有效的余额变更信息。![更新假期余额](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/0685227361/p355048.png)
...
| leave\_code | String | 是 | f84a2dxxxx | 假期类型唯一标识。   - 企业内部应用，通过[查询假期规则列表](https://open.dingtalk.com/document/orgapp/holiday-type-query)接口获取leave\_code参数值。 - 第三方企业应用，通过[查询假期规则列表](https://open.dingtalk.com/document/isvapp/holiday-type-query)接口获取leave\_code参数值。 |
