...
slug: "delete-form-data"
group: "应用开发"
tab: "服务端API"
breadcrumb: "宜搭 > 表单 > 删除表单数据"
doc_id: "vX2557j6tY"
updated_at: "2026-04-22 18:32:59"
---

> Source: https://open.dingtalk.com/document/development/delete-form-data
> Path: 应用开发 / 服务端API / 宜搭 > 表单 > 删除表单数据
> Updated: 2026-04-22 18:32:59

# 删除表单数据

调用本接口，根据实例ID删除指定表单数据。
...
| 字段 | 值 |
| --- | --- |
| HTTP URL | https://api.dingtalk.com/v1.0/yida/forms/instances |
| HTTP Method | DELETE |
...
| formInstanceId | String | 是 | 表单实例ID，可通过[查询表单数据](0334-api-getformdatabyid-v2.md)接口获取。 |
...
```
DELETE /v1.0/yida/forms/instances?appType=APP_PBKTxxx&systemToken=hexxxx&userId=manager123&language=zh_CN&formInstanceId=FORM_INST_12345 HTTP/1.1
...
public class Sample {
    ...
    public static void main(String[] args_) throws Exception {
        ...
        deleteFormDataHeaders.xAcsDingtalkAccessToken = "<your access token>";
        DeleteFormDataRequest deleteFormDataRequest = new DeleteFormDataRequest()
                ...
                .setLanguage("zh_CN")
                .setFormInstanceId("FORM_INST_12345");
        try {
...
export default class Client {
  ...
  static async main(args: string[]): Promise<void> {
    ...
    let deleteFormDataHeaders = new $dingtalkyida_1_0.DeleteFormDataHeaders({ });
    deleteFormDataHeaders.xAcsDingtalkAccessToken = "<your access token>";
    let deleteFormDataRequest = new $dingtalkyida_1_0.DeleteFormDataRequest({
      appType: "APP_PBKTxxx",
      systemToken: "hexxxx",
      userId: "manager123",
      language: "zh_CN",
    ...
    try {
      await client.deleteFormDataWithOptions(deleteFormDataRequest, deleteFormDataHeaders, new $Util.RuntimeOptions({ }));
    } catch (err) {
...
namespace AlibabaCloud.SDK.Sample
{
    public class Sample 
    {
        ...
        public static void Main(string[] args)
        {
            ...
            AlibabaCloud.SDK.Dingtalkyida_1_0.Models.DeleteFormDataHeaders deleteFormDataHeaders = new AlibabaCloud.SDK.Dingtalkyida_1_0.Models.DeleteFormDataHeaders();
            deleteFormDataHeaders.XAcsDingtalkAccessToken = "<your access token>";
            AlibabaCloud.SDK.Dingtalkyida_1_0.Models.DeleteFormDataRequest deleteFormDataRequest = new AlibabaCloud.SDK.Dingtalkyida_1_0.Models.DeleteFormDataRequest
            {
                AppType = "APP_PBKTxxx",
                SystemToken = "hexxxx",
                UserId = "manager123",
            ...
            try
            {
                client.DeleteFormDataWithOptions(deleteFormDataRequest, deleteFormDataHeaders, new AlibabaCloud.TeaUtil.Models.RuntimeOptions());
            }
            catch (TeaException err)
            {
...
int main(int argc, char *args[]) {
  ...
  shared_ptr<Alibabacloud_Dingtalkyida_1_0::DeleteFormDataHeaders> deleteFormDataHeaders = make_shared<Alibabacloud_Dingtalkyida_1_0::DeleteFormDataHeaders>();
  deleteFormDataHeaders->xAcsDingtalkAccessToken = make_shared<string>("<your access token>");
  shared_ptr<Alibabacloud_Dingtalkyida_1_0::DeleteFormDataRequest> deleteFormDataRequest = make_shared<Alibabacloud_Dingtalkyida_1_0::DeleteFormDataRequest>(map<string, boost::any>({
    ...
    {"formInstanceId", boost::any(string("FORM_INST_12345"))}
  }));
  try {
    client->deleteFormDataWithOptions(deleteFormDataRequest, deleteFormDataHeaders, make_shared<Darabonba_Util::RuntimeOptions>(Darabonba_Util::RuntimeOptions()));
  }
