...
doc_id: "3qEJBE3tDE"
updated_at: "2025-12-08 17:37:32"
---

> Source: https://open.dingtalk.com/document/development/add-pin-disk-permission
> Path: 应用开发 / 服务端API / 历史文档（不推荐） > 文档/文件 > 钉盘 > 权限管理 > 添加权限
> Updated: 2025-12-08 17:37:32
...
调用本接口，实现添加用户对钉盘空间和文件的权限，以添加用户对钉盘文件的权限为例，具体示例如下图所示。
