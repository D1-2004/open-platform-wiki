...
doc_id: "yzwHW6cnqt"
updated_at: "2025-09-08 19:03:28"
---
...
> - 新接入的用户建议直接使用新接口[针对单个日程进行签到](https://open.dingtalk.com/document/orgapp/sign-in-for-a-single-schedule-new)。

调用本接口实现单个日程签到动作，示例如下图所示：

![](https://img.alicdn.com/imgextra/i2/O1CN01ZuRiXl1N4N9kRNJe1_!!6000000001516-0-tps-200-432.jpg)
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| x-acs-dingtalk-access-token | String | 是 | 调用该接口的访问凭证。   - 企业内部应用可通过[获取企业内部应用的access\_token](https://open.dingtalk.com/document/orgapp/obtain-orgapp-token)接口获取 - 第三方企业应用可通过[获取第三方应用授权企业的access\_token](https://open.dingtalk.com/document/isvapp/obtains-the-enterprise-authorized-credential)接口获取。 - 第三方个人应用可调用[获取用户token](https://open.dingtalk.com/document/personalapp/obtain-user-token)接口获取。 |
