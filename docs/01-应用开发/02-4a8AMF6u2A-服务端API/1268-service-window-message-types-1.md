...
doc_id: "5aSd4KUbRt"
updated_at: "2025-09-10 19:31:39"
---

> Source: https://open.dingtalk.com/document/development/service-window-message-types-1
> Path: 应用开发 / 服务端API / 更多开放 > 服务窗 > 消息类型
> Updated: 2025-09-10 19:31:39
...
> **[!IMPORTANT]**
>
> 服务窗消息开放接口均为新版规范接口，请参考[如何调用服务端API](https://open.dingtalk.com/document/development/how-to-call-apis)和[服务端SDK下载](0002-download-the-server-side-sdk.md)。

## 调用限制

- 服务窗消息开放接口调用限制：针对不同类型的接口，调用限制不同。

  - [发送服务窗单人消息](1271-sends-a-single-message-from-the-service-window.md)接口，每天累计调用次数不超过服务窗粉丝数量限制。
  - [批量发送服务窗消息](1270-batch-sending-of-service-window-messages.md)接口，每天允许调用次数不超过100次。
...
| picUrl | String | 是 | @MOCK-123456 | 图片地址。   - 可以通过[上传媒体文件](0644-upload-media-files.md)接口获取 - 最长500个字符 |
