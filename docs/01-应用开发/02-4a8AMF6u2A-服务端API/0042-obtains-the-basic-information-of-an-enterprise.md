...
> Path: 应用开发 / 服务端API / 应用授权 > 获取企业授权信息
...
| signature | String | 是 | xxx | 签名。签名计算方式请参考[第三方访问接口的签名计算方法](1405-the-signature-calculation-method-of-the-third-party-access-interface.md)。  **[!NOTE]**  计算出签名以后，需要进行urlencode，才能把签名参数拼接到url中。 |
