...
doc_id: "Y3kSXNBVJv"
updated_at: "2025-09-08 19:06:46"
---
...
>
> - 如果未使用本接口，推荐使用存储产品[获取文件上传信息](https://open.dingtalk.com/document/orgapp/obtain-file-upload-informations)接口。
