---
title: "消息通知类型"
source_url: "https://open.dingtalk.com/document/development/message-types-and-data-format"
namespace: "development"
slug: "message-types-and-data-format"
group: "应用开发"
tab: "服务端API"
breadcrumb: "即时通信 > 消息通知 > 工作通知 > 消息通知类型"
doc_id: "aBgNN3kVT9"
updated_at: "2026-03-06 09:17:32"
---

> Source: https://open.dingtalk.com/document/development/message-types-and-data-format
> Path: 应用开发 / 服务端API / 即时通信 > 消息通知 > 工作通知 > 消息通知类型
> Updated: 2026-03-06 09:17:32
...
| media\_id | String | 是 | @lADOADmaWMzazQKA | 媒体文件mediaid，调用[上传媒体文件](0644-upload-media-files.md)接口获取mediaId参数值。建议宽600像素 x 400像素，宽高比3 : 2。 |
...
| media\_id | String | 是 | @lADOADmaWMzazQKA | 媒体文件ID，调用[上传媒体文件](0644-upload-media-files.md)接口获取。 |
...
| media\_id | String | 是 | @lADOADmaWMzazQKA | 媒体文件ID，引用的媒体文件最大10MB，可调用[上传媒体文件](0644-upload-media-files.md)接口获取。 |
...
| link.messageUrl | String | 是 | http://dingtalk.com | 消息点击链接地址，当发送消息为小程序时支持小程序跳转链接，请参考[消息链接说明](0774-message-link-description.md)。 |
| link.picUrl | String | 是 | @lADOADmaWMzazQKA | 调用[上传媒体文件](0644-upload-media-files.md)接口获取。 |
...
| 名称 | 类型 | 是否必填 | 示例值 | 描述 |
| --- | --- | --- | --- | --- |
| oa.message\_url | String | 是 | http://dingtalk.com | 消息点击链接地址，当发送消息为小程序时支持小程序跳转链接，请参考[消息链接说明](0774-message-link-description.md)。 |
...
| oa.head.text | String | 是 | 头部标题 | 消息的头部标题。如果是[发送工作通知](0767-asynchronous-sending-of-enterprise-session-messages.md)消息，该参数会被替换为当前应用名称。 |
| oa.status\_bar | JSON Object | 否 |  | 消息状态栏，只支持接收者的userid列表，userid最多不能超过5个人。  **[!NOTE]**  不支持部门id列表，  并且to\_all\_user不能传true。 |
...
| oa.body.image | String | 否 | @lADOADmaWMzazQKA | 消息体中的图片，支持图片资源@mediaId，通过调用[上传媒体文件](0644-upload-media-files.md)接口获取，建议宽600像素 x 400像素，宽高比3 : 2。 |
...
| 名称 | 类型 | 是否必填 | 示例值 | 描述 |
| --- | --- | --- | --- | --- |
| msgtype | String | 是 | markdown | 消息类型，通过调用[上传媒体文件](0644-upload-media-files.md)接口获取，Markdown类型为：markdown。 |
...
| action\_card.title | String | 否 | 测试标题 | 透出到会话列表和通知的文案。222 |
...
| action\_card.single\_url | String | 否 | https://open.dingtalk.com | 消息点击链接地址，调用[上传媒体文件](0644-upload-media-files.md)接口获取，当发送消息为小程序时支持小程序跳转链接，最长500个字符。 |
