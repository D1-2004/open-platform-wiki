---
title: "查询表单实例数据"
source_url: "https://open.dingtalk.com/document/development/querying-form-instance-data"
namespace: "development"
slug: "querying-form-instance-data"
group: "应用开发"
tab: "服务端API"
breadcrumb: "历史文档（不推荐） > 宜搭 > 表单 > 查询表单实例数据"
doc_id: "i6SRAf3MjL"
updated_at: "2025-09-08 19:03:43"
---

> Source: https://open.dingtalk.com/document/development/querying-form-instance-data
> Path: 应用开发 / 服务端API / 历史文档（不推荐） > 宜搭 > 表单 > 查询表单实例数据
> Updated: 2025-09-08 19:03:43
...
>
> - 如果未使用本接口，推荐使用[查询表单实例数据](https://open.dingtalk.com/document/orgapp/api-searchformdatas-v2)接口。
...
```
POST /v1.0/yida/forms/instances/search HTTP/1.1
...
| searchFieldJson | String | 否 | 根据表单内组件值查询，示例值如下：   ``` {     "textField_jcr0069m": "danhang",     "textareaField_jcr0069n": "duohang",     "numberField_jcr0069o": [         "1",         "10"     ],     "radioField_jcr0069p": "选项一",     "selectField_jcr0069q": "选项一",     "checkboxField_jcr0069r": [         "选项二"     ],     "multiSelectField_jcr0069s": [         "选项二",         "选项三"     ],     "dateField_jcr0069t": [         1514736000000,         1517414399000     ],     "cascadeDate_jcr0069u": [         [             1514736000000,             1517414399000         ],         [             1514736000000,             1517414399000         ]     ],     "employeeField_jcr0069x": [         "xxxxx"     ],     "citySelectField_jcr0069y": [         "110000",         "110100",         "110101"     ],     "departmentField_jcr0069z": 1123456,     "cascadeSelectField_jcr006a0": [         "part",         "part_b"     ],     "tableField_jcr006a1": "明细数据" } ``` |
| currentPage | Integer | 否 | 分页参数，当前页。 |
| pageSize | Integer | 否 | 分页参数，每页显示条数。 |
| originatorId | String | 否 | 根据数据提交人工号查询。 |
| createFromTimeGMT | String | 否 | 查询创建数据列表的开始时间，格式：`yyyy-MM-dd`。  **[!NOTE]**    **createFromTimeGMT**和**createToTimeGMT**两个时间构造一个时间段，查询在该时间段创建的数据列表。 |
| createToTimeGMT | String | 否 | 查询创建数据列表的结束时间，格式：`yyyy-MM-dd`。  **[!NOTE]**    **createFromTimeGMT**和**createToTimeGMT**两个时间构造一个时间段，查询在该时间段创建的数据列表。 |
| modifiedFromTimeGMT | String | 否 | 查询修改数据列表的开始时间，格式：`yyyy-MM-dd`。  **[!NOTE]**    **modifiedFromTimeGMT**和**modifiedTo**构成一个时间段，查询在该时间段有修改的数据列表。 |
| modifiedToTimeGMT | String | 否 | 查询修改数据列表的结束时间，格式：`yyyy-MM-dd`。  **[!NOTE]**    **modifiedFromTimeGMT**和**modifiedTo**构成一个时间段，查询在该时间段有修改的数据列表。 |
| dynamicOrder | String | 否 | 指定排序字段。 |
| logicOperator | String | 否 | 接口查询数据支持「或」条件 |

## 返回参数

| 名称 | 类型 | 描述 |
| --- | --- | --- |
| currentPage | Long | 分页参数，当前页。 |
| totalCount | Long | 符合条件的实例总数。 |
| data | Array | 实例详情列表。 |
| dataId | Long | 实体主键ID。 |
| formInstanceId | String | 表单实例ID。 |
| createdTimeGMT | String | 数据创建时间。 |
| modifiedTimeGMT | String | 最近修改时间。 |
| formUuid | String | 表单uid。 |
| modelUuid | String | 模型uid。 |
...
| nameInEnglish | String | 英文名称。 |
| type | String | 国际化。 |
| formData | Map | 表单数据，示例值如下：   ``` {     "numberField_jcr0069o": 1,     "multiSelectField_jcr0069s": [         "选项三",         "选项二"     ],     "textareaField_jcr0069n": "duohang",     "employeeField_jcr0069x": [         "xxxx"     ],     "departmentField_jcr0069z": "xxxx",     "selectField_jcr0069q": "选项一",     "citySelectField_jcr0069y": [         "北京",         "北京市",         "东城区"     ],     "checkboxField_jcr0069r": [         "选项三",         "选项二"     ],     "textField_jcr0069m": "danhang",     "radioField_jcr0069p": "选项一",     "dateField_jcr0069t": 1516636800000 } ``` |
| title | String | 标题。 |
| serialNo | String | 流水号。 |
| instanceValue | String | 表单实例原始格式值。 |
| version | Long | 数据版本。 |
| creatorUserId | String | 创建人的userid。 |
| modifierUserId | String | 修改人的userid。 |
| sequence | String | 批次号。 |
...
POST /v1.0/yida/forms/instances/search HTTP/1.1
Host:api.dingtalk.com
x-acs-dingtalk-access-token:dadfefafasaf2123133sf
Content-Type:application/json

{
  "appType" : "APP_PBKT0MFBEBTDO8T7SLVP",
  "systemToken" : "hexxx",
  "userId" : "17311111112231",
  "language" : "zh_CN",
  "formUuid" : "FORM-EF6Yxxx",
  "searchFieldJson" : "{\"textField_jcr0069m\":\"danhang\",\"textareaField_jcr0069n\":\"duohang\",\"numberField_jcr0069o\":[\"1\",\"10\"],\"radioField_jcr0069p\":\"选项一\",\"selectField_jcr0069q\":\"选项一\",\"checkboxField_jcr0069r\":[\"选项二\"],\"multiSelectField_jcr0069s\":[\"选项二\",\"选项三\"],\"dateField_jcr0069t\":[1514736000000,1517414399000],\"cascadeDate_jcr0069u\":[[1514736000000,1517414399000],[1514736000000,1517414399000]],\"employeeField_jcr0069x\":[\"xxxxx\"],\"citySelectField_jcr0069y\":[\"110000\",\"110100\",\"110101\"],\"departmentField_jcr0069z\":1123456,\"cascadeSelectField_jcr006a0\":[\"part\",\"part_b\"],\"tableField_jcr006a1\":\"明细数据\"}",
  "currentPage" : 1,
  "pageSize" : 10,
  "originatorId" : "1731111122223332",
  "createFromTimeGMT" : "2018-01-01",
  "createToTimeGMT" : "2018-02-01",
  "modifiedFromTimeGMT" : "2018-01-01",
  "modifiedToTimeGMT" : "2018-02-01",
  "dynamicOrder" : "{\"numberField_1ac\":\"+\"}, 表示按照字段numberField_1ac升序排列",
  "logicOperator" : "or"
}
```
...
public class Sample {
    ...
    public static void main(String[] args_) throws Exception {
        ...
        searchFormDatasHeaders.xAcsDingtalkAccessToken = "<your access token>";
        com.aliyun.dingtalkyida_1_0.models.SearchFormDatasRequest searchFormDatasRequest = new com.aliyun.dingtalkyida_1_0.models.SearchFormDatasRequest()
                ...
                .setUserId("17311111112231")
                .setLanguage("zh_CN")
                .setFormUuid("FORM-EF6Yxxx")
                .setSearchFieldJson("{\"textField_jcr0069m\":\"danhang\",\"textareaField_jcr0069n\":\"duohang\",\"numberField_jcr0069o\":[\"1\",\"10\"],\"radioField_jcr0069p\":\"选项一\",\"selectField_jcr0069q\":\"选项一\",\"checkboxField_jcr0069r\":[\"选项二\"],\"multiSelectField_jcr0069s\":[\"选项二\",\"选项三\"],\"dateField_jcr0069t\":[1514736000000,1517414399000],\"cascadeDate_jcr0069u\":[[1514736000000,1517414399000],[1514736000000,1517414399000]],\"employeeField_jcr0069x\":[\"xxxxx\"],\"citySelectField_jcr0069y\":[\"110000\",\"110100\",\"110101\"],\"departmentField_jcr0069z\":1123456,\"cascadeSelectField_jcr006a0\":[\"part\",\"part_b\"],\"tableField_jcr006a1\":\"明细数据\"}")
                .setCurrentPage(1)
                .setPageSize(10)
                ...
                .setLogicOperator("or");
        try {
            client.searchFormDatasWithOptions(searchFormDatasRequest, searchFormDatasHeaders, new com.aliyun.teautil.models.RuntimeOptions());
...
class Sample {
    ...
    public static function main($args){
        ...
        $searchFormDatasHeaders->xAcsDingtalkAccessToken = "<your access token>";
        $searchFormDatasRequest = new SearchFormDatasRequest([
            "appType" => "APP_PBKT0MFBEBTDO8T7SLVP",
            "systemToken" => "hexxx",
            "userId" => "17311111112231",
            "language" => "zh_CN",
...
func _main (args []*string) (_err error) {
  ...
  searchFormDatasHeaders := &dingtalkyida_1_0.SearchFormDatasHeaders{}
  searchFormDatasHeaders.XAcsDingtalkAccessToken = tea.String("<your access token>")
  searchFormDatasRequest := &dingtalkyida_1_0.SearchFormDatasRequest{
    AppType: tea.String("APP_PBKT0MFBEBTDO8T7SLVP"),
    SystemToken: tea.String("hexxx"),
    UserId: tea.String("17311111112231"),
    ...
    OriginatorId: tea.String("1731111122223332"),
...
class Client {
  ...
  static async main(args) {
    ...
    let searchFormDatasHeaders = new dingtalkyida_1_0.SearchFormDatasHeaders({ });
    searchFormDatasHeaders.xAcsDingtalkAccessToken = '<your access token>';
    let searchFormDatasRequest = new dingtalkyida_1_0.SearchFormDatasRequest({
      appType: 'APP_PBKT0MFBEBTDO8T7SLVP',
      systemToken: 'hexxx',
      userId: '17311111112231',
      language: 'zh_CN',
    ...
    try {
      await client.searchFormDatasWithOptions(searchFormDatasRequest, searchFormDatasHeaders, new Util.RuntimeOptions({ }));
    } catch (err) {
...
namespace AlibabaCloud.SDK.Sample
{
    public class Sample 
    {
        ...
        public static void Main(string[] args)
        {
            ...
            AlibabaCloud.SDK.Dingtalkyida_1_0.Models.SearchFormDatasHeaders searchFormDatasHeaders = new AlibabaCloud.SDK.Dingtalkyida_1_0.Models.SearchFormDatasHeaders();
            searchFormDatasHeaders.XAcsDingtalkAccessToken = "<your access token>";
            AlibabaCloud.SDK.Dingtalkyida_1_0.Models.SearchFormDatasRequest searchFormDatasRequest = new AlibabaCloud.SDK.Dingtalkyida_1_0.Models.SearchFormDatasRequest
            {
                AppType = "APP_PBKT0MFBEBTDO8T7SLVP",
                SystemToken = "hexxx",
                UserId = "17311111112231",
            ...
            try
            {
                client.SearchFormDatasWithOptions(searchFormDatasRequest, searchFormDatasHeaders, new AlibabaCloud.TeaUtil.Models.RuntimeOptions());
            }
            catch (TeaException err)
            {
    ...
    "data": [
        {
            ...
            "modelUuid": "FORM-EF6Y93URN24F1SCX15VA2P918LPEIJ2H3UFORCJ1",
            "originator": {
                "userId": "1731111122212122",
                "userName": {
                    "nameInChinese": "张三",
...
| 500 | unclassifiedError | 异常:%s | 宜搭未分类的异常信息 |
