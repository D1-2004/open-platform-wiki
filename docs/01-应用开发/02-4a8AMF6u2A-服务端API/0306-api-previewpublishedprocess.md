...
slug: "api-previewpublishedprocess"
group: "应用开发"
tab: "服务端API"
breadcrumb: "宜搭 > 流程 > 预览审批流程"
doc_id: "ITfMvR6egr"
updated_at: "2025-09-23 19:25:23"
---

> Source: https://open.dingtalk.com/document/development/api-previewpublishedprocess
> Path: 应用开发 / 服务端API / 宜搭 > 流程 > 预览审批流程
> Updated: 2025-09-23 19:25:23

# 预览审批流程

发起流程前，预览流程流向。预览流程发起后的审批人情况，不会真正发起流程，不产生业务数据。
...
| 字段 | 值 |
| --- | --- |
| HTTP URL | https://api.dingtalk.com/v1.0/yida/processes/preview |
| HTTP Method | POST |
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| appType | String | 是 | 应用编码。 |
| systemToken | String | 是 | 应用密钥，在应用数据中获取。 <props="intl">只发布虚商站 |
| userId | String | 是 | 用户的userid。 |
| language | String | 否 | 语言，取值：   - zh\_CN：中文（默认值） - en\_US：英文 |
| formUuid | String | 是 | 表单ID。 |
| formDataJson | String | 是 | 表单数据，示例：`"{\"textField_jcpm6agt\": \"单行\",\"employeeField_jcos0sar\": [\"workno\"]}"`   - key：流程组件标识，宜搭表单编辑页面，高级设置中查看。 - value：流程组件内的值。 |
| processCode | String | 否 | 流程编码。 |
| departmentId | String | 否 | 发起人所在部门ID。 |
...
```
POST /v1.0/yida/processes/preview HTTP/1.1
Host:api.dingtalk.com
x-acs-dingtalk-access-token:e1224c40ce5c3704a449a4c41d545681
...

{
  ...
  "userId" : "1731234567",
  "language" : "zh_CN",
  "formUuid" : "FORM-NJYJZELV8YZRDEI2N5IQ7L6VEDMR1VE9GMPCJB",
  "formDataJson" : "{\"textField_jcpm6agt\": \"单行\",\"employeeField_jcos0sar\": [\"workno\"]}",
...
public class Sample {
    ...
    public static void main(String[] args_) throws Exception {
        ...
        com.aliyun.dingtalkyida_1_0.models.PreviewPublishedProcessHeaders previewPublishedProcessHeaders = new com.aliyun.dingtalkyida_1_0.models.PreviewPublishedProcessHeaders();
        previewPublishedProcessHeaders.xAcsDingtalkAccessToken = "<your access token>";
        com.aliyun.dingtalkyida_1_0.models.PreviewPublishedProcessRequest previewPublishedProcessRequest = new com.aliyun.dingtalkyida_1_0.models.PreviewPublishedProcessRequest()
                .setAppType("APP_PBKT0MFBEBTDO8T7SLVP")
                .setSystemToken("hexxx")
                .setUserId("1731234567")
                .setLanguage("zh_CN")
                .setFormUuid("FORM-NJYJZELV8YZRDEI2N5IQ7L6VEDMR1VE9GMPCJB")
                .setFormDataJson("{\"textField_jcpm6agt\": \"单行\",\"employeeField_jcos0sar\": [\"workno\"]}")
                .setProcessCode("TPROC--EF6Y4G8WO2FN0SUB43TDQ3CGC3FMFQ1G9400RCJ4")
                .setDepartmentId("18295");
        try {
            client.previewPublishedProcessWithOptions(previewPublishedProcessRequest, previewPublishedProcessHeaders, new com.aliyun.teautil.models.RuntimeOptions());
...
class Sample:
    ...
    def main(
        ...
        preview_published_process_headers = dingtalkyida__1__0_models.PreviewPublishedProcessHeaders()
        preview_published_process_headers.x_acs_dingtalk_access_token = '<your access token>'
        preview_published_process_request = dingtalkyida__1__0_models.PreviewPublishedProcessRequest(
            app_type='APP_PBKT0MFBEBTDO8T7SLVP',
            system_token='hexxx',
            user_id='1731234567',
            language='zh_CN',
            form_uuid='FORM-NJYJZELV8YZRDEI2N5IQ7L6VEDMR1VE9GMPCJB',
            form_data_json='{"textField_jcpm6agt": "单行","employeeField_jcos0sar": ["workno"]}',
            process_code='TPROC--EF6Y4G8WO2FN0SUB43TDQ3CGC3FMFQ1G9400RCJ4',
            department_id='18295'
        )
        try:
            client.preview_published_process_with_options(preview_published_process_request, preview_published_process_headers, util_models.RuntimeOptions())
    ...
    async def main_async(
        ...
        try:
            await client.preview_published_process_with_options_async(preview_published_process_request, preview_published_process_headers, util_models.RuntimeOptions())
        except Exception as err:
            if not UtilClient.empty(err.code) and not UtilClient.empty(err.message):
                # err 中含有 code 和 message 属性，可帮助开发定位问题
                pass
...
class Sample {
    ...
    public static function main($args){
        ...
        $previewPublishedProcessHeaders = new PreviewPublishedProcessHeaders([]);
        $previewPublishedProcessHeaders->xAcsDingtalkAccessToken = "<your access token>";
        $previewPublishedProcessRequest = new PreviewPublishedProcessRequest([
            "appType" => "APP_PBKT0MFBEBTDO8T7SLVP",
            "systemToken" => "hexxx",
            "userId" => "1731234567",
            "language" => "zh_CN",
        ...
        try {
            $client->previewPublishedProcessWithOptions($previewPublishedProcessRequest, $previewPublishedProcessHeaders, new RuntimeOptions([]));
        }
        catch (Exception $err) {
...
func _main (args []*string) (_err error) {
  ...
  previewPublishedProcessHeaders := &dingtalkyida_1_0.PreviewPublishedProcessHeaders{}
  previewPublishedProcessHeaders.XAcsDingtalkAccessToken = tea.String("<your access token>")
  previewPublishedProcessRequest := &dingtalkyida_1_0.PreviewPublishedProcessRequest{
    AppType: tea.String("APP_PBKT0MFBEBTDO8T7SLVP"),
    SystemToken: tea.String("hexxx"),
    UserId: tea.String("1731234567"),
    Language: tea.String("zh_CN"),
    FormUuid: tea.String("FORM-NJYJZELV8YZRDEI2N5IQ7L6VEDMR1VE9GMPCJB"),
    FormDataJson: tea.String("{\"textField_jcpm6agt\": \"单行\",\"employeeField_jcos0sar\": [\"workno\"]}"),
    ProcessCode: tea.String("TPROC--EF6Y4G8WO2FN0SUB43TDQ3CGC3FMFQ1G9400RCJ4"),
    DepartmentId: tea.String("18295"),
  }
  tryErr := func()(_e error) {
    ...
    _, _err = client.PreviewPublishedProcessWithOptions(previewPublishedProcessRequest, previewPublishedProcessHeaders, &util.RuntimeOptions{})
    if _err != nil {
      return _err
    }
...
class Client {
  ...
  static async main(args) {
    ...
    let previewPublishedProcessHeaders = new dingtalkyida_1_0.PreviewPublishedProcessHeaders({ });
    previewPublishedProcessHeaders.xAcsDingtalkAccessToken = '<your access token>';
    let previewPublishedProcessRequest = new dingtalkyida_1_0.PreviewPublishedProcessRequest({
      appType: 'APP_PBKT0MFBEBTDO8T7SLVP',
      systemToken: 'hexxx',
      userId: '1731234567',
      language: 'zh_CN',
    ...
    try {
      await client.previewPublishedProcessWithOptions(previewPublishedProcessRequest, previewPublishedProcessHeaders, new Util.RuntimeOptions({ }));
    } catch (err) {
...
namespace AlibabaCloud.SDK.Sample
{
    public class Sample 
    {
        ...
        public static void Main(string[] args)
        {
            ...
            AlibabaCloud.SDK.Dingtalkyida_1_0.Models.PreviewPublishedProcessHeaders previewPublishedProcessHeaders = new AlibabaCloud.SDK.Dingtalkyida_1_0.Models.PreviewPublishedProcessHeaders();
            previewPublishedProcessHeaders.XAcsDingtalkAccessToken = "<your access token>";
            AlibabaCloud.SDK.Dingtalkyida_1_0.Models.PreviewPublishedProcessRequest previewPublishedProcessRequest = new AlibabaCloud.SDK.Dingtalkyida_1_0.Models.PreviewPublishedProcessRequest
            {
                AppType = "APP_PBKT0MFBEBTDO8T7SLVP",
                SystemToken = "hexxx",
                UserId = "1731234567",
            ...
            try
            {
                client.PreviewPublishedProcessWithOptions(previewPublishedProcessRequest, previewPublishedProcessHeaders, new AlibabaCloud.TeaUtil.Models.RuntimeOptions());
            }
            catch (TeaException err)
            {
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| result | Array | 流程实例操作记录数组 |
| processInstanceId | String | 流程实例ID。 |
| showName | String | 节点显示名称。 |
| operatorNickName | String | 操作人花名。 |
| activeTimeGMT | String | 激活时间。 |
| operateTimeGMT | String | 操作时间。 |
| operateType | String | 操作类型。 |
| operatorStatus | String | 操作者状态。 |
| remark | String | 审批意见。 |
| taskHoldTimeGMT | Long | 任务挂起时间。 |
| type | String | 节点类型。 |
| operatorName | String | 操作者名称。 |
| operatorUserId | String | 操作者userId。  **[!NOTE]**     - 对于普通节点，返回操作人useriId。 - 对于发起人自选节点，该字段会返回发起人自选节点唯一标识，例如：**\_\_optionalApproval\_node\_ocltdztr2b1**。 |
| activityId | String | 节点ID。 |
| taskType | String | 任务类型：   - 一个一个分发 COMMON\_ONE\_BY\_ONE - 一次性分发COMMON\_ALL\_AT\_ONCE - 中间插入的任务类型（一个一个分发）MIDDLE\_IN\_ONE\_BY\_ONE - 中间插入的任务类型（一次性分发）MIDDLE\_IN\_ALL\_AT\_ONCE   **[!NOTE]**    只有运行的待办任务才会都有值。 |
| taskExecuteType | String | 任务执行类型：   - NORMAL: 正常的执行 - FILTERED: 过滤的执行 - AUTO: 自动审批的执行   **[!NOTE]**    只有运行的待办任务才会有值。 |
| size | Integer | 大小。 |
| operatorDisplayName | String | 操作者展示名称。 |
| files | String | 文件。 |
| action | String | 动作。 |
| actionExit | String | 格式化的Action。 |
| dataId | Long | 数据ID。 |
| taskId | String | 任务ID。 |
| digitalSign | String | 手写签名。 |
| operatorPhotoUrl | String | 操作者的头像URL。 |
| domains | Array of Any | 子任务。 |
...

{
  "result" : [ {
    ...
    "type" : "FORCAST",
    "operatorName" : "卜多",
    "operatorUserId" : "5014533041684350",
    "activityId" : "sid-restartevent",
    "taskType" : "COMMON_ALL_AT_ONCE",
    "size" : 1,
    "operatorDisplayName" : "卜多",
    "action" : "提交申请",
    "taskId" : "null",
    "operatorPhotoUrl" : "https://static.dingtalk.com/media/lADPD4d83lteeeDNA8DNA8A_960_960.jpg"
  }, {
    "operatorUserId" : "__optionalApproval_node_ocltdztr2b1",
    "activityId" : "node_ocltdztr2b1",
    "taskType" : "COMMON_ALL_AT_ONCE",
    "showName" : "审批人",
    "size" : 1,
    "domains" : [ ],
    ...
    "operatorUserId" : "__optionalApproval_node_ocltdztr2b3",
    "activityId" : "node_ocltdztr2b3",
    "taskType" : "COMMON_ALL_AT_ONCE",
    "showName" : "审批人",
    "size" : 1,
    "domains" : [ ],
    ...
    "operatorUserId" : "__optionalApproval_node_oclte07cwn1",
    "activityId" : "node_oclte07cwn1",
    "taskType" : "COMMON_ALL_AT_ONCE",
    "showName" : "审批人",
    "size" : 1,
    "domains" : [ ],
