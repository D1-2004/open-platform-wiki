...
用于查询抄送我的任务列表（应用维度）。调用时通过 GET 请求。
...
| 字段 | 值 |
| --- | --- |
| HTTP URL | https://api.dingtalk.com/v1.0/yida/tasks/taskCopies |
| HTTP Method | GET |
...
| processCodes | String | 否 | 流程code列表。 |
...
```
GET /v1.0/yida/tasks/taskCopies?appType=APP_PBKTxxx&systemToken=hexxxx&pageSize=10&language=zh_CN&pageNumber=1&keyword={}&userId=manager123&processCodes=["xx","xxx"] HTTP/1.1
...
public class Sample {
    ...
    public static void main(String[] args_) throws Exception {
        ...
        GetTaskCopiesHeaders getTaskCopiesHeaders = new GetTaskCopiesHeaders();
        getTaskCopiesHeaders.xAcsDingtalkAccessToken = "<your access token>";
        GetTaskCopiesRequest getTaskCopiesRequest = new GetTaskCopiesRequest()
        ...
        try {
            client.getTaskCopiesWithOptions(getTaskCopiesRequest, getTaskCopiesHeaders, new RuntimeOptions());
...
class Sample:
    ...
    def main(
        ...
        get_task_copies_headers = dingtalkyida__1__0_models.GetTaskCopiesHeaders()
        get_task_copies_headers.x_acs_dingtalk_access_token = '<your access token>'
        get_task_copies_request = dingtalkyida__1__0_models.GetTaskCopiesRequest(
        ...
        try:
            client.get_task_copies_with_options(get_task_copies_request, get_task_copies_headers, util_models.RuntimeOptions())
    ...
    async def main_async(
        ...
        try:
            await client.get_task_copies_with_options_async(get_task_copies_request, get_task_copies_headers, util_models.RuntimeOptions())
        except Exception as err:
            if not UtilClient.empty(err.code) and not UtilClient.empty(err.message):
                # err 中含有 code 和 message 属性，可帮助开发定位问题
                pass
...
class Sample {
    ...
    public static function main($args){
        ...
        $getTaskCopiesHeaders = new GetTaskCopiesHeaders([]);
        $getTaskCopiesHeaders->xAcsDingtalkAccessToken = "<your access token>";
        $getTaskCopiesRequest = new GetTaskCopiesRequest([
            "appType" => "APP_PBKTxxx",
            "systemToken" => "hexxxx",
            "pageSize" => 10,
            "language" => "zh_CN",
...
func _main (args []*string) (_err error) {
  ...
  getTaskCopiesHeaders := &dingtalkyida_1_0.GetTaskCopiesHeaders{}
  getTaskCopiesHeaders.XAcsDingtalkAccessToken = tea.String("<your access token>")
  getTaskCopiesRequest := &dingtalkyida_1_0.GetTaskCopiesRequest{
  ...
  tryErr := func()(_e error) {
    ...
    _, _err = client.GetTaskCopiesWithOptions(getTaskCopiesRequest, getTaskCopiesHeaders, &util.RuntimeOptions{})
    if _err != nil {
      return _err
    }
...
export default class Client {
  ...
  static async main(args: string[]): Promise<void> {
    ...
    let getTaskCopiesHeaders = new $dingtalkyida_1_0.GetTaskCopiesHeaders({ });
    getTaskCopiesHeaders.xAcsDingtalkAccessToken = "<your access token>";
    let getTaskCopiesRequest = new $dingtalkyida_1_0.GetTaskCopiesRequest({
      appType: "APP_PBKTxxx",
      systemToken: "hexxxx",
      pageSize: 10,
      language: "zh_CN",
    ...
    try {
      await client.getTaskCopiesWithOptions(getTaskCopiesRequest, getTaskCopiesHeaders, new $Util.RuntimeOptions({ }));
    } catch (err) {
...
namespace AlibabaCloud.SDK.Sample
{
    public class Sample 
    {
        ...
        public static void Main(string[] args)
        {
            ...
            AlibabaCloud.SDK.Dingtalkyida_1_0.Models.GetTaskCopiesHeaders getTaskCopiesHeaders = new AlibabaCloud.SDK.Dingtalkyida_1_0.Models.GetTaskCopiesHeaders();
            getTaskCopiesHeaders.XAcsDingtalkAccessToken = "<your access token>";
            AlibabaCloud.SDK.Dingtalkyida_1_0.Models.GetTaskCopiesRequest getTaskCopiesRequest = new AlibabaCloud.SDK.Dingtalkyida_1_0.Models.GetTaskCopiesRequest
            {
                AppType = "APP_PBKTxxx",
                SystemToken = "hexxxx",
                PageSize = 10,
            ...
            try
            {
                client.GetTaskCopiesWithOptions(getTaskCopiesRequest, getTaskCopiesHeaders, new AlibabaCloud.TeaUtil.Models.RuntimeOptions());
            }
            catch (TeaException err)
            {
...
int main(int argc, char *args[]) {
  ...
  shared_ptr<Alibabacloud_Dingtalkyida_1_0::GetTaskCopiesHeaders> getTaskCopiesHeaders = make_shared<Alibabacloud_Dingtalkyida_1_0::GetTaskCopiesHeaders>();
  getTaskCopiesHeaders->xAcsDingtalkAccessToken = make_shared<string>("<your access token>");
  shared_ptr<Alibabacloud_Dingtalkyida_1_0::GetTaskCopiesRequest> getTaskCopiesRequest = make_shared<Alibabacloud_Dingtalkyida_1_0::GetTaskCopiesRequest>(map<string, boost::any>({
  ...
  try {
    client->getTaskCopiesWithOptions(getTaskCopiesRequest, getTaskCopiesHeaders, make_shared<Darabonba_Util::RuntimeOptions>(Darabonba_Util::RuntimeOptions()));
  }
...

{
  ...
  "totalCount" : 10,
  "data" : [ {
    "actionExecutorId" : [ "actxxx" ],
    "processInstanceId" : "f30233fb-72e1-xxx",
    "formUuid" : "FORM-EF6xxx",
    "serialNumber" : "ser-BNANFxxx",
    "processInstanceStatus" : "finished",
    "originatorDisplayName" : "张三",
    "modifiedTimeGMT" : "2020-01-01",
    "carbonActivityId" : "g02fbs08xxx",
    "dataType" : "edit",
    "actionExecutorName" : [ "小红" ],
    "originatorAvatar" : "guyagsd",
    "processInstanceStatusText" : "同意",
    "processApprovedResultText" : "同意",
    "formInstanceId" : "FINST-NJYJZxxx",
    "title" : "李四发起的请购单",
    "instanceValue" : "符合宜搭表单实例格式的json数据",
    "createTimeGMT" : "2021-01-01",
    "processApprovedResult" : "agree",
    "processName" : "符合宜搭表单实例测试",
    "processCode" : "TPROC--X1G***42ZMGA31OYELIWJ1",
