...
doc_id: "RGf2c17jLo"
updated_at: "2026-07-22 16:50:01"
---
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| openConversationIds | Array of String | 是 | 群会话openConversationId，可调用[创建钉钉客联普通互通群](1854-create-common-group-new-version.md) / [创建钉钉客联两人互通群](1855-creating-two-groups-of-people.md)接口获取，长度限制为1～32个字符，例如：14da\*\*\*\*2760。 |
...
| atAppUserId | String | 否 | 钉外账号在业务系统内的唯一标志，可调用[创建钉钉客联钉外账号](1853-create-bc-account-association.md)接口获取，长度限制为1～64个字符，例如：1107\*\*\*\*2120。 |
