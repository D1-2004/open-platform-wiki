...
doc_id: "d3frJHZcvO"
updated_at: "2026-05-19 20:36:09"
---

> Source: https://open.dingtalk.com/document/development/use-case-form
> Path: 应用开发 / 服务端API / 智能填表 > 使用教程 > 获取用户的填表数据详情
> Updated: 2026-05-19 20:36:09
...
1. 调用服务端API-[获取用户创建的填表模板列表](0961-new-obtains-the-template-that-a-user-creates.md)接口，获取智能填表模板`formCode`。
2. 根据智能填表模板`formCode`，调用服务端API-[获取填表实例列表](0962-obtain-the-table-filling-instance-list-data.md)接口，获取填表模板下的填表数据实例列表`list`。
3. 根据实例列表`list`下具体的实例。调用服务端API-[获取单条填表实例详情](0963-obtains-the-instance-details-of-a-single-fill-table.md)接口，获取填表数据详情。
