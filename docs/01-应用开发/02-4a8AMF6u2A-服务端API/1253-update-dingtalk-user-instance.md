---
title: "更新钉工牌电子码"
source_url: "https://open.dingtalk.com/document/development/update-dingtalk-user-instance"
namespace: "development"
slug: "update-dingtalk-user-instance"
group: "应用开发"
tab: "服务端API"
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| codeId | String | 是 | 用户码ID，可调用[创建钉工牌电子码](1252-create-a-badge-user-instance.md)接口获取codeId参数值。 |
| codeIdentity | String | 是 | 码标识，取值：   - **DT\_VISITOR**：访客码 - **DT\_CONFERENCE**：会展码 |
| codeValue | String | 否 | 码值，由调用方生成。     - 如果是固定码，则此参数必填。 - 如果是动态码，则此参数不填。 |
| status | String | 否 | 状态，传入关闭状态需要用户手动开启后才会渲染二维码。   - **OPEN**：开启 - **CLOSED**：关闭 - **INVALID**：失效 |
...
```
PUT /v1.0/badge/codes/userInstances HTTP/1.1
...
public class Sample {
    ...
    public static void main(String[] args_) throws Exception {
        ...
        updateBadgeCodeUserInstanceHeaders.xAcsDingtalkAccessToken = "<your access token>";
        ...
        try {
            client.updateBadgeCodeUserInstanceWithOptions(updateBadgeCodeUserInstanceRequest, updateBadgeCodeUserInstanceHeaders, new com.aliyun.teautil.models.RuntimeOptions());
...
class Sample:
    ...
    def main(
        ...
        update_badge_code_user_instance_headers = dingtalkbadge__1__0_models.UpdateBadgeCodeUserInstanceHeaders()
        update_badge_code_user_instance_headers.x_acs_dingtalk_access_token = '<your access token>'
        available_times_0 = dingtalkbadge__1__0_models.UpdateBadgeCodeUserInstanceRequestAvailableTimes(
            gmt_start='yyyy-MM-dd HH:mm:ss',
            gmt_end='yyyy-MM-dd HH:mm:ss'
        )
        update_badge_code_user_instance_request = dingtalkbadge__1__0_models.UpdateBadgeCodeUserInstanceRequest(
            code_id='ccodexxxxx',
            code_identity='TEST',
            code_value='dingbadgexxxx',
            status='OPEN',
            corp_id='corpIdxxxx',
        ...
        try:
            client.update_badge_code_user_instance_with_options(update_badge_code_user_instance_request, update_badge_code_user_instance_headers, util_models.RuntimeOptions())
    ...
    async def main_async(
        ...
        try:
            await client.update_badge_code_user_instance_with_options_async(update_badge_code_user_instance_request, update_badge_code_user_instance_headers, util_models.RuntimeOptions())
        except Exception as err:
            if not UtilClient.empty(err.code) and not UtilClient.empty(err.message):
                # err 中含有 code 和 message 属性，可帮助开发定位问题
                pass
...
class Sample {
    ...
    public static function main($args){
        ...
        $updateBadgeCodeUserInstanceHeaders = new UpdateBadgeCodeUserInstanceHeaders([]);
        $updateBadgeCodeUserInstanceHeaders->xAcsDingtalkAccessToken = "<your access token>";
        $availableTimes0 = new availableTimes([
            "gmtStart" => "yyyy-MM-dd HH:mm:ss",
            "gmtEnd" => "yyyy-MM-dd HH:mm:ss"
        ]);
        $updateBadgeCodeUserInstanceRequest = new UpdateBadgeCodeUserInstanceRequest([
            "codeId" => "ccodexxxxx",
            "codeIdentity" => "TEST",
            "codeValue" => "dingbadgexxxx",
            "status" => "OPEN",
        ...
        try {
            $client->updateBadgeCodeUserInstanceWithOptions($updateBadgeCodeUserInstanceRequest, $updateBadgeCodeUserInstanceHeaders, new RuntimeOptions([]));
        }
        catch (Exception $err) {
...
func _main (args []*string) (_err error) {
  ...
  updateBadgeCodeUserInstanceHeaders := &dingtalkbadge_1_0.UpdateBadgeCodeUserInstanceHeaders{}
  updateBadgeCodeUserInstanceHeaders.XAcsDingtalkAccessToken = tea.String("<your access token>")
  availableTimes0 := &dingtalkbadge_1_0.UpdateBadgeCodeUserInstanceRequestAvailableTimes{
    GmtStart: tea.String("yyyy-MM-dd HH:mm:ss"),
    GmtEnd: tea.String("yyyy-MM-dd HH:mm:ss"),
  }
  updateBadgeCodeUserInstanceRequest := &dingtalkbadge_1_0.UpdateBadgeCodeUserInstanceRequest{
    CodeId: tea.String("ccodexxxxx"),
    CodeIdentity: tea.String("TEST"),
    CodeValue: tea.String("dingbadgexxxx"),
    ...
    AvailableTimes: []*dingtalkbadge_1_0.UpdateBadgeCodeUserInstanceRequestAvailableTimes{availableTimes0},
  }
  tryErr := func()(_e error) {
    ...
    _, _err = client.UpdateBadgeCodeUserInstanceWithOptions(updateBadgeCodeUserInstanceRequest, updateBadgeCodeUserInstanceHeaders, &util.RuntimeOptions{})
    if _err != nil {
      return _err
    }
...
export default class Client {
  ...
  static async main(args: string[]): Promise<void> {
    ...
    let updateBadgeCodeUserInstanceHeaders = new $dingtalkbadge_1_0.UpdateBadgeCodeUserInstanceHeaders({ });
    updateBadgeCodeUserInstanceHeaders.xAcsDingtalkAccessToken = "<your access token>";
    let availableTimes0 = new $dingtalkbadge_1_0.UpdateBadgeCodeUserInstanceRequestAvailableTimes({
      gmtStart: "yyyy-MM-dd HH:mm:ss",
      gmtEnd: "yyyy-MM-dd HH:mm:ss",
    });
    let updateBadgeCodeUserInstanceRequest = new $dingtalkbadge_1_0.UpdateBadgeCodeUserInstanceRequest({
      codeId: "ccodexxxxx",
      codeIdentity: "TEST",
      codeValue: "dingbadgexxxx",
      status: "OPEN",
    ...
    try {
      await client.updateBadgeCodeUserInstanceWithOptions(updateBadgeCodeUserInstanceRequest, updateBadgeCodeUserInstanceHeaders, new $Util.RuntimeOptions({ }));
    } catch (err) {
...
namespace AlibabaCloud.SDK.Sample
{
    public class Sample 
    {
        ...
        public static void Main(string[] args)
        {
            ...
            AlibabaCloud.SDK.Dingtalkbadge_1_0.Models.UpdateBadgeCodeUserInstanceHeaders updateBadgeCodeUserInstanceHeaders = new AlibabaCloud.SDK.Dingtalkbadge_1_0.Models.UpdateBadgeCodeUserInstanceHeaders();
            updateBadgeCodeUserInstanceHeaders.XAcsDingtalkAccessToken = "<your access token>";
            AlibabaCloud.SDK.Dingtalkbadge_1_0.Models.UpdateBadgeCodeUserInstanceRequest.UpdateBadgeCodeUserInstanceRequestAvailableTimes availableTimes0 = new AlibabaCloud.SDK.Dingtalkbadge_1_0.Models.UpdateBadgeCodeUserInstanceRequest.UpdateBadgeCodeUserInstanceRequestAvailableTimes
            {
                GmtStart = "yyyy-MM-dd HH:mm:ss",
                GmtEnd = "yyyy-MM-dd HH:mm:ss",
            };
            AlibabaCloud.SDK.Dingtalkbadge_1_0.Models.UpdateBadgeCodeUserInstanceRequest updateBadgeCodeUserInstanceRequest = new AlibabaCloud.SDK.Dingtalkbadge_1_0.Models.UpdateBadgeCodeUserInstanceRequest
            {
                CodeId = "ccodexxxxx",
                CodeIdentity = "TEST",
                CodeValue = "dingbadgexxxx",
                ...
                UserIdentity = "86-xxxxxx",
                GmtExpired = "2021-09-09 12:12:12",
                AvailableTimes = new List<AlibabaCloud.SDK.Dingtalkbadge_1_0.Models.UpdateBadgeCodeUserInstanceRequest.UpdateBadgeCodeUserInstanceRequestAvailableTimes>
                {
                    availableTimes0
                },
            };
            try
            {
                client.UpdateBadgeCodeUserInstanceWithOptions(updateBadgeCodeUserInstanceRequest, updateBadgeCodeUserInstanceHeaders, new AlibabaCloud.TeaUtil.Models.RuntimeOptions());
            }
            catch (TeaException err)
            {
