...
doc_id: "S4AcuitnEF"
updated_at: "2025-12-31 15:32:56"
---

> Source: https://open.dingtalk.com/document/development/official-approval-adds-approval-comments
> Path: 应用开发 / 服务端API / OA 审批 > 官方 OA 审批 > 审批实例 > 添加审批评论
> Updated: 2025-12-31 15:32:56
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| processInstanceId | String | 是 | 审批实例ID：   - 调用[发起审批实例](0493-create-an-approval-instance.md)接口获取`InstanceId`参数值。 - 调用[获取单个审批实例详情](0497-obtain-an-approval-list-of-instance-ids.md)接口获取`list`参数值。 |
