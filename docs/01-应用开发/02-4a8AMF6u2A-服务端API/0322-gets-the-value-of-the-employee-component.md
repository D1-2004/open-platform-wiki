...
slug: "gets-the-value-of-the-employee-component"
group: "应用开发"
tab: "服务端API"
...
| 字段 | 值 |
| --- | --- |
| HTTP URL | https://api.dingtalk.com/v1.0/yida/forms/employeeFields |
| HTTP Method | POST |
...
```
POST /v1.0/yida/forms/employeeFields HTTP/1.1
Host:api.dingtalk.com
x-acs-dingtalk-access-token:BExxx
Content-Type:application/json

{
  "targetFieldJson" : "['textField_xahdfna']",
  ...
  "language" : "zh_CN",
  "searchFieldJson" : "{\"textField_annandfa\":\"1212\"}",
  "originatorId" : "112212221",
  "userId" : "manager123",
...
public class Sample {
    ...
    public static void main(String[] args_) throws Exception {
        ...
        SearchEmployeeFieldValuesHeaders searchEmployeeFieldValuesHeaders = new SearchEmployeeFieldValuesHeaders();
        searchEmployeeFieldValuesHeaders.xAcsDingtalkAccessToken = "<your access token>";
        SearchEmployeeFieldValuesRequest searchEmployeeFieldValuesRequest = new SearchEmployeeFieldValuesRequest()
                .setTargetFieldJson("['textField_xahdfna']")
                .setFormUuid("FORM-EF6Yxxx")
                .setAppType("APP_PBKxxx")
                .setModifiedToTimeGMT("2021-09-10")
                .setSystemToken("hexxxx")
                .setModifiedFromTimeGMT("2021-05-01")
                .setLanguage("zh_CN")
                .setSearchFieldJson("{\"textField_annandfa\":\"1212\"}")
                .setOriginatorId("112212221")
                .setUserId("manager123")
                .setCreateToTimeGMT("2021-05-01")
                .setCreateFromTimeGMT("2021-05-01");
        try {
            client.searchEmployeeFieldValuesWithOptions(searchEmployeeFieldValuesRequest, searchEmployeeFieldValuesHeaders, new RuntimeOptions());
...
class Sample:
    ...
    def main(
        ...
        search_employee_field_values_headers = dingtalkyida__1__0_models.SearchEmployeeFieldValuesHeaders()
        search_employee_field_values_headers.x_acs_dingtalk_access_token = '<your access token>'
        search_employee_field_values_request = dingtalkyida__1__0_models.SearchEmployeeFieldValuesRequest(
            target_field_json="['textField_xahdfna']",
            ...
            language='zh_CN',
            search_field_json='{"textField_annandfa":"1212"}',
            originator_id='112212221',
            user_id='manager123',
            create_to_time_gmt='2021-05-01',
            create_from_time_gmt='2021-05-01'
        )
        try:
            client.search_employee_field_values_with_options(search_employee_field_values_request, search_employee_field_values_headers, util_models.RuntimeOptions())
    ...
    async def main_async(
        ...
        try:
            await client.search_employee_field_values_with_options_async(search_employee_field_values_request, search_employee_field_values_headers, util_models.RuntimeOptions())
        except Exception as err:
            if not UtilClient.empty(err.code) and not UtilClient.empty(err.message):
                # err 中含有 code 和 message 属性，可帮助开发定位问题
                pass
...
class Sample {
    ...
    public static function main($args){
        ...
        $searchEmployeeFieldValuesHeaders = new SearchEmployeeFieldValuesHeaders([]);
        $searchEmployeeFieldValuesHeaders->xAcsDingtalkAccessToken = "<your access token>";
        $searchEmployeeFieldValuesRequest = new SearchEmployeeFieldValuesRequest([
            "targetFieldJson" => "['textField_xahdfna']",
            "formUuid" => "FORM-EF6Yxxx",
            "appType" => "APP_PBKxxx",
            "modifiedToTimeGMT" => "2021-09-10",
...
func _main (args []*string) (_err error) {
  ...
  searchEmployeeFieldValuesHeaders := &dingtalkyida_1_0.SearchEmployeeFieldValuesHeaders{}
  searchEmployeeFieldValuesHeaders.XAcsDingtalkAccessToken = tea.String("<your access token>")
  searchEmployeeFieldValuesRequest := &dingtalkyida_1_0.SearchEmployeeFieldValuesRequest{
    TargetFieldJson: tea.String("['textField_xahdfna']"),
    ...
    SearchFieldJson: tea.String("{\"textField_annandfa\":\"1212\"}"),
    OriginatorId: tea.String("112212221"),
  ...
  tryErr := func()(_e error) {
    ...
    _, _err = client.SearchEmployeeFieldValuesWithOptions(searchEmployeeFieldValuesRequest, searchEmployeeFieldValuesHeaders, &util.RuntimeOptions{})
    if _err != nil {
      return _err
    }
...
export default class Client {
  ...
  static async main(args: string[]): Promise<void> {
    ...
    let searchEmployeeFieldValuesHeaders = new $dingtalkyida_1_0.SearchEmployeeFieldValuesHeaders({ });
    searchEmployeeFieldValuesHeaders.xAcsDingtalkAccessToken = "<your access token>";
    let searchEmployeeFieldValuesRequest = new $dingtalkyida_1_0.SearchEmployeeFieldValuesRequest({
      targetFieldJson: "['textField_xahdfna']",
      formUuid: "FORM-EF6Yxxx",
      appType: "APP_PBKxxx",
      modifiedToTimeGMT: "2021-09-10",
    ...
    try {
      await client.searchEmployeeFieldValuesWithOptions(searchEmployeeFieldValuesRequest, searchEmployeeFieldValuesHeaders, new $Util.RuntimeOptions({ }));
    } catch (err) {
...
namespace AlibabaCloud.SDK.Sample
{
    public class Sample 
    {
        ...
        public static void Main(string[] args)
        {
            ...
            AlibabaCloud.SDK.Dingtalkyida_1_0.Models.SearchEmployeeFieldValuesHeaders searchEmployeeFieldValuesHeaders = new AlibabaCloud.SDK.Dingtalkyida_1_0.Models.SearchEmployeeFieldValuesHeaders();
            searchEmployeeFieldValuesHeaders.XAcsDingtalkAccessToken = "<your access token>";
            AlibabaCloud.SDK.Dingtalkyida_1_0.Models.SearchEmployeeFieldValuesRequest searchEmployeeFieldValuesRequest = new AlibabaCloud.SDK.Dingtalkyida_1_0.Models.SearchEmployeeFieldValuesRequest
            {
                TargetFieldJson = "['textField_xahdfna']",
                FormUuid = "FORM-EF6Yxxx",
                AppType = "APP_PBKxxx",
            ...
            try
            {
                client.SearchEmployeeFieldValuesWithOptions(searchEmployeeFieldValuesRequest, searchEmployeeFieldValuesHeaders, new AlibabaCloud.TeaUtil.Models.RuntimeOptions());
            }
            catch (TeaException err)
            {
...
int main(int argc, char *args[]) {
  ...
  shared_ptr<Alibabacloud_Dingtalkyida_1_0::SearchEmployeeFieldValuesHeaders> searchEmployeeFieldValuesHeaders = make_shared<Alibabacloud_Dingtalkyida_1_0::SearchEmployeeFieldValuesHeaders>();
  searchEmployeeFieldValuesHeaders->xAcsDingtalkAccessToken = make_shared<string>("<your access token>");
  shared_ptr<Alibabacloud_Dingtalkyida_1_0::SearchEmployeeFieldValuesRequest> searchEmployeeFieldValuesRequest = make_shared<Alibabacloud_Dingtalkyida_1_0::SearchEmployeeFieldValuesRequest>(map<string, boost::any>({
    {"targetFieldJson", boost::any(string("['textField_xahdfna']"))},
    {"formUuid", boost::any(string("FORM-EF6Yxxx"))},
    {"appType", boost::any(string("APP_PBKxxx"))},
    ...
    {"searchFieldJson", boost::any(string("{"textField_annandfa":"1212"}"))},
    {"originatorId", boost::any(string("112212221"))},
  ...
  try {
    client->searchEmployeeFieldValuesWithOptions(searchEmployeeFieldValuesRequest, searchEmployeeFieldValuesHeaders, make_shared<Darabonba_Util::RuntimeOptions>(Darabonba_Util::RuntimeOptions()));
  }
