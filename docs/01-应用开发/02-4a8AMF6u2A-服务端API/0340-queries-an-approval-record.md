...
slug: "queries-an-approval-record"
group: "应用开发"
tab: "服务端API"
breadcrumb: "宜搭 > 任务 > 获取审批记录"
doc_id: "6l32VVyHkF"
updated_at: "2026-04-24 14:14:19"
---

> Source: https://open.dingtalk.com/document/development/queries-an-approval-record
> Path: 应用开发 / 服务端API / 宜搭 > 任务 > 获取审批记录
> Updated: 2026-04-24 14:14:19
...
| 字段 | 值 |
| --- | --- |
| HTTP URL | https://api.dingtalk.com/v1.0/yida/processes/operationRecords |
| HTTP Method | GET |
...
| processInstanceId | String | 是 | 流程实例ID，可调用[获取多个表单实例ID](0325-api-searchformdataidlist-v2.md)接口获取。 |
| env | String | 否 | 调用的目标环境，国内填vpc，宜搭国际版填sgp\_vpc，不填时默认走国内vpc。 |
...
```
GET /v1.0/yida/processes/operationRecords?appType=APP_PBKT0xxx&systemToken=hexxxx&userId=user123&language=zh_CN&processInstanceId=f30233fb-72e1-4af4-8cb8-c7e0ea9ee530&env=vpc HTTP/1.1
...
public class Sample {
    ...
    public static void main(String[] args_) throws Exception {
        ...
        com.aliyun.dingtalkyida_1_0.models.GetOperationRecordsHeaders getOperationRecordsHeaders = new com.aliyun.dingtalkyida_1_0.models.GetOperationRecordsHeaders();
        getOperationRecordsHeaders.xAcsDingtalkAccessToken = "<your access token>";
        com.aliyun.dingtalkyida_1_0.models.GetOperationRecordsRequest getOperationRecordsRequest = new com.aliyun.dingtalkyida_1_0.models.GetOperationRecordsRequest()
                .setAppType("APP_PBKT0xxx")
                .setSystemToken("hexxxx")
                .setUserId("user123")
                .setLanguage("zh_CN")
                .setProcessInstanceId("f30233fb-72e1-4af4-8cb8-c7e0ea9ee530")
                .setEnv("vpc");
        try {
            client.getOperationRecordsWithOptions(getOperationRecordsRequest, getOperationRecordsHeaders, new com.aliyun.teautil.models.RuntimeOptions());
...
class Sample:
    ...
    def main(
        ...
        get_operation_records_headers = dingtalkyida__1__0_models.GetOperationRecordsHeaders()
        get_operation_records_headers.x_acs_dingtalk_access_token = '<your access token>'
        get_operation_records_request = dingtalkyida__1__0_models.GetOperationRecordsRequest(
            app_type='APP_PBKT0xxx',
            system_token='hexxxx',
            user_id='user123',
            language='zh_CN',
            process_instance_id='f30233fb-72e1-4af4-8cb8-c7e0ea9ee530',
            env='vpc'
        )
        try:
            client.get_operation_records_with_options(get_operation_records_request, get_operation_records_headers, util_models.RuntimeOptions())
    ...
    async def main_async(
        ...
        try:
            await client.get_operation_records_with_options_async(get_operation_records_request, get_operation_records_headers, util_models.RuntimeOptions())
        except Exception as err:
            if not UtilClient.empty(err.code) and not UtilClient.empty(err.message):
                # err 中含有 code 和 message 属性，可帮助开发定位问题
                pass
...
class Sample {
    ...
    public static function main($args){
        ...
        $getOperationRecordsHeaders = new GetOperationRecordsHeaders([]);
        $getOperationRecordsHeaders->xAcsDingtalkAccessToken = "<your access token>";
        $getOperationRecordsRequest = new GetOperationRecordsRequest([
        ...
        try {
            $client->getOperationRecordsWithOptions($getOperationRecordsRequest, $getOperationRecordsHeaders, new RuntimeOptions([]));
        }
        catch (Exception $err) {
...
func _main (args []*string) (_err error) {
  ...
  getOperationRecordsHeaders := &dingtalkyida_1_0.GetOperationRecordsHeaders{}
  getOperationRecordsHeaders.XAcsDingtalkAccessToken = tea.String("<your access token>")
  getOperationRecordsRequest := &dingtalkyida_1_0.GetOperationRecordsRequest{
    AppType: tea.String("APP_PBKT0xxx"),
    SystemToken: tea.String("hexxxx"),
    UserId: tea.String("user123"),
    Language: tea.String("zh_CN"),
    ProcessInstanceId: tea.String("f30233fb-72e1-4af4-8cb8-c7e0ea9ee530"),
    Env: tea.String("vpc"),
  }
  tryErr := func()(_e error) {
    ...
    _, _err = client.GetOperationRecordsWithOptions(getOperationRecordsRequest, getOperationRecordsHeaders, &util.RuntimeOptions{})
    if _err != nil {
      return _err
    }
...
class Client {
  ...
  static async main(args) {
    ...
    let getOperationRecordsHeaders = new dingtalkyida_1_0.GetOperationRecordsHeaders({ });
    getOperationRecordsHeaders.xAcsDingtalkAccessToken = '<your access token>';
    let getOperationRecordsRequest = new dingtalkyida_1_0.GetOperationRecordsRequest({
      appType: 'APP_PBKT0xxx',
      systemToken: 'hexxxx',
      userId: 'user123',
      language: 'zh_CN',
    ...
    try {
      await client.getOperationRecordsWithOptions(getOperationRecordsRequest, getOperationRecordsHeaders, new Util.RuntimeOptions({ }));
    } catch (err) {
...
namespace AlibabaCloud.SDK.Sample
{
    public class Sample 
    {
        ...
        public static void Main(string[] args)
        {
            ...
            AlibabaCloud.SDK.Dingtalkyida_1_0.Models.GetOperationRecordsHeaders getOperationRecordsHeaders = new AlibabaCloud.SDK.Dingtalkyida_1_0.Models.GetOperationRecordsHeaders();
            getOperationRecordsHeaders.XAcsDingtalkAccessToken = "<your access token>";
            AlibabaCloud.SDK.Dingtalkyida_1_0.Models.GetOperationRecordsRequest getOperationRecordsRequest = new AlibabaCloud.SDK.Dingtalkyida_1_0.Models.GetOperationRecordsRequest
            {
                AppType = "APP_PBKT0xxx",
                SystemToken = "hexxxx",
                UserId = "user123",
            ...
            try
            {
                client.GetOperationRecordsWithOptions(getOperationRecordsRequest, getOperationRecordsHeaders, new AlibabaCloud.TeaUtil.Models.RuntimeOptions());
            }
            catch (TeaException err)
            {
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| result | Array | 流程实例操作记录列表。 |
| processInstanceId | String | 流程实例ID。 |
| showName | String | 显示名称。 |
| operatorNickName | String | 操作者花名。 |
...
| operatorUserId | String | 操作者userid。 |
| activityId | String | 节点ID。 |
| taskType | String | 任务类型。   - 一个一个分发 COMMON\_ONE\_BY\_ONE, - 一次性分发COMMON\_ALL\_AT\_ONCE, - 中间插入的任务类型（一个一个分发）MIDDLE\_IN\_ONE\_BY\_ONE, - 中间插入的任务类型（一次性分发）MIDDLE\_IN\_ALL\_AT\_ONCE   备注: 只有运行的待办任务才会都有值 |
| taskExecuteType | String | 任务执行类型。   - NORMAL: 正常的执行 - FILTERED: 过滤的执行 - AUTO: 自动审批的执行   备注: 只有运行的待办任务才会有值 |
| size | Integer | 大小。 |
| operatorDisplayName | String | 操作者展示名称。 |
| files | String | 文件。 |
| action | String | 动作名称，取值：   - **已同意** - **处理中** - **已拒绝** - **已转交** - **已退回** - **已撤销** - **提交申请** - **加签任务** - **前加签任务** - **后加签任务** - **节点流转** - **等待审批** - **已完成** - **已收回** |
| actionExit | String | 动作类型，取值：   - **agree** ：已同意 - **doing** ：处理中 - **disagree** ：已拒绝 - **forward** ：已转交 - **restart** ：已退回 - **revoked** ：已撤销 - **submit** ：提交申请 - **append** ：加签任务 - **beforeAppend** ：前加签任务 - **afterAppend** ：后加签任务 - **redirect** ：节点流转 - **next** ：等待审批 - **carbon** ：已完成 - **recall** ：已收回 |
| dataId | Long | 数据ID。 |
| taskId | String | 任务ID。 |
...
| type | String | 类型。 |
| operatorName | String | 操作者名称。 |
| operator | String | 操作者的钉钉userId。 |
| formatAction | String | 格式化的action。 |
| activityId | String | 节点id。 |
| taskType | String | 任务类型。 |
| taskExecuteType | String | 任务执行类型。 |
| size | Integer | 大小。 |
| operatorDisplayName | String | 操作者展示名称。 |
| files | String | 文件。 |
| operatorAgentIdList | Array | 操作者代理人的userId列表。 |
...
| displayNameInEnglish | String | 英文名称。 |
| status | String | 状态。 |
| action | String | 动作。 |
| activeTimeGMT | String | 激活时间。 |
| taskId | String | 任务id。 |
...

{
  "result" : [ {
    ...
    "taskType" : "COMMON_ONE_BY_ONE,COMMON_ALL_AT_ONCE,MIDDLE_IN_ONE_BY_ON,MIDDLE_IN_ALL_AT_ONCE",
    "taskExecuteType" : "NORMAL,FILTERED,AUTO",
    "size" : 12,
    ...
    "dataId" : 12345,
    "taskId" : "task-123",
    "digitalSign" : "https://example.com/Signature.pdf",
    "operatorPhotoUrl" : "https://example.com/a.jpeg",
    "domainList" : [ {
      "processInstanceId" : "asdzc3124",
      "operateTimeGMT" : "2021-01-01",
      "showName" : "请购类型",
      "digitalSignature" : "https://example.com/Signature.pdf",
      "operateType" : "remove",
      "operatorNickName" : "无冬",
      "operatorStatus" : "良好",
      "remark" : "评论",
      ...
      "files" : "https://oss.com/a.pdf",
      "operatorAgentIdList" : [ {
        "orderNumber" : "o-YDJKINSSDLLND",
        "displayName" : "测试应用",
        "userInformation" : "张三",
        "departmentDescription" : "开发部成立于2000年",
        "userId" : "ding173982232112232",
        "personalPhoto" : "https://example.com/a.png",
        "displayNameInEnglish" : "ZhangSan",
        "status" : "running"
      } ],
      "action" : "return",
      "activeTimeGMT" : "2021-02-01",
