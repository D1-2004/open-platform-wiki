...
doc_id: "kK63kCLgqH"
updated_at: "2026-06-25 10:14:41"
---
...
| **API** | **API说明** | **API版本** |
| --- | --- | --- |
| [获取客户信息](1283-api-getcustomerinfo.md) | 通过本接口，获取AI销售管理中的单条客户数据。 | 新版 |
| [获取团队信息](1284-api-listteam.md) | 调用本接口，获取AI销售管理中的团队列表信息。 | 新版 |
| [创建ASR离线转写任务](1285-api-createasrtranscription.md) | 调用本接口创建音频离线转写任务。 | 新版 |
| [查询ASR转写结果](1286-api-getasrtranscription.md) | 调用本接口查询[创建ASR离线转写任务]的转写结果。 | 新版 |
| [查询单条服务记录](1287-api-getservicerecord.md) | 通过本接口，使用服务记录ID获取AI销售管理中的指定服务记录。 | 新版 |
| [获取服务待办信息](1288-api-listservicetodo.md) | 调用本接口，通过服务记录ID，获取AI销售管理中的服务记录待列表。 | 新版 |
| [获取服务会话总结](1289-api-getservicechatsummary.md) | 调用本接口，通过服务记录ID，获取AI销售管理中的服务会话总结。 | 新版 |
| [获取服务表现数据](1290-api-getservicequalityinspection.md) | 通过本接口，根据服务记录ID，获取AI销售管理中的服务表现数据。 | 新版 |
| [分页查询客户列表](1291-api-listcustomer.md) | 通过本接口，分页获取AI销售管理中的客户数据。 | 新版 |
| [更新设备绑定关系](1292-api-updatedevicebinding.md) | 通过本接口，更新AI销售管理中硬件设备与使用人之间的绑定关系。 | 新版 |
| [获取服务对话章节摘要](1293-api-getservicechaptersummary.md) | 通过本接口，获取AI销售管理中的服务记录对话章节摘要。 | 新版 |
| [获取AI销售管理客户洞察信息](1294-api-getcustomerinsight.md) | 通过本接口，获取AI销售管理中的客户洞察信息。 | 新版 |
| [分页获取企业下的服务记录信息](1295-api-listservicerecord.md) | 调用本接口，分页获取企业下的服务记录信息。 | 新版 |
