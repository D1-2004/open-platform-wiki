---
title: "获取流程定义"
source_url: "https://open.dingtalk.com/document/development/obtain-process-definition"
namespace: "development"
slug: "obtain-process-definition"
group: "应用开发"
tab: "服务端API"
breadcrumb: "历史文档（不推荐） > 宜搭 > 流程 > 获取流程定义"
doc_id: "ydtmbBMUES"
updated_at: "2025-09-08 19:03:37"
---

> Source: https://open.dingtalk.com/document/development/obtain-process-definition
> Path: 应用开发 / 服务端API / 历史文档（不推荐） > 宜搭 > 流程 > 获取流程定义
> Updated: 2025-09-08 19:03:37
...
>
> - 宜搭接口相关文档，已于**2022年7月8日**迁移至**历史文档（不推荐）**目录。
...
```
GET /v1.0/yida/processes/definitions/{processInstanceId}?corpId=String&groupId=String&appType=String&orderNumber=String&systemType=String&systemToken=String&nameSpace=String&language=String&userId=String HTTP/1.1
...
| masterDataDepartments | Array | 主数据部门。 |
| humanSourceGroupOrderNumber | String | HRG单号。 |
| deptPath | String | 部门路径。 |
| deptName | String | 部门名称。 |
| deptNameInEnglish | String | 英文部门名称。 |
| humanSourceGroupWorkNo | String | HRG的userid。 |
| id | Long | 数据ID。 |
| masterWorkNo | String | 主工号。 |
| deptNo | String | 部门编号。 |
| displayEnName | String | 英文名称。 |
| userId | String | 用户userid。 |
| personalPhoto | String | 个人照片。 |
| status | String | 状态。 |
| originator | Object | 创建者。 |
| userInfo | String | 用户信息。 |
| tbWang | String | 淘宝旺。 |
| orderNumber | String | 订单号。 |
| departmentDescription | String | 部门描述。 |
...
| deptNo | String | 部门编号。 |
| displayEnName | String | 英文名称。 |
| userId | String | 评论人钉钉的userId; |
| personalPhoto | String | 个人照片。 |
| status | String | 状态。 |
| title | String | 标题。 |
| tasks | Array | 任务列表。 |
| actionerId | String | 执行人。 |
| activity | Object | 流程信息。 |
...
```
GET /v1.0/yida/processes/definitions/j8hbas?corpId=ding123&groupId=c-xxafafaf&appType=APP_PBKTxxx&orderNumber=o-YDJKIxxx&systemType=hexabc1234&systemToken=hexxxx&nameSpace=dingtalk&language=zh_CN&userId=manager123 HTTP/1.1
Host:api.dingtalk.com
