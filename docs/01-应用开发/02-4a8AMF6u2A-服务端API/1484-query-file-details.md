...
当前接口已完成升级迭代且不再支持新应用申请，存量应用调用不受影响，建议未接入的开发者使用[获取文件详情](1074-gets-the-file-details.md)接口，已接入的开发者结合实际尽快完成迁移。
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| fileId | String | 否 | 调用[获取文件上传地址](1075-obtain-the-upload-url-of-a-file-1.md)返回的fileId。 |
