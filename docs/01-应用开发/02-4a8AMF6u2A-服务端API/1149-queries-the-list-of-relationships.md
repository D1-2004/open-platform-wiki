...
> Path: 应用开发 / 服务端API / 行业与生态 > 行业开放 > 新教育 > 家校通讯录2.0 > 获取班级内学生的关系列表
...
| class\_id | Number | 是 | 4240006 | 班级ID，可调用[获取部门列表](1146-obtains-the-department-node-list.md)接口获取dept\_type为class时的dept\_id参数值。 |
