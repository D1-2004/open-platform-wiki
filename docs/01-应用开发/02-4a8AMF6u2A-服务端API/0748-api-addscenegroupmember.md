...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| open\_conversation\_id | String | 是 | 群会话Id，可通过[创建场景群](0744-create-a-scene-group.md)接口获取。 |
