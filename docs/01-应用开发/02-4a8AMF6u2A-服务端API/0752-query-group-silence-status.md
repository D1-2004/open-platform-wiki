...
- 基于群模板创建的群，详情参见[创建群](1461-create-a-scene-group-v2.md)。
...
| openConversationId | String | 是 | 群ID，通过[创建群](1461-create-a-scene-group-v2.md)接口获取`open_conversation_id`字段值。 |
