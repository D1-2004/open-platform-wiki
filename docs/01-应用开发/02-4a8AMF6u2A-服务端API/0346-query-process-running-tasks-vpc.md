...
slug: "query-process-running-tasks-vpc"
group: "应用开发"
tab: "服务端API"
breadcrumb: "宜搭 > 任务 > 查询流程运行任务（VPC）"
doc_id: "VQAWR0zuGt"
updated_at: "2025-10-09 18:05:51"
---

> Source: https://open.dingtalk.com/document/development/query-process-running-tasks-vpc
> Path: 应用开发 / 服务端API / 宜搭 > 任务 > 查询流程运行任务（VPC）
...
| 字段 | 值 |
| --- | --- |
| HTTP URL | https://api.dingtalk.com/v1.0/yida/processes/tasks/getRunningTasks |
| HTTP Method | GET |
...
| systemToken | String | 否 | 应用秘钥，在应用数据中获取。 |
...
```
GET /v1.0/yida/processes/tasks/getRunningTasks?processInstanceId=f30233fb-72e1-4xx&appType=APP_PBKTxxx&systemToken=hexxxx&language=zh_CN&userId=manager123 HTTP/1.1
...
public class Sample {
    ...
    public static void main(String[] args_) throws Exception {
        ...
        getRunningTasksHeaders.xAcsDingtalkAccessToken = "<your access token>";
        GetRunningTasksRequest getRunningTasksRequest = new GetRunningTasksRequest()
                .setProcessInstanceId("f30233fb-72e1-4xx")
                .setAppType("APP_PBKTxxx")
                .setSystemToken("hexxxx")
                .setLanguage("zh_CN")
                .setUserId("manager123");
        try {
            client.getRunningTasksWithOptions(getRunningTasksRequest, getRunningTasksHeaders, new RuntimeOptions());
...
class Sample:
    ...
    def main(
        ...
        get_running_tasks_headers = dingtalkyida__1__0_models.GetRunningTasksHeaders()
        get_running_tasks_headers.x_acs_dingtalk_access_token = '<your access token>'
        get_running_tasks_request = dingtalkyida__1__0_models.GetRunningTasksRequest(
            process_instance_id='f30233fb-72e1-4xx',
        ...
        try:
            client.get_running_tasks_with_options(get_running_tasks_request, get_running_tasks_headers, util_models.RuntimeOptions())
    ...
    async def main_async(
        ...
        try:
            await client.get_running_tasks_with_options_async(get_running_tasks_request, get_running_tasks_headers, util_models.RuntimeOptions())
        except Exception as err:
            if not UtilClient.empty(err.code) and not UtilClient.empty(err.message):
                # err 中含有 code 和 message 属性，可帮助开发定位问题
                pass
...
class Sample {
    ...
    public static function main($args){
        ...
        $getRunningTasksHeaders = new GetRunningTasksHeaders([]);
        $getRunningTasksHeaders->xAcsDingtalkAccessToken = "<your access token>";
        $getRunningTasksRequest = new GetRunningTasksRequest([
            "processInstanceId" => "f30233fb-72e1-4xx",
            "appType" => "APP_PBKTxxx",
            "systemToken" => "hexxxx",
            "language" => "zh_CN",
            "userId" => "manager123"
...
func _main (args []*string) (_err error) {
  ...
  getRunningTasksHeaders := &dingtalkyida_1_0.GetRunningTasksHeaders{}
  getRunningTasksHeaders.XAcsDingtalkAccessToken = tea.String("<your access token>")
  getRunningTasksRequest := &dingtalkyida_1_0.GetRunningTasksRequest{
    ProcessInstanceId: tea.String("f30233fb-72e1-4xx"),
  ...
  tryErr := func()(_e error) {
    ...
    _, _err = client.GetRunningTasksWithOptions(getRunningTasksRequest, getRunningTasksHeaders, &util.RuntimeOptions{})
    if _err != nil {
      return _err
    }
...
export default class Client {
  ...
  static async main(args: string[]): Promise<void> {
    ...
    let getRunningTasksHeaders = new $dingtalkyida_1_0.GetRunningTasksHeaders({ });
    getRunningTasksHeaders.xAcsDingtalkAccessToken = "<your access token>";
    let getRunningTasksRequest = new $dingtalkyida_1_0.GetRunningTasksRequest({
      processInstanceId: "f30233fb-72e1-4xx",
      appType: "APP_PBKTxxx",
      systemToken: "hexxxx",
      language: "zh_CN",
    ...
    try {
      await client.getRunningTasksWithOptions(getRunningTasksRequest, getRunningTasksHeaders, new $Util.RuntimeOptions({ }));
    } catch (err) {
...
namespace AlibabaCloud.SDK.Sample
{
    public class Sample 
    {
        ...
        public static void Main(string[] args)
        {
            ...
            AlibabaCloud.SDK.Dingtalkyida_1_0.Models.GetRunningTasksHeaders getRunningTasksHeaders = new AlibabaCloud.SDK.Dingtalkyida_1_0.Models.GetRunningTasksHeaders();
            getRunningTasksHeaders.XAcsDingtalkAccessToken = "<your access token>";
            AlibabaCloud.SDK.Dingtalkyida_1_0.Models.GetRunningTasksRequest getRunningTasksRequest = new AlibabaCloud.SDK.Dingtalkyida_1_0.Models.GetRunningTasksRequest
            {
                ProcessInstanceId = "f30233fb-72e1-4xx",
                AppType = "APP_PBKTxxx",
                SystemToken = "hexxxx",
            ...
            try
            {
                client.GetRunningTasksWithOptions(getRunningTasksRequest, getRunningTasksHeaders, new AlibabaCloud.TeaUtil.Models.RuntimeOptions());
            }
            catch (TeaException err)
            {
...
int main(int argc, char *args[]) {
  ...
  shared_ptr<Alibabacloud_Dingtalkyida_1_0::GetRunningTasksHeaders> getRunningTasksHeaders = make_shared<Alibabacloud_Dingtalkyida_1_0::GetRunningTasksHeaders>();
  getRunningTasksHeaders->xAcsDingtalkAccessToken = make_shared<string>("<your access token>");
  shared_ptr<Alibabacloud_Dingtalkyida_1_0::GetRunningTasksRequest> getRunningTasksRequest = make_shared<Alibabacloud_Dingtalkyida_1_0::GetRunningTasksRequest>(map<string, boost::any>({
    {"processInstanceId", boost::any(string("f30233fb-72e1-4xx"))},
  ...
  try {
    client->getRunningTasksWithOptions(getRunningTasksRequest, getRunningTasksHeaders, make_shared<Darabonba_Util::RuntimeOptions>(Darabonba_Util::RuntimeOptions()));
  }
...
| originatorId | String | 流程发起人的userid。 |
