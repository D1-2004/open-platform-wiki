...
doc_id: "ZwVpp3KM4g"
updated_at: "2025-09-08 19:07:11"
---
...
例如，员工小钉在测试空间内拥有EDITOR编辑权限。调用本接口，可删除小钉在本空间内的编辑权限。

> **[!NOTE]**
>
> 如果小钉需要再次操作测试空间的文件或者文件夹，需要重新添加权限。
...
| --- | --- | --- | --- |
| 企业内部应用 | 支持 | 企业存储授权信息写权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=org&api=storage_1.0%23DeletePermission) |
| 第三方企业应用 | 支持 | 企业存储授权信息写权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=isv&api=storage_1.0%23DeletePermission) |
...
| dentryId | String | 是 | 文件Id。   - 企业内部应用，调用[获取文件或文件夹列表](https://open.dingtalk.com/document/orgapp/obtain-the-file-list-storage)接口获取id参数值。 - 第三方企业应用，调用[获取文件或文件夹列表](https://open.dingtalk.com/document/isvapp/obtain-the-file-list-storage)接口获取id参数值。 |
