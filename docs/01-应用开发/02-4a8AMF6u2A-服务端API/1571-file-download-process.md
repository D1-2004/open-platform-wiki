...
>
> - 如果未使用本流程内的接口，推荐使用存储产品[获取文件下载信息](https://open.dingtalk.com/document/orgapp/obtains-the-download-information-about-a-file)接口内的步骤下载文件。
> - 如果已使用本流程内的接口，建议您根据自身实际情况切换至推荐接口。

## 操作步骤

1. 调用[获取文件下载信息](https://open.dingtalk.com/document/orgapp/obtain-download-file-info)接口，获取文件下载所需的加签URL信息。
...
2. 根据获取到的加签URL信息，下载文件。
   ...
   > **[!NOTE]**
   >
   > 必须使用[获取文件下载信息](https://open.dingtalk.com/document/orgapp/obtain-download-file-info)接口返回的加签URL信息和Header信息才能下载。
