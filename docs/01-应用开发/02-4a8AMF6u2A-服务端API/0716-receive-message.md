---
title: "接收消息"
source_url: "https://open.dingtalk.com/document/development/receive-message"
namespace: "development"
slug: "receive-message"
group: "应用开发"
tab: "服务端API"
breadcrumb: "即时通信 > 机器人 > 消息接收 > 接收消息"
doc_id: "ZY0TpsrESc"
updated_at: "2025-12-29 11:43:05"
---

> Source: https://open.dingtalk.com/document/development/receive-message
> Path: 应用开发 / 服务端API / 即时通信 > 机器人 > 消息接收 > 接收消息
> Updated: 2025-12-29 11:43:05
...
| senderId | 是 | String | 加密的发送者ID。  **[!NOTE]**  使用senderStaffId，作为发送者userid值。 |
...
| isAdmin | 否 | boolean | 是否为管理员。  **[!NOTE]**  机器人发布上线后生效。 |
| chatbotCorpId | 否 | String | 加密的机器人所在的企业corpId。 |
| isInAtList | 否 | boolean | 是否在@列表中。 |
| senderStaffId | 否 | String | 企业内部群中@该机器人的成员userid。  **[!NOTE]**  该字段在机器人发布线上版本后，才会返回。 |
...
| downloadCode | String | 语音文件的下载码，用于换取下载语音的二进制文件，调用服务端API-[下载机器人接收消息的文件内容](0717-download-the-file-content-of-the-robot-receiving-message.md)接口，获取临时下载链接。 |
...
| downloadCode | String | 图片文件的下载码，用于换取下载图片的二进制文件，调用服务端API-[下载机器人接收消息的文件内容](0717-download-the-file-content-of-the-robot-receiving-message.md)接口，获取临时下载链接。 |
...
| downloadCode | String | 视频文件的下载码，用于换取下载视频的二进制文件，调用服务端API-[下载机器人接收消息的文件内容](0717-download-the-file-content-of-the-robot-receiving-message.md)接口，获取临时下载链接。 |
...
| downloadCode | String | 文件的下载码，用于换取下载文件的二进制文件，调用服务端API-[下载机器人接收消息的文件内容](0717-download-the-file-content-of-the-robot-receiving-message.md)接口，获取临时下载链接。 |
| fileName | String | 文件名。 |
...
| richText | Array | 是 | 富文本列表。  **[!NOTE]**  消息列表中可以包含：   - **text：**文本消息 - **picture**：图片消息 |

## HTTP响应格式

开发者可以根据自己的业务需要，选择回复一段消息，目前支持text、markdown、整体跳转actionCard类型、独立跳转actionCard类型、feedCard这5种[消息类型](0697-robot-message-type.md)。
