...
> Path: 应用开发 / 服务端API / 专属钉钉 > 互动服务窗 > 文章管理 > 获取文章详情
...
| 名称 | 类型 | 是否必填 | 示例值 | 描述 |
| --- | --- | --- | --- | --- |
| unionid | String | 是 | ftO2dFpz1zAiE | 服务号的unionid，可通过[查询服务号列表](0807-query-service-number-list.md)接口获取。 |
| article\_id | Number | 是 | 114001 | 文章id，可以通过[查询文章列表](0812-query-the-article-list.md)接口获取。 |
