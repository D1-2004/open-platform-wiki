...
slug: "delete-the-process-instance"
group: "应用开发"
tab: "服务端API"
breadcrumb: "宜搭 > 流程 > 删除流程实例"
doc_id: "qbBL5smIQw"
updated_at: "2026-04-24 14:14:21"
---

> Source: https://open.dingtalk.com/document/development/delete-the-process-instance
> Path: 应用开发 / 服务端API / 宜搭 > 流程 > 删除流程实例
> Updated: 2026-04-24 14:14:21
...
| 字段 | 值 |
| --- | --- |
| HTTP URL | https://api.dingtalk.com/v1.0/yida/processes/instances |
| HTTP Method | DELETE |
...
```
DELETE /v1.0/yida/processes/instances?appType=APP_PBKTxxx&systemToken=hexxxx&userId=user123&language=zh_CN&processInstanceId=f30233fb-72xxx HTTP/1.1
