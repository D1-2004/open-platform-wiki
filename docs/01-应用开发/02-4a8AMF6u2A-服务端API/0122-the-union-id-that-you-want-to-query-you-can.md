---
title: "根据原unionId查询迁移后的unionId"
source_url: "https://open.dingtalk.com/document/development/the-union-id-that-you-want-to-query-you-can"
namespace: "development"
slug: "the-union-id-that-you-want-to-query-you-can"
group: "应用开发"
tab: "服务端API"
breadcrumb: "通讯录管理 > 企业账号 > 根据原unionId查询迁移后的unionId"
doc_id: "MkLLhCJE13"
updated_at: "2025-09-11 21:01:45"
---

> Source: https://open.dingtalk.com/document/development/the-union-id-that-you-want-to-query-you-can
> Path: 应用开发 / 服务端API / 通讯录管理 > 企业账号 > 根据原unionId查询迁移后的unionId
> Updated: 2025-09-11 21:01:45
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| unionId | String | 是 | 原普通账号的unionId，可调用[通过免登码获取用户信息](0024-obtain-the-userid-of-a-user-by-using-the-log-free.md)获取unionid参数值。 |
