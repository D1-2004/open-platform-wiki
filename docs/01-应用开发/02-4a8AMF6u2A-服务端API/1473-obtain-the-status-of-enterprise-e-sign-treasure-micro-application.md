...
slug: "obtain-the-status-of-enterprise-e-sign-treasure-micro-application"
group: "应用开发"
tab: "服务端API"
...
调用本接口获取企业的e签宝微应用的状态。企业开启电子签章时，第一步首先需要确保企业已安装e签宝微应用，需要通过该接口查询是否安装，已安装则直接获取授权地址进授权页，未安装则进行展示渠道码进行安装引导。

## **接口调用说明**

当前接口不再支持新应用申请，存量应用调用不受影响。
...
| 字段 | 值 |
| --- | --- |
| HTTP URL | https://api.dingtalk.com/v1.0/esign/corps/statuses |
| HTTP Method | GET |
...
public class Sample {
    ...
    public static void main(String[] args_) throws Exception {
        ...
        GetCropStatusHeaders getCropStatusHeaders = new GetCropStatusHeaders();
        getCropStatusHeaders.xAcsDingtalkAccessToken = "<your access token>";
        try {
            client.getCropStatusWithOptions(getCropStatusHeaders, new RuntimeOptions());
...
class Sample:
    ...
    def main(
        ...
        get_crop_status_headers = dingtalkesign__1__0_models.GetCropStatusHeaders()
        get_crop_status_headers.x_acs_dingtalk_access_token = '<your access token>'
        try:
            client.get_crop_status_with_options(get_crop_status_headers, util_models.RuntimeOptions())
    ...
    async def main_async(
        ...
        get_crop_status_headers.x_acs_dingtalk_access_token = '<your access token>'
        try:
            await client.get_crop_status_with_options_async(get_crop_status_headers, util_models.RuntimeOptions())
        except Exception as err:
            if not UtilClient.empty(err.code) and not UtilClient.empty(err.message):
                # err 中含有 code 和 message 属性，可帮助开发定位问题
                pass
...
class Sample {
    ...
    public static function main($args){
        ...
        $getCropStatusHeaders = new GetCropStatusHeaders([]);
        $getCropStatusHeaders->xAcsDingtalkAccessToken = "<your access token>";
        try {
            $client->getCropStatusWithOptions($getCropStatusHeaders, new RuntimeOptions([]));
        }
...
func _main (args []*string) (_err error) {
  ...
  getCropStatusHeaders := &dingtalkesign_1_0.GetCropStatusHeaders{}
  getCropStatusHeaders.XAcsDingtalkAccessToken = tea.String("<your access token>")
  tryErr := func()(_e error) {
    ...
    _, _err = client.GetCropStatusWithOptions(getCropStatusHeaders, &util.RuntimeOptions{})
    if _err != nil {
      return _err
    }
...
export default class Client {
  ...
  static async main(args: string[]): Promise<void> {
    ...
    let getCropStatusHeaders = new $dingtalkesign_1_0.GetCropStatusHeaders({ });
    getCropStatusHeaders.xAcsDingtalkAccessToken = "<your access token>";
    try {
      await client.getCropStatusWithOptions(getCropStatusHeaders, new $Util.RuntimeOptions({ }));
    } catch (err) {
...
namespace AlibabaCloud.SDK.Sample
{
    public class Sample 
    {
        ...
        public static void Main(string[] args)
        {
            ...
            AlibabaCloud.SDK.Dingtalkesign_1_0.Models.GetCropStatusHeaders getCropStatusHeaders = new AlibabaCloud.SDK.Dingtalkesign_1_0.Models.GetCropStatusHeaders();
            getCropStatusHeaders.XAcsDingtalkAccessToken = "<your access token>";
            try
            {
                client.GetCropStatusWithOptions(getCropStatusHeaders, new AlibabaCloud.TeaUtil.Models.RuntimeOptions());
            }
            catch (TeaException err)
            {
...
int main(int argc, char *args[]) {
  ...
  shared_ptr<Alibabacloud_Dingtalkesign_1_0::GetCropStatusHeaders> getCropStatusHeaders = make_shared<Alibabacloud_Dingtalkesign_1_0::GetCropStatusHeaders>();
  getCropStatusHeaders->xAcsDingtalkAccessToken = make_shared<string>("<your access token>");
  try {
    client->getCropStatusWithOptions(getCropStatusHeaders, make_shared<Darabonba_Util::RuntimeOptions>(Darabonba_Util::RuntimeOptions()));
  }
