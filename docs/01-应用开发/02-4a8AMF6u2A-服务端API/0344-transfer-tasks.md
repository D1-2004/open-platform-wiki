...
| 字段 | 值 |
| --- | --- |
| HTTP URL | https://api.dingtalk.com/v1.0/yida/tasks/redirect |
| HTTP Method | POST |
...
| byManager | String | 否 | 是否应用管理员进行转交，取值：   - **y**：**userId**必须传应用管理员的userid或者yida\_pub\_account - **n**：**userId**必须传任务的当前执行人 |
...
| nowActionExecutorId | String | 是 | 新的任务处理人工号。 |
| userId | String | 是 | 处理人的userid。 |
| taskId | Long | 是 | 任务ID。 |
...
```
POST /v1.0/yida/tasks/redirect HTTP/1.1
...

{
  ...
  "language" : "zh_CN",
  "remark" : "确认同意",
  "nowActionExecutorId" : "manager123",
  "userId" : "manager123"
}
```
...
public class Sample {
    ...
    public static void main(String[] args_) throws Exception {
        ...
        RedirectTaskHeaders redirectTaskHeaders = new RedirectTaskHeaders();
        redirectTaskHeaders.xAcsDingtalkAccessToken = "<your access token>";
        RedirectTaskRequest redirectTaskRequest = new RedirectTaskRequest()
                .setProcessInstanceId("f30233fb-72e1-4xxx")
                .setByManager("y")
                .setAppType("APP_PBKxxx")
                .setSystemToken("hexxxx")
                .setLanguage("zh_CN")
                .setRemark("确认同意")
                .setNowActionExecutorId("manager123")
                .setUserId("manager123");
        try {
            client.redirectTaskWithOptions(redirectTaskRequest, redirectTaskHeaders, new RuntimeOptions());
...
class Sample:
    ...
    def main(
        ...
        redirect_task_headers = dingtalkyida__1__0_models.RedirectTaskHeaders()
        redirect_task_headers.x_acs_dingtalk_access_token = '<your access token>'
        redirect_task_request = dingtalkyida__1__0_models.RedirectTaskRequest(
            process_instance_id='f30233fb-72e1-4xxx',
            by_manager='y',
            app_type='APP_PBKxxx',
            system_token='hexxxx',
            language='zh_CN',
            remark='确认同意',
            now_action_executor_id='manager123',
            user_id='manager123'
        )
        try:
            client.redirect_task_with_options(redirect_task_request, redirect_task_headers, util_models.RuntimeOptions())
    ...
    async def main_async(
        ...
        try:
            await client.redirect_task_with_options_async(redirect_task_request, redirect_task_headers, util_models.RuntimeOptions())
        except Exception as err:
            if not UtilClient.empty(err.code) and not UtilClient.empty(err.message):
                # err 中含有 code 和 message 属性，可帮助开发定位问题
                pass
...
class Sample {
    ...
    public static function main($args){
        ...
        $redirectTaskHeaders = new RedirectTaskHeaders([]);
        $redirectTaskHeaders->xAcsDingtalkAccessToken = "<your access token>";
        $redirectTaskRequest = new RedirectTaskRequest([
            "processInstanceId" => "f30233fb-72e1-4xxx",
            "byManager" => "y",
            "appType" => "APP_PBKxxx",
            "systemToken" => "hexxxx",
...
func _main (args []*string) (_err error) {
  ...
  redirectTaskHeaders := &dingtalkyida_1_0.RedirectTaskHeaders{}
  redirectTaskHeaders.XAcsDingtalkAccessToken = tea.String("<your access token>")
  redirectTaskRequest := &dingtalkyida_1_0.RedirectTaskRequest{
    ProcessInstanceId: tea.String("f30233fb-72e1-4xxx"),
    ByManager: tea.String("y"),
    AppType: tea.String("APP_PBKxxx"),
    SystemToken: tea.String("hexxxx"),
    Language: tea.String("zh_CN"),
    Remark: tea.String("确认同意"),
    NowActionExecutorId: tea.String("manager123"),
  ...
  tryErr := func()(_e error) {
    ...
    _, _err = client.RedirectTaskWithOptions(redirectTaskRequest, redirectTaskHeaders, &util.RuntimeOptions{})
    if _err != nil {
      return _err
    }
...
export default class Client {
  ...
  static async main(args: string[]): Promise<void> {
    ...
    let redirectTaskHeaders = new $dingtalkyida_1_0.RedirectTaskHeaders({ });
    redirectTaskHeaders.xAcsDingtalkAccessToken = "<your access token>";
    let redirectTaskRequest = new $dingtalkyida_1_0.RedirectTaskRequest({
      processInstanceId: "f30233fb-72e1-4xxx",
      byManager: "y",
      appType: "APP_PBKxxx",
      systemToken: "hexxxx",
    ...
    try {
      await client.redirectTaskWithOptions(redirectTaskRequest, redirectTaskHeaders, new $Util.RuntimeOptions({ }));
    } catch (err) {
...
namespace AlibabaCloud.SDK.Sample
{
    public class Sample 
    {
        ...
        public static void Main(string[] args)
        {
            ...
            AlibabaCloud.SDK.Dingtalkyida_1_0.Models.RedirectTaskHeaders redirectTaskHeaders = new AlibabaCloud.SDK.Dingtalkyida_1_0.Models.RedirectTaskHeaders();
            redirectTaskHeaders.XAcsDingtalkAccessToken = "<your access token>";
            AlibabaCloud.SDK.Dingtalkyida_1_0.Models.RedirectTaskRequest redirectTaskRequest = new AlibabaCloud.SDK.Dingtalkyida_1_0.Models.RedirectTaskRequest
            {
                ProcessInstanceId = "f30233fb-72e1-4xxx",
                ByManager = "y",
                AppType = "APP_PBKxxx",
            ...
            try
            {
                client.RedirectTaskWithOptions(redirectTaskRequest, redirectTaskHeaders, new AlibabaCloud.TeaUtil.Models.RuntimeOptions());
            }
            catch (TeaException err)
            {
...
int main(int argc, char *args[]) {
  ...
  shared_ptr<Alibabacloud_Dingtalkyida_1_0::RedirectTaskHeaders> redirectTaskHeaders = make_shared<Alibabacloud_Dingtalkyida_1_0::RedirectTaskHeaders>();
  redirectTaskHeaders->xAcsDingtalkAccessToken = make_shared<string>("<your access token>");
  shared_ptr<Alibabacloud_Dingtalkyida_1_0::RedirectTaskRequest> redirectTaskRequest = make_shared<Alibabacloud_Dingtalkyida_1_0::RedirectTaskRequest>(map<string, boost::any>({
    {"processInstanceId", boost::any(string("f30233fb-72e1-4xxx"))},
    {"byManager", boost::any(string("y"))},
    ...
    {"nowActionExecutorId", boost::any(string("manager123"))},
    {"userId", boost::any(string("manager123"))}
  }));
  try {
    client->redirectTaskWithOptions(redirectTaskRequest, redirectTaskHeaders, make_shared<Darabonba_Util::RuntimeOptions>(Darabonba_Util::RuntimeOptions()));
  }
