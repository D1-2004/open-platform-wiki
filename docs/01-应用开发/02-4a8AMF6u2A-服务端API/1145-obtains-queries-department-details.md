...
doc_id: "GBr2enMEVB"
updated_at: "2026-06-08 09:48:01"
---
...
| 名称 | 类型 | 是否必填 | 示例值 | 描述 |
| --- | --- | --- | --- | --- |
| dept\_id | Number | 是 | 132691544 | 家校部门ID，可调用[获取部门列表](1146-obtains-the-department-node-list.md)接口获取dept\_id参数值。 |
...
-d 'access_token=8b67a52b-ed98-4d0a-8280-d64ed85d95cd' \
-d 'dept_id=1234'
```
