...
slug: "get-form-field-information-based-on-form-uuid"
group: "应用开发"
tab: "服务端API"
...
| formUuid | String | 是 | 表单唯一标识，可通过以下方式获取：   - 调用[获取指定应用下的表单列表](0320-depending-on-the-application-id-to-get-the-form-list.md)接口获取formUuid参数值。 - 通过应用获取： |
