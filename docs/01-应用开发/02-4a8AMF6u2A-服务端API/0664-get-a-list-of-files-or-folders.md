...
slug: "get-a-list-of-files-or-folders"
group: "应用开发"
tab: "服务端API"
...
| 字段 | 值 |
| --- | --- |
| HTTP URL | https://api.dingtalk.com/v1.0/storage/spaces/{spaceId}/dentries |
| HTTP Method | GET |
...
| unionId | String | 是 | 操作者的unionId，可调用[查询用户详情](0056-query-user-details.md)接口获取。 |
