...
> Path: 应用开发 / 服务端API / 更多开放 > 客户管理（官方CRM） > 自定义对象 > 更新自定义对象数据
...
| instance\_id | String | 是 | INST\_XX | 自定义对象数据ID，可通过[根据指定条件查询自定义对象数据](1376-api-getobjectdata.md)接口获取instance\_id参数值。 |
