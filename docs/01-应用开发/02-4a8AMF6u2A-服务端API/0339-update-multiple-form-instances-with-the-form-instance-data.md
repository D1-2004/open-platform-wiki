---
title: "通过表单实例数据批量更新表单实例"
source_url: "https://open.dingtalk.com/document/development/update-multiple-form-instances-with-the-form-instance-data"
namespace: "development"
slug: "update-multiple-form-instances-with-the-form-instance-data"
group: "应用开发"
tab: "服务端API"
breadcrumb: "宜搭 > 表单 > 通过表单实例数据批量更新表单实例"
doc_id: "yfw5nfXGF0"
updated_at: "2026-04-22 20:38:53"
---

> Source: https://open.dingtalk.com/document/development/update-multiple-form-instances-with-the-form-instance-data
> Path: 应用开发 / 服务端API / 宜搭 > 表单 > 通过表单实例数据批量更新表单实例
> Updated: 2026-04-22 20:38:53

# 通过表单实例数据批量更新表单实例

调用本接口，根据宜搭表单组件数据，批量更新表单实例信息。
...
| 字段 | 值 |
| --- | --- |
| HTTP URL | https://api.dingtalk.com/v1.0/yida/forms/instances/datas |
| HTTP Method | PUT |
...
| asynchronousExecution | Boolean | 否 | 该任务是否需要服务端异步执行：   - **true**：需要 - **false**：不需要 |
...
```
PUT /v1.0/yida/forms/instances/datas HTTP/1.1
...

{
  ...
  "updateFormDataJsonMap":{"FINST-ANSFSNNDS2212NSKLKKSFD":"{\"rateField_l0c1cwis\":3,\"countrySelectField_l0c1cwiu\":[{\"value\":\"US\"}]}"},
...
public class Sample {
    ...
    public static void main(String[] args_) throws Exception {
        ...
        BatchUpdateFormDataByInstanceMapHeaders batchUpdateFormDataByInstanceMapHeaders = new BatchUpdateFormDataByInstanceMapHeaders();
        batchUpdateFormDataByInstanceMapHeaders.xAcsDingtalkAccessToken = "<your access token>";
        BatchUpdateFormDataByInstanceMapRequest batchUpdateFormDataByInstanceMapRequest = new BatchUpdateFormDataByInstanceMapRequest()
        ...
        try {
            client.batchUpdateFormDataByInstanceMapWithOptions(batchUpdateFormDataByInstanceMapRequest, batchUpdateFormDataByInstanceMapHeaders, new RuntimeOptions());
...
class Sample:
    ...
    def main(
        ...
        batch_update_form_data_by_instance_map_headers = dingtalkyida__1__0_models.BatchUpdateFormDataByInstanceMapHeaders()
        batch_update_form_data_by_instance_map_headers.x_acs_dingtalk_access_token = '<your access token>'
        batch_update_form_data_by_instance_map_request = dingtalkyida__1__0_models.BatchUpdateFormDataByInstanceMapRequest(
        ...
        try:
            client.batch_update_form_data_by_instance_map_with_options(batch_update_form_data_by_instance_map_request, batch_update_form_data_by_instance_map_headers, util_models.RuntimeOptions())
    ...
    async def main_async(
        ...
        try:
            await client.batch_update_form_data_by_instance_map_with_options_async(batch_update_form_data_by_instance_map_request, batch_update_form_data_by_instance_map_headers, util_models.RuntimeOptions())
        except Exception as err:
            if not UtilClient.empty(err.code) and not UtilClient.empty(err.message):
                # err 中含有 code 和 message 属性，可帮助开发定位问题
                pass
...
class Sample {
    ...
    public static function main($args){
        ...
        $batchUpdateFormDataByInstanceMapHeaders = new BatchUpdateFormDataByInstanceMapHeaders([]);
        $batchUpdateFormDataByInstanceMapHeaders->xAcsDingtalkAccessToken = "<your access token>";
        $batchUpdateFormDataByInstanceMapRequest = new BatchUpdateFormDataByInstanceMapRequest([
            "noExecuteExpression" => true,
            "formUuid" => "FORM-GX866MC1NC1VOFF6WVQW33FD16E23L3CPMKVKA",
            "asynchronousExecution" => true,
            "appType" => "APP_XCE0EVXS6DYG3YDYC5RD",
...
func _main (args []*string) (_err error) {
  ...
  batchUpdateFormDataByInstanceMapHeaders := &dingtalkyida_1_0.BatchUpdateFormDataByInstanceMapHeaders{}
  batchUpdateFormDataByInstanceMapHeaders.XAcsDingtalkAccessToken = tea.String("<your access token>")
  batchUpdateFormDataByInstanceMapRequest := &dingtalkyida_1_0.BatchUpdateFormDataByInstanceMapRequest{
  ...
  tryErr := func()(_e error) {
    ...
    _, _err = client.BatchUpdateFormDataByInstanceMapWithOptions(batchUpdateFormDataByInstanceMapRequest, batchUpdateFormDataByInstanceMapHeaders, &util.RuntimeOptions{})
    if _err != nil {
      return _err
    }
...
export default class Client {
  ...
  static async main(args: string[]): Promise<void> {
    ...
    let batchUpdateFormDataByInstanceMapHeaders = new $dingtalkyida_1_0.BatchUpdateFormDataByInstanceMapHeaders({ });
    batchUpdateFormDataByInstanceMapHeaders.xAcsDingtalkAccessToken = "<your access token>";
    let batchUpdateFormDataByInstanceMapRequest = new $dingtalkyida_1_0.BatchUpdateFormDataByInstanceMapRequest({
      noExecuteExpression: true,
      formUuid: "FORM-GX866MC1NC1VOFF6WVQW33FD16E23L3CPMKVKA",
      asynchronousExecution: true,
      appType: "APP_XCE0EVXS6DYG3YDYC5RD",
    ...
    try {
      await client.batchUpdateFormDataByInstanceMapWithOptions(batchUpdateFormDataByInstanceMapRequest, batchUpdateFormDataByInstanceMapHeaders, new $Util.RuntimeOptions({ }));
    } catch (err) {
...
namespace AlibabaCloud.SDK.Sample
{
    public class Sample 
    {
        ...
        public static void Main(string[] args)
        {
            ...
            AlibabaCloud.SDK.Dingtalkyida_1_0.Models.BatchUpdateFormDataByInstanceMapHeaders batchUpdateFormDataByInstanceMapHeaders = new AlibabaCloud.SDK.Dingtalkyida_1_0.Models.BatchUpdateFormDataByInstanceMapHeaders();
            batchUpdateFormDataByInstanceMapHeaders.XAcsDingtalkAccessToken = "<your access token>";
            AlibabaCloud.SDK.Dingtalkyida_1_0.Models.BatchUpdateFormDataByInstanceMapRequest batchUpdateFormDataByInstanceMapRequest = new AlibabaCloud.SDK.Dingtalkyida_1_0.Models.BatchUpdateFormDataByInstanceMapRequest
            {
                NoExecuteExpression = true,
                FormUuid = "FORM-GX866MC1NC1VOFF6WVQW33FD16E23L3CPMKVKA",
                AsynchronousExecution = true,
            ...
            try
            {
                client.BatchUpdateFormDataByInstanceMapWithOptions(batchUpdateFormDataByInstanceMapRequest, batchUpdateFormDataByInstanceMapHeaders, new AlibabaCloud.TeaUtil.Models.RuntimeOptions());
            }
            catch (TeaException err)
            {
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| result | Array of String | 更新成功的表单实例Id。 |
