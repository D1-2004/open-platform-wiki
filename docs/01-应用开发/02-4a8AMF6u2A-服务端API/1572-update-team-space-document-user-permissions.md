...
![](https://img.alicdn.com/imgextra/i1/O1CN01JS2ZnR1WS2Di6OSLK_!!6000000002786-2-tps-2470-1392.png)
...
| --- | --- | --- | --- |
| 企业内部应用 | 支持 | 知识库文档写权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=org&api=doc_1.0%23UpdateWorkspaceDocMembers) |
| 第三方企业应用 | 支持 | 知识库文档写权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=isv&api=doc_1.0%23UpdateWorkspaceDocMembers) |
