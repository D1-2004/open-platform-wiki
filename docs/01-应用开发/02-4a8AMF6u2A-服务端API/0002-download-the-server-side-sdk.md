...
> - **新版接口**：请参考本文「[新版服务端SDK](#section-3uc-c2m-3no) 」说明，使用[新版工具包](#e2287636e4q62)，**Maven 最新版本为**`2.2.56`。
...
- **Java**
  ...
  **方式一**：通过Maven安装DingTalk OpenAPI Java SDK
  ...
  > **[!NOTE]**
  >
  > 请替换下方代码中的`{version}`，并填写最新Maven版本**2.2.56**。
