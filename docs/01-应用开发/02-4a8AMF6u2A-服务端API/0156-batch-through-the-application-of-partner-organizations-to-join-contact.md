---
title: "批量通过伙伴组织的加入申请"
source_url: "https://open.dingtalk.com/document/development/batch-through-the-application-of-partner-organizations-to-join-contact"
namespace: "development"
slug: "batch-through-the-application-of-partner-organizations-to-join-contact"
group: "应用开发"
tab: "服务端API"
breadcrumb: "通讯录管理 > 上下级组织（原关联组织） > 批量通过伙伴组织的加入申请"
doc_id: "RthW8ckVRv"
updated_at: "2026-05-26 09:01:02"
---
...
> Path: 应用开发 / 服务端API / 通讯录管理 > 上下级组织（原关联组织） > 批量通过伙伴组织的加入申请
> Updated: 2026-05-26 09:01:02

# 批量通过伙伴组织的加入申请

调用本接口，批量通过分支组织加入主干组织申请。

## **接口调用说明**

例如，某主干组织的通讯录目前没有任何分支组织关联，如下图所示。![iShot2022-06-15 19](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1491925561/p449716.png)该组织收到两条分支组织的关联申请，分别为**关联组织**和**体验组织**，申请信息如下图所示。![iShot2022-06-15 19](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1491925561/p449717.png)调用本接口可同时同意这两条关联主干组织的申请。接口调用成功后，主干组织的通讯录新增了**关联组织**和**体验组织**，如下图所示。![iShot2022-06-15 19](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/0491925561/p449718.png)
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| x-acs-dingtalk-access-token | String | 是 | 调用该接口的访问凭证，通过以下获取：   - 企业内部应用，调用[获取企业内部应用的accessToken](0033-obtain-the-access-token-of-an-internal-app.md)接口获取。 - 第三方企业应用，调用[获取企业accessToken(应用商店应用)](0034-obtain-the-access-token-of-the-authorized-enterprise-1.md)接口获取。 |
...
| branchCorpId | String | 否 | 申请的分支组织CorpId，详情参见[基础概念](https://open.dingtalk.com/document/development/development-basic-concepts#section-bbk-mv0-oxd)。 |
| unionRootName | String | 否 | 分支组织在主干组织内的名称。 |
| linkDeptId | Long | 否 | 分支组织在主干组织内的位置，可调用[获取部门列表](0082-user-management-acquires-the-list-departments.md)接口获取dept\_id参数值。 |
