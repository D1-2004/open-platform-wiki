...
doc_id: "IhtAgkMji2"
updated_at: "2026-05-19 11:19:23"
---
...
- 调用服务端API-[钉钉文本翻译](0999-dingtalk-translation.md)接口后，实现文本内容翻译。
...
步骤四：调用[获取企业内部应用的access\_token](1420-obtain-orgapp-token.md)接口，获取应用访问凭证access\_token（有效期2小时，建议服务端缓存并自动刷新。

步骤五：调用服务端API-[钉钉文本翻译](0999-dingtalk-translation.md)接口，实现文本内容翻译。

## 步骤一：创建企业内部应用

1. 登录[开发者后台](https://open-dev.dingtalk.com/#/)，创建[企业内部应用](../01-XOnnmGCTbn-开发指南/0007-create-application.md)。

   ![1](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/3771889661/p527245.png)
...
![3](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/3771889661/p527248.png)

## 步骤三：添加接口权限

[申请AI接口权限](0003-add-api-permission.md)，搜索“AI”，申请相应权限。![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/3771889661/p527257.png)

## 步骤四：获取应用访问凭证accessToken

根据步骤二中的AppKey和AppSecret，调用[获取企业内部应用的access\_token](1420-obtain-orgapp-token.md)接口获取组织级access\_token。

## 步骤五：调用服务端AI相关API

调用服务端API-[钉钉文本翻译](0999-dingtalk-translation.md)接口，实现文本内容的翻译。
