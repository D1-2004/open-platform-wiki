...
> Path: 应用开发 / 服务端API / 专属钉钉 > 互动服务窗 > 图文卡片管理 > 更新图文卡片
...
| media\_id | String | 是 | P16mHftLYX8iE | 图文卡片素材id，可以通过[查询图文卡片列表](0819-query-message-card-list.md)接口获取。 |
| articles | ArticleDTO[] | 否 |  | 文章列表。 |
| article\_id | Number | 否 | 10001 | 文章id，可以通过[查询文章列表](0812-query-the-article-list.md)接口获取。 |
