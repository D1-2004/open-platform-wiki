...
步骤二：调用[获取文件分片上传信息](0677-obtains-the-information-about-multipart-uploads-of-an-object.md)接口，获取每片文件的上传信息。

步骤三：循环对每片文件执行上传操作。

步骤四：使用步骤一接口获取的上传标识uploadKey，调用[提交文件](0675-submittal-file.md)接口，完成上传。
