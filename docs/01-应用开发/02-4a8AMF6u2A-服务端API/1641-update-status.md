---
title: "更新状态"
source_url: "https://open.dingtalk.com/document/development/update-status"
namespace: "development"
slug: "update-status"
group: "应用开发"
tab: "服务端API"
breadcrumb: "历史文档（不推荐） > 宜搭 > 表单 > 更新状态"
doc_id: "VyKgCXDkph"
updated_at: "2025-09-08 19:03:45"
---

> Source: https://open.dingtalk.com/document/development/update-status
> Path: 应用开发 / 服务端API / 历史文档（不推荐） > 宜搭 > 表单 > 更新状态
> Updated: 2025-09-08 19:03:45
...
```
PUT /v1.0/yida/forms/status HTTP/1.1
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| importSequence | String | 否 | 导入序列。 |
| errorLines | Array of Integer | 否 | 错误行列表。 |
...
public class Sample {
    ...
    public static void main(String[] args_) throws Exception {
        ...
        UpdateStatusHeaders updateStatusHeaders = new UpdateStatusHeaders();
        updateStatusHeaders.xAcsDingtalkAccessToken = "<your access token>";
        UpdateStatusRequest updateStatusRequest = new UpdateStatusRequest()
                .setImportSequence("seq-123")
                .setErrorLines(java.util.Arrays.asList(
                    12
                ))
                ...
                .setStatus("running");
        try {
            client.updateStatusWithOptions(updateStatusRequest, updateStatusHeaders, new RuntimeOptions());
...
class Sample:
    ...
    def main(
        ...
        update_status_headers = dingtalkyida__1__0_models.UpdateStatusHeaders()
        update_status_headers.x_acs_dingtalk_access_token = '<your access token>'
        update_status_request = dingtalkyida__1__0_models.UpdateStatusRequest(
            import_sequence='seq-123',
            error_lines=[
                12
            ],
        ...
        try:
            client.update_status_with_options(update_status_request, update_status_headers, util_models.RuntimeOptions())
    ...
    async def main_async(
        ...
        try:
            await client.update_status_with_options_async(update_status_request, update_status_headers, util_models.RuntimeOptions())
        except Exception as err:
            if not UtilClient.empty(err.code) and not UtilClient.empty(err.message):
                # err 中含有 code 和 message 属性，可帮助开发定位问题
                pass
...
class Sample {
    ...
    public static function main($args){
        ...
        $updateStatusHeaders = new UpdateStatusHeaders([]);
        $updateStatusHeaders->xAcsDingtalkAccessToken = "<your access token>";
...
func _main (args []*string) (_err error) {
  ...
  updateStatusHeaders := &dingtalkyida_1_0.UpdateStatusHeaders{}
  updateStatusHeaders.XAcsDingtalkAccessToken = tea.String("<your access token>")
  updateStatusRequest := &dingtalkyida_1_0.UpdateStatusRequest{
    ImportSequence: tea.String("seq-123"),
    ErrorLines: []*int32{tea.Int(12)},
  ...
  tryErr := func()(_e error) {
    ...
    _, _err = client.UpdateStatusWithOptions(updateStatusRequest, updateStatusHeaders, &util.RuntimeOptions{})
    if _err != nil {
      return _err
    }
...
export default class Client {
  ...
  static async main(args: string[]): Promise<void> {
    ...
    let updateStatusHeaders = new $dingtalkyida_1_0.UpdateStatusHeaders({ });
    updateStatusHeaders.xAcsDingtalkAccessToken = "<your access token>";
    let updateStatusRequest = new $dingtalkyida_1_0.UpdateStatusRequest({
      importSequence: "seq-123",
      errorLines: [
        12
      ],
    ...
    try {
      await client.updateStatusWithOptions(updateStatusRequest, updateStatusHeaders, new $Util.RuntimeOptions({ }));
    } catch (err) {
...
namespace AlibabaCloud.SDK.Sample
{
    public class Sample 
    {
        ...
        public static void Main(string[] args)
        {
            ...
            AlibabaCloud.SDK.Dingtalkyida_1_0.Models.UpdateStatusHeaders updateStatusHeaders = new AlibabaCloud.SDK.Dingtalkyida_1_0.Models.UpdateStatusHeaders();
            updateStatusHeaders.XAcsDingtalkAccessToken = "<your access token>";
            AlibabaCloud.SDK.Dingtalkyida_1_0.Models.UpdateStatusRequest updateStatusRequest = new AlibabaCloud.SDK.Dingtalkyida_1_0.Models.UpdateStatusRequest
            {
                ImportSequence = "seq-123",
            ...
            try
            {
                client.UpdateStatusWithOptions(updateStatusRequest, updateStatusHeaders, new AlibabaCloud.TeaUtil.Models.RuntimeOptions());
            }
            catch (TeaException err)
            {
...
int main(int argc, char *args[]) {
  ...
  shared_ptr<Alibabacloud_Dingtalkyida_1_0::UpdateStatusHeaders> updateStatusHeaders = make_shared<Alibabacloud_Dingtalkyida_1_0::UpdateStatusHeaders>();
  updateStatusHeaders->xAcsDingtalkAccessToken = make_shared<string>("<your access token>");
  shared_ptr<Alibabacloud_Dingtalkyida_1_0::UpdateStatusRequest> updateStatusRequest = make_shared<Alibabacloud_Dingtalkyida_1_0::UpdateStatusRequest>(map<string, boost::any>({
    {"importSequence", boost::any(string("seq-123"))},
    {"errorLines", boost::any(vector<int>({
      12
    }))},
  ...
  try {
    client->updateStatusWithOptions(updateStatusRequest, updateStatusHeaders, make_shared<Darabonba_Util::RuntimeOptions>(Darabonba_Util::RuntimeOptions()));
  }
