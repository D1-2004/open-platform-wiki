...
slug: "api-updateformdata-v2"
group: "应用开发"
tab: "服务端API"
breadcrumb: "宜搭 > 表单 > 更新表单数据"
doc_id: "IbpWa0weJR"
updated_at: "2026-06-15 10:44:17"
---

> Source: https://open.dingtalk.com/document/development/api-updateformdata-v2
> Path: 应用开发 / 服务端API / 宜搭 > 表单 > 更新表单数据
> Updated: 2026-06-15 10:44:17
...
| **基本信息** | |
| --- | --- |
| HTTP URL | https://api.dingtalk.com/v2.0/yida/forms/instances |
| HTTP Method | PUT |
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| appType | String | 否 | 应用编码，获取方式如下图所示： |
...
| formInstanceId | String | 是 | 流程实例ID，调用[保存表单数据](0316-api-saveformdata-v2.md)接口获取。 |
...
| useAlias | Boolean | 否 | 是否使用组件别名；开启之后，入参updateFormDataJson中组件id支持以别名形式传入; |
| formUuid | String | 否 | 表单UID，当使用组件别名时必填，可通过[获取指定应用下的表单列表](0334-depending-on-the-application-id-to-get-the-form-list.md)接口获取。 |
...
```
PUT /v2.0/yida/forms/instances HTTP/1.1
...
public class Sample {
    ...
    public static void main(String[] args_) throws Exception {
        ...
        com.aliyun.dingtalkyida_2_0.models.UpdateFormDataHeaders updateFormDataHeaders = new com.aliyun.dingtalkyida_2_0.models.UpdateFormDataHeaders();
        updateFormDataHeaders.xAcsDingtalkAccessToken = "<your access token>";
        com.aliyun.dingtalkyida_2_0.models.UpdateFormDataRequest updateFormDataRequest = new com.aliyun.dingtalkyida_2_0.models.UpdateFormDataRequest()
...
class Client {
  ...
  static async main(args) {
    ...
    let updateFormDataHeaders = new dingtalkyida_2_0.UpdateFormDataHeaders({ });
    updateFormDataHeaders.xAcsDingtalkAccessToken = '<your access token>';
    let updateFormDataRequest = new dingtalkyida_2_0.UpdateFormDataRequest({
      appType: 'APP_PBKTxxx',
      systemToken: 'hexxxx',
      userId: 'manager123',
      language: 'zh_CN',
...
namespace AlibabaCloud.SDK.Sample
{
    public class Sample 
    {
        ...
        public static void Main(string[] args)
        {
            ...
            AlibabaCloud.SDK.Dingtalkyida_2_0.Models.UpdateFormDataHeaders updateFormDataHeaders = new AlibabaCloud.SDK.Dingtalkyida_2_0.Models.UpdateFormDataHeaders();
            updateFormDataHeaders.XAcsDingtalkAccessToken = "<your access token>";
            AlibabaCloud.SDK.Dingtalkyida_2_0.Models.UpdateFormDataRequest updateFormDataRequest = new AlibabaCloud.SDK.Dingtalkyida_2_0.Models.UpdateFormDataRequest
            {
                AppType = "APP_PBKTxxx",
                SystemToken = "hexxxx",
                UserId = "manager123",
