...
slug: "get-notifications-sent-to-users"
group: "应用开发"
tab: "服务端API"
...
| 字段 | 值 |
| --- | --- |
| HTTP URL | https://api.dingtalk.com/v1.0/yida/corpNotifications/{userId} |
| HTTP Method | GET |
...
| instanceCreateFromTimeGMT | Long | 否 | 流程创建时间起始值。 |
| instanceCreateToTimeGMT | Long | 否 | 流程创建时间终止值。 |
...
```
GET /v1.0/yida/corpNotifications/manager123?corpId=ding123&token=adfasdadfasfda112adfaf&pageNumber=1&pageSize=10&language=zh_CN&keyword={}&appTypes=["APP_xxx","APP_xxx"]&processCodes=["xx","xxx"] HTTP/1.1
...
public class Sample {
    ...
    public static void main(String[] args_) throws Exception {
        ...
        GetNotifyMeHeaders getNotifyMeHeaders = new GetNotifyMeHeaders();
        getNotifyMeHeaders.xAcsDingtalkAccessToken = "<your access token>";
        GetNotifyMeRequest getNotifyMeRequest = new GetNotifyMeRequest()
                .setCorpId("ding123")
        ...
        try {
            client.getNotifyMeWithOptions("manager123", getNotifyMeRequest, getNotifyMeHeaders, new RuntimeOptions());
...
class Sample:
    ...
    def main(
        ...
        get_notify_me_headers = dingtalkyida__1__0_models.GetNotifyMeHeaders()
        get_notify_me_headers.x_acs_dingtalk_access_token = '<your access token>'
        get_notify_me_request = dingtalkyida__1__0_models.GetNotifyMeRequest(
            corp_id='ding123',
        ...
        try:
            client.get_notify_me_with_options('manager123', get_notify_me_request, get_notify_me_headers, util_models.RuntimeOptions())
    ...
    async def main_async(
        ...
        try:
            await client.get_notify_me_with_options_async('manager123', get_notify_me_request, get_notify_me_headers, util_models.RuntimeOptions())
        except Exception as err:
            if not UtilClient.empty(err.code) and not UtilClient.empty(err.message):
                # err 中含有 code 和 message 属性，可帮助开发定位问题
                pass
...
class Sample {
    ...
    public static function main($args){
        ...
        $getNotifyMeHeaders = new GetNotifyMeHeaders([]);
        $getNotifyMeHeaders->xAcsDingtalkAccessToken = "<your access token>";
        $getNotifyMeRequest = new GetNotifyMeRequest([
            "corpId" => "ding123",
            "token" => "adfasdadfasfda112adfaf",
            "pageNumber" => 1,
            "pageSize" => 10,
...
func _main (args []*string) (_err error) {
  ...
  getNotifyMeHeaders := &dingtalkyida_1_0.GetNotifyMeHeaders{}
  getNotifyMeHeaders.XAcsDingtalkAccessToken = tea.String("<your access token>")
  getNotifyMeRequest := &dingtalkyida_1_0.GetNotifyMeRequest{
  ...
  tryErr := func()(_e error) {
    ...
    _, _err = client.GetNotifyMeWithOptions(tea.String("manager123"), getNotifyMeRequest, getNotifyMeHeaders, &util.RuntimeOptions{})
    if _err != nil {
      return _err
    }
...
export default class Client {
  ...
  static async main(args: string[]): Promise<void> {
    ...
    let getNotifyMeHeaders = new $dingtalkyida_1_0.GetNotifyMeHeaders({ });
    getNotifyMeHeaders.xAcsDingtalkAccessToken = "<your access token>";
    let getNotifyMeRequest = new $dingtalkyida_1_0.GetNotifyMeRequest({
      corpId: "ding123",
      token: "adfasdadfasfda112adfaf",
      pageNumber: 1,
      pageSize: 10,
    ...
    try {
      await client.getNotifyMeWithOptions("manager123", getNotifyMeRequest, getNotifyMeHeaders, new $Util.RuntimeOptions({ }));
    } catch (err) {
...
namespace AlibabaCloud.SDK.Sample
{
    public class Sample 
    {
        ...
        public static void Main(string[] args)
        {
            ...
            AlibabaCloud.SDK.Dingtalkyida_1_0.Models.GetNotifyMeHeaders getNotifyMeHeaders = new AlibabaCloud.SDK.Dingtalkyida_1_0.Models.GetNotifyMeHeaders();
            getNotifyMeHeaders.XAcsDingtalkAccessToken = "<your access token>";
            AlibabaCloud.SDK.Dingtalkyida_1_0.Models.GetNotifyMeRequest getNotifyMeRequest = new AlibabaCloud.SDK.Dingtalkyida_1_0.Models.GetNotifyMeRequest
            {
                CorpId = "ding123",
                Token = "adfasdadfasfda112adfaf",
                PageNumber = 1,
            ...
            try
            {
                client.GetNotifyMeWithOptions("manager123", getNotifyMeRequest, getNotifyMeHeaders, new AlibabaCloud.TeaUtil.Models.RuntimeOptions());
            }
            catch (TeaException err)
            {
...
int main(int argc, char *args[]) {
  ...
  shared_ptr<Alibabacloud_Dingtalkyida_1_0::GetNotifyMeHeaders> getNotifyMeHeaders = make_shared<Alibabacloud_Dingtalkyida_1_0::GetNotifyMeHeaders>();
  getNotifyMeHeaders->xAcsDingtalkAccessToken = make_shared<string>("<your access token>");
  shared_ptr<Alibabacloud_Dingtalkyida_1_0::GetNotifyMeRequest> getNotifyMeRequest = make_shared<Alibabacloud_Dingtalkyida_1_0::GetNotifyMeRequest>(map<string, boost::any>({
  ...
  try {
    client->getNotifyMeWithOptions(make_shared<string>("manager123"), getNotifyMeRequest, getNotifyMeHeaders, make_shared<Darabonba_Util::RuntimeOptions>(Darabonba_Util::RuntimeOptions()));
  }
...
| mobileUrl | String | 手机号url。 |
| formInstanceId | String | 流程实例ID。 |
| instStatus | String | 实例状态，取值：   - RUNNING：运行中 - TERMINATED：已终止 - COMPLETED：已完成 - ERROR：异常 |
| title | String | 标题。 |
| url | String | 链接。 |
...

{
  ...
  "data" : [ {
    ...
    "mobileUrl" : "mobileUrlexample",
    "formInstanceId" : "FORM_INST_12345",
    "instStatus" : "RUNNING",
    "title" : "李四发起的请购单",
    "url" : "urlexample"
  } ]
