...
| 字段 | 值 |
| --- | --- |
| HTTP URL | https://api.dingtalk.com/v1.0/yida/logs/automations |
| HTTP Method | GET |
...
| procInstanceId | String | 是 | 通过调用[分页获取集成自动化日志列表](0362-api-pageautoflowlog.md)接口获取实例 id。 |
...
```
GET /v1.0/yida/logs/automations?pageSize=100&userId=manager7675&procInstanceId=da7ae0f8-c8e2-4207-9f87-47bd887430ef&pageNumber=1&token=B073NCJSHYD59F8F612DXXXXX&corpId=ding5d17e3add038d44535c2f46xxx485s HTTP/1.1
Host:api.dingtalk.com
x-acs-dingtalk-access-token:da7zxcsf8-c8e2-4207-9f87-47bxxxas2830ef
...
public class Sample {
    ...
    public static void main(String[] args_) throws Exception {
        ...
        com.aliyun.dingtalkyida_1_0.models.GetAutoFlowLogDetailHeaders getAutoFlowLogDetailHeaders = new com.aliyun.dingtalkyida_1_0.models.GetAutoFlowLogDetailHeaders();
        getAutoFlowLogDetailHeaders.xAcsDingtalkAccessToken = "<your access token>";
        com.aliyun.dingtalkyida_1_0.models.GetAutoFlowLogDetailRequest getAutoFlowLogDetailRequest = new com.aliyun.dingtalkyida_1_0.models.GetAutoFlowLogDetailRequest()
                .setPageSize(100)
                .setUserId("manager7675")
                .setProcInstanceId("da7ae0f8-c8e2-4207-9f87-47bd887430ef")
                .setPageNumber(1)
                .setToken("B073NCJSHYD59F8F612DXXXXX")
                .setCorpId("ding5d17e3add038d44535c2f46xxx485s");
        try {
            client.getAutoFlowLogDetailWithOptions(getAutoFlowLogDetailRequest, getAutoFlowLogDetailHeaders, new com.aliyun.teautil.models.RuntimeOptions());
...
class Sample:
    ...
    def main(
        ...
        get_auto_flow_log_detail_headers = dingtalkyida__1__0_models.GetAutoFlowLogDetailHeaders()
        get_auto_flow_log_detail_headers.x_acs_dingtalk_access_token = '<your access token>'
        get_auto_flow_log_detail_request = dingtalkyida__1__0_models.GetAutoFlowLogDetailRequest(
            page_size=100,
            user_id='manager7675',
            proc_instance_id='da7ae0f8-c8e2-4207-9f87-47bd887430ef',
            page_number=1,
            token='B073NCJSHYD59F8F612DXXXXX',
            corp_id='ding5d17e3add038d44535c2f46xxx485s'
        )
        try:
            client.get_auto_flow_log_detail_with_options(get_auto_flow_log_detail_request, get_auto_flow_log_detail_headers, util_models.RuntimeOptions())
    ...
    async def main_async(
        ...
        try:
            await client.get_auto_flow_log_detail_with_options_async(get_auto_flow_log_detail_request, get_auto_flow_log_detail_headers, util_models.RuntimeOptions())
        except Exception as err:
            if not UtilClient.empty(err.code) and not UtilClient.empty(err.message):
                # err 中含有 code 和 message 属性，可帮助开发定位问题
                pass
...
class Sample {
    ...
    public static function main($args){
        ...
        $getAutoFlowLogDetailHeaders = new GetAutoFlowLogDetailHeaders([]);
        $getAutoFlowLogDetailHeaders->xAcsDingtalkAccessToken = "<your access token>";
        $getAutoFlowLogDetailRequest = new GetAutoFlowLogDetailRequest([
            "pageSize" => 100,
            "userId" => "manager7675",
            "procInstanceId" => "da7ae0f8-c8e2-4207-9f87-47bd887430ef",
            "pageNumber" => 1,
            "token" => "B073NCJSHYD59F8F612DXXXXX",
            "corpId" => "ding5d17e3add038d44535c2f46xxx485s"
        ]);
        try {
            $client->getAutoFlowLogDetailWithOptions($getAutoFlowLogDetailRequest, $getAutoFlowLogDetailHeaders, new RuntimeOptions([]));
        }
        catch (Exception $err) {
...
func _main (args []*string) (_err error) {
  ...
  getAutoFlowLogDetailHeaders := &dingtalkyida_1_0.GetAutoFlowLogDetailHeaders{}
  getAutoFlowLogDetailHeaders.XAcsDingtalkAccessToken = tea.String("<your access token>")
  getAutoFlowLogDetailRequest := &dingtalkyida_1_0.GetAutoFlowLogDetailRequest{
    PageSize: tea.Int32(100),
    UserId: tea.String("manager7675"),
    ProcInstanceId: tea.String("da7ae0f8-c8e2-4207-9f87-47bd887430ef"),
    PageNumber: tea.Int32(1),
    Token: tea.String("B073NCJSHYD59F8F612DXXXXX"),
    CorpId: tea.String("ding5d17e3add038d44535c2f46xxx485s"),
  }
  tryErr := func()(_e error) {
    ...
    _, _err = client.GetAutoFlowLogDetailWithOptions(getAutoFlowLogDetailRequest, getAutoFlowLogDetailHeaders, &util.RuntimeOptions{})
    if _err != nil {
      return _err
    }
...
export default class Client {
  ...
  static async main(args: string[]): Promise<void> {
    ...
    let getAutoFlowLogDetailHeaders = new $dingtalkyida_1_0.GetAutoFlowLogDetailHeaders({ });
    getAutoFlowLogDetailHeaders.xAcsDingtalkAccessToken = "<your access token>";
    let getAutoFlowLogDetailRequest = new $dingtalkyida_1_0.GetAutoFlowLogDetailRequest({
      pageSize: 100,
      userId: "manager7675",
      procInstanceId: "da7ae0f8-c8e2-4207-9f87-47bd887430ef",
      pageNumber: 1,
    ...
    try {
      await client.getAutoFlowLogDetailWithOptions(getAutoFlowLogDetailRequest, getAutoFlowLogDetailHeaders, new $Util.RuntimeOptions({ }));
    } catch (err) {
...
namespace AlibabaCloud.SDK.Sample
{
    public class Sample 
    {
        ...
        public static void Main(string[] args)
        {
            ...
            AlibabaCloud.SDK.Dingtalkyida_1_0.Models.GetAutoFlowLogDetailHeaders getAutoFlowLogDetailHeaders = new AlibabaCloud.SDK.Dingtalkyida_1_0.Models.GetAutoFlowLogDetailHeaders();
            getAutoFlowLogDetailHeaders.XAcsDingtalkAccessToken = "<your access token>";
            AlibabaCloud.SDK.Dingtalkyida_1_0.Models.GetAutoFlowLogDetailRequest getAutoFlowLogDetailRequest = new AlibabaCloud.SDK.Dingtalkyida_1_0.Models.GetAutoFlowLogDetailRequest
            {
                PageSize = 100,
                UserId = "manager7675",
                ProcInstanceId = "da7ae0f8-c8e2-4207-9f87-47bd887430ef",
            ...
            try
            {
                client.GetAutoFlowLogDetailWithOptions(getAutoFlowLogDetailRequest, getAutoFlowLogDetailHeaders, new AlibabaCloud.TeaUtil.Models.RuntimeOptions());
            }
            catch (TeaException err)
            {
...
| others | String | 其他说明信息。 |
| status | String | 状态：   - 运行成功 - 运行异常 |
...

{
  ...
  "data" : [ {
    "activityKey" : "sid_abc",
    "flag" : "abc",
    "uuid" : "da7ae0f8-c8e2-4207-9f87-47bdksjeu-28dam",
    "name" : "测试应用",
    "elapsedTimeGMT" : 100,
