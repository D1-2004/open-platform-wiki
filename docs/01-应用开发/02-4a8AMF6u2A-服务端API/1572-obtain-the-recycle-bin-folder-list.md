...
doc_id: "Z41ULc1pgi"
updated_at: "2025-09-08 19:06:49"
---
...
>
> - 如果未使用本接口，推荐使用存储产品[获取回收项列表](https://open.dingtalk.com/document/orgapp/gets-the-list-of-recycle-items)接口。
> - 如果已使用本接口，建议您根据自身实际情况切换至推荐接口。

调用本接口，实现查询回收站内文件（夹）列表，具体示例如下图所示。

![](https://img.alicdn.com/imgextra/i3/O1CN01OivlCK1CXGMp7KAv7_!!6000000000090-2-tps-335-314.png)
