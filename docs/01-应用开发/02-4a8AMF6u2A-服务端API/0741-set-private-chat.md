...
slug: "set-private-chat"
group: "应用开发"
tab: "服务端API"
breadcrumb: "即时通信 > 会话管理 > 群管理 > 设置禁止群成员私聊"
doc_id: "0s8TsaLqIS"
updated_at: "2026-05-29 09:13:39"
---

> Source: https://open.dingtalk.com/document/development/set-private-chat
> Path: 应用开发 / 服务端API / 即时通信 > 会话管理 > 群管理 > 设置禁止群成员私聊
> Updated: 2026-05-29 09:13:39
...
| 名称 | 类型 | 是否必填 | 示例值 | 描述 |
| --- | --- | --- | --- | --- |
| chatid | String | 是 | chatdafe234xxxx | 企业会话ID。可以通过以下方式获取。   - 调用服务端[创建群](1458-session-management-creates-groups.md)接口获取chatid参数值。 - 调用客户端[chooseChat](../03-Ogu5SlPY4t-客户端JSAPI/0318-jsapi-choose-chat.md)获取chatId参数值。 |
