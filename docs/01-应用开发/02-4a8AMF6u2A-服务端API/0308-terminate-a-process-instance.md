...
slug: "terminate-a-process-instance"
group: "应用开发"
tab: "服务端API"
...
| 字段 | 值 |
| --- | --- |
| HTTP URL | https://api.dingtalk.com/v1.0/yida/processes/instances/terminate |
| HTTP Method | PUT |
...
```
PUT /v1.0/yida/processes/instances/terminate?appType=APP_PBKT0MFBEBTDO8T7SLVP&systemToken=hexxxx&userId=未知&language=zh_CN&processInstanceId=f30233fb-72e1-4af4-8cb8-c7e0ea9ee530 HTTP/1.1
...
public class Sample {
    ...
    public static void main(String[] args_) throws Exception {
        ...
        terminateInstanceHeaders.xAcsDingtalkAccessToken = "<your access token>";
...
class Sample:
    ...
    def main(
        ...
        terminate_instance_headers = dingtalkyida__1__0_models.TerminateInstanceHeaders()
        terminate_instance_headers.x_acs_dingtalk_access_token = '<your access token>'
        terminate_instance_request = dingtalkyida__1__0_models.TerminateInstanceRequest(
        ...
        try:
            client.terminate_instance_with_options(terminate_instance_request, terminate_instance_headers, util_models.RuntimeOptions())
    ...
    async def main_async(
        ...
        try:
            await client.terminate_instance_with_options_async(terminate_instance_request, terminate_instance_headers, util_models.RuntimeOptions())
        except Exception as err:
            if not UtilClient.empty(err.code) and not UtilClient.empty(err.message):
                # err 中含有 code 和 message 属性，可帮助开发定位问题
                pass
...
class Sample {
    ...
    public static function main($args){
        ...
        $terminateInstanceHeaders = new TerminateInstanceHeaders([]);
        $terminateInstanceHeaders->xAcsDingtalkAccessToken = "<your access token>";
        $terminateInstanceRequest = new TerminateInstanceRequest([
...
func _main (args []*string) (_err error) {
  ...
  terminateInstanceHeaders := &dingtalkyida_1_0.TerminateInstanceHeaders{}
  terminateInstanceHeaders.XAcsDingtalkAccessToken = tea.String("<your access token>")
  terminateInstanceRequest := &dingtalkyida_1_0.TerminateInstanceRequest{
  ...
  tryErr := func()(_e error) {
    ...
    _, _err = client.TerminateInstanceWithOptions(terminateInstanceRequest, terminateInstanceHeaders, &util.RuntimeOptions{})
    if _err != nil {
      return _err
    }
...
export default class Client {
  ...
  static async main(args: string[]): Promise<void> {
    ...
    let terminateInstanceHeaders = new $dingtalkyida_1_0.TerminateInstanceHeaders({ });
    terminateInstanceHeaders.xAcsDingtalkAccessToken = "<your access token>";
    let terminateInstanceRequest = new $dingtalkyida_1_0.TerminateInstanceRequest({
      appType: "APP_PBKT0MFBEBTDO8T7SLVP",
      systemToken: "hexxxx",
      userId: "未知",
      language: "zh_CN",
    ...
    try {
      await client.terminateInstanceWithOptions(terminateInstanceRequest, terminateInstanceHeaders, new $Util.RuntimeOptions({ }));
    } catch (err) {
...
namespace AlibabaCloud.SDK.Sample
{
    public class Sample 
    {
        ...
        public static void Main(string[] args)
        {
            ...
            AlibabaCloud.SDK.Dingtalkyida_1_0.Models.TerminateInstanceHeaders terminateInstanceHeaders = new AlibabaCloud.SDK.Dingtalkyida_1_0.Models.TerminateInstanceHeaders();
            terminateInstanceHeaders.XAcsDingtalkAccessToken = "<your access token>";
            AlibabaCloud.SDK.Dingtalkyida_1_0.Models.TerminateInstanceRequest terminateInstanceRequest = new AlibabaCloud.SDK.Dingtalkyida_1_0.Models.TerminateInstanceRequest
            {
                AppType = "APP_PBKT0MFBEBTDO8T7SLVP",
                SystemToken = "hexxxx",
                UserId = "未知",
            ...
            try
            {
                client.TerminateInstanceWithOptions(terminateInstanceRequest, terminateInstanceHeaders, new AlibabaCloud.TeaUtil.Models.RuntimeOptions());
            }
            catch (TeaException err)
            {
...
int main(int argc, char *args[]) {
  ...
  shared_ptr<Alibabacloud_Dingtalkyida_1_0::TerminateInstanceHeaders> terminateInstanceHeaders = make_shared<Alibabacloud_Dingtalkyida_1_0::TerminateInstanceHeaders>();
  terminateInstanceHeaders->xAcsDingtalkAccessToken = make_shared<string>("<your access token>");
  shared_ptr<Alibabacloud_Dingtalkyida_1_0::TerminateInstanceRequest> terminateInstanceRequest = make_shared<Alibabacloud_Dingtalkyida_1_0::TerminateInstanceRequest>(map<string, boost::any>({
  ...
  try {
    client->terminateInstanceWithOptions(terminateInstanceRequest, terminateInstanceHeaders, make_shared<Darabonba_Util::RuntimeOptions>(Darabonba_Util::RuntimeOptions()));
  }
