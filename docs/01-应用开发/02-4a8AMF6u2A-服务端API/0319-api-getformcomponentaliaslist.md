...
slug: "api-getformcomponentaliaslist"
group: "应用开发"
tab: "服务端API"
breadcrumb: "宜搭 > 表单 > 获取组件别名列表"
doc_id: "IVFV69n4tp"
updated_at: "2026-06-15 10:44:18"
---

> Source: https://open.dingtalk.com/document/development/api-getformcomponentaliaslist
> Path: 应用开发 / 服务端API / 宜搭 > 表单 > 获取组件别名列表
> Updated: 2026-06-15 10:44:18
...
| **基本信息** | |
| --- | --- |
| HTTP URL | https://api.dingtalk.com/v2.0/yida/forms/component/alias/{appType}/{formUuid} |
| HTTP Method | GET |
...
```
GET /v2.0/yida/forms/component/alias/APP_PBKT0MFBEBTDO8T7SLVP/FORM-NJYJZELV8YZRDEI2N5IQ7L6VEDMR1VE9GMPCJB?systemToken=hexxxx&userId=未知&language=zh_CN&version=1 HTTP/1.1
...
public class Sample {
    ...
    public static void main(String[] args_) throws Exception {
        ...
        com.aliyun.dingtalkyida_2_0.models.GetFormComponentAliasListHeaders getFormComponentAliasListHeaders = new com.aliyun.dingtalkyida_2_0.models.GetFormComponentAliasListHeaders();
        getFormComponentAliasListHeaders.xAcsDingtalkAccessToken = "<your access token>";
        com.aliyun.dingtalkyida_2_0.models.GetFormComponentAliasListRequest getFormComponentAliasListRequest = new com.aliyun.dingtalkyida_2_0.models.GetFormComponentAliasListRequest();
        try {
            client.getFormComponentAliasListWithOptions("", "", getFormComponentAliasListRequest, getFormComponentAliasListHeaders, new com.aliyun.teautil.models.RuntimeOptions());
...
class Sample:
    ...
    def main(
        ...
        try:
            client.get_form_component_alias_list_with_options('', '', get_form_component_alias_list_request, get_form_component_alias_list_headers, util_models.RuntimeOptions())
    ...
    async def main_async(
        ...
        get_form_component_alias_list_request = dingtalkyida__2__0_models.GetFormComponentAliasListRequest()
        try:
            await client.get_form_component_alias_list_with_options_async('', '', get_form_component_alias_list_request, get_form_component_alias_list_headers, util_models.RuntimeOptions())
        except Exception as err:
            if not UtilClient.empty(err.code) and not UtilClient.empty(err.message):
                # err 中含有 code 和 message 属性，可帮助开发定位问题
                pass
...
class Sample {
    ...
    public static function main($args){
        ...
        $getFormComponentAliasListHeaders = new GetFormComponentAliasListHeaders([]);
        $getFormComponentAliasListHeaders->xAcsDingtalkAccessToken = "<your access token>";
        $getFormComponentAliasListRequest = new GetFormComponentAliasListRequest([]);
        try {
            $client->getFormComponentAliasListWithOptions("", "", $getFormComponentAliasListRequest, $getFormComponentAliasListHeaders, new RuntimeOptions([]));
        }
        catch (Exception $err) {
...
func _main (args []*string) (_err error) {
  ...
  tryErr := func()(_e error) {
    ...
    _, _err = client.GetFormComponentAliasListWithOptions(tea.String(""), tea.String(""), getFormComponentAliasListRequest, getFormComponentAliasListHeaders, &util.RuntimeOptions{})
    if _err != nil {
      return _err
    }
...
class Client {
  ...
  static async main(args) {
    ...
    let getFormComponentAliasListHeaders = new dingtalkyida_2_0.GetFormComponentAliasListHeaders({ });
    getFormComponentAliasListHeaders.xAcsDingtalkAccessToken = '<your access token>';
    let getFormComponentAliasListRequest = new dingtalkyida_2_0.GetFormComponentAliasListRequest({ });
    try {
      await client.getFormComponentAliasListWithOptions('', '', getFormComponentAliasListRequest, getFormComponentAliasListHeaders, new Util.RuntimeOptions({ }));
    } catch (err) {
...
namespace AlibabaCloud.SDK.Sample
{
    public class Sample 
    {
        ...
        public static void Main(string[] args)
        {
            ...
            AlibabaCloud.SDK.Dingtalkyida_2_0.Models.GetFormComponentAliasListHeaders getFormComponentAliasListHeaders = new AlibabaCloud.SDK.Dingtalkyida_2_0.Models.GetFormComponentAliasListHeaders();
            getFormComponentAliasListHeaders.XAcsDingtalkAccessToken = "<your access token>";
            AlibabaCloud.SDK.Dingtalkyida_2_0.Models.GetFormComponentAliasListRequest getFormComponentAliasListRequest = new AlibabaCloud.SDK.Dingtalkyida_2_0.Models.GetFormComponentAliasListRequest();
            try
            {
                client.GetFormComponentAliasListWithOptions("", "", getFormComponentAliasListRequest, getFormComponentAliasListHeaders, new AlibabaCloud.TeaUtil.Models.RuntimeOptions());
            }
            catch (TeaException err)
            {
