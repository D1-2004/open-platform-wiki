---
title: "获取企业控制台地址"
source_url: "https://open.dingtalk.com/document/development/get-the-address-enterprise-console-through-e-sign"
namespace: "development"
slug: "get-the-address-enterprise-console-through-e-sign"
group: "应用开发"
tab: "服务端API"
...
当前接口已完成升级迭代且不再支持新应用申请，存量应用调用不受影响，建议未接入的开发者使用[获取企业控制台地址](1069-get-enterprise-console-address.md)接口，已接入的开发者结合实际尽快完成迁移。
...
public class Sample {
    ...
    public static void main(String[] args_) throws Exception {
        ...
        CorpConsoleHeaders corpConsoleHeaders = new CorpConsoleHeaders();
        corpConsoleHeaders.xAcsDingtalkAccessToken = "<your access token>";
        try {
            client.corpConsoleWithOptions(corpConsoleHeaders, new RuntimeOptions());
...
class Sample:
    ...
    def main(
        ...
        corp_console_headers = dingtalkesign__1__0_models.CorpConsoleHeaders()
        corp_console_headers.x_acs_dingtalk_access_token = '<your access token>'
        try:
            client.corp_console_with_options(corp_console_headers, util_models.RuntimeOptions())
    ...
    async def main_async(
        ...
        corp_console_headers.x_acs_dingtalk_access_token = '<your access token>'
        try:
            await client.corp_console_with_options_async(corp_console_headers, util_models.RuntimeOptions())
        except Exception as err:
            if not UtilClient.empty(err.code) and not UtilClient.empty(err.message):
                # err 中含有 code 和 message 属性，可帮助开发定位问���
                pass
...
class Sample {
    ...
    public static function main($args){
        ...
        $corpConsoleHeaders = new CorpConsoleHeaders([]);
        $corpConsoleHeaders->xAcsDingtalkAccessToken = "<your access token>";
        try {
            $client->corpConsoleWithOptions($corpConsoleHeaders, new RuntimeOptions([]));
        }
...
func _main (args []*string) (_err error) {
  ...
  corpConsoleHeaders := &dingtalkesign_1_0.CorpConsoleHeaders{}
  corpConsoleHeaders.XAcsDingtalkAccessToken = tea.String("<your access token>")
  tryErr := func()(_e error) {
    ...
    _, _err = client.CorpConsoleWithOptions(corpConsoleHeaders, &util.RuntimeOptions{})
    if _err != nil {
      return _err
    }
...
export default class Client {
  ...
  static async main(args: string[]): Promise<void> {
    ...
    let corpConsoleHeaders = new $dingtalkesign_1_0.CorpConsoleHeaders({ });
    corpConsoleHeaders.xAcsDingtalkAccessToken = "<your access token>";
    try {
      await client.corpConsoleWithOptions(corpConsoleHeaders, new $Util.RuntimeOptions({ }));
    } catch (err) {
...
namespace AlibabaCloud.SDK.Sample
{
    public class Sample 
    {
        ...
        public static void Main(string[] args)
        {
            ...
            AlibabaCloud.SDK.Dingtalkesign_1_0.Models.CorpConsoleHeaders corpConsoleHeaders = new AlibabaCloud.SDK.Dingtalkesign_1_0.Models.CorpConsoleHeaders();
            corpConsoleHeaders.XAcsDingtalkAccessToken = "<your access token>";
            try
            {
                client.CorpConsoleWithOptions(corpConsoleHeaders, new AlibabaCloud.TeaUtil.Models.RuntimeOptions());
            }
            catch (TeaException err)
            {
...
int main(int argc, char *args[]) {
  ...
  shared_ptr<Alibabacloud_Dingtalkesign_1_0::CorpConsoleHeaders> corpConsoleHeaders = make_shared<Alibabacloud_Dingtalkesign_1_0::CorpConsoleHeaders>();
  corpConsoleHeaders->xAcsDingtalkAccessToken = make_shared<string>("<your access token>");
  try {
    client->corpConsoleWithOptions(corpConsoleHeaders, make_shared<Darabonba_Util::RuntimeOptions>(Darabonba_Util::RuntimeOptions()));
  }
