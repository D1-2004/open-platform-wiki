...
doc_id: "usM4n1Dxpm"
updated_at: "2025-09-08 19:05:20"
---

> Source: https://open.dingtalk.com/document/development/create-an-h5-microapplication
> Path: 应用开发 / 服务端API / 历史文档（不推荐） > 应用管理 > 创建企业内部应用H5微应用
> Updated: 2025-09-08 19:05:20
...
>
> - 如果未使用本接口，推荐使用新版规范[创建企业内部应用H5微应用](https://open.dingtalk.com/document/orgapp/create-an-h5-application-for-your-enterprise)接口。
> - 如果已使用本接口，建议您根据自身实际情况评估是否切换至推荐接口。

![iShot2021-12-22 09](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/6318891461/p373886.png)
...
| 名称 | 类型 | 是否必填 | 示例值 | 描述 |
| --- | --- | --- | --- | --- |
| appIcon | String | 是 | @lADPDfmVQafoVxxxx | H5微应用的图标。  需要调用[上传媒体文件](https://open.dingtalk.com/document/orgapp/upload-media-files)将图标上传到钉钉服务器后获取到的mediaId。 |
