...
| **API** | **接口说明** |
| --- | --- |
| [创建钉钉客联钉外账号](1853-create-bc-account-association.md) | 创建钉外用户账号，并建立与钉内用户的账号关联关系。 |
| [创建互通群](1852-create-an-intercommunication-group.md) | 创建钉钉客联互通群，群类型为普通群或跨钉两人群。 |
| [创建钉外两人群](1851-create-two-people-outside-the-nail.md) | 创建钉外两人群。 |
| [创建店铺群](1850-create-a-store-group.md) | 创建店铺群。 |
| [获取钉钉客联H5页面地址](1856-get-the-dingtalk-guest-group-session-address.md) | 获取钉钉客联群会话地址，钉外用户可通过该地址进入对应群内。 |
| [添加钉钉客联互通群成员](1859-add-a-group-member-1.md) | 向互通群内添加群成员。 |
| [查询钉钉客联互通群成员列表](1864-queries-the-group-member-list.md) | 查询互通群成员列表，包括普通群、跨钉两人群、钉外两人群和店铺群。 |
| [移除钉钉客联互通群成员](1860-remove-group-members.md) | 移除互通群成员。 |
| [修改钉钉客联互通群头像](1861-modify-the-avatar-of-a-communication-group.md) | 修改互通群头像，包括普通群、跨钉两人群、钉外两人群和商铺群。 |
| [修改钉钉客联互通群名称](1862-modify-the-group-name.md) | 修改群名称，包括普通群、跨钉两人群、钉外两人群和店铺群。 |
| [更换钉钉客联互通群群主](1863-change-group-owner.md) | 更换互通群的群主。 |
| [在钉钉客联互通群中使用钉外账号发送消息](1867-send-c2b-messages.md) | 实现钉外用户向钉内用户或互通群发送消息。 |
| [在钉钉客联互通群中使用钉内账号发送消息](1868-send-b2c-messages.md) | 实现钉内用户给钉外用户或者互通群发送消息。 |
| [在钉钉客联互通群中使用机器人发送消息](1866-group-robots-send-messages.md) | 通过互通群内机器人向群内发送消息。 |
| [查询钉钉客联钉外账号未读消息数](1858-querying-the-number-of-unread-messages-of-the-user.md) | 查询钉外用户未读消息的数量。 |
| [批量查询跨钉两人互通群列表](1857-queries-the-session-information-of-two-population-groups.md) | 根据群成员批量查询跨钉两人群列表。 |
| [解散钉钉客联互通群](1865-disband-bc-interconnection-group.md) | 解散互通群，包括普通群、跨钉两人群、钉外两人群和店铺群。 |
...
| **API** | **接口说明** |
| --- | --- |
| [智能问答](1835-alimebot-intelligent-q-a-interface.md) | 使用小蜜客服机器人的能力进行智能问答。 |
| [推送小蜜机器人单聊O2O消息](1837-push-xiaomi-customer-service-robot-single-chat-message.md) | 通过小蜜客服机器人发送O2O（即Online To Offline）线上线下消息。 |
| [小蜜客服机器人消息回复](1838-xiaomi-customer-service-robot-message-reply.md) | 根据小蜜客服机器人sessionId进行异步消息回复。 |
| [查询机器人基础指标数据](1839-query-robot-data-indicators.md) | 根据机器人ID查询某时间段机器人的基础指标数据。 |
| [获取用户登录凭证](1836-obtains-the-user-login-credential-of-the-third-party-system-of.md) | 获取用户的登录凭证。 |
...
| **API** | **接口说明** |
| --- | --- |
| [使用服务助手推送消息](1832-the-message-pushing-interface-of-the-assistant.md) | 通过服务助手机器人给企业员工发送消息。 |

### **制造业**

| **API** | **接口说明** |
| --- | --- |
| [计件报工](1107-riqing-monthly-settlement-piece-rate-reporting-interface.md) | 用于MES系统上报计件数据到平台。 |
| [查询计件报工数据](1108-riqing-monthly-settlement-query-interface-for-piece-rate-reporting.md) | 查询计件报工的数据。 |

### **e签宝**

| **API** | **接口说明** |
| --- | --- |
| [e签宝数据初始化](1070-isv-service-provider-data-initialization.md) | 帮助钉钉企业进行e签宝开放平台的数据初始化。 |
| [获取授权的页面地址](1071-obtain-the-address-of-the-authorized-page.md) | 获取企业授权的页面地址。 |
| [取消企业授权](1072-cancel-enterprise-authorization.md) | 取消授权过企业的授权状态。 |
| [套餐转售—分润模式](1073-package-resale-1-distribution-mode.md) | 为使用电子合同的用户创建转售订单。 |
| [套餐转售—底价结算模式](1074-package-resale-2-reserve-price-settlement-mode.md) | 直接转售e签宝订单给最终真正使用电子合同的用户。 |
| [查询套餐余量](1075-query-package-balance.md) | 查询当前企业的套餐余量。 |
| [获取企业的e签宝微应用状态](1076-obtain-the-current-status-of-the-company-s-e-sign-micro-application.md) | 获取企业的e签宝微应用状态。 |
| [查询企业是否实名认证](1077-query-enterprise-information.md) | 查询企业是否已在e签宝完成实名认证。 |
| [获取企业控制台地址](1078-get-enterprise-console-address.md) | 获取的企业在e签宝的控制台地址。 |
| [查询个人是否实名认证](1079-query-personal-information.md) | 查询当前用户是否已在e签宝完成实名认证。 |
| [获取个人实名的地址](1080-obtain-the-address-that-is-redirected-to-the-user-s-real.md) | 通过个人信息接口查询到个人未实名时，可调用本接口获取个人实名认证地址。 |
| [获取跳转到企业实名的地址](1081-obtain-the-address-that-is-redirected-to-the-enterprise-s-real.md) | 通过企业信息接口查询到企业未实名时，可调用本接口获取实名地址，在应用内展示给企业。 |
| [获取文件上传地址](1084-obtain-the-upload-url-of-a-file-1.md) | 获取到文件上传地址。 |
| [获取文件详情](1083-gets-the-file-details.md) | 查询文件详情。 |
| [获取发起签署任务的地址](1088-obtain-the-address-used-to-initiate-a-signed-task.md) | 获取发起签署任务的地址。 |
| [创建签署流程](1085-use-the-api-to-initiate-a-signature-process.md) | 当ISV侧企业有文件需签署时，可调用本接口获取发起签署地址。 |
| [获取签署人签署地址](1086-get-signatory-address.md) | 获取签署人签署地址。 |
| [获取流程的签署详情](1087-get-the-details-of-process-signing.md) | 根据taskId获取流程签署相关的详细信息。 |
| [获取流程任务用印审批列表](1089-obtains-the-print-approval-list-for-process-tasks.md) | 获取流程任务用印审批列表。 |
| [获取流程详细信息及操作记录](1090-obtains-the-task-details.md) | 获取流程详细信息及操作记录。 |
| [获取流程任务的所有合同列表](1091-get-a-list-of-all-contracts-for-the-process-task.md) | 获取流程任务的所有合同列表，收到签署完成消息后查询。 |
...
| [销售机会](1060-add-or-edit-opportunities.md) | 新增或编辑销售机会。 |
| [报价记录](1061-add-or-edit-quotation-records.md) | 新增或编辑报价记录。 |
| [采购单](1062-edit-purchase-order.md) | 新增或编辑采购单。 |
| [生产单](1063-add-or-edit-a-production-order.md) | 新增或编辑生产单。 |
| [产品信息](1064-add-or-edit-product-information.md) | 新增或编辑产品信息。 |
| [入库单](1065-add-or-edit-a-shipment-record.md) | 新增或编辑入库单。 |
| [出库单](1066-add-or-edit-an-issue-ticket.md) | 新增或编辑出库单。 |
| [获取数据列表](1068-obtain-the-data-list.md) | 获取各种单据的列表数据。 |
| [获取数据详情](1067-queries-data-details.md) | 获取各种单据的详情数据。 |

### 氚云

| **API** | **接口说明** |
| --- | --- |
| [获取应用列表](1812-queries-applications.md) | 查询氚云的应用信息。 |
| [获取应用功能节点](1813-queries-the-application-feature-nodes.md) | 获取应用的功能节点信息。 |
| [获取组织数据](1814-queries-organization-data.md) | 获取组织部门数据信息。 |
| [获取用户数据](1815-obtain-user-data.md) | 获取用户基础数据信息。 |
| [获取角色数据](1816-obtain-role-data.md) | 获取角色组、角色数据等信息。 |
| [获取角色用户数据](1817-historical-acquisition-of-role-user-data.md) | 获取指定角色包含的用户。 |
| [获取表单对象结构](1818-gets-the-form-object-structure.md) | 获取表单对象结构信息。 |
| [创建表单业务数据](1819-create-form-business-data.md) | 创建单条表单、流程表单的业务数据对象。 |
| [查询表单业务数据列表](1820-querying-form-business-data.md) | 查询表单业务数据实例集合。 |
| [修改表单业务对象数据](1821-modify-form-business-object-data.md) | 修改表单的单条业务实例数据。 |
| [批量新增表单业务数据](1822-batch-add-form-business-data.md) | 批量新增表单的业务实例数据。 |
| [删除业务对象](1823-delete-a-business-object.md) | 批量新增表单的业务实例数据。 |
| [获取业务实例信息](1824-queries-business-instance-information.md) | 获取表单的单条业务实例数据。 |
| [创建流程实例](1825-create-a-process-instance.md) | 创建流程表单的流程实例数据。 |
| [删除流程实例数据](1826-delete-process-instance-data.md) | 流程表单的单条流程实例数据。 |
| [取消流程实例](1827-cancel-a-process-instance.md) | 取消流程实例，取消后的流程实例状态为已取消。 |
| [查询流程实例](1828-query-flow-instances.md) | 查询流程表单的流程实例数据。 |
| [查询流程实例节点工作项](1829-query-flow-instance-node-work-items.md) | 获取流程实例节点工作项的相关信息。 |
| [获取附件临时免登地址](1830-obtain-the-temporary-attachment-free-address.md) | 获取附件临时免登的访问地址。 |
| [获取文件上传地址](1831-obtain-the-upload-url-of-a-file-2.md) | 返回表单中指定图片、附件等控件的文件上传地址。 |
