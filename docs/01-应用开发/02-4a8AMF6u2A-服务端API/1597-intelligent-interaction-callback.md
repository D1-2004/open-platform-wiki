...
doc_id: "aM1dJ6E0n8"
updated_at: "2026-03-06 09:27:18"
---
...
在使用 AI 卡片回调功能前，你需要了解钉钉 AI 助理如何实现消息发送及使用场景，详情可参考[智能交互](https://open.dingtalk.com/document/development/intelligent-interaction-overview)。
...
> 智能交互的卡片回调是基于 Stream 模式实现的。想要了解更多关于 Stream 模式的内容，详见：[服务端Stream模式](https://open.dingtalk.com/document/development/introduction-to-stream-mode)。
...
1. AI 助理编辑页面，单击“我的应用信息”，进入企业开发者后台。单击**事件订阅**，选择**Stream模式推送**。
   ...
   > 仅支持[创建组织内使用的 AI 助理](../../04-AI-PaaS/03-9d1vBG1t78-AI-助理创建平台/0005-create-a-dingtalk-ai-assistant-1.md)。
...
如果你想要多次更新卡片，可以使用卡片回调请求中的 conversationToken，按你的情况调用卡片更新接口和（[AI 助理更新消息（主动发送模式）](1593-the-ai-assistant-updates-active-message-sending-mode.md)或者 [AI 助理发消息（回复消息模式）](1591-ai-assistant-messages-reply-mode.md) ）。
