...
>
> - 如果未接入1.0版接口，请使用新的[更新钉钉待办任务](https://open.dingtalk.com/document/orgapp/updates-dingtalk-to-do-tasks)接口。
...
| record\_id | String | 是 | recordfcf7403667fcd9 | 待办任务唯一ID。  该ID可以使用[新增钉钉待办任务](https://open.dingtalk.com/document/orgapp/new-to-do-items)中传入的biz\_id，也可以使用[新增钉钉待办任务](https://open.dingtalk.com/document/orgapp/new-to-do-items)返回结果中的record\_id。 |
