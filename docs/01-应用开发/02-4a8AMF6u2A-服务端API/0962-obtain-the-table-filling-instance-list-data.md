...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| formCode | String | 是 | 填表code，可调用[获取用户创建的填表模板列表](0961-new-obtains-the-template-that-a-user-creates.md)接口获取formCode参数值。 |
