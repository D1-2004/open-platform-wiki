...
doc_id: "D4A8SbEnPy"
updated_at: "2025-09-08 19:07:06"
---
...
>
>    - 如果未使用本接口，推荐使用[获取节点列表](https://open.dingtalk.com/document/orgapp/get-node-list)接口。
>    - 如果已使用本接口，建议您根据自身实际情况评估是否切换至推荐接口。
> 2. 新老接口中的ID不兼容, 不支持混用。

### 接口功能介绍

例如，测试知识库的目录结构如下图所示。调用本接口可逐级获取目录结构信息，包括目录节点名称、目录节点ID、目录创建人等信息。
![](https://img.alicdn.com/imgextra/i2/O1CN01pttW0t27XerncsC6Q_!!6000000007807-2-tps-1752-1302.png)
...
| --- | --- | --- | --- |
| 企业内部应用 | 支持 | 知识库文档读权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=org&api=doc_2.0%23GetSpaceDirectories) |
| 第三方企业应用 | 支持 | 知识库文档读权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=isv&api=doc_2.0%23GetSpaceDirectories) |
| 第三方个人应用 | 暂不支持 | 知识库文档读权限 | 暂不支持 |
...
| operatorId | String | 是 | 当前操作用户的unionId。   - 企业内部应用，调用[查询用户详情](https://open.dingtalk.com/document/orgapp/query-user-details)接口获取unionid参数值。 - 第三方企业应用，调用[查询用户详情](https://open.dingtalk.com/document/isvapp/query-user-details)接口获取unionid参数值。 |
...
| DentryModel | DentryModel | 节点信息。   - 企业内部应用，请参考[知识库通用数据格式-DentryVO](https://open.dingtalk.com/document/orgapp/common-data-structure)。 - 第三方企业应用，请参考[知识库通用数据格式-DentryVO](https://open.dingtalk.com/document/isvapp/common-data-structure)。 |
