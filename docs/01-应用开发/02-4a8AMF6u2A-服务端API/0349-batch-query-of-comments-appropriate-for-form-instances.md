...
slug: "batch-query-of-comments-appropriate-for-form-instances"
group: "应用开发"
tab: "服务端API"
...
调用本接口，批量查询宜搭表单下的所有评论，本接口也可获取全部评论的详情信息。
...
| 字段 | 值 |
| --- | --- |
| HTTP URL | https://api.dingtalk.com/v1.0/yida/forms/remarks/query |
| HTTP Method | POST |
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| formUuid | String | 是 | 表单页面编码，该参数从宜搭应用中获取。 |
| appType | String | 是 | 宜搭应用编码，该参数从宜搭应用中获取。 |
| systemToken | String | 是 | 宜搭应用密钥，该参数从宜搭应用中获取。 |
| formInstanceIdList | Array of String | 否 | 宜搭表单实例Id，调用[获取实例ID列表](0310-api-getinstanceidlist-v2.md)接口或者[获取多个表单实例ID](0324-api-searchformdataidlist-v2.md)接口获取。 |
...
```
POST /v1.0/yida/forms/remarks/query HTTP/1.1
Host:api.dingtalk.com
x-acs-dingtalk-access-token:554xxx
Content-Type:application/json

{
  "formUuid" : "FORM-GX866xxxx",
  "appType" : "APP_XCxxxx",
  "systemToken" : "098661xxxx",
  "formInstanceIdList" : [ "FINST-GWxxx" ],
  "userId" : "user001"
}
```
...
public class Sample {
    ...
    public static void main(String[] args_) throws Exception {
        ...
        ListFormRemarksHeaders listFormRemarksHeaders = new ListFormRemarksHeaders();
        listFormRemarksHeaders.xAcsDingtalkAccessToken = "<your access token>";
        ListFormRemarksRequest listFormRemarksRequest = new ListFormRemarksRequest()
                .setFormUuid("FORM-GX866xxxx")
                .setAppType("APP_XCxxxx")
                .setSystemToken("098661xxxx")
                .setFormInstanceIdList(java.util.Arrays.asList(
                    "FINST-GWxxx"
                ))
                .setUserId("user001");
        try {
            client.listFormRemarksWithOptions(listFormRemarksRequest, listFormRemarksHeaders, new RuntimeOptions());
...
class Sample:
    ...
    def main(
        ...
        list_form_remarks_headers = dingtalkyida__1__0_models.ListFormRemarksHeaders()
        list_form_remarks_headers.x_acs_dingtalk_access_token = '<your access token>'
        list_form_remarks_request = dingtalkyida__1__0_models.ListFormRemarksRequest(
            form_uuid='FORM-GX866xxxx',
            app_type='APP_XCxxxx',
            system_token='098661xxxx',
        ...
        try:
            client.list_form_remarks_with_options(list_form_remarks_request, list_form_remarks_headers, util_models.RuntimeOptions())
    ...
    async def main_async(
        ...
        try:
            await client.list_form_remarks_with_options_async(list_form_remarks_request, list_form_remarks_headers, util_models.RuntimeOptions())
        except Exception as err:
            if not UtilClient.empty(err.code) and not UtilClient.empty(err.message):
                # err 中含有 code 和 message 属性，可帮助开发定位问题
                pass
...
class Sample {
    ...
    public static function main($args){
        ...
        $listFormRemarksHeaders = new ListFormRemarksHeaders([]);
        $listFormRemarksHeaders->xAcsDingtalkAccessToken = "<your access token>";
        $listFormRemarksRequest = new ListFormRemarksRequest([
            "formUuid" => "FORM-GX866xxxx",
            "appType" => "APP_XCxxxx",
            "systemToken" => "098661xxxx",
            "formInstanceIdList" => [
...
func _main (args []*string) (_err error) {
  ...
  listFormRemarksHeaders := &dingtalkyida_1_0.ListFormRemarksHeaders{}
  listFormRemarksHeaders.XAcsDingtalkAccessToken = tea.String("<your access token>")
  listFormRemarksRequest := &dingtalkyida_1_0.ListFormRemarksRequest{
    FormUuid: tea.String("FORM-GX866xxxx"),
    AppType: tea.String("APP_XCxxxx"),
    SystemToken: tea.String("098661xxxx"),
    FormInstanceIdList: []*string{tea.String("FINST-GWxxx")},
  ...
  tryErr := func()(_e error) {
    ...
    _, _err = client.ListFormRemarksWithOptions(listFormRemarksRequest, listFormRemarksHeaders, &util.RuntimeOptions{})
    if _err != nil {
      return _err
    }
...
export default class Client {
  ...
  static async main(args: string[]): Promise<void> {
    ...
    let listFormRemarksHeaders = new $dingtalkyida_1_0.ListFormRemarksHeaders({ });
    listFormRemarksHeaders.xAcsDingtalkAccessToken = "<your access token>";
    let listFormRemarksRequest = new $dingtalkyida_1_0.ListFormRemarksRequest({
      formUuid: "FORM-GX866xxxx",
      appType: "APP_XCxxxx",
      systemToken: "098661xxxx",
      formInstanceIdList: [
    ...
    try {
      await client.listFormRemarksWithOptions(listFormRemarksRequest, listFormRemarksHeaders, new $Util.RuntimeOptions({ }));
    } catch (err) {
...
namespace AlibabaCloud.SDK.Sample
{
    public class Sample 
    {
        ...
        public static void Main(string[] args)
        {
            ...
            AlibabaCloud.SDK.Dingtalkyida_1_0.Models.ListFormRemarksHeaders listFormRemarksHeaders = new AlibabaCloud.SDK.Dingtalkyida_1_0.Models.ListFormRemarksHeaders();
            listFormRemarksHeaders.XAcsDingtalkAccessToken = "<your access token>";
            AlibabaCloud.SDK.Dingtalkyida_1_0.Models.ListFormRemarksRequest listFormRemarksRequest = new AlibabaCloud.SDK.Dingtalkyida_1_0.Models.ListFormRemarksRequest
            {
                FormUuid = "FORM-GX866xxxx",
                AppType = "APP_XCxxxx",
                SystemToken = "098661xxxx",
            ...
            try
            {
                client.ListFormRemarksWithOptions(listFormRemarksRequest, listFormRemarksHeaders, new AlibabaCloud.TeaUtil.Models.RuntimeOptions());
            }
            catch (TeaException err)
            {
...
int main(int argc, char *args[]) {
  ...
  shared_ptr<Alibabacloud_Dingtalkyida_1_0::ListFormRemarksHeaders> listFormRemarksHeaders = make_shared<Alibabacloud_Dingtalkyida_1_0::ListFormRemarksHeaders>();
  listFormRemarksHeaders->xAcsDingtalkAccessToken = make_shared<string>("<your access token>");
  shared_ptr<Alibabacloud_Dingtalkyida_1_0::ListFormRemarksRequest> listFormRemarksRequest = make_shared<Alibabacloud_Dingtalkyida_1_0::ListFormRemarksRequest>(map<string, boost::any>({
    {"formUuid", boost::any(string("FORM-GX866xxxx"))},
    {"appType", boost::any(string("APP_XCxxxx"))},
    {"systemToken", boost::any(string("098661xxxx"))},
    {"formInstanceIdList", boost::any(vector<string>({
      "FINST-GWxxx"
    }))},
    {"userId", boost::any(string("user001"))}
  }));
  try {
    client->listFormRemarksWithOptions(listFormRemarksRequest, listFormRemarksHeaders, make_shared<Darabonba_Util::RuntimeOptions>(Darabonba_Util::RuntimeOptions()));
  }
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| formRemarkVoMap | Map | 获取的结果详情。Map格式，key值为当前宜搭表单实例的Id，value值为某个评论的详情信息。      value内表示评论的详情信息，有以下字段：   - images：如果提交评论时上传了图片，该字段表示图片的信息，包含图片格式和名称等信息。 - creator：当前评论提交人的userId。 - formInstId：当前宜搭表单实例Id。 - files：如果提交评论时上传了文件，该字段表示文件的信息，包含文件格式和名称等信息。 - id：当前评论的标识。 - gmtCreate：评论提交的时间。 - content：评论的文本内容。 |
...

{
  "FINST-GW866Dxxxx" : [ {
    "creator" : "manager9358",
    "images" : "[]",
    "formInstId" : "FINSTxxxxNZVP1L0",
    "files" : "[]",
    "id" : 3261500001,
    "gmtCreate" : 1649387753000,
    "class" : "com.alibaba.work.tianshu.api.model.form.RemarkVO",
    "content" : "评论1"
  } ],
  "FINST-966MxxxXM" : [ {
    "creator" : "manager9358",
    "images" : "[]",
    "formInstId" : "FINST-96766xxxxKWWR3MX3CS41LXM6",
    "files" : "[]",
    "id" : 3261500003,
    "gmtCreate" : 1649387988000,
    "class" : "com.alibaba.work.tianshu.api.model.form.RemarkVO",
    "content" : "评论4"
  } ]
}
