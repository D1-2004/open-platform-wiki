...
当前接口已完成升级迭代且不再支持新应用申请，存量应用调用不受影响，建议未接入的开发者使用[获取文件详情](1083-gets-the-file-details.md)接口，已接入的开发者结合实际尽快完成迁移。
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| fileId | String | 否 | 调用[获取文件上传地址](1084-obtain-the-upload-url-of-a-file-1.md)返回的fileId。 |
...
public class Sample {
    ...
    public static void main(String[] args_) throws Exception {
        ...
        GetFileHeaders getFileHeaders = new GetFileHeaders();
        getFileHeaders.xAcsDingtalkAccessToken = "<your access token>";
        try {
            client.getFileWithOptions("049dxxxxxx", getFileHeaders, new RuntimeOptions());
...
class Sample:
    ...
    def main(
        ...
        get_file_headers = dingtalkesign__1__0_models.GetFileHeaders()
        get_file_headers.x_acs_dingtalk_access_token = '<your access token>'
        try:
            client.get_file_with_options('049dxxxxxx', get_file_headers, util_models.RuntimeOptions())
    ...
    async def main_async(
        ...
        get_file_headers.x_acs_dingtalk_access_token = '<your access token>'
        try:
            await client.get_file_with_options_async('049dxxxxxx', get_file_headers, util_models.RuntimeOptions())
        except Exception as err:
            if not UtilClient.empty(err.code) and not UtilClient.empty(err.message):
                # err 中含有 code 和 message 属性，可帮助开发定位问题
                pass
...
class Sample {
    ...
    public static function main($args){
        ...
        $getFileHeaders = new GetFileHeaders([]);
        $getFileHeaders->xAcsDingtalkAccessToken = "<your access token>";
        try {
            $client->getFileWithOptions("049dxxxxxx", $getFileHeaders, new RuntimeOptions([]));
        }
...
func _main (args []*string) (_err error) {
  ...
  getFileHeaders := &dingtalkesign_1_0.GetFileHeaders{}
  getFileHeaders.XAcsDingtalkAccessToken = tea.String("<your access token>")
  tryErr := func()(_e error) {
    ...
    _, _err = client.GetFileWithOptions(tea.String("049dxxxxxx"), getFileHeaders, &util.RuntimeOptions{})
    if _err != nil {
      return _err
    }
...
export default class Client {
  ...
  static async main(args: string[]): Promise<void> {
    ...
    let getFileHeaders = new $dingtalkesign_1_0.GetFileHeaders({ });
    getFileHeaders.xAcsDingtalkAccessToken = "<your access token>";
    try {
      await client.getFileWithOptions("049dxxxxxx", getFileHeaders, new $Util.RuntimeOptions({ }));
    } catch (err) {
...
namespace AlibabaCloud.SDK.Sample
{
    public class Sample 
    {
        ...
        public static void Main(string[] args)
        {
            ...
            AlibabaCloud.SDK.Dingtalkesign_1_0.Models.GetFileHeaders getFileHeaders = new AlibabaCloud.SDK.Dingtalkesign_1_0.Models.GetFileHeaders();
            getFileHeaders.XAcsDingtalkAccessToken = "<your access token>";
            try
            {
                client.GetFileWithOptions("049dxxxxxx", getFileHeaders, new AlibabaCloud.TeaUtil.Models.RuntimeOptions());
            }
            catch (TeaException err)
            {
...
int main(int argc, char *args[]) {
  ...
  shared_ptr<Alibabacloud_Dingtalkesign_1_0::GetFileHeaders> getFileHeaders = make_shared<Alibabacloud_Dingtalkesign_1_0::GetFileHeaders>();
  getFileHeaders->xAcsDingtalkAccessToken = make_shared<string>("<your access token>");
  try {
    client->getFileWithOptions(make_shared<string>("049dxxxxxx"), getFileHeaders, make_shared<Darabonba_Util::RuntimeOptions>(Darabonba_Util::RuntimeOptions()));
  }
