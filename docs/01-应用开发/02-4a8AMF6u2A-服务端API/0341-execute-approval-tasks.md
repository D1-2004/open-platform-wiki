...
调用本接口，用于同意或拒绝指定任务的宜搭审批，效果如下图所示：
...
| 字段 | 值 |
| --- | --- |
| HTTP URL | https://api.dingtalk.com/v1.0/yida/tasks/execute |
| HTTP Method | POST |
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| outResult | String | 是 | 审批结果。   - **AGREE**：同意。 - **DISAGREE**：拒绝。 |
| noExecuteExpressions | String | 否 | 是否不执行校验和关联操作，取值：   - **y**：不执行校验规则&关联操作 - **n**：执行校验规则&关联操作（默认值） |
| appType | String | 是 | 应用编码，可在宜搭的应用设置中获取，如下图所示： |
| formDataJson | String | 否 | 更新的表单值。 |
| systemToken | String | 是 | 应用密钥，可在宜搭的应用设置中获取，如下图所示： |
| language | String | 否 | 语言，取值：   - zh\_CN：中文（默认值） - en\_US：英文 |
| remark | String | 是 | 审批意见。 |
| processInstanceId | String | 是 | 实例ID，调用[获取多个表单实例ID](0325-api-searchformdataidlist-v2.md)接口获取。 |
| userId | String | 是 | 用户的userid，可调用[获取部门用户userid列表](0065-query-the-list-of-department-userids.md)接口获取。 |
| taskId | Long | 是 | 任务ID，可通过[获取实例ID列表](0311-api-getinstanceidlist-v2.md)接口获取返回值中的taskId。 |
| digitalSignUrl | String | 否 | 电子签名地址。审批人生成过电子签名后，可在签名展示页的接口返回值中查询到电子签名的url。 |
...
```
POST /v1.0/yida/tasks/execute HTTP/1.1
...
class Sample:
    ...
    def main(
        ...
        execute_task_headers = dingtalkyida__1__0_models.ExecuteTaskHeaders()
        execute_task_headers.x_acs_dingtalk_access_token = '<your access token>'
        execute_task_request = dingtalkyida__1__0_models.ExecuteTaskRequest(
            out_result='AGREE',
        ...
        try:
            client.execute_task_with_options(execute_task_request, execute_task_headers, util_models.RuntimeOptions())
    ...
    async def main_async(
        ...
        try:
            await client.execute_task_with_options_async(execute_task_request, execute_task_headers, util_models.RuntimeOptions())
        except Exception as err:
            if not UtilClient.empty(err.code) and not UtilClient.empty(err.message):
                # err 中含有 code 和 message 属性，可帮助开发定位问题
                pass
...
class Sample {
    ...
    public static function main($args){
        ...
        $executeTaskHeaders = new ExecuteTaskHeaders([]);
        $executeTaskHeaders->xAcsDingtalkAccessToken = "<your access token>";
        $executeTaskRequest = new ExecuteTaskRequest([
            "outResult" => "AGREE",
            "noExecuteExpressions" => "y",
            "appType" => "APP_PBKT0MFBEBTDO8T7SLVP",
            "formDataJson" => "未知",
...
func _main (args []*string) (_err error) {
  ...
  executeTaskHeaders := &dingtalkyida_1_0.ExecuteTaskHeaders{}
  executeTaskHeaders.XAcsDingtalkAccessToken = tea.String("<your access token>")
  executeTaskRequest := &dingtalkyida_1_0.ExecuteTaskRequest{
  ...
  tryErr := func()(_e error) {
    ...
    _, _err = client.ExecuteTaskWithOptions(executeTaskRequest, executeTaskHeaders, &util.RuntimeOptions{})
    if _err != nil {
      return _err
    }
...
export default class Client {
  ...
  static async main(args: string[]): Promise<void> {
    ...
    let executeTaskHeaders = new $dingtalkyida_1_0.ExecuteTaskHeaders({ });
    executeTaskHeaders.xAcsDingtalkAccessToken = "<your access token>";
    let executeTaskRequest = new $dingtalkyida_1_0.ExecuteTaskRequest({
      outResult: "AGREE",
      noExecuteExpressions: "y",
      appType: "APP_PBKT0MFBEBTDO8T7SLVP",
      formDataJson: "未知",
    ...
    try {
      await client.executeTaskWithOptions(executeTaskRequest, executeTaskHeaders, new $Util.RuntimeOptions({ }));
    } catch (err) {
...
namespace AlibabaCloud.SDK.Sample
{
    public class Sample 
    {
        ...
        public static void Main(string[] args)
        {
            ...
            AlibabaCloud.SDK.Dingtalkyida_1_0.Models.ExecuteTaskHeaders executeTaskHeaders = new AlibabaCloud.SDK.Dingtalkyida_1_0.Models.ExecuteTaskHeaders();
            executeTaskHeaders.XAcsDingtalkAccessToken = "<your access token>";
            AlibabaCloud.SDK.Dingtalkyida_1_0.Models.ExecuteTaskRequest executeTaskRequest = new AlibabaCloud.SDK.Dingtalkyida_1_0.Models.ExecuteTaskRequest
            {
                OutResult = "AGREE",
                NoExecuteExpressions = "y",
                AppType = "APP_PBKT0MFBEBTDO8T7SLVP",
            ...
            try
            {
                client.ExecuteTaskWithOptions(executeTaskRequest, executeTaskHeaders, new AlibabaCloud.TeaUtil.Models.RuntimeOptions());
            }
            catch (TeaException err)
            {
...
int main(int argc, char *args[]) {
  ...
  shared_ptr<Alibabacloud_Dingtalkyida_1_0::ExecuteTaskHeaders> executeTaskHeaders = make_shared<Alibabacloud_Dingtalkyida_1_0::ExecuteTaskHeaders>();
  executeTaskHeaders->xAcsDingtalkAccessToken = make_shared<string>("<your access token>");
  shared_ptr<Alibabacloud_Dingtalkyida_1_0::ExecuteTaskRequest> executeTaskRequest = make_shared<Alibabacloud_Dingtalkyida_1_0::ExecuteTaskRequest>(map<string, boost::any>({
    ...
    {"systemToken", boost::any(string("hexxyy"))},
    {"language", boost::any(string("zh_CN"))},
    {"remark", boost::any(string("确认同意"))},
    {"processInstanceId", boost::any(string("f30233fb-72e1-4af4-8cb8-c7e0ea9ee530"))},
    {"userId", boost::any(string("未知"))},
    {"taskId", boost::any(12002575)}
  }));
  try {
    client->executeTaskWithOptions(executeTaskRequest, executeTaskHeaders, make_shared<Darabonba_Util::RuntimeOptions>(Darabonba_Util::RuntimeOptions()));
  }
