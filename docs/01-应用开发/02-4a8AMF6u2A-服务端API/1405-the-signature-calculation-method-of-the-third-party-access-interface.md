...
doc_id: "HUXzMt4yKW"
updated_at: "2026-01-22 20:27:58"
---
...
本签名方法适用于 **第三方企业应用**（ISV 应用），第三方在调用[获取API调用凭证](https://open.dingtalk.com/document/app/obtains-the-enterprise-authorized-credential#topic-1936798)接口获取access\_token，或调用[获取企业授权信息](https://open.dingtalk.com/document/app/obtains-the-basic-information-of-an-enterprise#topic-1936797)接口获取授权企业信息时，钉钉会对请求进行签名验证，用以提升安全水位。
