...
| roomId | String | 是 | 会议室ID，可调用[查询会议室列表](0433-check-the-meeting-room-list.md)接口获取。 |
...
| groupId | Long | 否 | 会议室所属分组ID，可调用[查询会议室分组列表](0444-query-meeting-rooms-groups.md)接口获取。 |
