...
> Path: 应用开发 / 服务端API / 更多开放 > 智能硬件 > 设备管理 > 解绑设备
...
| device\_id | String | 否 | QWR45GT | 设备id，可通过[查询设备列表](1316-intelligent-hardware-list-query.md)接口获取。  **[!NOTE]**  该参数不能和`device_name`同时为空。 |
