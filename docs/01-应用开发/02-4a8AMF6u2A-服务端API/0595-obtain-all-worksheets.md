...
slug: "obtain-all-worksheets"
group: "应用开发"
tab: "服务端API"
breadcrumb: "文档/文件 > 表格 > 工作表 > 获取所有工作表"
doc_id: "FXPiPeytkB"
updated_at: "2025-09-12 17:20:17"
---

> Source: https://open.dingtalk.com/document/development/obtain-all-worksheets
> Path: 应用开发 / 服务端API / 文档/文件 > 表格 > 工作表 > 获取所有工作表
> Updated: 2025-09-12 17:20:17

# 获取所有工作表

调用本接口，获取指定表格内所有工作表的信息，包括工作表ID和工作表名称。
