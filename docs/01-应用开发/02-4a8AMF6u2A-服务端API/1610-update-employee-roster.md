...
> - 新接入的用户建议直接使用[更新员工花名册信息](https://open.dingtalk.com/document/orgapp/intelligent-personnel-update-employee-file-information)。
