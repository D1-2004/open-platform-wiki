...
> Path: 应用开发 / 服务端API / 历史文档（不推荐） > 文档/文件 > 钉盘 > 回收站 > 清空回收站
...
>
> - 如果未使用本接口，推荐使用存储产品[清空回收站](https://open.dingtalk.com/document/orgapp/empty-the-recycle-bin)接口。
> - 如果已使用本接口，建议您根据自身实际情况切换至推荐接口。

调用本接口，实现清空回收站，具体示例如下图所示。

![](https://img.alicdn.com/imgextra/i1/O1CN01yoF5Bf1Ur6btiZ0Hb_!!6000000002570-2-tps-327-637.png)
