...
slug: "get-permission-list"
group: "应用开发"
tab: "服务端API"
breadcrumb: "文档/文件 > 存储管理 > 权限管理 > 获取权限列表"
doc_id: "r72A0M0gXd"
updated_at: "2026-03-27 19:01:42"
---

> Source: https://open.dingtalk.com/document/development/get-permission-list
> Path: 应用开发 / 服务端API / 文档/文件 > 存储管理 > 权限管理 > 获取权限列表
> Updated: 2026-03-27 19:01:42

# 获取权限列表

调用本接口，根据指定id（文件uuid、知识库rootNodeId、知识库节点nodeId)和操作者id，查询用户文件权限列表。

## 请求

| **基本信息** | |
| --- | --- |
| HTTP URL | https://api.dingtalk.com/v2.0/storage/spaces/dentries/{dentryUuid}/permissions/query |
| HTTP Method | POST |
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| dentryUuid | String | 是 | 文件uuid，可调用[搜索文件](0638-search-for-files.md)接口或[获取dentryUuid信息](0672-api-getuuidbydentryid.md)接口，获取返回参数dentryUuid字段。 |

### 查询参数

| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| unionId | String | 是 | 用户unionId，调用[查询用户详情](0056-query-user-details.md)接口获取。 |
...
| maxResults | Integer | 否 | 分页大小，默认值30。 |
| filterRoleIds | Array of String | 否 | 过滤角色。 |
