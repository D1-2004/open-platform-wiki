...
doc_id: "ejrvhRT7s8"
updated_at: "2025-09-08 19:04:43"
---

> Source: https://open.dingtalk.com/document/development/delete-a-template
> Path: 应用开发 / 服务端API / 历史文档（不推荐） > OA审批 > 删除模板
> Updated: 2025-09-08 19:04:43
...
>
> - 如果未使用本接口，推荐使用新版规范[删除模板](https://open.dingtalk.com/document/orgapp/delete-a-template-new)接口。
...
| 名称 | 类型 | 是否必填 | 示例值 | 描述 |
| --- | --- | --- | --- | --- |
| access\_token | String | 是 | 6d1bxxxx | 调用该接口的应用凭证。   - 企业内部应用，通过[获取企业内部应用的access\_token](https://open.dingtalk.com/document/orgapp/obtain-orgapp-token)接口获取。 - 第三方企业应用，通过[获取第三方企业应用access\_token](https://open.dingtalk.com/document/isvapp/obtains-the-enterprise-authorized-credential)接口获取。 |
...
| agentid | Number | 是 | 123456 | 应用标识。可在[开发者后台](https://open-dev.dingtalk.com/)的应用详情页获取。应用的agentid。   - 企业内部应用可在[开发者后台](https://open-dev.dingtalk.com/)的应用详情页获取。  image - 第三方企业应用可调用[获取企业授权信息](https://open.dingtalk.com/document/isvapp/obtains-the-basic-information-of-an-enterprise)接口获取。   **[!IMPORTANT]**  如果是第三方企业应用必须指定该参数。 |
| process\_code | String | 是 | PROC-7C8BB7AE-E758-4Axxxx | 审批模板唯一码。   - 企业内部应用，调用[创建或更新审批模板](https://open.dingtalk.com/document/orgapp/save-approval-template)接口获取process\_code参数值。 - 第三方企业应用，调用[创建或更新审批模板](https://open.dingtalk.com/document/isvapp/save-approval-template)接口获取process\_code参数值。 |
