---
title: "知识库上传文件"
source_url: "https://open.dingtalk.com/document/development/upload-files-to-the-knowledge-base"
namespace: "development"
slug: "upload-files-to-the-knowledge-base"
group: "应用开发"
tab: "服务端API"
breadcrumb: "文档/文件 > 知识库 > 使用教程 > 知识库上传文件"
doc_id: "QqxqIgFzw5"
updated_at: "2026-03-27 19:05:57"
---

> Source: https://open.dingtalk.com/document/development/upload-files-to-the-knowledge-base
> Path: 应用开发 / 服务端API / 文档/文件 > 知识库 > 使用教程 > 知识库上传文件
> Updated: 2026-03-27 19:05:57
...
> **[!NOTE]**
>
> 接口请参考[获取文件上传信息](0672-obtain-file-upload-informations.md)文档说明，如何调用请参考[如何调用服务端API](https://open.dingtalk.com/document/development/how-to-call-apis)文档介绍。

**关键入参：**

- `parentDentryUuid`（Path）：上传目标目录的 dentryUuid。若上传到知识库根目录，可通过以下两种方式获取根目录的dentryUuid：

  - 调用[获取我的文档知识库信息](0560-get-my-documents.md)接口，取返回结果`workspace`下的`rootNodeId`字段值；
  - 调用[获取知识库列表](0557-get-knowledge-base-list.md)接口，取返回结果`workspaces`下的`rootNodeId`字段值。
...
> - 接口请参考[提交文件](0673-submittal-file.md)文档说明，如何调用请参考[如何调用服务端API](https://open.dingtalk.com/document/development/how-to-call-apis)文档介绍。
