...
slug: "api-pageautoflowlog"
group: "应用开发"
tab: "服务端API"
breadcrumb: "宜搭 > 服务日志 > 分页获取集成自动化日志列表"
doc_id: "w8nUwJeQRA"
updated_at: "2025-10-09 18:06:00"
---

> Source: https://open.dingtalk.com/document/development/api-pageautoflowlog
> Path: 应用开发 / 服务端API / 宜搭 > 服务日志 > 分页获取集成自动化日志列表
> Updated: 2025-10-09 18:06:00

# 分页获取集成自动化日志列表

调用本接口，根据表单信息数据，获取集成自动化日志列表。
...
| 字段 | 值 |
| --- | --- |
| HTTP URL | https://api.dingtalk.com/v1.0/yida/logs/automations/paginationQuery |
| HTTP Method | POST |
| 支持的应用类型 | appType-企业内部应用　appType-第三方企业应用 |
| 权限要求 | permission-Yida.App.Read-宜搭应用数据读权限 |
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| formUuid | String | 否 | 表单页面编码，可以在应用设置-部署运维中获取。 |
| pageNumber | Integer | 是 | 当前第几页，大于等于1。 |
| corpId | String | 是 | 钉钉组织 corpId。 |
| startTimeGMT | Long | 否 | 开始时间，格式为时间戳 |
| appType | String | 否 | 宜搭应用编码，可以在应用设置-部署运维中获取。 |
| processCode | String | 否 | 流程编码，可以在集成自动化详情页的链接中获取。 |
| endTimeGMT | Long | 否 | 结束时间，格式为时间戳，单位毫秒。 |
| pageSize | Integer | 是 | 分页大小，最大值为100。 |
| userId | String | 是 | 钉钉userId。 |
| token | String | 是 | corpId+userId+CorpToken做md5加密计算生成的字符串，每个企业有自己的唯一corpToken，可以在平台设置-基本信息中查看。 |
| status | Integer | 否 | 状态：   - **0**：运行中 - **2**：执行失败 - **3**：执行结束 |
...
```
POST /v1.0/yida/logs/automations/paginationQuery HTTP/1.1
...

{
  ...
  "pageNumber" : 1,
  "corpId" : "dingxxxxx",
  "startTimeGMT" : 1706716800000,
  "appType" : "APP_XCE0EVXS6DYG3YDYXXXX",
  "processCode" : "LPROC-CB666X91M65IFJLJ64GBIAXKP6YN3TRM4XXXXX",
  "endTimeGMT" : 1706889600000,
  "pageSize" : 100,
  "userId" : "12345",
  "token" : "B073AF673BEB044D59F8F612D65E1EA2",
  "status" : 0
}
```
...
public class Sample {
    ...
    public static void main(String[] args_) throws Exception {
        ...
        com.aliyun.dingtalkyida_1_0.models.PageAutoFlowLogHeaders pageAutoFlowLogHeaders = new com.aliyun.dingtalkyida_1_0.models.PageAutoFlowLogHeaders();
        pageAutoFlowLogHeaders.xAcsDingtalkAccessToken = "<your access token>";
        com.aliyun.dingtalkyida_1_0.models.PageAutoFlowLogRequest pageAutoFlowLogRequest = new com.aliyun.dingtalkyida_1_0.models.PageAutoFlowLogRequest()
                .setFormUuid("FORM-GX866MC1NC1VOFF6WVQW33FD16E23L3CPMKVKA")
                .setPageNumber(1)
                .setCorpId("dingxxxxx")
                .setStartTimeGMT(1706716800000L)
                .setAppType("APP_XCE0EVXS6DYG3YDYXXXX")
                .setProcessCode("LPROC-CB666X91M65IFJLJ64GBIAXKP6YN3TRM4XXXXX")
                .setEndTimeGMT(1706889600000L)
                .setPageSize(100)
                .setUserId("12345")
                .setToken("B073AF673BEB044D59F8F612D65E1EA2")
                .setStatus(0);
        try {
            client.pageAutoFlowLogWithOptions(pageAutoFlowLogRequest, pageAutoFlowLogHeaders, new com.aliyun.teautil.models.RuntimeOptions());
...
class Sample:
    ...
    def main(
        ...
        page_auto_flow_log_headers = dingtalkyida__1__0_models.PageAutoFlowLogHeaders()
        page_auto_flow_log_headers.x_acs_dingtalk_access_token = '<your access token>'
        page_auto_flow_log_request = dingtalkyida__1__0_models.PageAutoFlowLogRequest(
            form_uuid='FORM-GX866MC1NC1VOFF6WVQW33FD16E23L3CPMKVKA',
            page_number=1,
            corp_id='dingxxxxx',
            start_time_gmt=1706716800000,
            app_type='APP_XCE0EVXS6DYG3YDYXXXX',
            process_code='LPROC-CB666X91M65IFJLJ64GBIAXKP6YN3TRM4XXXXX',
            end_time_gmt=1706889600000,
            page_size=100,
            user_id='12345',
            token='B073AF673BEB044D59F8F612D65E1EA2',
            status=0
        ...
        try:
            client.page_auto_flow_log_with_options(page_auto_flow_log_request, page_auto_flow_log_headers, util_models.RuntimeOptions())
    ...
    async def main_async(
        ...
        try:
            await client.page_auto_flow_log_with_options_async(page_auto_flow_log_request, page_auto_flow_log_headers, util_models.RuntimeOptions())
        except Exception as err:
            if not UtilClient.empty(err.code) and not UtilClient.empty(err.message):
                # err 中含有 code 和 message 属性，可帮助开发定位问题
                pass
...
class Sample {
    ...
    public static function main($args){
        ...
        $pageAutoFlowLogHeaders = new PageAutoFlowLogHeaders([]);
        $pageAutoFlowLogHeaders->xAcsDingtalkAccessToken = "<your access token>";
        $pageAutoFlowLogRequest = new PageAutoFlowLogRequest([
            "formUuid" => "FORM-GX866MC1NC1VOFF6WVQW33FD16E23L3CPMKVKA",
            "pageNumber" => 1,
            "corpId" => "dingxxxxx",
            "startTimeGMT" => 1706716800000,
        ...
        try {
            $client->pageAutoFlowLogWithOptions($pageAutoFlowLogRequest, $pageAutoFlowLogHeaders, new RuntimeOptions([]));
        }
        catch (Exception $err) {
...
func _main (args []*string) (_err error) {
  ...
  pageAutoFlowLogHeaders := &dingtalkyida_1_0.PageAutoFlowLogHeaders{}
  pageAutoFlowLogHeaders.XAcsDingtalkAccessToken = tea.String("<your access token>")
  pageAutoFlowLogRequest := &dingtalkyida_1_0.PageAutoFlowLogRequest{
    FormUuid: tea.String("FORM-GX866MC1NC1VOFF6WVQW33FD16E23L3CPMKVKA"),
    PageNumber: tea.Int32(1),
    CorpId: tea.String("dingxxxxx"),
    StartTimeGMT: tea.Int64(1706716800000),
    AppType: tea.String("APP_XCE0EVXS6DYG3YDYXXXX"),
    ProcessCode: tea.String("LPROC-CB666X91M65IFJLJ64GBIAXKP6YN3TRM4XXXXX"),
    EndTimeGMT: tea.Int64(1706889600000),
    PageSize: tea.Int32(100),
    UserId: tea.String("12345"),
    Token: tea.String("B073AF673BEB044D59F8F612D65E1EA2"),
    Status: tea.Int32(0),
  }
  tryErr := func()(_e error) {
    ...
    _, _err = client.PageAutoFlowLogWithOptions(pageAutoFlowLogRequest, pageAutoFlowLogHeaders, &util.RuntimeOptions{})
    if _err != nil {
      return _err
    }
...
export default class Client {
  ...
  static async main(args: string[]): Promise<void> {
    ...
    let pageAutoFlowLogHeaders = new $dingtalkyida_1_0.PageAutoFlowLogHeaders({ });
    pageAutoFlowLogHeaders.xAcsDingtalkAccessToken = "<your access token>";
    let pageAutoFlowLogRequest = new $dingtalkyida_1_0.PageAutoFlowLogRequest({
      formUuid: "FORM-GX866MC1NC1VOFF6WVQW33FD16E23L3CPMKVKA",
      pageNumber: 1,
      corpId: "dingxxxxx",
      startTimeGMT: 1706716800000,
    ...
    try {
      await client.pageAutoFlowLogWithOptions(pageAutoFlowLogRequest, pageAutoFlowLogHeaders, new $Util.RuntimeOptions({ }));
    } catch (err) {
...
namespace AlibabaCloud.SDK.Sample
{
    public class Sample 
    {
        ...
        public static void Main(string[] args)
        {
            ...
            AlibabaCloud.SDK.Dingtalkyida_1_0.Models.PageAutoFlowLogHeaders pageAutoFlowLogHeaders = new AlibabaCloud.SDK.Dingtalkyida_1_0.Models.PageAutoFlowLogHeaders();
            pageAutoFlowLogHeaders.XAcsDingtalkAccessToken = "<your access token>";
            AlibabaCloud.SDK.Dingtalkyida_1_0.Models.PageAutoFlowLogRequest pageAutoFlowLogRequest = new AlibabaCloud.SDK.Dingtalkyida_1_0.Models.PageAutoFlowLogRequest
            {
                FormUuid = "FORM-GX866MC1NC1VOFF6WVQW33FD16E23L3CPMKVKA",
                PageNumber = 1,
                CorpId = "dingxxxxx",
            ...
            try
            {
                client.PageAutoFlowLogWithOptions(pageAutoFlowLogRequest, pageAutoFlowLogHeaders, new AlibabaCloud.TeaUtil.Models.RuntimeOptions());
            }
            catch (TeaException err)
            {
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| hasMoreData | Boolean | 是否还有数据。 |
| pageNumber | Long | 当前第几页。 |
| totalCount | Long | 总数量。 |
| data | Array | 数据。 |
| flag | String | 日志标识。 |
| appType | String | 宜搭应用编码。 |
| processCode | String | 流程编码。 |
| procInstanceId | String | 实例 id。 |
| srcProcInstanceId | String | 原始实例 id。 |
| elapsedTimeGMT | Long | 耗时（ms）。 |
| finishTimeGMT | String | 结束时间。 |
| srcProcInstanceFinishTimeGMT | String | 结束时间。 |
| status | Integer | 状态。 |
...

{
  ...
  "data" : [ {
    ...
    "processCode" : "LPROC-CB666X91M65IFJLJ64GBIAXKP6YN3TRM4XXXX",
    "procInstanceId" : "da7ae0f8-c8e2-4207-9f87-47bd887430ef",
    "srcProcInstanceId" : "da7ae0f8-c8e2-4207-9f87-47bd887430ef",
    "elapsedTimeGMT" : 10,
    "finishTimeGMT" : "2021-01-01",
    "srcProcInstanceFinishTimeGMT" : "1706889600000"
  } ]
}
```
