...
slug: "queries-multiple-process-instances"
group: "应用开发"
tab: "服务端API"
...
| 字段 | 值 |
| --- | --- |
| HTTP URL | https://api.dingtalk.com/v1.0/yida/processes/instances/searchWithIds |
| HTTP Method | GET |
...
| processInstanceIds | String | 是 | 流程实例ID列表，多个流程实例ID之间使用英文逗号分隔。 |
...
```
GET /v1.0/yida/processes/instances/searchWithIds?appType=APP_PBKTxxx&systemToken=hexxxx&userId=manager123&language=zh_CN&processInstanceIds=inst-123,inst-223 HTTP/1.1
...
public class Sample {
    ...
    public static void main(String[] args_) throws Exception {
        ...
        GetInstancesByIdListHeaders getInstancesByIdListHeaders = new GetInstancesByIdListHeaders();
        getInstancesByIdListHeaders.xAcsDingtalkAccessToken = "<your access token>";
        GetInstancesByIdListRequest getInstancesByIdListRequest = new GetInstancesByIdListRequest()
                .setAppType("APP_PBKTxxx")
                .setSystemToken("hexxxx")
                .setUserId("manager123")
                .setLanguage("zh_CN")
                .setProcessInstanceIds("inst-123,inst-223");
        try {
            client.getInstancesByIdListWithOptions(getInstancesByIdListRequest, getInstancesByIdListHeaders, new RuntimeOptions());
...
class Sample:
    ...
    def main(
        ...
        get_instances_by_id_list_headers = dingtalkyida__1__0_models.GetInstancesByIdListHeaders()
        get_instances_by_id_list_headers.x_acs_dingtalk_access_token = '<your access token>'
        get_instances_by_id_list_request = dingtalkyida__1__0_models.GetInstancesByIdListRequest(
            app_type='APP_PBKTxxx',
            system_token='hexxxx',
            user_id='manager123',
            language='zh_CN',
            process_instance_ids='inst-123,inst-223'
        )
        try:
            client.get_instances_by_id_list_with_options(get_instances_by_id_list_request, get_instances_by_id_list_headers, util_models.RuntimeOptions())
    ...
    async def main_async(
        ...
        try:
            await client.get_instances_by_id_list_with_options_async(get_instances_by_id_list_request, get_instances_by_id_list_headers, util_models.RuntimeOptions())
        except Exception as err:
            if not UtilClient.empty(err.code) and not UtilClient.empty(err.message):
                # err 中含有 code 和 message 属性，可帮助开发定位问题
                pass
...
class Sample {
    ...
    public static function main($args){
        ...
        $getInstancesByIdListHeaders = new GetInstancesByIdListHeaders([]);
        $getInstancesByIdListHeaders->xAcsDingtalkAccessToken = "<your access token>";
        $getInstancesByIdListRequest = new GetInstancesByIdListRequest([
            "appType" => "APP_PBKTxxx",
            "systemToken" => "hexxxx",
            "userId" => "manager123",
            "language" => "zh_CN",
            "processInstanceIds" => "inst-123,inst-223"
        ]);
        try {
            $client->getInstancesByIdListWithOptions($getInstancesByIdListRequest, $getInstancesByIdListHeaders, new RuntimeOptions([]));
        }
...
func _main (args []*string) (_err error) {
  ...
  getInstancesByIdListHeaders := &dingtalkyida_1_0.GetInstancesByIdListHeaders{}
  getInstancesByIdListHeaders.XAcsDingtalkAccessToken = tea.String("<your access token>")
  getInstancesByIdListRequest := &dingtalkyida_1_0.GetInstancesByIdListRequest{
    AppType: tea.String("APP_PBKTxxx"),
    SystemToken: tea.String("hexxxx"),
    UserId: tea.String("manager123"),
    Language: tea.String("zh_CN"),
    ProcessInstanceIds: tea.String("inst-123,inst-223"),
  }
  tryErr := func()(_e error) {
    ...
    _, _err = client.GetInstancesByIdListWithOptions(getInstancesByIdListRequest, getInstancesByIdListHeaders, &util.RuntimeOptions{})
    if _err != nil {
      return _err
    }
...
export default class Client {
  ...
  static async main(args: string[]): Promise<void> {
    ...
    let getInstancesByIdListHeaders = new $dingtalkyida_1_0.GetInstancesByIdListHeaders({ });
    getInstancesByIdListHeaders.xAcsDingtalkAccessToken = "<your access token>";
    let getInstancesByIdListRequest = new $dingtalkyida_1_0.GetInstancesByIdListRequest({
      appType: "APP_PBKTxxx",
      systemToken: "hexxxx",
      userId: "manager123",
      language: "zh_CN",
    ...
    try {
      await client.getInstancesByIdListWithOptions(getInstancesByIdListRequest, getInstancesByIdListHeaders, new $Util.RuntimeOptions({ }));
    } catch (err) {
...
namespace AlibabaCloud.SDK.Sample
{
    public class Sample 
    {
        ...
        public static void Main(string[] args)
        {
            ...
            try
            {
                client.GetInstancesByIdListWithOptions(getInstancesByIdListRequest, getInstancesByIdListHeaders, new AlibabaCloud.TeaUtil.Models.RuntimeOptions());
            }
            catch (TeaException err)
            {
...
int main(int argc, char *args[]) {
  ...
  shared_ptr<Alibabacloud_Dingtalkyida_1_0::GetInstancesByIdListHeaders> getInstancesByIdListHeaders = make_shared<Alibabacloud_Dingtalkyida_1_0::GetInstancesByIdListHeaders>();
  getInstancesByIdListHeaders->xAcsDingtalkAccessToken = make_shared<string>("<your access token>");
  shared_ptr<Alibabacloud_Dingtalkyida_1_0::GetInstancesByIdListRequest> getInstancesByIdListRequest = make_shared<Alibabacloud_Dingtalkyida_1_0::GetInstancesByIdListRequest>(map<string, boost::any>({
    ...
    {"processInstanceIds", boost::any(string("inst-123,inst-223"))}
  }));
  try {
    client->getInstancesByIdListWithOptions(getInstancesByIdListRequest, getInstancesByIdListHeaders, make_shared<Darabonba_Util::RuntimeOptions>(Darabonba_Util::RuntimeOptions()));
  }
