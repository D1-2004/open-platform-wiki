...
slug: "batch-update-of-component-values-in-form-instances"
group: "应用开发"
tab: "服务端API"
breadcrumb: "宜搭 > 表单 > 批量更新表单实例内的组件值"
doc_id: "SA3Vzd0gfn"
updated_at: "2026-04-22 20:34:30"
---

> Source: https://open.dingtalk.com/document/development/batch-update-of-component-values-in-form-instances
> Path: 应用开发 / 服务端API / 宜搭 > 表单 > 批量更新表单实例内的组件值
> Updated: 2026-04-22 20:34:30

# 批量更新表单实例内的组件值

调用本接口，根据宜搭表单实例Id，批量更新宜搭表单实例的组件值。
...
| 字段 | 值 |
| --- | --- |
| HTTP URL | https://api.dingtalk.com/v1.0/yida/forms/instances/components |
| HTTP Method | PUT |
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| noExecuteExpression | Boolean | 否 | 是否不触发表单绑定的校验规则、关联业务规则和第三方服务回调。   - **true**：不触发 - **false**：触发     该参数值传true可以降低API的耗时以及获得更大的单次更新数据量上限。 |
| formUuid | String | 是 | 表单的页面编码，该参数从宜搭应用中获取。 |
| updateFormDataJson | String | 是 | 用于更新表单实例的数据，格式参考[创建或更新表单数据格式说明](0363-instructions-for-creating-or-updating-form-data-format.md)。 |
...
| asynchronousExecution | Boolean | 否 | 是否需要宜搭服务端异步执行该任务。   - **true**：需要 - **false**：不需要 |
| formInstanceIdList | Array of String | 是 | 表单实例Id，调用[获取实例ID列表](0311-api-getinstanceidlist-v2.md)接口或者[获取多个表单实例ID](0325-api-searchformdataidlist-v2.md)接口获取。 |
...
```
PUT /v1.0/yida/forms/instances/components HTTP/1.1
Host:api.dingtalk.com
x-acs-dingtalk-access-token:ad9dxxxxaf91
Content-Type:application/json

{
  "noExecuteExpression" : true,
  "formUuid" : "FORM-GxxxxKVKA",
  "updateFormDataJson" : "{\"countrySelectField_l0c1cwiu\":[{\"value\":\"US\"}],\"addressField_l0c1cwiy\":{\"address\":\"111\",\"regionIds\":[460xxxx0,46xxxx27,46xxxx01],\"regionText\":[{\"en_US\":\"hai+nan+sheng\",\"zh_CN\":\"海南省\"},{\"en_US\":\"cheng+mai+xian\",\"zh_CN\":\"澄迈县\"},{\"en_US\":\"guo+ying+hong+gang+nong+chang\",\"zh_CN\":\"国营xxxx农场\"}]}}",
  "appType" : "APP_XCxxxxRD",
  "ignoreEmpty" : true,
  "systemToken" : "098xxxxWK7",
  "useLatestFormSchemaVersion" : false,
  "asynchronousExecution" : true,
  "formInstanceIdList" : [ "FINST-J8xxxxL24" ],
  "userId" : "dingxxxx2232",
  "env" : "vpc"
}
```
...
public class Sample {
    ...
    public static void main(String[] args_) throws Exception {
        ...
        com.aliyun.dingtalkyida_1_0.models.BatchUpdateFormDataByInstanceIdHeaders batchUpdateFormDataByInstanceIdHeaders = new com.aliyun.dingtalkyida_1_0.models.BatchUpdateFormDataByInstanceIdHeaders();
        batchUpdateFormDataByInstanceIdHeaders.xAcsDingtalkAccessToken = "<your access token>";
        com.aliyun.dingtalkyida_1_0.models.BatchUpdateFormDataByInstanceIdRequest batchUpdateFormDataByInstanceIdRequest = new com.aliyun.dingtalkyida_1_0.models.BatchUpdateFormDataByInstanceIdRequest()
                .setNoExecuteExpression(true)
                .setFormUuid("FORM-GxxxxKVKA")
                .setUpdateFormDataJson("{\"countrySelectField_l0c1cwiu\":[{\"value\":\"US\"}],\"addressField_l0c1cwiy\":{\"address\":\"111\",\"regionIds\":[460xxxx0,46xxxx27,46xxxx01],\"regionText\":[{\"en_US\":\"hai+nan+sheng\",\"zh_CN\":\"海南省\"},{\"en_US\":\"cheng+mai+xian\",\"zh_CN\":\"澄迈县\"},{\"en_US\":\"guo+ying+hong+gang+nong+chang\",\"zh_CN\":\"国营xxxx农场\"}]}}")
                .setAppType("APP_XCxxxxRD")
                .setIgnoreEmpty(true)
                .setSystemToken("098xxxxWK7")
                .setUseLatestFormSchemaVersion(false)
                .setAsynchronousExecution(true)
                .setFormInstanceIdList(java.util.Arrays.asList(
                    "FINST-J8xxxxL24"
                ))
                .setUserId("dingxxxx2232")
                .setEnv("vpc");
        try {
            client.batchUpdateFormDataByInstanceIdWithOptions(batchUpdateFormDataByInstanceIdRequest, batchUpdateFormDataByInstanceIdHeaders, new com.aliyun.teautil.models.RuntimeOptions());
...
class Sample:
    ...
    def main(
        ...
        batch_update_form_data_by_instance_id_request = dingtalkyida__1__0_models.BatchUpdateFormDataByInstanceIdRequest(
            ...
            form_uuid='FORM-GxxxxKVKA',
            update_form_data_json='{"countrySelectField_l0c1cwiu":[{"value":"US"}],"addressField_l0c1cwiy":{"address":"111","regionIds":[460xxxx0,46xxxx27,46xxxx01],"regionText":[{"en_US":"hai+nan+sheng","zh_CN":"海南省"},{"en_US":"cheng+mai+xian","zh_CN":"澄迈县"},{"en_US":"guo+ying+hong+gang+nong+chang","zh_CN":"国营xxxx农场"}]}}',
            app_type='APP_XCxxxxRD',
            ignore_empty=True,
            system_token='098xxxxWK7',
            use_latest_form_schema_version=False,
            asynchronous_execution=True,
            form_instance_id_list=[
                'FINST-J8xxxxL24'
            ],
            user_id='dingxxxx2232',
            env='vpc'
        )
        try:
...
class Sample {
    ...
    public static function main($args){
        ...
        $batchUpdateFormDataByInstanceIdHeaders = new BatchUpdateFormDataByInstanceIdHeaders([]);
        $batchUpdateFormDataByInstanceIdHeaders->xAcsDingtalkAccessToken = "<your access token>";
        $batchUpdateFormDataByInstanceIdRequest = new BatchUpdateFormDataByInstanceIdRequest([
            "noExecuteExpression" => true,
            "formUuid" => "FORM-GxxxxKVKA",
            "updateFormDataJson" => "{\"countrySelectField_l0c1cwiu\":[{\"value\":\"US\"}],\"addressField_l0c1cwiy\":{\"address\":\"111\",\"regionIds\":[460xxxx0,46xxxx27,46xxxx01],\"regionText\":[{\"en_US\":\"hai+nan+sheng\",\"zh_CN\":\"海南省\"},{\"en_US\":\"cheng+mai+xian\",\"zh_CN\":\"澄迈县\"},{\"en_US\":\"guo+ying+hong+gang+nong+chang\",\"zh_CN\":\"国营xxxx农场\"}]}}",
            "appType" => "APP_XCxxxxRD",
        ...
        try {
            $client->batchUpdateFormDataByInstanceIdWithOptions($batchUpdateFormDataByInstanceIdRequest, $batchUpdateFormDataByInstanceIdHeaders, new RuntimeOptions([]));
        }
        catch (Exception $err) {
...
func _main (args []*string) (_err error) {
  ...
  batchUpdateFormDataByInstanceIdRequest := &dingtalkyida_1_0.BatchUpdateFormDataByInstanceIdRequest{
    ...
    FormUuid: tea.String("FORM-GxxxxKVKA"),
    UpdateFormDataJson: tea.String("{\"countrySelectField_l0c1cwiu\":[{\"value\":\"US\"}],\"addressField_l0c1cwiy\":{\"address\":\"111\",\"regionIds\":[460xxxx0,46xxxx27,46xxxx01],\"regionText\":[{\"en_US\":\"hai+nan+sheng\",\"zh_CN\":\"海南省\"},{\"en_US\":\"cheng+mai+xian\",\"zh_CN\":\"澄迈县\"},{\"en_US\":\"guo+ying+hong+gang+nong+chang\",\"zh_CN\":\"国营xxxx农场\"}]}}"),
    AppType: tea.String("APP_XCxxxxRD"),
    IgnoreEmpty: tea.Bool(true),
    SystemToken: tea.String("098xxxxWK7"),
    UseLatestFormSchemaVersion: tea.Bool(false),
    AsynchronousExecution: tea.Bool(true),
    FormInstanceIdList: []*string{tea.String("FINST-J8xxxxL24")},
    UserId: tea.String("dingxxxx2232"),
    Env: tea.String("vpc"),
  }
...
class Client {
  ...
  static async main(args) {
    ...
    let batchUpdateFormDataByInstanceIdHeaders = new dingtalkyida_1_0.BatchUpdateFormDataByInstanceIdHeaders({ });
    batchUpdateFormDataByInstanceIdHeaders.xAcsDingtalkAccessToken = '<your access token>';
    let batchUpdateFormDataByInstanceIdRequest = new dingtalkyida_1_0.BatchUpdateFormDataByInstanceIdRequest({
      noExecuteExpression: true,
      formUuid: 'FORM-GxxxxKVKA',
      updateFormDataJson: '{"countrySelectField_l0c1cwiu":[{"value":"US"}],"addressField_l0c1cwiy":{"address":"111","regionIds":[460xxxx0,46xxxx27,46xxxx01],"regionText":[{"en_US":"hai+nan+sheng","zh_CN":"海南省"},{"en_US":"cheng+mai+xian","zh_CN":"澄迈县"},{"en_US":"guo+ying+hong+gang+nong+chang","zh_CN":"国营xxxx农场"}]}}',
      appType: 'APP_XCxxxxRD',
    ...
    try {
      await client.batchUpdateFormDataByInstanceIdWithOptions(batchUpdateFormDataByInstanceIdRequest, batchUpdateFormDataByInstanceIdHeaders, new Util.RuntimeOptions({ }));
    } catch (err) {
...
namespace AlibabaCloud.SDK.Sample
{
    public class Sample 
    {
        ...
        public static void Main(string[] args)
        {
            ...
            AlibabaCloud.SDK.Dingtalkyida_1_0.Models.BatchUpdateFormDataByInstanceIdHeaders batchUpdateFormDataByInstanceIdHeaders = new AlibabaCloud.SDK.Dingtalkyida_1_0.Models.BatchUpdateFormDataByInstanceIdHeaders();
            batchUpdateFormDataByInstanceIdHeaders.XAcsDingtalkAccessToken = "<your access token>";
            AlibabaCloud.SDK.Dingtalkyida_1_0.Models.BatchUpdateFormDataByInstanceIdRequest batchUpdateFormDataByInstanceIdRequest = new AlibabaCloud.SDK.Dingtalkyida_1_0.Models.BatchUpdateFormDataByInstanceIdRequest
            {
                NoExecuteExpression = true,
                FormUuid = "FORM-GxxxxKVKA",
                UpdateFormDataJson = "{\"countrySelectField_l0c1cwiu\":[{\"value\":\"US\"}],\"addressField_l0c1cwiy\":{\"address\":\"111\",\"regionIds\":[460xxxx0,46xxxx27,46xxxx01],\"regionText\":[{\"en_US\":\"hai+nan+sheng\",\"zh_CN\":\"海南省\"},{\"en_US\":\"cheng+mai+xian\",\"zh_CN\":\"澄迈县\"},{\"en_US\":\"guo+ying+hong+gang+nong+chang\",\"zh_CN\":\"国营xxxx农场\"}]}}",
            ...
            try
            {
                client.BatchUpdateFormDataByInstanceIdWithOptions(batchUpdateFormDataByInstanceIdRequest, batchUpdateFormDataByInstanceIdHeaders, new AlibabaCloud.TeaUtil.Models.RuntimeOptions());
            }
            catch (TeaException err)
            {
