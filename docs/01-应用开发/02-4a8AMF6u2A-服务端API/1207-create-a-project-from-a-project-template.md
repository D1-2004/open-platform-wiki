...
> Path: 应用开发 / 服务端API / Teambition 项目管理 > 项目 > 根据项目模板创建项目
...
| --- | --- | --- | --- |
| name | String | 是 | 项目名字。 |
| templateId | String | 是 | 模板Id，调用[搜索企业项目模板](1206-search-for-enterprise-custom-templates-by-project-template-name.md)接口获取id参数值。 |
