---
title: "根据ID列表批量获取跟进记录数据"
source_url: "https://open.dingtalk.com/document/development/dingtalk-the-primary-data-of-apsara-stack-agility-paas-allows-you"
namespace: "development"
slug: "dingtalk-the-primary-data-of-apsara-stack-agility-paas-allows-you"
group: "应用开发"
tab: "服务端API"
breadcrumb: "更多开放 > 客户管理（官方CRM） > 跟进记录 > 根据ID列表批量获取跟进记录数据"
doc_id: "5pJtsbIw7S"
updated_at: "2026-06-08 09:53:22"
---

> Source: https://open.dingtalk.com/document/development/dingtalk-the-primary-data-of-apsara-stack-agility-paas-allows-you
> Path: 应用开发 / 服务端API / 更多开放 > 客户管理（官方CRM） > 跟进记录 > 根据ID列表批量获取跟进记录数据
> Updated: 2026-06-08 09:53:22

# 根据ID列表批量获取跟进记录数据

调用本接口，根据实例ID列表批量获取跟进记录数据，最多可一次获取200条数据。

## **请求**

| **基本信息** | |
| --- | --- |
| HTTP URL | https://oapi.dingtalk.com/topapi/crm/objectdata/followrecord/list |
| HTTP Method | POST |
...
| 名称 | 类型 | 是否必填 | 示例值 | 描述 |
| --- | --- | --- | --- | --- |
| access\_token | String | 是 | dc73axxxx | 调用该接口的应用凭证，通过[获取企业内部应用的access\_token](1443-obtain-orgapp-token.md)接口获取。 |
...
| data\_id\_list | String | 是 | INST\_XX1,INST\_XX2 | 数据ID列表，可通过[根据指定条件查询跟进记录数据](1370-query-and-dingtalk-data-of-track-records-in-apsara-stack.md)接口获取instance\_id参数值，多个用英文逗号隔开。 |
...
```
curl -X POST "https://oapi.dingtalk.com/topapi/crm/objectdata/followrecord/list" \
...
req=dingtalk.api.OapiCrmObjectdataFollowrecordListRequest("https://oapi.dingtalk.com/topapi/crm/objectdata/followrecord/list")
...
$req = new OapiCrmObjectdataFollowrecordListRequest;
$req->setCurrentOperatorUserid("ding_userid");
$req->setDataIdList("instance_id");
$resp = $c->execute($req, $access_token, "https://oapi.dingtalk.com/topapi/crm/objectdata/followrecord/list");
```

C#

```
IDingTalkClient client = new DefaultDingTalkClient("https://oapi.dingtalk.com/topapi/crm/objectdata/followrecord/list");
OapiCrmObjectdataFollowrecordListRequest req = new OapiCrmObjectdataFollowrecordListRequest();
req.CurrentOperatorUserid = "user01";
req.DataIdList = "INST_XX1,INST_XX2";
OapiCrmObjectdataFollowrecordListResponse rsp = client.Execute(req, accessToken);
