...
slug: "query-a-calendar"
group: "应用开发"
tab: "服务端API"
breadcrumb: "日程 > 日历 > 查询日历"
doc_id: "G6AvqKZXRK"
updated_at: "2025-09-11 21:02:37"
---

> Source: https://open.dingtalk.com/document/development/query-a-calendar
> Path: 应用开发 / 服务端API / 日程 > 日历 > 查询日历
> Updated: 2025-09-11 21:02:37
...
| 字段 | 值 |
| --- | --- |
| HTTP URL | https://api.dingtalk.com/v1.0/calendar/users/{userId}/calendars |
| HTTP Method | GET |
| 支持的应用类型 | appType-企业内部应用　appType-第三方企业应用　appType-第三方个人应用 |
| 权限要求 | permission-Calendar.Event.Read-日历应用中日历读权限 |
