...
>
> - 如果未使用本接口，推荐使用存储产品[移动文件或文件夹](https://open.dingtalk.com/document/orgapp/move-a-file-or-folder)接口。
> - 如果已使用本接口，建议您根据自身实际情况切换至推荐接口。

调用本接口，实现移动文件（夹），以移动文件为例，具体示例如下图所示。

![](https://img.alicdn.com/imgextra/i2/O1CN01h1Z02S1Js3f3cXzw5_!!6000000001083-2-tps-327-652.png)
