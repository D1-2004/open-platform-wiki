---
title: "查询表单数据"
source_url: "https://open.dingtalk.com/document/development/query-form-data"
namespace: "development"
slug: "query-form-data"
group: "应用开发"
tab: "服务端API"
breadcrumb: "历史文档（不推荐） > 宜搭 > 表单 > 查询表单数据"
doc_id: "F7jKVMacZh"
updated_at: "2025-09-08 19:03:40"
---

> Source: https://open.dingtalk.com/document/development/query-form-data
> Path: 应用开发 / 服务端API / 历史文档（不推荐） > 宜搭 > 表单 > 查询表单数据
> Updated: 2025-09-08 19:03:40
...
>
> - 如果未使用本接口，推荐使用[查询表单数据](https://open.dingtalk.com/document/orgapp/api-getformdatabyid-v2)接口。
> - 如果已使用本接口，建议您根据自身实际情况评估是否切换至推荐接口。

![](https://img.alicdn.com/imgextra/i1/O1CN01EFCwje1jSZdi7rLtu_!!6000000004547-2-tps-930-434.png)
...
```
GET /v1.0/yida/forms/instances/{id}?appType=String&systemToken=String&userId=String&language=String HTTP/1.1
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| id | String | 否 | 表单实例ID。   - 企业内部应用，可以通过[获取多个表单实例ID](https://open.dingtalk.com/document/orgapp/obtain-the-ids-of-multiple-form-instances)接口获取。 - 第三方企业应用，通过[获取多个表单实例ID](https://open.dingtalk.com/document/isvapp/obtain-the-ids-of-multiple-form-instances)接口获取。 |

## Query参数

| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| appType | String | 否 | 应用编码。 |
| systemToken | String | 否 | 应用秘钥。 |
...
| formData | Map | 表单数据详情。 示例值：   ``` {     "numberField_jcr0069o": 1,     "multiSelectField_jcr0069s": [         "选项三"     ],     "textareaField_jcr0069n": "duohang",     "employeeField_jcr0069x": [         "xxxx"     ],     "departmentField_jcr0069z": "xxxx",     "cascadeDate_jcr0069u": [         "1514736000000"     ],     "cascadeSelectField_jcr006a0": [         "part"     ],     "tableField_jcr006a1": [         {             "departmentField_jcr006ad": "xxxx",             "cascadeDate_jcr006aa": [                 "1514736000000"             ],             "selectField_jcr006a6": "选项三",             "citySelectField_jcr006ac": [                 "天津",                 "天津市",                 "河东区"             ],             "radioField_jcr006a5": "选项二",             "employeeField_jcr006ab": [                 "xxxxxx"             ],             "dateField_jcr006a9": 1517328000000,             "textField_jcr006a2": "明细下单行",             "textareaField_jcr006a3": "明细下多行",             "cascadeSelectField_jcr006ae": [                 "product"             ],             "numberField_jcr006a4": 2,             "checkboxField_jcr006a7": [                 "选项一"             ],             "multiSelectField_jcr006a8": [                 "选项一"             ]         }     ],     "selectField_jcr0069q": "选项一",     "citySelectField_jcr0069y": [         "北京",         "北京市",         "东城区"     ],     "checkboxField_jcr0069r": [         "选项三",         "选项二"     ],     "textField_jcr0069m": "danhang",     "radioField_jcr0069p": "选项一",     "dateField_jcr0069t": 1516636800000 } ``` |
...
```
GET /v1.0/yida/forms/instances/FORM_INST_12345?appType=APP_PBKT0MFBEBTDO8T7SLVP&systemToken=hexxxx&userId=user123&language=zh_CN HTTP/1.1
Host:api.dingtalk.com
...
public class Sample {
    ...
    public static void main(String[] args_) throws Exception {
        ...
        getFormDataByIDHeaders.xAcsDingtalkAccessToken = "<your access token>";
        GetFormDataByIDRequest getFormDataByIDRequest = new GetFormDataByIDRequest()
                ...
                .setLanguage("zh_CN");
        try {
            client.getFormDataByIDWithOptions("FORM_INST_12345", getFormDataByIDRequest, getFormDataByIDHeaders, new RuntimeOptions());
...
class Sample:
    ...
    def main(
        ...
        get_form_data_by_idheaders = dingtalkyida__1__0_models.GetFormDataByIDHeaders()
        get_form_data_by_idheaders.x_acs_dingtalk_access_token = '<your access token>'
        get_form_data_by_idrequest = dingtalkyida__1__0_models.GetFormDataByIDRequest(
...
func _main (args []*string) (_err error) {
  ...
  getFormDataByIDHeaders := &dingtalkyida_1_0.GetFormDataByIDHeaders{}
  getFormDataByIDHeaders.XAcsDingtalkAccessToken = tea.String("<your access token>")
  getFormDataByIDRequest := &dingtalkyida_1_0.GetFormDataByIDRequest{
...
export default class Client {
  ...
  static async main(args: string[]): Promise<void> {
    ...
    let getFormDataByIDHeaders = new $dingtalkyida_1_0.GetFormDataByIDHeaders({ });
    getFormDataByIDHeaders.xAcsDingtalkAccessToken = "<your access token>";
    let getFormDataByIDRequest = new $dingtalkyida_1_0.GetFormDataByIDRequest({
      appType: "APP_PBKT0MFBEBTDO8T7SLVP",
      systemToken: "hexxxx",
      userId: "user123",
      language: "zh_CN",
    ...
    try {
      await client.getFormDataByIDWithOptions("FORM_INST_12345", getFormDataByIDRequest, getFormDataByIDHeaders, new $Util.RuntimeOptions({ }));
    } catch (err) {
...
namespace AlibabaCloud.SDK.Sample
{
    public class Sample 
    {
        ...
        public static void Main(string[] args)
        {
            ...
            try
            {
                client.GetFormDataByIDWithOptions("FORM_INST_12345", getFormDataByIDRequest, getFormDataByIDHeaders, new AlibabaCloud.TeaUtil.Models.RuntimeOptions());
            }
            catch (TeaException err)
            {
...
int main(int argc, char *args[]) {
  ...
  shared_ptr<Alibabacloud_Dingtalkyida_1_0::GetFormDataByIDHeaders> getFormDataByIDHeaders = make_shared<Alibabacloud_Dingtalkyida_1_0::GetFormDataByIDHeaders>();
  getFormDataByIDHeaders->xAcsDingtalkAccessToken = make_shared<string>("<your access token>");
  shared_ptr<Alibabacloud_Dingtalkyida_1_0::GetFormDataByIDRequest> getFormDataByIDRequest = make_shared<Alibabacloud_Dingtalkyida_1_0::GetFormDataByIDRequest>(map<string, boost::any>({
  ...
  try {
    client->getFormDataByIDWithOptions(make_shared<string>("FORM_INST_12345"), getFormDataByIDRequest, getFormDataByIDHeaders, make_shared<Darabonba_Util::RuntimeOptions>(Darabonba_Util::RuntimeOptions()));
  }
