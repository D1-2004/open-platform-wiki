---
title: "保存表单数据"
source_url: "https://open.dingtalk.com/document/development/save-form-data"
namespace: "development"
slug: "save-form-data"
group: "应用开发"
tab: "服务端API"
breadcrumb: "历史文档（不推荐） > 宜搭 > 表单 > 保存表单数据"
doc_id: "3CAg3nHy6a"
updated_at: "2025-09-08 19:03:39"
---

> Source: https://open.dingtalk.com/document/development/save-form-data
> Path: 应用开发 / 服务端API / 历史文档（不推荐） > 宜搭 > 表单 > 保存表单数据
> Updated: 2025-09-08 19:03:39
...
>
> - 如果未使用本接口，推荐使用[保存表单数据](https://open.dingtalk.com/document/orgapp/api-saveformdata-v2)接口。
> - 如果已使用本接口，建议您根据自身实际情况评估是否切换至推荐接口。

![](https://img.alicdn.com/imgextra/i1/O1CN01b48G2B27PPgcQLVBX_!!6000000007789-2-tps-948-304.png)
...
public class Sample {
    ...
    public static void main(String[] args_) throws Exception {
        ...
        saveFormDataHeaders.xAcsDingtalkAccessToken = "<your access token>";
        ...
        try {
            client.saveFormDataWithOptions(saveFormDataRequest, saveFormDataHeaders, new RuntimeOptions());
...
func _main (args []*string) (_err error) {
  ...
  saveFormDataHeaders := &dingtalkyida_1_0.SaveFormDataHeaders{}
  saveFormDataHeaders.XAcsDingtalkAccessToken = tea.String("<your access token>")
  saveFormDataRequest := &dingtalkyida_1_0.SaveFormDataRequest{
...
export default class Client {
  ...
  static async main(args: string[]): Promise<void> {
    ...
    let saveFormDataHeaders = new $dingtalkyida_1_0.SaveFormDataHeaders({ });
    saveFormDataHeaders.xAcsDingtalkAccessToken = "<your access token>";
    let saveFormDataRequest = new $dingtalkyida_1_0.SaveFormDataRequest({
      appType: "APP_PBKxxx",
      systemToken: "hexxxx",
      userId: "manager123",
      language: "zh_CN",
    ...
    try {
      await client.saveFormDataWithOptions(saveFormDataRequest, saveFormDataHeaders, new $Util.RuntimeOptions({ }));
    } catch (err) {
...
namespace AlibabaCloud.SDK.Sample
{
    public class Sample 
    {
        ...
        public static void Main(string[] args)
        {
            ...
            try
            {
                client.SaveFormDataWithOptions(saveFormDataRequest, saveFormDataHeaders, new AlibabaCloud.TeaUtil.Models.RuntimeOptions());
            }
            catch (TeaException err)
            {
...
int main(int argc, char *args[]) {
  ...
  shared_ptr<Alibabacloud_Dingtalkyida_1_0::SaveFormDataHeaders> saveFormDataHeaders = make_shared<Alibabacloud_Dingtalkyida_1_0::SaveFormDataHeaders>();
  saveFormDataHeaders->xAcsDingtalkAccessToken = make_shared<string>("<your access token>");
  shared_ptr<Alibabacloud_Dingtalkyida_1_0::SaveFormDataRequest> saveFormDataRequest = make_shared<Alibabacloud_Dingtalkyida_1_0::SaveFormDataRequest>(map<string, boost::any>({
    ...
    {"formUuid", boost::any(string("FORM-EF6Y4G8WO2FN0SUB43TDQ3CGC3FMFQ1G9400RCJ3"))},
    {"formDataJson", boost::any(string("{"textField_jcpm6agt": "单行","employeeField_jcos0sar": ["workno"]}"))}
  }));
  try {
    client->saveFormDataWithOptions(saveFormDataRequest, saveFormDataHeaders, make_shared<Darabonba_Util::RuntimeOptions>(Darabonba_Util::RuntimeOptions()));
  }
