...
slug: "obtain-the-userid-of-your-mobile-phone-number"
group: "应用开发"
tab: "服务端API"
breadcrumb: "通讯录管理 > 企业账号 > 根据手机号查询企业账号用户"
doc_id: "KrmYHDXZyf"
...
> Path: 应用开发 / 服务端API / 通讯录管理 > 企业账号 > 根据手机号查询企业账号用户
> Updated: 2026-05-27 13:09:09
...
| support\_exclusive\_account\_search | Boolean | 是 | true | 是否支持通过手机号搜索企业账号。   - **true**：支持。 - **fasle**：不支持。   **[!NOTE]**     - 仅适用于企业账号。 - 仅支持搜索当前企业创建的企业账号。 |
...
| exclusive\_account\_userid\_list | String[] | ["zxxxx","lixxxi"] | 企业账号员工的userId列表。  **[!NOTE]**  只返回由当前组织创建的企业账号。 |
