...
doc_id: "OpkayGkV72"
updated_at: "2026-06-08 09:48:11"
---
...
| 名称 | 类型 | 是否必填 | 示例值 | 描述 |
| --- | --- | --- | --- | --- |
| super\_id | Number | 是 | 4240018 | 校区ID，可调用[获取部门列表](1146-obtains-the-department-node-list.md)接口获取dept\_type为campus时的dept\_id参数值。 |
