...
doc_id: "610NIo2cBV"
updated_at: "2026-05-29 09:13:47"
---
...
| 名称 | 类型 | 是否必填 | 示例值 | 描述 |
| --- | --- | --- | --- | --- |
| open\_conversation\_id | String | 是 | cid9FTRQSLo+s\*\*\*\*\*== | 群ID，调用[创建群](1461-create-a-scene-group-v2.md)接口获取`open_conversation_id`参数值。 |
