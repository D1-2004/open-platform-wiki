...
doc_id: "uC2iCBdMvY"
updated_at: "2025-09-08 19:04:40"
---
...
>
> - 如果未使用本接口，推荐使用新版规范[同意或拒绝审批任务](https://open.dingtalk.com/document/orgapp/approve-or-reject-the-approval-task)接口。
> - 如果已使用本接口，建议您根据自身实际情况评估是否切换至推荐接口。

调用本接口，可以看到审批节点对应审批人的审批结果。以同意为例，如下图所示。![同意或拒绝](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/9494796361/p352455.png)
...
| process\_instance\_id | String | 是 | 88c2fxxxxx | 审批实例id，可通过调用[获取审批实例ID列表](https://open.dingtalk.com/document/orgapp/operation-to-retrieve-a-list-of)接口获取。 |
...
| actioner\_userid | String | 是 | user123 | 操作人userid，可通过调用[获取单个审批实例详情](https://open.dingtalk.com/document/orgapp/obtains-the-details-of-a-single-approval-instance)接口获取。 |
| task\_id | Number | 是 | 67583405630 | 任务节点id，可通过调用[获取单个审批实例详情](https://open.dingtalk.com/document/orgapp/obtains-the-details-of-a-single-approval-instance)接口获取。 |
