...
slug: "get-a-list-of-form-component-definitions"
group: "应用开发"
tab: "服务端API"
breadcrumb: "宜搭 > 表单 > 获取表单组件定义列表"
doc_id: "mxuXJv0Ogw"
updated_at: "2025-10-09 18:05:39"
---

> Source: https://open.dingtalk.com/document/development/get-a-list-of-form-component-definitions
> Path: 应用开发 / 服务端API / 宜搭 > 表单 > 获取表单组件定义列表
> Updated: 2025-10-09 18:05:39
...
| 字段 | 值 |
| --- | --- |
| HTTP URL | https://api.dingtalk.com/v1.0/yida/forms/definitions/{appType}/{formUuid} |
| HTTP Method | GET |
...
```
GET /v1.0/yida/forms/definitions/APP_PBKT0MFBEBTDO8T7SLVP/FORM-EFxxx?systemToken=hexxxx&userId=manager123&language=zh_CN HTTP/1.1
...
public class Sample {
    ...
    public static void main(String[] args_) throws Exception {
        ...
        GetFormComponentDefinitionListHeaders getFormComponentDefinitionListHeaders = new GetFormComponentDefinitionListHeaders();
        getFormComponentDefinitionListHeaders.xAcsDingtalkAccessToken = "<your access token>";
        GetFormComponentDefinitionListRequest getFormComponentDefinitionListRequest = new GetFormComponentDefinitionListRequest()
                .setSystemToken("hexxxx")
                .setUserId("manager123")
                .setLanguage("zh_CN");
        try {
            client.getFormComponentDefinitionListWithOptions("APP_PBKT0MFBEBTDO8T7SLVP", "FORM-EFxxx", getFormComponentDefinitionListRequest, getFormComponentDefinitionListHeaders, new RuntimeOptions());
...
class Sample:
    ...
    def main(
        ...
        get_form_component_definition_list_headers.x_acs_dingtalk_access_token = '<your access token>'
        ...
        try:
            client.get_form_component_definition_list_with_options('APP_PBKT0MFBEBTDO8T7SLVP', 'FORM-EFxxx', get_form_component_definition_list_request, get_form_component_definition_list_headers, util_models.RuntimeOptions())
    ...
    async def main_async(
        ...
        try:
            await client.get_form_component_definition_list_with_options_async('APP_PBKT0MFBEBTDO8T7SLVP', 'FORM-EFxxx', get_form_component_definition_list_request, get_form_component_definition_list_headers, util_models.RuntimeOptions())
        except Exception as err:
            if not UtilClient.empty(err.code) and not UtilClient.empty(err.message):
                # err 中含有 code 和 message 属性，可帮助开发定位问题
                pass
...
class Sample {
    ...
    public static function main($args){
        ...
        $getFormComponentDefinitionListHeaders = new GetFormComponentDefinitionListHeaders([]);
        $getFormComponentDefinitionListHeaders->xAcsDingtalkAccessToken = "<your access token>";
        $getFormComponentDefinitionListRequest = new GetFormComponentDefinitionListRequest([
            "systemToken" => "hexxxx",
            "userId" => "manager123",
            "language" => "zh_CN"
        ]);
...
func _main (args []*string) (_err error) {
  ...
  getFormComponentDefinitionListHeaders := &dingtalkyida_1_0.GetFormComponentDefinitionListHeaders{}
  getFormComponentDefinitionListHeaders.XAcsDingtalkAccessToken = tea.String("<your access token>")
  getFormComponentDefinitionListRequest := &dingtalkyida_1_0.GetFormComponentDefinitionListRequest{
  ...
  tryErr := func()(_e error) {
    ...
    _, _err = client.GetFormComponentDefinitionListWithOptions(tea.String("APP_PBKT0MFBEBTDO8T7SLVP"), tea.String("FORM-EFxxx"), getFormComponentDefinitionListRequest, getFormComponentDefinitionListHeaders, &util.RuntimeOptions{})
    if _err != nil {
      return _err
    }
...
export default class Client {
  ...
  static async main(args: string[]): Promise<void> {
    ...
    let getFormComponentDefinitionListHeaders = new $dingtalkyida_1_0.GetFormComponentDefinitionListHeaders({ });
    getFormComponentDefinitionListHeaders.xAcsDingtalkAccessToken = "<your access token>";
    let getFormComponentDefinitionListRequest = new $dingtalkyida_1_0.GetFormComponentDefinitionListRequest({
      systemToken: "hexxxx",
      userId: "manager123",
      language: "zh_CN",
    });
    try {
      await client.getFormComponentDefinitionListWithOptions("APP_PBKT0MFBEBTDO8T7SLVP", "FORM-EFxxx", getFormComponentDefinitionListRequest, getFormComponentDefinitionListHeaders, new $Util.RuntimeOptions({ }));
    } catch (err) {
...
namespace AlibabaCloud.SDK.Sample
{
    public class Sample 
    {
        ...
        public static void Main(string[] args)
        {
            ...
            AlibabaCloud.SDK.Dingtalkyida_1_0.Models.GetFormComponentDefinitionListHeaders getFormComponentDefinitionListHeaders = new AlibabaCloud.SDK.Dingtalkyida_1_0.Models.GetFormComponentDefinitionListHeaders();
            getFormComponentDefinitionListHeaders.XAcsDingtalkAccessToken = "<your access token>";
            AlibabaCloud.SDK.Dingtalkyida_1_0.Models.GetFormComponentDefinitionListRequest getFormComponentDefinitionListRequest = new AlibabaCloud.SDK.Dingtalkyida_1_0.Models.GetFormComponentDefinitionListRequest
            {
                SystemToken = "hexxxx",
                UserId = "manager123",
                Language = "zh_CN",
            ...
            try
            {
                client.GetFormComponentDefinitionListWithOptions("APP_PBKT0MFBEBTDO8T7SLVP", "FORM-EFxxx", getFormComponentDefinitionListRequest, getFormComponentDefinitionListHeaders, new AlibabaCloud.TeaUtil.Models.RuntimeOptions());
            }
            catch (TeaException err)
            {
...
int main(int argc, char *args[]) {
  ...
  shared_ptr<Alibabacloud_Dingtalkyida_1_0::GetFormComponentDefinitionListHeaders> getFormComponentDefinitionListHeaders = make_shared<Alibabacloud_Dingtalkyida_1_0::GetFormComponentDefinitionListHeaders>();
  getFormComponentDefinitionListHeaders->xAcsDingtalkAccessToken = make_shared<string>("<your access token>");
  shared_ptr<Alibabacloud_Dingtalkyida_1_0::GetFormComponentDefinitionListRequest> getFormComponentDefinitionListRequest = make_shared<Alibabacloud_Dingtalkyida_1_0::GetFormComponentDefinitionListRequest>(map<string, boost::any>({
    {"systemToken", boost::any(string("hexxxx"))},
    {"userId", boost::any(string("manager123"))},
    {"language", boost::any(string("zh_CN"))}
  }));
  try {
    client->getFormComponentDefinitionListWithOptions(make_shared<string>("APP_PBKT0MFBEBTDO8T7SLVP"), make_shared<string>("FORM-EFxxx"), getFormComponentDefinitionListRequest, getFormComponentDefinitionListHeaders, make_shared<Darabonba_Util::RuntimeOptions>(Darabonba_Util::RuntimeOptions()));
  }
