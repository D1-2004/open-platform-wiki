---
title: "获取实例ID列表"
source_url: "https://open.dingtalk.com/document/development/obtains-a-list-of-instance-ids"
namespace: "development"
slug: "obtains-a-list-of-instance-ids"
group: "应用开发"
tab: "服务端API"
breadcrumb: "历史文档（不推荐） > 宜搭 > 流程 > 获取实例ID列表"
doc_id: "BVehyTcvcO"
updated_at: "2025-09-08 19:03:32"
---

> Source: https://open.dingtalk.com/document/development/obtains-a-list-of-instance-ids
> Path: 应用开发 / 服务端API / 历史文档（不推荐） > 宜搭 > 流程 > 获取实例ID列表
...
>
> - 如果未使用本接口，推荐使用[获取实例ID列表](https://open.dingtalk.com/document/orgapp/api-getinstanceidlist-v2)接口。
> - 如果已使用本接口，建议您根据自身实际情况评估是否切换至推荐接口。

![](https://img.alicdn.com/imgextra/i1/O1CN010N2LDi1cEBtZLdKCY_!!6000000003568-2-tps-1008-512.png)
...
```
POST /v1.0/yida/processes/instanceIds?pageSize=Integer&pageNumber=Integer HTTP/1.1
...
```
POST /v1.0/yida/processes/instanceIds?pageSize=100&pageNumber=1 HTTP/1.1
Host:api.dingtalk.com
...
class Sample:
    ...
    def main(
        ...
        get_instance_id_list_headers = dingtalkyida__1__0_models.GetInstanceIdListHeaders()
        get_instance_id_list_headers.x_acs_dingtalk_access_token = '<your access token>'
        get_instance_id_list_request = dingtalkyida__1__0_models.GetInstanceIdListRequest(
...
func _main (args []*string) (_err error) {
  ...
  getInstanceIdListHeaders := &dingtalkyida_1_0.GetInstanceIdListHeaders{}
  getInstanceIdListHeaders.XAcsDingtalkAccessToken = tea.String("<your access token>")
  getInstanceIdListRequest := &dingtalkyida_1_0.GetInstanceIdListRequest{
...
export default class Client {
  ...
  static async main(args: string[]): Promise<void> {
    ...
    let getInstanceIdListHeaders = new $dingtalkyida_1_0.GetInstanceIdListHeaders({ });
    getInstanceIdListHeaders.xAcsDingtalkAccessToken = "<your access token>";
    let getInstanceIdListRequest = new $dingtalkyida_1_0.GetInstanceIdListRequest({
      formUuid: "FORM-EF6Yxxx",
      modifiedToTimeGMT: "2021-09-10",
      systemToken: "hexxxx",
      modifiedFromTimeGMT: "2021-05-01",
...
int main(int argc, char *args[]) {
  ...
  shared_ptr<Alibabacloud_Dingtalkyida_1_0::GetInstanceIdListHeaders> getInstanceIdListHeaders = make_shared<Alibabacloud_Dingtalkyida_1_0::GetInstanceIdListHeaders>();
  getInstanceIdListHeaders->xAcsDingtalkAccessToken = make_shared<string>("<your access token>");
  shared_ptr<Alibabacloud_Dingtalkyida_1_0::GetInstanceIdListRequest> getInstanceIdListRequest = make_shared<Alibabacloud_Dingtalkyida_1_0::GetInstanceIdListRequest>(map<string, boost::any>({
    ...
    {"searchFieldJson", boost::any(string("{"textField":"123"}"))},
  ...
  try {
    client->getInstanceIdListWithOptions(getInstanceIdListRequest, getInstanceIdListHeaders, make_shared<Darabonba_Util::RuntimeOptions>(Darabonba_Util::RuntimeOptions()));
  }
