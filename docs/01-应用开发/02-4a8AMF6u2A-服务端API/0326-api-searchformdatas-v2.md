...
slug: "api-searchformdatas-v2"
group: "应用开发"
tab: "服务端API"
breadcrumb: "宜搭 > 表单 > 查询表单实例数据"
doc_id: "sahvsZ2dQ4"
updated_at: "2026-04-22 20:26:05"
---

> Source: https://open.dingtalk.com/document/development/api-searchformdatas-v2
> Path: 应用开发 / 服务端API / 宜搭 > 表单 > 查询表单实例数据
> Updated: 2026-04-22 20:26:05

# 查询表单实例数据

调用本接口，根据表单ID查询指定表单实例数据。
...
| 字段 | 值 |
| --- | --- |
| HTTP URL | https://api.dingtalk.com/v2.0/yida/forms/instances/search |
| HTTP Method | POST |
...
| systemToken | String | 是 | 应用密钥，获取方式如下图所示： |
...
| createFromTimeGMT | String | 否 | 查询创建数据列表的开始时间，格式：`yyyy-MM-dd`。    **createFromTimeGMT**和**createToTimeGMT**两个时间构造一个时间段，查询在该时间段创建的数据列表。 |
| createToTimeGMT | String | 否 | 查询创建数据列表的结束时间，格式：`yyyy-MM-dd`。    **createFromTimeGMT**和**createToTimeGMT**两个时间构造一个时间段，查询在该时间段创建的数据列表。 |
| modifiedFromTimeGMT | String | 否 | 查询修改数据列表的开始时间，格式：`yyyy-MM-dd`。    **modifiedFromTimeGMT**和**modifiedTo**构成一个时间段，查询在该时间段有修改的数据列表。 |
| modifiedToTimeGMT | String | 否 | 查询修改数据列表的结束时间，格式：`yyyy-MM-dd`。    **modifiedFromTimeGMT**和**modifiedTo**构成一个时间段，查询在该时间段有修改的数据列表。 |
| dynamicOrder | String | 否 | 指定排序字段。 |
| useAlias | Boolean | 否 | 是否使用组件别名；开启之后，入参searchFieldJson、dynamicOrder中组件id支持以别名形式传入，同时返回值formData中组件id将以别名形式返回 |
...
```
POST /v2.0/yida/forms/instances/search HTTP/1.1
...
public class Sample {
    ...
    public static void main(String[] args_) throws Exception {
        ...
        com.aliyun.dingtalkyida_2_0.models.SearchFormDatasHeaders searchFormDatasHeaders = new com.aliyun.dingtalkyida_2_0.models.SearchFormDatasHeaders();
        searchFormDatasHeaders.xAcsDingtalkAccessToken = "<your access token>";
        com.aliyun.dingtalkyida_2_0.models.SearchFormDatasRequest searchFormDatasRequest = new com.aliyun.dingtalkyida_2_0.models.SearchFormDatasRequest()
                .setAppType("APP_PBKT0MFBEBTDO8T7SLVP")
                .setSystemToken("hexxx")
                .setUserId("173112212211")
                .setLanguage("zh_CN")
                .setFormUuid("FORM-EF6Y4G8WO2FN0SUB43TDQ3CGC3FMFQ1G9400RCJ3")
...
class Client {
  ...
  static async main(args) {
    ...
    let searchFormDatasHeaders = new dingtalkyida_2_0.SearchFormDatasHeaders({ });
    searchFormDatasHeaders.xAcsDingtalkAccessToken = '<your access token>';
    let searchFormDatasRequest = new dingtalkyida_2_0.SearchFormDatasRequest({
      appType: 'APP_PBKT0MFBEBTDO8T7SLVP',
      systemToken: 'hexxx',
      userId: '173112212211',
      language: 'zh_CN',
...
namespace AlibabaCloud.SDK.Sample
{
    public class Sample 
    {
        ...
        public static void Main(string[] args)
        {
            ...
            AlibabaCloud.SDK.Dingtalkyida_2_0.Models.SearchFormDatasHeaders searchFormDatasHeaders = new AlibabaCloud.SDK.Dingtalkyida_2_0.Models.SearchFormDatasHeaders();
            searchFormDatasHeaders.XAcsDingtalkAccessToken = "<your access token>";
            AlibabaCloud.SDK.Dingtalkyida_2_0.Models.SearchFormDatasRequest searchFormDatasRequest = new AlibabaCloud.SDK.Dingtalkyida_2_0.Models.SearchFormDatasRequest
            {
                AppType = "APP_PBKT0MFBEBTDO8T7SLVP",
                SystemToken = "hexxx",
                UserId = "173112212211",
...
| version | Long | 数据版本。 |
| creatorUserId | String | 表单创建人的userId |
