...
slug: "obtain-child-table-component-data"
group: "应用开发"
tab: "服务端API"
breadcrumb: "宜搭 > 表单 > 获取子表组件数据"
doc_id: "kuT4JYxqVw"
updated_at: "2025-09-23 19:25:29"
---

> Source: https://open.dingtalk.com/document/development/obtain-child-table-component-data
> Path: 应用开发 / 服务端API / 宜搭 > 表单 > 获取子表组件数据
> Updated: 2025-09-23 19:25:29

# 获取子表组件数据

调用本接口通过表单实例ID和子表组ID获取子表组件数据。
...
| 字段 | 值 |
| --- | --- |
| HTTP URL | https://api.dingtalk.com/v1.0/yida/forms/innerTables/{formInstanceId} |
| HTTP Method | GET |
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| formInstanceId | String | 是 | 要查询的实例的实例ID，可通过[获取多个表单实例ID](0325-api-searchformdataidlist-v2.md)接口获取。 |
...
| appType | String | 是 | 宜搭应用的唯一编码。 |
| tableFieldId | String | 是 | 需要查找的子表单组件ID。 |
| pageNumber | Integer | 否 | 分页页码。 |
| pageSize | Integer | 否 | 分页大小。 |
| systemToken | String | 是 | 应用密钥，在应用数据中获取。 |
| userId | String | 是 | 用户的userid。 |
| needRowId | Boolean | 否 | 获取子表数据的RowId。   - **true**：返回子表数据的RowId。 - **false**：不返回子表数据的RowId。 |
...
```
GET /v1.0/yida/forms/innerTables/FINST-Nxxx?formUuid=FORM-EF6xxx&appType=APP_CNNSINSKNF&tableFieldId=tableField_ksyaujq1&pageNumber=1&pageSize=100&systemToken=hexxxx&userId=manager123&needRowId=false HTTP/1.1
...
public class Sample {
    ...
    public static void main(String[] args_) throws Exception {
        ...
        com.aliyun.dingtalkyida_1_0.models.ListTableDataByFormInstanceIdTableIdHeaders listTableDataByFormInstanceIdTableIdHeaders = new com.aliyun.dingtalkyida_1_0.models.ListTableDataByFormInstanceIdTableIdHeaders();
        listTableDataByFormInstanceIdTableIdHeaders.xAcsDingtalkAccessToken = "<your access token>";
        com.aliyun.dingtalkyida_1_0.models.ListTableDataByFormInstanceIdTableIdRequest listTableDataByFormInstanceIdTableIdRequest = new com.aliyun.dingtalkyida_1_0.models.ListTableDataByFormInstanceIdTableIdRequest()
                .setFormUuid("FORM-EF6xxx")
                .setAppType("APP_CNNSINSKNF")
                .setTableFieldId("tableField_ksyaujq1")
                .setPageNumber(1)
                .setPageSize(100)
                ...
                .setNeedRowId(false);
        try {
            client.listTableDataByFormInstanceIdTableIdWithOptions("FINST-Nxxx", listTableDataByFormInstanceIdTableIdRequest, listTableDataByFormInstanceIdTableIdHeaders, new com.aliyun.teautil.models.RuntimeOptions());
...
class Sample:
    ...
    def main(
        ...
        list_table_data_by_form_instance_id_table_id_headers.x_acs_dingtalk_access_token = '<your access token>'
        list_table_data_by_form_instance_id_table_id_request = dingtalkyida__1__0_models.ListTableDataByFormInstanceIdTableIdRequest(
            ...
            app_type='APP_CNNSINSKNF',
            table_field_id='tableField_ksyaujq1',
            page_number=1,
            page_size=100,
            system_token='hexxxx',
            user_id='manager123',
        ...
        try:
            client.list_table_data_by_form_instance_id_table_id_with_options('FINST-Nxxx', list_table_data_by_form_instance_id_table_id_request, list_table_data_by_form_instance_id_table_id_headers, util_models.RuntimeOptions())
    ...
    async def main_async(
        ...
        try:
            await client.list_table_data_by_form_instance_id_table_id_with_options_async('FINST-Nxxx', list_table_data_by_form_instance_id_table_id_request, list_table_data_by_form_instance_id_table_id_headers, util_models.RuntimeOptions())
        except Exception as err:
            if not UtilClient.empty(err.code) and not UtilClient.empty(err.message):
                # err 中含有 code 和 message 属性，可帮助开发定位问题
                pass
...
class Sample {
    ...
    public static function main($args){
        ...
        $listTableDataByFormInstanceIdTableIdHeaders->xAcsDingtalkAccessToken = "<your access token>";
        $listTableDataByFormInstanceIdTableIdRequest = new ListTableDataByFormInstanceIdTableIdRequest([
            "formUuid" => "FORM-EF6xxx",
            "appType" => "APP_CNNSINSKNF",
            "tableFieldId" => "tableField_ksyaujq1",
            "pageNumber" => 1,
            "pageSize" => 100,
            "systemToken" => "hexxxx",
            "userId" => "manager123",
        ...
        try {
            $client->listTableDataByFormInstanceIdTableIdWithOptions("FINST-Nxxx", $listTableDataByFormInstanceIdTableIdRequest, $listTableDataByFormInstanceIdTableIdHeaders, new RuntimeOptions([]));
        }
        catch (Exception $err) {
...
func _main (args []*string) (_err error) {
  ...
  listTableDataByFormInstanceIdTableIdHeaders := &dingtalkyida_1_0.ListTableDataByFormInstanceIdTableIdHeaders{}
  listTableDataByFormInstanceIdTableIdHeaders.XAcsDingtalkAccessToken = tea.String("<your access token>")
  listTableDataByFormInstanceIdTableIdRequest := &dingtalkyida_1_0.ListTableDataByFormInstanceIdTableIdRequest{
    FormUuid: tea.String("FORM-EF6xxx"),
    AppType: tea.String("APP_CNNSINSKNF"),
    TableFieldId: tea.String("tableField_ksyaujq1"),
    PageNumber: tea.Int32(1),
    PageSize: tea.Int32(100),
    SystemToken: tea.String("hexxxx"),
    UserId: tea.String("manager123"),
    NeedRowId: tea.Bool(false),
  }
  tryErr := func()(_e error) {
    ...
    _, _err = client.ListTableDataByFormInstanceIdTableIdWithOptions(tea.String("FINST-Nxxx"), listTableDataByFormInstanceIdTableIdRequest, listTableDataByFormInstanceIdTableIdHeaders, &util.RuntimeOptions{})
    if _err != nil {
      return _err
    }
...
class Client {
  ...
  static async main(args) {
    ...
    let listTableDataByFormInstanceIdTableIdHeaders = new dingtalkyida_1_0.ListTableDataByFormInstanceIdTableIdHeaders({ });
    listTableDataByFormInstanceIdTableIdHeaders.xAcsDingtalkAccessToken = '<your access token>';
    let listTableDataByFormInstanceIdTableIdRequest = new dingtalkyida_1_0.ListTableDataByFormInstanceIdTableIdRequest({
      formUuid: 'FORM-EF6xxx',
      appType: 'APP_CNNSINSKNF',
      tableFieldId: 'tableField_ksyaujq1',
      pageNumber: 1,
    ...
    try {
      await client.listTableDataByFormInstanceIdTableIdWithOptions('FINST-Nxxx', listTableDataByFormInstanceIdTableIdRequest, listTableDataByFormInstanceIdTableIdHeaders, new Util.RuntimeOptions({ }));
    } catch (err) {
...
namespace AlibabaCloud.SDK.Sample
{
    public class Sample 
    {
        ...
        public static void Main(string[] args)
        {
            ...
            AlibabaCloud.SDK.Dingtalkyida_1_0.Models.ListTableDataByFormInstanceIdTableIdHeaders listTableDataByFormInstanceIdTableIdHeaders = new AlibabaCloud.SDK.Dingtalkyida_1_0.Models.ListTableDataByFormInstanceIdTableIdHeaders();
            listTableDataByFormInstanceIdTableIdHeaders.XAcsDingtalkAccessToken = "<your access token>";
            AlibabaCloud.SDK.Dingtalkyida_1_0.Models.ListTableDataByFormInstanceIdTableIdRequest listTableDataByFormInstanceIdTableIdRequest = new AlibabaCloud.SDK.Dingtalkyida_1_0.Models.ListTableDataByFormInstanceIdTableIdRequest
            {
                FormUuid = "FORM-EF6xxx",
                AppType = "APP_CNNSINSKNF",
                TableFieldId = "tableField_ksyaujq1",
            ...
            try
            {
                client.ListTableDataByFormInstanceIdTableIdWithOptions("FINST-Nxxx", listTableDataByFormInstanceIdTableIdRequest, listTableDataByFormInstanceIdTableIdHeaders, new AlibabaCloud.TeaUtil.Models.RuntimeOptions());
            }
            catch (TeaException err)
            {
