...
doc_id: "4VxVQgHOVU"
updated_at: "2026-04-24 14:10:41"
---

> Source: https://open.dingtalk.com/document/development/approval-process-prediction
> Path: 应用开发 / 服务端API / OA 审批 > 官方 OA 审批 > 审批表单 > 获取审批单流程中的节点信息
> Updated: 2026-04-24 14:10:41
...
1. 用于判断是否有自选节点，和[发起审批实例](0493-create-an-approval-instance.md)接口配合使用。
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| processCode | String | 是 | 审批流的唯一码，调用[创建或更新审批表单模板](0487-create-an-approval-form-template.md)接口或[OA审批概述-名词解释](0469-workflow-overview.md)获取。 |
