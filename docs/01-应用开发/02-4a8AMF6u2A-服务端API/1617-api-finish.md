...
doc_id: "IIwWFiBV62"
updated_at: "2026-03-06 09:27:16"
---

> Source: https://open.dingtalk.com/document/development/api-finish
> Path: 应用开发 / 服务端API / 历史文档（不推荐） > 智能交互 > AI 助理结束发消息（主动发送模式）
> Updated: 2026-03-06 09:27:16

# AI 助理结束发消息（主动发送模式）

开发者可以通过钉钉 AI 助理主动给用户发送自定义智能消息。主动发送的步骤可以分为：[预备](1615-api-prepare.md)、[更新](1616-the-ai-assistant-updates-active-message-sending-mode.md)和[结束](#)三步。本文档介绍的接口是结束接口，该接口能结束消息框的更新。
