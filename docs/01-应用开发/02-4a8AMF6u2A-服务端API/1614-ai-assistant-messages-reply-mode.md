...
source_url: "https://open.dingtalk.com/document/development/ai-assistant-messages-reply-mode"
namespace: "development"
slug: "ai-assistant-messages-reply-mode"
group: "应用开发"
tab: "服务端API"
...
开发者可以通过钉钉 AI 助理用自定义智能消息回复用户。本文档介绍的接口是回复接口，用户先与聊天对象（比如 AI 助理）发起对话，然后开发者获取到钉钉颁发的会话凭证，然后开发者可以使用会话凭证调用回复接口，回复用户的话。
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| conversationToken | String | 是 | 会话凭证。  **[!NOTE]**  凭证中保存了会话的上下文信息，包括：聊天场景（如单聊、群聊等）、聊天对象（如 AI 助理、机器人等）、会话发起人信息等。 |
| contentType | String | 是 | 消息体类型：   - **ai\_card：**AI 卡片 |
| content | String | 否 | 消息体内容，与消息体类型对应，必须是 **JSON** 格式。详见[消息体内容填写指南](1619-message-content-filling-guidance.md)。 |
...
public class Sample {
    ...
    public static void main(String[] args_) throws Exception {
        ...
        replyHeaders.xAcsDingtalkAccessToken = "<your access token>";
...
class Sample:
    ...
    def main(
        ...
        reply_headers = dingtalkai_interaction__1__0_models.ReplyHeaders()
        reply_headers.x_acs_dingtalk_access_token = '<your access token>'
        reply_request = dingtalkai_interaction__1__0_models.ReplyRequest(
            conversation_token='ctxxxx',
            content_type='ai_card',
            content='{"templateId": "xxx","cardData": {"title":"我是标题","desc":"我是描述。"}}'
        )
        try:
            client.reply_with_options(reply_request, reply_headers, util_models.RuntimeOptions())
    ...
    async def main_async(
        ...
        try:
            await client.reply_with_options_async(reply_request, reply_headers, util_models.RuntimeOptions())
        except Exception as err:
            if not UtilClient.empty(err.code) and not UtilClient.empty(err.message):
                # err 中含有 code 和 message 属性，可帮助开发定位问题
                pass
...
class Sample {
    ...
    public static function main($args){
        ...
        try {
            $client->replyWithOptions($replyRequest, $replyHeaders, new RuntimeOptions([]));
        }
        catch (Exception $err) {
...
func _main (args []*string) (_err error) {
  ...
  replyHeaders := &dingtalkaiinteraction_1_0.ReplyHeaders{}
  replyHeaders.XAcsDingtalkAccessToken = tea.String("<your access token>")
  replyRequest := &dingtalkaiinteraction_1_0.ReplyRequest{
  ...
  tryErr := func()(_e error) {
    ...
    _, _err = client.ReplyWithOptions(replyRequest, replyHeaders, &util.RuntimeOptions{})
    if _err != nil {
      return _err
    }
...
class Client {
  ...
  static async main(args) {
    ...
    let replyHeaders = new dingtalkaiInteraction_1_0.ReplyHeaders({ });
    replyHeaders.xAcsDingtalkAccessToken = '<your access token>';
    let replyRequest = new dingtalkaiInteraction_1_0.ReplyRequest({
      conversationToken: 'ctxxxx',
      contentType: 'ai_card',
      content: '{"templateId": "xxx","cardData": {"title":"我是标题","desc":"我是描述。"}}',
    });
    try {
      await client.replyWithOptions(replyRequest, replyHeaders, new Util.RuntimeOptions({ }));
    } catch (err) {
...
namespace AlibabaCloud.SDK.Sample
{
    public class Sample 
    {
        ...
        public static void Main(string[] args)
        {
            ...
            AlibabaCloud.SDK.Dingtalkai_interaction_1_0.Models.ReplyHeaders replyHeaders = new AlibabaCloud.SDK.Dingtalkai_interaction_1_0.Models.ReplyHeaders();
            replyHeaders.XAcsDingtalkAccessToken = "<your access token>";
            AlibabaCloud.SDK.Dingtalkai_interaction_1_0.Models.ReplyRequest replyRequest = new AlibabaCloud.SDK.Dingtalkai_interaction_1_0.Models.ReplyRequest
            {
                ConversationToken = "ctxxxx",
                ContentType = "ai_card",
                Content = "{\"templateId\": \"xxx\",\"cardData\": {\"title\":\"我是标题\",\"desc\":\"我是描述。\"}}",
            ...
            try
            {
                client.ReplyWithOptions(replyRequest, replyHeaders, new AlibabaCloud.TeaUtil.Models.RuntimeOptions());
            }
            catch (TeaException err)
            {
