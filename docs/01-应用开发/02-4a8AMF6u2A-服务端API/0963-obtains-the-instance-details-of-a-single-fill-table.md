...
doc_id: "DLJ4fwHEp4"
updated_at: "2025-09-12 17:19:10"
---
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| formInstanceId | String | 是 | 填表实例ID，调用[获取填表实例列表](0962-obtain-the-table-filling-instance-list-data.md)接口获取formInstanceId参数值。 |
