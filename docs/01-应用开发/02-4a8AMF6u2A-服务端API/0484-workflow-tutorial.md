...
group: "应用开发"
tab: "服务端API"
breadcrumb: "OA 审批 > 使用教程 > 审批实现及发送通知"
doc_id: "qUMnu25eGJ"
updated_at: "2025-10-21 14:05:30"
---

> Source: https://open.dingtalk.com/document/development/workflow-tutorial
> Path: 应用开发 / 服务端API / OA 审批 > 使用教程 > 审批实现及发送通知
> Updated: 2025-10-21 14:05:30
...
3. 在**基础配置**页面，完成基础信息配置。并保存[processCode](0469-workflow-overview.md)。
...
2. 修改`com.config.Constant.java`文件：
   ...
   | **配置项** | **说明** |
   | --- | --- |
   | CORP\_ID | 企业[CorpId](https://open.dingtalk.com/document/development/development-basic-concepts#section-bbk-mv0-oxd)。 |
   | APPKEY | 应用[Client ID](https://open.dingtalk.com/document/development/development-basic-concepts#section-pje-9wf-l7c)。 |
   | APPSECRET | 应用[Client Secret](https://open.dingtalk.com/document/development/development-basic-concepts#section-pje-9wf-l7c)。 |
   | PROCESS\_CODE | 审批表单[Code](0469-workflow-overview.md)。 |
