...
| apply\_id | Number | 否 | 7438532 | 商旅审批单ID，调用[获取申请单列表](1024-search-enterprise-approval-form-data.md)接口获取。 |
...
| thirdpart\_apply\_id | String | 否 | 123 | 第三方申请单ID，调用[获取申请单列表](1024-search-enterprise-approval-form-data.md)接口获取。 |
