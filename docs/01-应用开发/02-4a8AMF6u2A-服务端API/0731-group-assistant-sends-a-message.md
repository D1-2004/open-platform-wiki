...
doc_id: "ItyRrLUMsj"
updated_at: "2025-09-25 21:14:07"
---

> Source: https://open.dingtalk.com/document/development/group-assistant-sends-a-message
> Path: 应用开发 / 服务端API / 即时通信 > 会话管理 > 使用教程 > 群助手发送消息
> Updated: 2025-09-25 21:14:07
...
8. 进入对应群模板，提交审核，点击发布。
9. 依据**template\_id**调用[创建群](1461-create-a-scene-group-v2.md)接口，获取**openConversationId**。
10. 调用[发送群助手消息](0761-group-template-robot-message.md)接口，实现机器人群消息的发送。
...
9. 通过**template\_id**调用[创建群](1461-create-a-scene-group-v2.md)接口，获取**openConversationId**。
10. 调用[发送群助手消息](0761-group-template-robot-message.md)接口，实现机器人群消息的发送。
