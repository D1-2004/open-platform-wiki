...
doc_id: "Kccyup3xPu"
updated_at: "2025-09-11 21:04:27"
---
...
| fieldId | String | 是 | 审批表单控件ID：   - 企业内部应用，与[创建或更新审批表单模板](0487-create-an-approval-form-template.md)接口中组件`componentId`字段值保持一致。 |
