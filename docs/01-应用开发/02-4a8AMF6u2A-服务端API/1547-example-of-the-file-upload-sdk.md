...
doc_id: "VaJmPLGflq"
updated_at: "2025-09-08 19:06:47"
---

> Source: https://open.dingtalk.com/document/development/example-of-the-file-upload-sdk
> Path: 应用开发 / 服务端API / 历史文档（不推荐） > 文档/文件 > 钉盘 > 文件传输 > 文件上传流程
> Updated: 2025-09-08 19:06:47
...
>
> - 如果未使用本流程内的接口，推荐使用存储产品[获取文件上传信息](https://open.dingtalk.com/document/orgapp/obtain-storage-upload-information)接口内的文件上传流程。
> - 如果已使用本流程内的接口，建议您根据自身实际情况切换至推荐接口。

## 操作步骤

1. 调用[获取文件上传信息](https://open.dingtalk.com/document/orgapp/obtain-upload-information)接口，获取文件上传临时凭证。
...
3. 调用[添加文件（夹）](https://open.dingtalk.com/document/orgapp/add-file)接口添加钉盘文件源信息。
