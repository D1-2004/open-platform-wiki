...
| avatar\_media\_id | String | 是 | @lALPBbCc1XuaP\_rNAljNAlg | 头像图片mediaId，可以通过[上传媒体文件](0644-upload-media-files.md)接口上传图片获取mediaId。 |
| brief | String | 否 | 互动服务窗 | 机器人管理列表中的简介。 |
| desc | String | 是 | 我是描述 | 机器人主页中的服务号功能简介，最多200个字符。 |
| preview\_media\_id | String | 是 | @lALPBbCc1XuaP\_rNAljNAlg | 机器人主页中，消息预览图片的mediaId，可以通过[上传媒体文件](0644-upload-media-files.md)接口上传图片获取mediaId。 |
