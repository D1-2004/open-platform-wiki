...
doc_id: "iAoDjlJr0o"
updated_at: "2025-09-11 21:04:30"
---

> Source: https://open.dingtalk.com/document/development/api-premiumaddapprovedentryauth
> Path: 应用开发 / 服务端API / OA 审批 > 高级版专享接口 > 官方 OA 审批 > 审批钉盘空间&附件 > 授权下载审批钉盘文件
> Updated: 2025-09-11 21:04:30
...
| fileId | String | 是 | 文件fileId，可调用[获取单个审批实例详情](0494-obtains-the-details-of-a-single-approval-instance-pop.md)接口获取。      文件id是审批组件或审批评论中上传的fileId。 |
| spaceId | Long | 是 | 审批钉盘空间spaceId，可调用[获取审批钉盘空间信息](0498-obtains-the-information-about-approval-nail-disk.md)接口获取`spaceId`参数值。 |
