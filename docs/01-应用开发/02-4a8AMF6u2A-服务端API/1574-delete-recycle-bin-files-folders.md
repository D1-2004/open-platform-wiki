...
doc_id: "kBtEc8CwLi"
updated_at: "2025-09-08 19:06:51"
---
...
>
> - 如果未使用本接口，推荐使用存储产品[删除回收项](https://open.dingtalk.com/document/orgapp/delete-recycle-item)或者[批量删除回收项](https://open.dingtalk.com/document/orgapp/batch-delete-recycle-items)接口。
> - 如果已使用本接口，建议您根据自身实际情况切换至推荐接口。

调用本接口，实现删除回收站文件或文件夹，以删除回收站文件为例，具体示例如下图所示。

![](https://img.alicdn.com/imgextra/i3/O1CN01TH0mca1kqg5kNET9q_!!6000000004735-2-tps-325-645.png)
