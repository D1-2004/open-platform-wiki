...
> Path: 应用开发 / 服务端API / Teambition 项目管理 > 任务 > 项目任务 > 查询任务分组
...
| taskListIds | String | 否 | 任务分组ID集合，多个使用英文逗号隔开，可调用[查询项目](1206-query-enterprise-all-projects.md)接口，获取返回参数`taskListId`字段。 |
