...
doc_id: "uXr0mSl7Jh"
updated_at: "2025-12-08 13:08:54"
---
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| spaceId | String | 是 | 空间Id。   - 企业内部应用，调用[添加空间](https://open.dingtalk.com/document/orgapp/add-space)接口获取id参数值。 - 第三方企业应用，调用[添加空间](https://open.dingtalk.com/document/isvapp/add-space)接口获取id参数值。   **[!NOTE]**  如果空间类型为APP时，当前操作人只能查看本人在该空间内的权限，不能查看全部的权限。 |
| dentryId | String | 是 | 文件或文件夹Id。   - 企业内部应用，调用[获取文件或文件夹列表](https://open.dingtalk.com/document/orgapp/obtain-the-file-list-storage)接口获取id参数值。 - 第三方企业应用，调用[获取文件或文件夹列表](https://open.dingtalk.com/document/isvapp/obtain-the-file-list-storage)接口获取id参数值。   **[!NOTE]**  该参数值传0时，获取的是空间根目录的权限列表信息。 |
