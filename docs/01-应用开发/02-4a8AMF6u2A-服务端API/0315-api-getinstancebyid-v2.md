...
slug: "api-getinstancebyid-v2"
group: "应用开发"
tab: "服务端API"
breadcrumb: "宜搭 > 流程 > 根据流程实例ID获取流程实例"
doc_id: "E43nL1NThr"
updated_at: "2026-06-15 10:44:09"
---

> Source: https://open.dingtalk.com/document/development/api-getinstancebyid-v2
> Path: 应用开发 / 服务端API / 宜搭 > 流程 > 根据流程实例ID获取流程实例
> Updated: 2026-06-15 10:44:09

# 根据流程实例ID获取流程实例

调用本接口，根据指定流程实例ID获取流程实例详情。

## **请求**

| **基本信息** | |
| --- | --- |
| HTTP URL | https://api.dingtalk.com/v2.0/yida/processes/instancesInfos/{id} |
| HTTP Method | GET |
...
| useAlias | Boolean | 否 | 是否使用组件别名，开启之后返回值data中组件id将以别名形式返回 |
...
```
GET /v2.0/yida/processes/instancesInfos/f30233fb-72e1-xxx?appType=APP_PBKT0xxx&systemToken=hexxxx&userId=manager123&language=zh_CN&useAlias=false&formUuid=FORM-ADFC8E8E5ADE4B2F8FC2316CFC42A55CJLWZ HTTP/1.1
Host:api.dingtalk.com
x-acs-dingtalk-access-token:12wedcx
...
public class Sample {
    ...
    public static void main(String[] args_) throws Exception {
        ...
        com.aliyun.dingtalkyida_2_0.models.GetInstanceByIdRequest getInstanceByIdRequest = new com.aliyun.dingtalkyida_2_0.models.GetInstanceByIdRequest()
                ...
                .setLanguage("zh_CN")
                .setUseAlias(false)
                .setFormUuid("FORM-ADFC8E8E5ADE4B2F8FC2316CFC42A55CJLWZ");
        try {
            client.getInstanceByIdWithOptions("f30233fb-72e1-xxx", getInstanceByIdRequest, getInstanceByIdHeaders, new com.aliyun.teautil.models.RuntimeOptions());
...
class Sample:
    ...
    def main(
        ...
        get_instance_by_id_headers = dingtalkyida__2__0_models.GetInstanceByIdHeaders()
        get_instance_by_id_headers.x_acs_dingtalk_access_token = '<your access token>'
        get_instance_by_id_request = dingtalkyida__2__0_models.GetInstanceByIdRequest(
            app_type='APP_PBKT0xxx',
            system_token='hexxxx',
            user_id='manager123',
            language='zh_CN',
            use_alias=False,
            form_uuid='FORM-ADFC8E8E5ADE4B2F8FC2316CFC42A55CJLWZ'
        )
        try:
...
class Sample {
    ...
    public static function main($args){
        ...
        $getInstanceByIdRequest = new GetInstanceByIdRequest([
            ...
            "language" => "zh_CN",
            "useAlias" => false,
            "formUuid" => "FORM-ADFC8E8E5ADE4B2F8FC2316CFC42A55CJLWZ"
        ]);
        try {
...
func _main (args []*string) (_err error) {
  ...
  getInstanceByIdHeaders := &dingtalkyida_2_0.GetInstanceByIdHeaders{}
  getInstanceByIdHeaders.XAcsDingtalkAccessToken = tea.String("<your access token>")
  getInstanceByIdRequest := &dingtalkyida_2_0.GetInstanceByIdRequest{
    ...
    FormUuid: tea.String("FORM-ADFC8E8E5ADE4B2F8FC2316CFC42A55CJLWZ"),
  }
...
class Client {
  ...
  static async main(args) {
    ...
    let getInstanceByIdHeaders = new dingtalkyida_2_0.GetInstanceByIdHeaders({ });
    getInstanceByIdHeaders.xAcsDingtalkAccessToken = '<your access token>';
    let getInstanceByIdRequest = new dingtalkyida_2_0.GetInstanceByIdRequest({
      appType: 'APP_PBKT0xxx',
      systemToken: 'hexxxx',
      userId: 'manager123',
      language: 'zh_CN',
...
namespace AlibabaCloud.SDK.Sample
{
    public class Sample 
    {
        ...
        public static void Main(string[] args)
        {
            ...
            AlibabaCloud.SDK.Dingtalkyida_2_0.Models.GetInstanceByIdHeaders getInstanceByIdHeaders = new AlibabaCloud.SDK.Dingtalkyida_2_0.Models.GetInstanceByIdHeaders();
            getInstanceByIdHeaders.XAcsDingtalkAccessToken = "<your access token>";
            AlibabaCloud.SDK.Dingtalkyida_2_0.Models.GetInstanceByIdRequest getInstanceByIdRequest = new AlibabaCloud.SDK.Dingtalkyida_2_0.Models.GetInstanceByIdRequest
            {
                AppType = "APP_PBKT0xxx",
                SystemToken = "hexxxx",
                UserId = "manager123",
