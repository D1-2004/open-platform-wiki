...
slug: "query-tasks-from-the-organization-dimension"
group: "应用开发"
tab: "服务端API"
...
| 字段 | 值 |
| --- | --- |
| HTTP URL | https://api.dingtalk.com/v1.0/yida/corpTasks |
| HTTP Method | GET |
...
```
GET /v1.0/yida/corpTasks?corpId=ding123&pageSize=10&language=zh_CN&pageNumber=1&keyword={}&appTypes=["APP_xxx","APP_xxx"]&processCodes=["xx","xxx"]&userId=manager123&token=IASUDYxxx HTTP/1.1
...
public class Sample {
    ...
    public static void main(String[] args_) throws Exception {
        ...
        GetCorpTasksHeaders getCorpTasksHeaders = new GetCorpTasksHeaders();
        getCorpTasksHeaders.xAcsDingtalkAccessToken = "<your access token>";
        GetCorpTasksRequest getCorpTasksRequest = new GetCorpTasksRequest()
                .setCorpId("ding123")
                .setPageSize(10)
                .setLanguage("zh_CN")
                .setPageNumber(1)
                ...
                .setToken("IASUDYxxx");
        try {
            client.getCorpTasksWithOptions(getCorpTasksRequest, getCorpTasksHeaders, new RuntimeOptions());
...
class Sample:
    ...
    def main(
        ...
        get_corp_tasks_headers = dingtalkyida__1__0_models.GetCorpTasksHeaders()
        get_corp_tasks_headers.x_acs_dingtalk_access_token = '<your access token>'
        get_corp_tasks_request = dingtalkyida__1__0_models.GetCorpTasksRequest(
            corp_id='ding123',
            page_size=10,
            language='zh_CN',
            page_number=1,
        ...
        try:
            client.get_corp_tasks_with_options(get_corp_tasks_request, get_corp_tasks_headers, util_models.RuntimeOptions())
    ...
    async def main_async(
        ...
        try:
            await client.get_corp_tasks_with_options_async(get_corp_tasks_request, get_corp_tasks_headers, util_models.RuntimeOptions())
        except Exception as err:
            if not UtilClient.empty(err.code) and not UtilClient.empty(err.message):
                # err 中含有 code 和 message 属性，可帮助开发定位问题
                pass
...
class Sample {
    ...
    public static function main($args){
        ...
        $getCorpTasksHeaders = new GetCorpTasksHeaders([]);
        $getCorpTasksHeaders->xAcsDingtalkAccessToken = "<your access token>";
        $getCorpTasksRequest = new GetCorpTasksRequest([
            "corpId" => "ding123",
            "pageSize" => 10,
            "language" => "zh_CN",
            "pageNumber" => 1,
...
func _main (args []*string) (_err error) {
  ...
  getCorpTasksHeaders := &dingtalkyida_1_0.GetCorpTasksHeaders{}
  getCorpTasksHeaders.XAcsDingtalkAccessToken = tea.String("<your access token>")
  getCorpTasksRequest := &dingtalkyida_1_0.GetCorpTasksRequest{
  ...
  tryErr := func()(_e error) {
    ...
    _, _err = client.GetCorpTasksWithOptions(getCorpTasksRequest, getCorpTasksHeaders, &util.RuntimeOptions{})
    if _err != nil {
      return _err
    }
...
export default class Client {
  ...
  static async main(args: string[]): Promise<void> {
    ...
    let getCorpTasksHeaders = new $dingtalkyida_1_0.GetCorpTasksHeaders({ });
    getCorpTasksHeaders.xAcsDingtalkAccessToken = "<your access token>";
    let getCorpTasksRequest = new $dingtalkyida_1_0.GetCorpTasksRequest({
      corpId: "ding123",
      pageSize: 10,
      language: "zh_CN",
      pageNumber: 1,
    ...
    try {
      await client.getCorpTasksWithOptions(getCorpTasksRequest, getCorpTasksHeaders, new $Util.RuntimeOptions({ }));
    } catch (err) {
...
namespace AlibabaCloud.SDK.Sample
{
    public class Sample 
    {
        ...
        public static void Main(string[] args)
        {
            ...
            AlibabaCloud.SDK.Dingtalkyida_1_0.Models.GetCorpTasksHeaders getCorpTasksHeaders = new AlibabaCloud.SDK.Dingtalkyida_1_0.Models.GetCorpTasksHeaders();
            getCorpTasksHeaders.XAcsDingtalkAccessToken = "<your access token>";
            AlibabaCloud.SDK.Dingtalkyida_1_0.Models.GetCorpTasksRequest getCorpTasksRequest = new AlibabaCloud.SDK.Dingtalkyida_1_0.Models.GetCorpTasksRequest
            {
                CorpId = "ding123",
                PageSize = 10,
                Language = "zh_CN",
            ...
            try
            {
                client.GetCorpTasksWithOptions(getCorpTasksRequest, getCorpTasksHeaders, new AlibabaCloud.TeaUtil.Models.RuntimeOptions());
            }
            catch (TeaException err)
            {
...
int main(int argc, char *args[]) {
  ...
  shared_ptr<Alibabacloud_Dingtalkyida_1_0::GetCorpTasksHeaders> getCorpTasksHeaders = make_shared<Alibabacloud_Dingtalkyida_1_0::GetCorpTasksHeaders>();
  getCorpTasksHeaders->xAcsDingtalkAccessToken = make_shared<string>("<your access token>");
  shared_ptr<Alibabacloud_Dingtalkyida_1_0::GetCorpTasksRequest> getCorpTasksRequest = make_shared<Alibabacloud_Dingtalkyida_1_0::GetCorpTasksRequest>(map<string, boost::any>({
    ...
    {"token", boost::any(string("IASUDYxxx"))}
  }));
  try {
    client->getCorpTasksWithOptions(getCorpTasksRequest, getCorpTasksHeaders, make_shared<Darabonba_Util::RuntimeOptions>(Darabonba_Util::RuntimeOptions()));
  }
...
| data | Array | 任务列表。 |
| originatorNickName | String | 发起人姓名。 |
| processInstanceId | String | 流程实例ID。 |
| originatorName | String | 发起人昵称。 |
| finishTimeGMT | String | 结束时间。 |
| activeTimeGMT | String | 激活时间 |
| actualActionerId | String | 实际执行人ID。 |
| originatorEmail | String | 发起人邮箱。 |
| title | String | 标题。 |
| outResultName | String | 结果标题。 |
| outResult | String | 审批结果，取值：   - agree：同意 - disagree：不同意 |
| originatorPhoto | String | 发起人照片。 |
| taskType | String | 任务类型。 |
| originatorNickNameEn | String | 发起人英文昵称。 |
