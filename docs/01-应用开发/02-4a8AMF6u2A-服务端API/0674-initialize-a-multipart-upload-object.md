...
slug: "initialize-a-multipart-upload-object"
group: "应用开发"
tab: "服务端API"
breadcrumb: "文档/文件 > 存储管理 > 文件传输 > 分片上传 > 初始化文件分片上传"
doc_id: "psKPRnVdgW"
updated_at: "2025-09-12 17:20:52"
---

> Source: https://open.dingtalk.com/document/development/initialize-a-multipart-upload-object
> Path: 应用开发 / 服务端API / 文档/文件 > 存储管理 > 文件传输 > 分片上传 > 初始化文件分片上传
> Updated: 2025-09-12 17:20:52
...
步骤二：调用[获取文件分片上传信息](0675-obtains-the-information-about-multipart-uploads-of-an-object.md)接口，获取每片文件的上传信息。

步骤三：循环对每片文件执行上传操作。

步骤四：使用步骤一接口获取的上传标识uploadKey，调用[提交文件](0673-submittal-file.md)接口，完成上传。
