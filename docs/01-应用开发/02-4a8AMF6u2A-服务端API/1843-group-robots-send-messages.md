...
> Path: 应用开发 / 服务端API / 历史文档（不推荐） > 钉钉客联 > 在钉钉客联互通群中使用机器人发送消息
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| openConversationIds | Array of String | 是 | 群会话openConversationId，可调用[创建钉钉客联普通互通群](1831-create-common-group-new-version.md) / [创建钉钉客联两人互通群](1832-creating-two-groups-of-people.md)接口获取，长度限制为1～32个字符，例如：14da\*\*\*\*2760。 |
...
| atAppUserId | String | 否 | 钉外账号在业务系统内的唯一标志，可调用[创建钉钉客联钉外账号](1830-create-bc-account-association.md)接口获取，长度限制为1～64个字符，例如：1107\*\*\*\*2120。 |
