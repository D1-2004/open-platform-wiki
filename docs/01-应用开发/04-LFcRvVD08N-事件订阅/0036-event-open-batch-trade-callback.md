...
批量支付完成事件回调。配合[创建批量付款单](https://open.dingtalk.com/document/isvapp/create-batch-payment-order)，[拉起批量支付](https://open.dingtalk.com/document/isvapp/create-batch-payment-order) 接口使用，创建批量付款单并支付后，当支付处理完成时，给对应归属的ISV应用定向推送回调。
