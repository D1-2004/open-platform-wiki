...
![图片](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/3810961761/p537684.png)该事件为审批任务状态变更（定向）时推送的相关数据。
