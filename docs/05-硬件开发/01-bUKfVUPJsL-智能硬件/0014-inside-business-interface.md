...
group: "硬件开发"
tab: "智能硬件"
breadcrumb: "钉钉门禁Linux SDK接入 > SDK接口 > inside业务接口"
doc_id: "V8mGHCN5tD"
updated_at: "2025-10-09 18:05:28"
---

> Source: https://open.dingtalk.com/document/development/inside-business-interface
> Path: 硬件开发 / 智能硬件 / 钉钉门禁Linux SDK接入 > SDK接口 > inside业务接口
> Updated: 2025-10-09 18:05:28
...
| 参数 | 是否必填 | 说明 |
| --- | --- | --- |
| response | 否 | 回调函数。  在注册inside业务时，不要再去注册门禁、考勤两个单独模块。 |
