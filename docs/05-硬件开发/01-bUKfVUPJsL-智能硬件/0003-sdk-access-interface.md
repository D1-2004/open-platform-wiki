...
group: "硬件开发"
tab: "智能硬件"
breadcrumb: "钉钉SDK(通用)接入 > SDK接入接口"
doc_id: "810oeVo9oR"
updated_at: "2026-01-23 10:46:03"
---

> Source: https://open.dingtalk.com/document/development/sdk-access-interface
> Path: 硬件开发 / 智能硬件 / 钉钉SDK(通用)接入 > SDK接入接口
> Updated: 2026-01-23 10:46:03
...
3. 蓝牙数据通讯
   ...
   蓝牙数据通讯的交互流程图如下：![BEB9444A-87C8-4276-8936-3BD979B7224D](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/2306276061/p186369.png)

## dtiot\_device\_service模块接入
...
1. **init接口**
   ...
   - **device\_mac**为您设备的蓝牙MAC信息，请保证每台设备具有唯一的MAC信息。
     ...
     | product\_key | PRODUCT\_KEY | 产品的蓝牙绑定接入秘钥 |
     | --- | --- | --- |
