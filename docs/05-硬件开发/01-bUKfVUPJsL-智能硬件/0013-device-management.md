...
group: "硬件开发"
tab: "智能硬件"
breadcrumb: "钉钉门禁Linux SDK接入 > SDK接口 > 设备管理"
doc_id: "YlS3T3BpQl"
updated_at: "2025-10-09 18:05:27"
---

> Source: https://open.dingtalk.com/document/development/device-management
> Path: 硬件开发 / 智能硬件 / 钉钉门禁Linux SDK接入 > SDK接口 > 设备管理
> Updated: 2025-10-09 18:05:27
...
**接口：**int (\*init)(dtiot\_product\_info\_t \*product\_info, const char \*device\_sn,

       const char \*device\_mac, const char \*device\_name, const char \*device\_secret);
